...
{
	$.ajax({
		url: "/event/event_commajax.asp?view=l&iCC="+page+"&eventid=<%=eCode%>&linkevt=<%=LinkEvtCode%>&blnB=<%=blnBlogURL%>",
		cache: false,
		async: false,
		...
		<div class="content bgGry" id="layerScroll">
			<div id="scrollarea">
				<div class="inner5 tMar15 cmtCont">
					<div class="tab01 noMove" id="writediv" style="display:<%=CHKIIF(vView="w","block","none")%>;">
						...
						<div class="tabContainer box1">
							<div id="cmtWrite" class="tabContent">
								<form method="post" action="/event/lib/doEventComment.asp" name="upcomment" target="iframeDB" style="margin:0px;">
					...
					<form name="frmactNew" method="post" action="/event/lib/doEventComment.asp" target="iframeDB" style="margin:0px;">
