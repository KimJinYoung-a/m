...
<%
    ...
    categoryCode = request("disp") '' 카테고리코드
...
<!-- Category Component -->
	<script src="/vue/components/category/ctgr_nav_type1.js?v=1.0"></script>
...
<!-- Product Component -->
	<script src="/vue/components/product/prd_list_photo2.js?v=1.1"></script>
    ...
    <script src="/vue/components/product/modal_filter.js?v=1.1"></script>
<!-- //Product Component -->
...
<!-- 핵심 JS -->
<script src="/vue/category/Detail/store.js?v=1.02"></script>
<script src="/vue/category/Detail/index.js?v=1.04"></script>
<!-- //핵심 JS -->