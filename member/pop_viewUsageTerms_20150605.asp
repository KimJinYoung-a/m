			...
			<div id="scrollarea">
				...
				<div class="inner5">
					...
					<div class="policyCont">
						...
						<section id="terms07">
							<h3>[제 7장 기타]</h3>
							<h4>제 26조 (저작권의 귀속 및 게시물 이용 제한)</h4>
						...
						<p class="startDate">2012년 08월 21일부터 시행합니다. (2012.08.21 개정)</p>
						<p class="fs11 tPad05 lPad05"><a href="" onclick="fnOpenModal('/member/pop_viewUsageTerms.asp'); return false;" style="text-decoration:underline;">개정 후 서비스 약관 보기</a></p>
					</div>
				</div>
				<!--// 이용약관 -->
			</div>
