...
<div class="heightGrid">
	...
	<%
	'### SNS 변수선언
	Dim vTitle, vSquareImg, snpTitle, snpLink, snpPre, snpTag, snpTag2, snpImg, kakaotitle, kakaoimage, kakaoimg_width, kakaoimg_height, kakaolink_url
	vTitle = "[텐바이텐] PLAYing"
	vSquareImg = "http://webimage.10x10.co.kr/eventIMG/2016/74503/Plaing_th.jpg"
	snpTitle	= Server.URLEncode(vTitle)
	snpLink		= Server.URLEncode(wwwUrl&"/playing/list.asp?cate="&vCate&"&page="&vPage&"")	'### PC주소
	...
	If isapp = "1" Then '앱일경우
		kakaolink_url = "http://m.10x10.co.kr/apps/appcom/wish/web2014/playing/list.asp?cate="&vCate&"&page="&vPage
	Else '앱이 아닐경우
		kakaolink_url = "http://m.10x10.co.kr/playing/list.asp?cate="&vCate&"&page="&vPage
	End If
	%>
	<script>
	// SNS 공유 팝업
