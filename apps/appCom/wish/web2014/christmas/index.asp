...
<%
    ...
    if GetLoginUserLevel<>"7" then
        if now() < #11/23/2020 00:00:00# then
            response.redirect "/apps/appcom/wish/web2014/christmas/2019/"
        end if
    end if
...
<body class="default-font body-<%=chkiif(gnbflag,"main","sub")%>">
	<div id="content" class="content xmas2020">
						...
						<article class="swiper-slide prd_item">
							...
							<div class="prd_info">
								<div class="prd_price">
									...
									<span class="discount"><dfn>할인율</dfn><em>더블할인</em></span>
									<% else %>
							...
							<a href="#" onclick="TnGotoProduct('<%=oExhibition.FItemList(i).Fitemid%>');return false;" class="prd_link"><span class="blind">상품 바로가기</span></a>
						</article>
						<% next %>
					</div>
				</div>
		...
		<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=107401');return false;" class="bnr_mkt"><img src="//webimage.10x10.co.kr/fixevent/event/2020/xmas/m/bnr_mkt.jpg" alt="마케팅 배너"></a>
		<% elseif date() >= "2020-11-30" and date() <= "2020-12-06"  then %>
		<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=107776');return false;" class="bnr_mkt"><img src="//webimage.10x10.co.kr/fixevent/event/2020/xmas/m/bnr_mkt_v2.jpg" alt="마케팅 배너"></a>
		<% elseif date() >= "2020-12-07" and date() <= "2020-12-13"  then %>
		<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=107790');return false;" class="bnr_mkt"><img src="//webimage.10x10.co.kr/fixevent/event/2020/xmas/m/bnr_mkt_v3.jpg" alt="마케팅 배너"></a>
		<% end if %>

		<!-- 이벤트(수작업) -->
		<section class="xmas_event">
			<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=107444');return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2020/xmas/m/img_event.jpg" alt="event"></a>
			<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=107466');return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2020/xmas/m/img_ch1.jpg?v=2" alt="chapter1"></a>
			<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=107467');return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2020/xmas/m/img_ch2.jpg?v=2" alt="chapter2"></a>
			<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=107468');return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2020/xmas/m/img_ch3.jpg?v=2" alt="chapter3"></a>
		</section>

		<%' 상품리스트 %>
		<div id="app" v-cloak></div>

		<a href="#xmas_item" class="btn_cate" style="display:none;"><img src="//webimage.10x10.co.kr/fixevent/event/2020/xmas/m/btn_cate.png" alt="카테고리보기"></a>
	</div>
