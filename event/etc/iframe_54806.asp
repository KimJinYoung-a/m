...
<%
'########################################################
' 3rd AROUND CAMPING FESTIVAL - for mobileWeb
' 2014-09-03 이종화 작성
'########################################################
Dim eCode
...
.shareAround {position:relative;}
.shareAround .btnShare {position:absolute; left:0; bottom:18%; width:100%; text-align:center;}
...
<!--
	...
	function jsSubmitComment(frm){
	   ...
	   frm.action = "doEventSubscript54806.asp";
	   return true;
	}
...
<div class="mEvt54806">
	...
	<div class="applyCamping">
		<div class="cmtField">
			...
			<div class="writeCmt">
				<textarea title="코멘트 작성" cols="60" rows="5" id="writearea" name="txtcomm" onClick="jsChklogin11('<%=IsUserLoginOK%>');" onblur="jsChkUnblur()" onKeyUp="jsChklogin11('<%=IsUserLoginOK%>');return Limit(this);" <%IF NOT IsUserLoginOK THEN%>readonly<%END IF%> autocomplete="off" maxlength="100">100자 이내로 입력해주세요.</textarea>
			</div>
