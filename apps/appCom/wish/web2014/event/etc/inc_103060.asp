...
'// SNS 공유용
	...
	snpTitle	= Server.URLEncode("[마일리지 나눔 이벤트]")
	snpLink		= Server.URLEncode("http://m.10x10.co.kr/event/eventmain.asp?eventid="& moECode)
	snpPre		= Server.URLEncode("10x10 이벤트")
	snpImg		= Server.URLEncode("http://webimage.10x10.co.kr/fixevent/event/2020/103060/m/img_kakao.jpg")
	appfblink	= "http://m.10x10.co.kr/event/eventmain.asp?eventid="& moECode

	'// 카카오링크 변수
	Dim kakaotitle : kakaotitle = "[마일리지 나눔 이벤트]"
	Dim kakaodescription : kakaodescription = "단 2일간! 마일리지 2,222원으로 추가 할인 받으세요!"
	Dim kakaooldver : kakaooldver = "단 2일간! 마일리지 2,222원으로 추가 할인 받으세요!"
	Dim kakaoimage : kakaoimage = "http://webimage.10x10.co.kr/fixevent/event/2020/103060/m/img_kakao.jpg"
...
%>
<style>
.mEvt103060 {position:relative; background:#ff7d36;}
.mEvt103060 .topic {position:relative;}
.mEvt103060 .txt-only {position:absolute; right:0; top:36%; width:33%; animation:bounce 1s 10 both;}
.mEvt103060 .btn-get {width:100%; margin-bottom:-1px;}
.mEvt103060 .share {position:relative;}
.mEvt103060 .share button {position:absolute; top:0; right:27%; width:18%; height:100%; text-indent:-999em; background:none;}
.mEvt103060 .share button:last-child {right:7%;}
@keyframes bounce {
...
<div class="mEvt103060">
	<div class="topic">
		<h2><img src="//webimage.10x10.co.kr/fixevent/event/2020/103060/m/tit_mileage.jpg" alt="2222 마일리지"></h2>
		<span class="txt-only"><img src="//webimage.10x10.co.kr/fixevent/event/2020/103060/m/txt_only.png" alt="단 2일간"></span>
	</div>
	<!-- for dev msg : 마일리지 받기 버튼-->
	<button type="button" onclick="doAction();" class="btn-get"><img src="//webimage.10x10.co.kr/fixevent/event/2020/103060/m/btn_get.jpg" alt="마일리지 받기"></button>
	<p><img src="//webimage.10x10.co.kr/fixevent/event/2020/103060/m/txt_tip_01.jpg" alt="꿀팁"></p>
	<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=102947');" target="_blank">
		<img src="//webimage.10x10.co.kr/fixevent/event/2020/103060/m/txt_tip_02.jpg" alt="판도라">
	</a>
	<p><img src="//webimage.10x10.co.kr/fixevent/event/2020/103060/m/txt_guide.jpg" alt="결제시"></p>
	<!-- for dev msg : 공유하기 -->
	<div class="share">
		<img src="//webimage.10x10.co.kr/fixevent/event/2020/103060/m/img_share.jpg" alt="친구에게 공유하기">
		<button type="button" onclick="snschk('fb');">페이스북</button>
		<button type="button" onclick="snschk('kt');">카카오톡</button>
	</div>
	<p><img src="//webimage.10x10.co.kr/fixevent/event/2020/103060/m/txt_noti.jpg" alt="유의사항"></p>
</div>
