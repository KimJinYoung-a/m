...
function getRecentlyViewedProductsApp(products){
	...
	fnAPPpopupBrowserURL("최근 본 상품","<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/mytodayshopping.asp?itemarr="+products.join(','));
}
function tencardreg(){
	//'카드 발급
	if (confirm('포인트카드를 발급 받으시겠습니까?')){
		var rstStr = $.ajax({
			type: "POST",
			url: "/apps/appcom/wish/web2014/my10x10/dotentencard.asp",
			dataType: "text",
			async: false
		}).responseText;
		if (rstStr == "0000"){
...
<div id="content" class="content">
	...
	<div class="my10x10-menu column-2">
		<ul>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('주문/배송조회','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/order/myorderlist.asp'); return false;">
					<span class="icon icon-order"></span>
					<span class="name">주문/배송조회</span>
				</a>
			</li>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('1:1 상담','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/qna/myqnalist.asp'); return false;">
	...
	<div class="my10x10-menu column-3 member-benefit">
		...
		<div class="btn-group">
			<a href="" onclick="fnAPPpopupBrowserURL('회원가입','<%=wwwUrl%>/apps/appCom/wish/web2014/member/join.asp');return false;" class="btn btn-red btn-large btn-block">텐바이텐 회원가입</a>
		</div>
	</div>
	<% else %>
	<div id="myProfile" class="my-profile">
		...
		<div class="toolbar">
			<a href="" onclick="fnAPPpopupNotiList();return false;" class="btn-alarm">알림</a>
			<a href="" onclick="fnAPPpopupSetting();return false;" class="btn-setting">설정</a>
		</div>
	</div>
	...
	<div class="my-profile-glade">
        ...
        <div class="my-profile">
            <a href="" onclick="fnAPPpopupBrowserURL('트로피룸','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/userinfo/mygrade.asp','right');return false;" class="btn-arrow">등급 혜택보기</a>
        </div>
    </div>
			...
			<div class="swiper-wrapper">
				<section class="swiper-slide mileage">
					<div class="article">
						...
						<a href="" onclick="fnAPPpopupBrowserURL('마일리지 내역','<%=wwwUrl%>/apps/appCom/wish/web2014/offshop/point/mileagelist.asp','right','','sc');return false;" class="linkarea">
				...
				<section class="swiper-slide coupon">
					<div class="article">
						<% If left(now(),10) >= "2021-10-05" And left(now(),10) < "2021-11-01" Then %>					
							<a href="" onclick="fnAPPpopupBrowserURL('사용가능한 쿠폰','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/couponbook.asp?tab=1','right','','sc');return false;" class="linkarea">
						<% Else %>
							<a href="" onclick="fnAPPpopupBrowserURL('사용가능한 쿠폰','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/couponbook.asp?tab=2','right','','sc');return false;" class="linkarea">
						<% End If %>
						...
						<a href="" onclick="fnAPPpopupBrowserURL('쿠폰등록','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/changecoupon.asp','right','','sc');return false;" class="btn-more-plus">쿠폰등록</a>
						<div class="btn-group">
							<% If left(now(),10) >= "2020-10-05" And left(now(),10) < "2020-10-30" Then %>						
								<a href="" onclick="fnAPPpopupBrowserURL('쿠폰북','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/couponbook.asp?tab=3','right','','sc');return false;" class="btn-half">사용가능한 쿠폰</a>
							<% Else %>
								<a href="" onclick="fnAPPpopupBrowserURL('쿠폰북','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/couponbook.asp','right','','sc');return false;" class="btn-half">사용가능한 쿠폰</a>
							<% End If %>
							<a href="" onclick="fnAPPpopupBrowserURL('쿠폰북','<%=wwwUrl%>/apps/appCom/wish/web2014/shoppingtoday/couponshop.asp','right','','sc');return false;" class="btn-half">쿠폰북</a>
						</div>
					</div>
				</section>
				<section class="swiper-slide balance">
					<div class="article">
						<a href="" onclick="fnAPPpopupBrowserURL('예치금 내역확인','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/deposit/mydepositlist.asp','right','','sc'); return false;">
						...
						<div class="btn-group">
							<a href="" onclick="fnAPPpopupBrowserURL('예치금 안내','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/popDeposit.asp','right','','sc'); return false;" class="btn-half">예치금 안내</a>
				...
				<section class="swiper-slide giftcard">
					<div class="article">
						...
						<a href="" onclick="fnAPPpopupBrowserURL('기프트카드 내역','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/giftcard/giftcardUseHistory.asp','right','','sc');return false;" class="linkarea">
						...
						<!--<a href="" onclick="fnAPPpopupBrowserURL('카드등록','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/giftcard/giftcardRegist.asp','right','','sc');return false;" class="btn-more-plus">기프트카드 &gt; 카드등록</a>-->
						<div class="btn-giftcard"><a href="" onclick="fnAPPpopupBrowserURL('바코드','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/giftcard/giftcardBarcode.asp'); return false;">텐바이텐 기프트카드 보기</a></div>
						<div class="btn-group">
							<a href="" onclick="fnAPPpopupBrowserURL('기프트카드 안내','<%=wwwUrl%>/apps/appCom/wish/web2014/giftcard/usageNotice.asp','right','','sc');return false;" class="btn-half">기프트카드 안내</a>
							<a href="" onclick="fnAPPpopupBrowserURL('주문/등록 내역','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/giftcard/giftCardList.asp','right','','sc');return false;" class="btn-half">주문/등록 내역</a>							
						</div>
					</div>
				</section>
			</div>
		...
		<div class="swiper-container">
			...
			<% If request.cookies("uinfo")("isTester") Then %>
				<div class="swiper-slide tester">
					<a href="" onclick="fnAPPpopupBrowserURL('테스터후기','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10//mytester/'); return false;"><p><span class="icon icon-mileage"></span><b>테스터 후기</b>를 작성해주세요<span class="icon icon-arrow"></span></p></a>
				</div>
			<% End If %>
				<%'!-- for dev msg : 주문/배송조회 알림 배너 --%>
				<% If mymainClass.FOneItem.FOrderSerial <> "" Then %>
				<div class="swiper-slide order">
					<a href="" onclick="fnAPPpopupBrowserURL('주문상세조회','<%=wwwUrl%>/apps/appcom/wish/web2014/my10x10/order/myorderdetail.asp?idx=<%=mymainClass.FOneItem.FOrderSerial%>','right','','sc'); return false;"><p><span class="icon icon-car"></span>주문하신 <b><span class="ellipsis"><%=mymainClass.FOneItem.FOrderItemNames%></span>
			...
			<% If vMileArr(0,0) > 0 Then %>
				<div class="swiper-slide review review-event">
					<a href="" onclick="fnAPPpopupBrowserURL('상품후기','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/goodsusing.asp'); return false;"><p><span class="icon icon-mileage<%=chkiif(isdoubleMileage,"x2","")%>"></span><%=chkiif(isdoubleMileage,"[더블 마일리지 이벤트]<br /> ","")%>모든 후기를 작성하면 <b><%=FormatNumber(vMileArr(1,0),0)%>p </b> 적립!<span class="icon icon-arrow"></span></p></a>
				</div>
			<% End If %>
			</div>
	...
	<div class="my10x10-menu column-2">
		<ul>
			<li>
				<a href="" onclick="fnAPPmoveTabMenu('order');return false;">
					<span class="icon icon-order"></span>
					<span class="name">주문/배송조회</span>
					<% If mycount(0) > 0 Then %>
			...
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('상품후기','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/goodsusing.asp','right','','sc'); return false;">
	...
	<div class="my10x10-menu type-row">
		<ul>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('1:1 상담','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/qna/myqnalist.asp','right','','sc'); return false;">
					<span class="icon icon-cs"></span>
					<span class="name">1:1 상담</span>
					<% If mycount(3) > 0 Then %>
			...
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('상품Q&amp;A','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/myitemqna.asp','right','','sc'); return false;">
			...
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('반품/환불','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/order/myorder_return_step1.asp','right','','sc'); return false;">
					<span class="icon icon-ret"></span>
					<span class="name">반품/환불</span>
				</a>
			</li>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('내가 신청한 서비스','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/order/order_cslist.asp','right','','sc'); return false;">
					<span class="icon icon-myret"></span>
					<span class="name">내가 신청한 서비스</span>
				</a>
			</li>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('입고 알림 신청내역','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/MyAlarmHistory.asp','right','','sc'); return false;">
					<span class="icon icon-warehousing"></span>
					<span class="name">입고 알림 신청내역</span>
				</a>
			</li>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('당첨안내','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/myeventmaster.asp','right','','sc'); return false;">
					<span class="icon icon-win"></span>
					<span class="name">이벤트 당첨안내</span>
				</a>
			</li>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('기프티콘 상품교환','<%=wwwUrl%>/apps/appcom/wish/web2014/gift/gifticon/'); return false;">
			...
			<% if IsUserLoginOK then %>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('찜 브랜드','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/myzzimbrand.asp','right','','sc'); return false;">
	...
	<section id="mywishSwiper" class="my10x10-menu item-carousel-4">
		<h3 class="headline"><a href="" onclick="fnAPPpopupBrowserURL('위시','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/myWish/myWish.asp','right','','sc'); return false;">나의 위시상품</a></h3>
			...
			<ul class="swiper-wrapper">
				...
				<li class="swiper-slide">
					<a href="<%=chkiif(wi = (mymainWishitem.FResultCount - 1),"/my10x10/mywish/mywish.asp","/category/category_itemprd.asp?itemid="& mymainWishitem.FItemList(wi).Fitemid &"")%>"
						...
						onclick="fnAPPpopupBrowserURL('위시','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/myWish/myWish.asp','right','','sc'); return false;"
						<% Else %>
						onclick="fnAPPpopupProduct('<%=mymainWishitem.FItemList(wi).Fitemid%>');return false;"
						<% End If %>>
	...
	<div class="my10x10-menu column-3">
		...
		<ul>
			<% if IsUserLoginOK then %>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('개인정보수정','<%=M_SSLUrl%>/apps/appCom/wish/web2014/my10x10/userinfo/membermodify.asp','right','','sc'); return false;">
			...
			<% end if %>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('나의 주소록','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/MyAddress/MyAddressList.asp','right','','sc'); return false;">
					<span class="icon icon-address"></span>
					<span class="name">주소록 관리</span>
				</a>
			</li>
			<li>
				<a href="" onclick="fnAPPpopupBrowserURL('나의 기념일','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/MyAnniversary/MyAnniversaryList.asp','right','','sc'); return false;">
...
<script src="/vue/components/linker/modal_profile_write.js?v=1.0"></script>
