...
dim limitItemCNT, itemName, oEvent, arrEvtInfo, eCode, moECode, mktTest
	...
	if(itemList.length > 0){
		...
		newArr.forEach(function(item){
            ...
            tmpEl = '\
                ...
                <div class="limit-bar"><%=limitItemCNT%>대 한정 수량</div>\
                <dl class="prd-info">\
