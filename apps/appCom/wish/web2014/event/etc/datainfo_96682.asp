...
<%
'####################################################
' Description : 2019 추석 보너스 이벤트 데이터
...
if LoginUserid="ley330" or LoginUserid="greenteenz" or LoginUserid="rnldusgpfla" or LoginUserid="cjw0515" or LoginUserid="thensi7" Then		
        ...
        sqlStr = sqlStr & "    WHERE e.evt_code=96682 "
        'sqlStr = sqlStr & "    WHERE e.evt_code=90368 "
        sqlStr = sqlStr & "                    AND e.sub_opt3='draw' "
