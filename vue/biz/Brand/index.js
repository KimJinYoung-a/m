var app = new Vue({
    ...
    template: /*html*/`
		<div id="content" class="content brand_detail">
            ...
            <header class="head_type1 head_biz_type1">
                <span class="txt">{{number_format(product_count)}}건의</span>
                <h2 class="ttl">상품이 있어요</h2>
            </header>
            
            <!-- 정렬바 -->
            <Sortbar
                v-show="product_count > 0 || is_filter_searched"
                ref="sort_bar"
                :sort="sort_method"
                :kkomkkom_flag="true"
    ...
    created() {
        ...
        this.$store.dispatch("GET_BRAND_LIST", this.brand_id);
    },
    ...
    mounted() {
        ...
        fnAmplitudeEventMultiPropertiesAction('view_biz_brand','brand_id',this.brand_id);
    },
