...
IF application("Svr_Info") = "Dev" THEN
	...
	'head.asp에서 출력
	strOGMeta = strOGMeta & "<meta property=""og:title"" content=""텐텐 초이스"">" & vbCrLf
	strOGMeta = strOGMeta & "<meta property=""og:type"" content=""website"" />" & vbCrLf
	strOGMeta = strOGMeta & "<meta property=""og:url"" content=""http://m.10x10.co.kr//shoppingtoday/10x10choice.asp"" />" & vbCrLf
	strOGMeta = strOGMeta & "<meta property=""og:image"" content=""" & ogImg & """>" & vbCrLf
	strOGMeta = strOGMeta & "<meta property=""og:description"" content=""텐바이텐이 선택한 수입브랜드, 콜라보, PB상품을 소개합니다!"">" & vbCrLf

	'// 타이틀 지정
	strPageKeyword = "텐텐초이스, 수입브랜드, 콜라보, PB상품"
	strHeadTitleName = "텐텐 초이스"
%>
