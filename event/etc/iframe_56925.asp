...
<style type="text/css">
.xmasVillage {background-color:#f5f5f5;}
.xmasVillage img {width:100%; vertical-align:top;}
.xmasVillage .hgroup {position:relative;}
.xmasVillage .deco {position:absolute; top:0; left:0; width:100%;}
.find-presentbox {position:relative;}
.presentbox {position:absolute; bottom:0; right:3%; width:25.6%; padding-bottom:16.6%;}
...
.presentbox a {background-image:url(http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/btn_present_village_off.png);}
.presentbox span {background-image:url(http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/btn_present_village_on.png);}
/*present box layer popop*/
#lyPresent {display:none; position:absolute; top:10%; left:50% !important; z-index:210; width:84%; margin-left:-42%; border:5px solid #b3915c; background-color:#fff;}
...
<div class="evtCont evtView">
	<!-- MINI VILLAGE -->
	<div class="xmasVillage">
		<div class="hgroup">
			<span class="deco animated fadeIn"><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/img_deco_village.png" alt="" /></span>
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/txt_mini_village.gif" alt="우리 아이에게 크리스마스 마을을 선물하세요" /></p>
		</div>
		...
		<div class="find-presentbox">
			...
			<div><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/img_village.jpg" alt="" /></div>
			...
			<div id="lyPresent">
				<div class="lyPresent window">
					<div class="present">
						...
						<div class="coupon"><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/img_xmas_coupon_04.gif" alt="3만원 이상 구매시 3천원 할인 쿠폰 일부상품 제외" /></div>
