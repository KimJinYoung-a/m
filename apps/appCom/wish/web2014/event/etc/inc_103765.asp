...
'// SNS 공유용
	...
	snpTitle	= Server.URLEncode("[마일리지 100% 증정 이벤트]")
	snpLink		= Server.URLEncode("http://m.10x10.co.kr/event/eventmain.asp?eventid="& moECode)
	snpPre		= Server.URLEncode("10x10 이벤트")
	snpImg		= Server.URLEncode("http://webimage.10x10.co.kr/fixevent/event/2020/103765/m/img_kakao.jpg")
	appfblink	= "http://m.10x10.co.kr/event/eventmain.asp?eventid="& moECode

	'// 카카오링크 변수
	Dim kakaotitle : kakaotitle = "[마일리지 100% 증정 이벤트]"
	Dim kakaodescription : kakaodescription = "단 2일간 드립니다. 마일리지 2,222원으로 추가 할인 받으세요!"
	Dim kakaooldver : kakaooldver = "단 2일간 드립니다. 마일리지 2,222원으로 추가 할인 받으세요!"
	Dim kakaoimage : kakaoimage = "http://webimage.10x10.co.kr/fixevent/event/2020/103765/m/img_kakao.jpg"
...
<div class="evt-mileage">
	<!-- for dev msg : 마일리지 받기 -->
	<button type="button" onclick="doAction();" class="btn-get"><img src="//webimage.10x10.co.kr/fixevent/event/2020/103765/m/tit_2222.jpg" alt="마일리지 받기"></button>
	<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/benefit/');" target="_blank">
		<img src="//webimage.10x10.co.kr/fixevent/event/2020/103765/m/txt_tip_1.jpg" alt="혜택">
	</a>
	<p><img src="//webimage.10x10.co.kr/fixevent/event/2020/103765/m/txt_tip_2.jpg" alt="차이"></p>
	<a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=103720');" target="_blank">
		<img src="//webimage.10x10.co.kr/fixevent/event/2020/103765/m/bnr_evt.jpg" alt="여름 문구 쇼핑하기">
	</a>
	<p><img src="//webimage.10x10.co.kr/fixevent/event/2020/103765/m/txt_guide.jpg" alt="결제시"></p>
	<!-- for dev msg : 공유하기 -->
	<button type="button" onclick="snschk('kt');" class="btn-share"><img src="//webimage.10x10.co.kr/fixevent/event/2020/103765/m/bnr_share.jpg" alt="공유하기"></button>
	<p><img src="//webimage.10x10.co.kr/fixevent/event/2020/103765/m/txt_noti.jpg" alt="유의사항"></p>
</div>
