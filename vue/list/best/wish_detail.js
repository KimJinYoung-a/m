var app = new Vue({
    el: '#app',
    store: store,
    template: `<div id="content" class="content best_wish">
    ...
    created() {
        this.$store.commit('SET_DETAIL_TYPE', 'wish'); // SET 상세 구분값
        ...
        // 상품 목록 불러오기
        this.$store.commit('SET_URI', '/best/wish/more');
    ...
    mounted() {
        ...
        fnAmplitudeEventObjectAction('view_best_wish', {
            'category_code' : 0,
            'category_name' : '전체',
            'paging_index' : 1
        });
