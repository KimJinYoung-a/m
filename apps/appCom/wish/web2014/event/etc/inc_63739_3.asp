...
<%
'####################################################
' Description : 아이러브떡볶이 3차
' History : 2015.06.24 한용민 생성
'####################################################
%>
<style type="text/css">
...
.topic ul li.nav1 {width:25%;}
.topic ul li.nav2 {width:26%;}
.topic ul li.nav3 {width:46%;}
...
.topic ul li.nav1 strong {padding-bottom:62.25%;}
.topic ul li.nav2 strong {margin-left:2%; padding-bottom:59.25%;}
.topic ul li.nav3 strong {margin-left:2%; padding-bottom:33.25%;}
.topic ul li span {position:absolute; top:0; left:0; width:100%; height:100%; /*background-color:black; opacity:0.3;*/}

.make {padding-bottom:8%; background:#ffd674 url(http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/bg_pattern.png) repeat-y 50% 0; background-size:100% auto;}
...
.make .step ol li span button {display:block; background-color:transparent; background-image:url(http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/bg_type.jpg); background-repeat:no-repeat; background-position:0 0; background-size:279px auto;}
...
.make .step ol li.step2 button {background-image:url(http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/bg_source.jpg);}
.make .step ol li.step3 button {background-image:url(http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/bg_noodles.jpg);}
...
.present .btncoupon {position:absolute; bottom:5.5%; left:50%; width:53.6%; margin-left:-26.8%;}
...
<script type="text/javascript">
	...
	function kakaosendcall(){
		<% if not( left(currenttime,10)>="2015-06-26" and left(currenttime,10)<"2015-06-29" ) then %>
			alert("이벤트 응모 기간이 아닙니다.");
			return;
		<% else %>
			var rstStr = $.ajax({
				type: "POST",
				url: "/apps/appCom/wish/web2014/event/etc/doEventSubscript63739_3.asp",
				data: "mode=KAKAO",
				dataType: "text",
				async: false
			}).responseText;
...
<% '<!-- [APP] 푸드파이터 2탄 I ♥ 치킨 --> %>
<div class="mEvt63739">
	<% '<!-- for dev msg : 이미지 폴더 coffee에서 6/23~6/25 : chicken, 6/26부터는 tteokbokki 폴더로 바꿔주세요 --> %>
	<section>
		<div class="topic">
			<h1><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/tit_i_love.png" alt="아이 러브 떡볶이" /></h1>
			<p>원하는 재료로 나만의 떡볶이를 만들면, 매일 500명에게 진짜 떡볶이가 찾아갑니다!</p>
			<% '<!-- for dev msg : 3탄 떡볶이 클릭시 alert msg --> %>
			<ul>
				<li class="nav1"><strong><span></span>1탄 커피</strong></li>
				<li class="nav2"><strong><span></span>2탄 치킨</strong></li>
				<li class="nav3"><strong><span></span>3탄 떡볶이</strong></li>
			</ul>
		</div>

		<div class="make">
			<div class="inner">
				<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/txt_choice.png" alt="원하는 취향을 클릭해주세요!" /></p>

				<div class="step">
					<ol>
						<li class="step1">
							<strong><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/txt_choice_01.png" alt="떡종류 선택" /></strong>
							<% '<!-- for dev msg : 진행중인 단계에는 클래스 ing / 선택시 클래스명 on 입니다. --> %>
							<span class="vs1"><button type="button" ID="select1" onclick="chselect('1');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_box_transprent.png" alt="배달" /></button></span>
							<span class="vs2"><button type="button" ID="select2" onclick="chselect('2');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_box_transprent.png" alt="매장" /></button></span>
						</li>
						<li class="step2">
							<strong><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/txt_choice_02.png" alt="소스 선택" /></strong>
							<span class="vs1"><button type="button" ID="select3" onclick="chselect('3');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_box_transprent.png" alt="양념" /></button></span>
							<span class="vs2"><button type="button" ID="select4" onclick="chselect('4');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_box_transprent.png" alt="후라이드" /></button></span>
						</li>
						<li class="step3">
							<strong><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/txt_choice_03.png" alt="사리 선택" /></strong>
							<span class="vs1"><button type="button" ID="select5" onclick="chselect('5');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_box_transprent.png" alt="콜라" /></button></span>
							<span class="vs2"><button type="button" ID="select6" onclick="chselect('6');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_box_transprent.png" alt="맥주" /></button></span>
						</li>
					</ol>
				</div>

				<a href="" onclick="goAvengers(); return false;" class="btnmake"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/btn_make.png" alt="만들어 주세요!" /></a>
				<!--button type="button" class="btnmake"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/btn_make.png" alt="만들어 주세요!" /></button-->
			</div>
		</div>
		...
		<div class="gift">
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_gift.jpg" alt="깜짝선물을 드려요! 죠스떡볶이 떡볶이 튀김 순대 500명, 반8 김밥 튀김 세트 10명, 추천상품 할인 쿠폰 랜덤" /></p>
			<% '<!-- for dev msg : 계란후라이타월 링크 --> %>
			<a href="" onclick='fnAPPpopupProduct(1219453); return false;' class="linkarea"><span></span>반8 김밥 튀김 세트</a>
		</div>

		<% '<!-- for dev msg : 카카오톡 --> %>
		<div class="kakao">
			<a href="" onclick="kakaosendcall(); return false;" title="카카오톡으로 친구에게 소문내기"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/btn_kakao.png" alt="카카오톡으로 떡볶이를 선물해보세요! 친구에게 아이♥떡볶이 알려주기!" /></a>
		</div>
		...
		<div class="noti">
			...
			<ul>
				...
				<li>추추천상품 할인쿠폰은 랜덤으로 자동 발급되며, 사용기한은 6월 30일까지입니다.</li>
			</ul>
		</div>
