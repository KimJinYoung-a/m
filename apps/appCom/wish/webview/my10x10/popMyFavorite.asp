...
<script language="javascript" src="/apps/appCom/wish/webview/js/tencommon.js"></script>
<script>
    ...
    <div class="box">
        ...
        <div class="modal-body">
        	<div class="iscroll-area">
	        	...
	        	<input type="hidden" name="backurl" value="/apps/appCom/wish/webview/my10x10/popMyFavorite.asp">
