...
<script src="/vue/exhibition/components/mdpick/appletype-itemlist.js?v=1.1"></script>
<script src="/vue/exhibition/components/item/item-list.js?v=1.1"></script>
<script src="/vue/exhibition/components/slideEvent-list.js?v=1.1"></script>
<script src="/vue/exhibition/modules/store.js?v=1.1"></script>
<script src="/vue/exhibition/main/apple2020/index.js?v=1.2"></script>