...
''Require base64unicode===================================
function TBTEncrypt(byVal sPlainEnc)
    TBTEncrypt = Base64encodeUnicode(tenEncW(sPlainEnc))
end function

function TBTDecrypt(byVal sEncryptedEnc)
    TBTDecrypt = tenDecW(Base64decodeUnicode(sEncryptedEnc))
end function

function TBTEncryptUrl(byVal sPlainEnc)
    TBTEncryptUrl = Base64URLEncode(tenEncW(sPlainEnc))
end function

function TBTDecryptUrl(byVal sEncryptedEnc)
    TBTDecryptUrl = tenDecW(Base64URLDecode(sEncryptedEnc))
end function
''========================================================
