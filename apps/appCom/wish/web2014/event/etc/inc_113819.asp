...
.mEvt113819 .section-apply .btn-apply {width:100%; height:10rem; position:absolute; left:0; bottom:6%;}
.mEvt113819 .section-apply .item01 {width:47.60vw; position:absolute; left:20%; top:22%; z-index:2;}
.mEvt113819 .section-apply .item02 {width:26.80vw; position:absolute; left:61%; top:26%; z-index:3;}
.mEvt113819 .section-apply .item03 {width:50.80vw; position:absolute; left:15%; top:46%; z-index:1;}
.mEvt113819 .section-apply .item04 {width:19.73vw; position:absolute; left:70%; top:45%;}
.mEvt113819 .section-apply .icon-arr {width:28.67vw; position:absolute; left:23%; bottom:27.5%; animation: swing 1s linear alternate infinite;}
...
/* 2021-09-01 추가 */
.mEvt113819 .pop-container .name {position:absolute; left:50%; top:18%; transform:translate(-50%,0); width:100%; text-align:center; font-size:1.92rem; color:#ec5887; font-family:'CoreSansCRegular', 'AppleSDGothicNeo-Medium', 'NotoSansKRMedium';}
.mEvt113819 .pop-container .name span {text-decoration:underline; text-decoration-color:#ec5887;}
.mEvt113819 .pop-container.first .name {top:16%;}
/* // */
.mEvt113819 .pop-container.win {display:block;}
.mEvt113819 .pop-container .pop-contents .go_link {display:inline-block; width:100%; height:16rem; position:absolute; left:0; bottom:0;}
@keyframes bouns {
...
<script src="/vue/event/etc/113819/index_app.js?v=1.00"></script>
<script>
$(function(){
