...
%>
		<li>
			<div class="kwdWrap" onclick="fnAPPpopupCustomUrl('<% If appdiv = "4" Then Response.write appcate Else Response.write kurl_app End If %>','<%=appdiv%>');">
				<img src="<%= getThumbImgFromURL(vHotKeyImg,360,360,"true","false") %>" alt="<%=ktitle%>" />
				<dl>
					<dt><%=kword%></dt>
					<dd>
						<p class="Kwd"><%=ktitle%></p>
						<p class="KwdCont"><span><%=kcontents%></span></p>
					</dd>
				</dl>
			</div>
		</li>
