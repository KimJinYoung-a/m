	...
	<div class="popWin">
		...
		<div class="content" id="layerScroll">
			<div id="scrollarea">
				<!-- 개인정보 취급방침 -->
				<div class="inner5">
					<h2 class="tit01 tMar20">개인정보 취급방침</h2>
					<ul class="policyList box2">
						...
						<li><a href="#personal05" onclick="myScroll.scrollToElement('#personal05',500);return false;">제 5조 (수집한 개인정보 취급 위탁)</a></li>
					...
					<div class="policyCont">
						...
						<section id="personal05">
							...
							<ul>
								<li>- 이니시스, KCP, LG U+ : 상품구매에 필요한 신용카드, 현금결제 등의 결제정보전송</li>
						...
						<ul class="startDate">
							...
							<li class="tMar10">- 개인정보처리방침 버전번호 : v20150724</li>
							<li>- 개인정보처리방침 변경공고일자 : 2015년 07월 17일</li>
							<li>- 개인정보처리 시행일자 : 2015년 07월 24일</li>
						</ul>
