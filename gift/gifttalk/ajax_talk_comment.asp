...
//function gocommentView(a,b){
//	location.href = "/apps/appCom/wish/web2014/gift/gifttalk/talk_view.asp?talkidx="+a+"&wagubun="+b;
//}
...
<div class="giftReply">
	<div class="replyList">
		<form name="commfrm" action="/apps/appCom/wish/web2014/gift/gifttalk/iframe_talk_comment_proc.asp" method="post" style="margin:0px;" target="iframecproc">
		...
		<% If (cTalkComm.FResultCount > 0) Then %>
			...
			<div class="btnWrap ct tPad15">
				<span class="button btM2 btRed cWh1 w30p"><a href="" onClick="fnOpenModal('/apps/appCom/wish/web2014/gift/gifttalk/talk_view.asp?talkidx=<%= vTalkIdx %>&wagubun=w'); return false;">쓰기</a></span>
				<span class="button btM2 btRedBdr cRd1 w30p"><a href="" onClick="fnOpenModal('/apps/appCom/wish/web2014/gift/gifttalk/talk_view.asp?talkidx=<%= vTalkIdx %>&wagubun=a'); return false;">전체보기</a></span>
			</div>
		<% else %>
			<!-- 코멘트가 없을 경우 -->
			<div class="btnWrap ct tPad15">
