...
%>
<style type="text/css">
.mEvt94919 {position: relative; background-color: #e1f4fb;}
.mEvt94919 button {background-color: transparent; border: 0;}
.mEvt94919 .pos {position: absolute; top: 0; left: 0; width: 100%;}
.mEvt94919 .posr {position: relative;}
.mEvt94919 textarea:focus::-webkit-input-placeholder {opacity: 0;} 
...
.topic div span strong {display: block; transform: scale(0);  transition: transform .6s 1.9s cubic-bezier(0.18, 0.89, 0.32, 1.28);}
.topic div.on span strong {transform: scale(1);}
.topic > p {transition: transform 1.2s cubic-bezier(0.68,-0.1, 1, 1) ; transform: scale(1.2)}
.topic > p.on {transform: scale(1)}
...
.info .rolling .swiper-scrollbar-drag {top: -0.09rem; height: .18rem; background-color:#0dde5d; border-radius:0; }
...
.info .rolling .btn-area > div {display: inline-block; width: 2.13rem; height: 2.13rem; background-image: url(//webimage.10x10.co.kr/fixevent/event/2019/94919/m/btn_prev.jpg); background-size: cover; text-indent: -999rem;}
...
.cmt-area {margin-top: -.08rem; text-align:center; background-color:#dcf7e6;}
...
.cmt-area .cmt-input .textarea-wrap .now-txt {position: absolute; bottom: 1rem; right: 3rem; color:#b1c1b0; font-size:1.02rem;}
...
.cmt-area .cmt-input textarea::-webkit-input-placeholder {color:#b1c1b0;}
.cmt-area .cmt-input textarea::-moz-placeholder {color:#b1c1b0;}
.cmt-area .cmt-input textarea:-ms-input-placeholder {color:#b1c1b0;}
.cmt-area .cmt-input textarea:-moz-placeholder {color:#b1c1b0;}
.cmt-area .cmt-list { padding-top: 2.13rem;}
...
.cmt-area .cmt-list li .num {margin-bottom: 1rem; font-size:1.11rem; font-weight:bold; color: #1ad160;}
...
.cmt-area .cmt-list li button {width: 4.69rem; height: 2.35rem; color: #35455f; margin-right: .5rem; font-size: 1.02rem; background-color: #79f4a8;}
.cmt-area .pagingV15a {padding-bottom: 1.8rem; padding-top: .5rem; margin-top: 0;}
.cmt-area .pagingV15a .arrow {opacity: .5;}
.cmt-area .pagingV15a span {min-width: 1.28rem; margin: 0 .8rem; color: #abb4c5;}
.cmt-area .pagingV15a span.current {font-weight: normal; color: #1ad160; border-bottom: 0.23rem solid #1ad160; }
.cmt-area .pagingV15a span.current a{transform: skewX(-10deg)}
.noti {padding:3.2rem 6.67% ; background-color:#50b074; color: #fff; }
...
function fnChkByte(obj) {
    ...
    if (rbyte > maxByte) {
        ...
        document.getElementById('byteInfo').innerText = Math.ceil(rbyte / 2);
            ...
            <div class="mEvt94919">
                <div class="topic ">
                    <p><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/bg_top.jpg" alt=""></p>
                    <div class="pos">
                        <p><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_top_01.png" alt="ten by ten x jaju"></p>
                        <span class="delay1"><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_top_02.png" alt="조용하고 편안한"></span>
                        <span class="delay2 posr"><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_top_03.png" alt="여름날의 바람 선물!">
                            <strong class="pos"><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_top_03s.png" alt="2탄"></strong>
                        </span>
                        <span class="delay3"><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_top_04.png" alt="당신의 조용하고 편안한 휴식 시간을 위해"></span>
                    </div>
                </div>
                <div class="info">
                    <span><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_info.jpg" alt="JAJU 조용한 바람 리모컨 선풍기란?"></span>
                    <div class="rolling">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_slide_01.jpg" alt="리버스윈도" /></div>
                                <div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_slide_02.jpg?v=1.02" alt="바람조절" /></div>
                                <div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_slide_03.jpg?v=1.02" alt="4가지모드" /></div>
                                <div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_slide_04.jpg?v=1.02" alt="리모컨" /></div>
                            </div>
                        </div>
                    ...
                    <a href="/category/category_itemPrd.asp?itemid=2365293&pEtr=94919" onclick="TnGotoProduct('2365293');return false;">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/btn_more.jpg" alt="자세히 알아보기">
                    </a>
                </div>
                <div class="cmt-evt">
                    <div class="inner">
                        <span><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/img_evt.jpg" alt="여름을 시원하게 보내는 당신만의 방법을 알려주세요!"></span>
                    </div>
                </div>
                <div class="cmt-area">
                    <div class="cmt-input">
                        <div class="inner">
                            ...
                            <input type="hidden" name="isApp" value="<%= isApp %>">                                                                
                                <div class="input-box posr">
                                    <img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/bg_textarea.jpg" alt="">                            
                            ...
                            <button type="button" onclick="jsSubmitComment(document.frmcom); return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/btn_enter.jpg" alt="등록하기"></button>
                            <button type="button" onclick="location.href='http://www.sivillage.com/jaju/event/initEventDetail.siv?event_no=E190502448&partnerNm=jaju_10x10'"><img src="//webimage.10x10.co.kr/fixevent/event/2019/94919/m/btn_jaju.jpg" alt="jaju에도 이벤트 참여하러 가기"></button>
                            </form>
                ...
                <div class="noti">
                    ...
                    <ul>
                        ...
                        <li>- 텐바이텐 X JAJU 이벤트 당첨 고객의 최소한의 개인정보는 경품 배송을 위해 양사에 제공될 수 있습니다. 배송된 후 개인정보는 즉시 파기 될 예정입니다.</li>
                    </ul>                    
                </div>
            </div>           
