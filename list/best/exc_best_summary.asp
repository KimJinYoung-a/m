...
<script src="/vue/components/product/prd_item_type4.js?v=1.0"></script>
...
<!-- Brand Components -->
<script src="/vue/components/brand/brd_set_type2.js?v=1.0"></script>
<!-- //Brand Components -->

<!-- Review Components -->
<script src="/vue/components/review/rv_list_type1.js?v=1.0"></script>
<script src="/vue/components/review/rv_info.js?v=1.0"></script>
<script src="/vue/components/review/rv_list_this_item.js?v=1.1"></script>
...
<!-- Core -->
<script src="/vue/list/best/summary_store.js?v=1.1"></script>
<script src="/vue/list/best/summary.js?v=2.14"></script>
<!-- //Core -->