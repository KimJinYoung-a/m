...
'	End If 
	...
	'### Record 저장
'	vQuery = "IF NOT EXISTS(SELECT pidx FROM db_sitemaster.dbo.tbl_playlist_mylist WHERE pidx = "& vPidx &" and userid = '"& vUserid &"') "
'	vQuery = vQuery & "	BEGIN "
'	vQuery = vQuery & "		INSERT INTO db_sitemaster.dbo.tbl_playlist_mylist "
'	vQuery = vQuery & "		(pidx , userid) VALUES ("& vPidx &" , '"& vUserid &"') "
'	vQuery = vQuery & "	END "
'	vQuery = vQuery & " ELSE "
'	vQuery = vQuery & "	BEGIN "
'	vQuery = vQuery & "		DELETE FROM db_sitemaster.dbo.tbl_playlist_mylist "
