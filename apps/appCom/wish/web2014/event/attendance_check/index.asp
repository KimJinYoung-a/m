...
.mEvt113634 .section-mileage .id-area {text-align:center;}
...
.mEvt113634 .section-mileage .event-area .ch-after {position:relative; width:28.40vw; margin:0 0.42rem 1.28rem; text-align:center;}
.mEvt113634 .section-mileage .event-area .ch-fail img {width:25.60vw;}
.mEvt113634 .section-mileage .event-area .ch-before .point {position:absolute; left:50%; top:50%; transform: translate(-50%,0); font-size:2.34rem; color:#fff; font-family:'CoreSansCBold', 'AppleSDGothicNeo-Bold', 'NotoSansKRBold';}
.mEvt113634 .section-mileage .event-area .ch-after .point {position:absolute; left:50%; top:50%; transform: translate(-50%,0); font-size:2.34rem; color:#fff; font-family:'CoreSansCBold', 'AppleSDGothicNeo-Bold', 'NotoSansKRBold';}
.mEvt113634 .section-mileage .event-area .ch-fail .point {position:absolute; left:50%; top:50%; transform: translate(-50%,0); font-size:2.34rem; color:#fff; font-family:'CoreSansCBold', 'AppleSDGothicNeo-Bold', 'NotoSansKRBold';}.mEvt113634 .section-mileage .event-area .ch-before .day,
.mEvt113634 .section-mileage .event-area .ch-after .day,
.mEvt113634 .section-mileage .event-area .ch-fail .day {position:absolute; left:50%; top:23%; transform:translate(-50%,0); width:100%; letter-spacing:-0.25px; font-size:1.36rem; color:#fff; opacity:.5;}
.mEvt113634 .section-mileage .event-area .ch-fail .day {top:19.5%;}
.mEvt113634 .section-mileage .show-mileage {position:relative; padding-top:1.70rem;}
...
.mEvt113634 .section-mileage .show-mileage .btn-mileage {display:inline-block; width:12vw; height:16vw; position:absolute; right:16%; top:32%; z-index:10;}
...
.mEvt113634 .btn-detail .icon {width:0.98rem; height:0.55rem; position:absolute; left:50%; top:56%; margin-left:7.55rem;}
...
<script>
    ...
    let event_code =  113634;
    let start_date = "2021-08-27";
    let end_date = "2021-09-04";


    /*실서버 테스트용*/
    let query_param = new URLSearchParams(window.location.search);
    let is_test_mode = query_param.get("mode");
    <% IF application("Svr_Info")="Dev" THEN %>
        event_code =  113634;
...
<script src="/vue/event/mileage_attendance/index_app.js?v=2.00"></script>
<script>
$(function(){
