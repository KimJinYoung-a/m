...
<body class="default-font body-sub body-1depth bg-grey">
	...
	<div id="content" class="content">
		<div class="returnWrap">
			...
			<% if myorder.FResultCount > 0 then %>
				...
				<ul class="myOdrList">
					<% for i = 0 to (myorder.FResultCount - 1) %>
						<li>
							<a href="/my10x10/order/myorder_return_step2.asp?idx=<%=myorder.FItemList(i).FOrderSerial%>">
								<div class="odrInfo">
							...
							<div class="btnReturn">
								<span class="button"><a href="/my10x10/order/myorder_return_step2.asp?idx=<%=myorder.FItemList(i).FOrderSerial%>">반품 접수</a></span>
							</div>
						</li>
					<% Next %>
				</ul>
			...
			<% End If %>
			<div class="btn-return-list"><a href="/my10x10/order/order_cslist.asp"><span>나의 반품 내역 보기</span></a></div>
		</div>
	</div>
