...
If not( left(Now(),10)>="2015-08-24" and left(Now(),10)<"2015-08-27" ) Then
...
'// 마일리지 로그 테이블에 넣는다.
vQuery = " insert into db_user.dbo.tbl_mileagelog(userid , mileage , jukyocd , jukyo , deleteyn) values ('"&userid&"', '+1000','"&eCode&"', '마일리지는 돌아오는 거야 이벤트 마일리지 지급','N') "
dbget.Execute vQuery
