		...
		<div class="cont">
			<div class=""><!-- for dev msg : 타겟별 다른 클래스 추가(남:targetM/여:targetF) -->
				<div class="bnrForTheme">
					<h2><img src="http://fiximage.10x10.co.kr/m/webview/between/main/@temp_bnr_plan.jpg" alt="달콤한 발렌타인데이를 완성하는 방법" /></h2><!-- for dev msg : 기획전 이름으로 Alt값 넣어주세요. -->
				</div>

				<!-- Product List -->
				<div class="pdtListWrap">
					<h3 style="background-color:#b87b52; color:#fff;">구분자명1</h3><!-- for dev msg : 관리자에서 배경과 폰트 색상 등록 -->
					...
					<h3 style="background-color:#b87b52; color:#fff;">구분자명2</h3>
					<ul class="pdtList list03 boxMdl">
						<li>
							<div>
								<a href="">
