				...
				If inStr(sCurrUrl,"/salelife")<=0 Then
					if inStr(sCurrUrl,"/gnbevent/")<=0 then
						...
						elseif inStr(sCurrUrl,"/family2020")>0 then ' gnb 추가용 설정
							strHeadTitleName = ""
                        elseif inStr(sCurrUrl,"/family2021")>0 then ' gnb 추가용 설정
                            strHeadTitleName = ""
						elseif inStr(sCurrUrl,"/apple")>0 then ' gnb 추가용 설정
							strHeadTitleName = ""
						elseif inStr(sCurrUrl,"/renewal")>0 then ' gnb 추가용 설정
							strHeadTitleName = ""
						else
...
'			strHeadTitleName="카테고리"
	...
	Dim isBizSummary : isBizSummary = (InStr(Request.ServerVariables("url"), "/biz/summary.asp") > 0)
	Dim isBizSearch : isBizSearch = (InStr(Request.ServerVariables("url"), "search") > 0)
%>
<% '// 비즈 헤더 적용으로 분기 처리(Biz서머리페이지는 예외. cause GNB노출)
	'// "~BizPage일 경우" 까지
	If isBizSummary Or Not isBizMode Then %>
...
<aside class="aside_wrap">
	...
	<div class="aside_inner">
		<div class="aside_header">
            ...
            <a href="/biz/change_biz_mode.asp?mode=Y" class="go_10x10_biz"><img src="//fiximage.10x10.co.kr/web2021/biz/logo_biz.png" alt="10x10 비즈 로고">바로가기</a>
		</div>
		<nav class="aside_nav">
			<ul class="depth1">
				<li><a href="/">오늘의 추천</a></li>
				<li><a href="/category/category_main.asp">카테고리</a></li>
		...
		<% If (Trim(fnGetImportantNotice) <> "") Then %>
			<div class="aside_notice">
				<article class="notice_item">
					...
					<a href="/common/news/news_view.asp?idx=<%=headerImportantNoticeSplit(0)%>" class="notice_link"><span class="blind">공지사항 바로가기</span></a>
				</article>
			</div>
		<% End If %>
...
<% '// BizPage일 경우
	...
	<div id="header" class="header_wrap header_wrap_biz">
		<header class="tenten_header header_main biz_header">
			<div class="header_inner">
				<button type="button" class="header_opener"><span class="blind">메뉴 열기</span></button>
				<h1 class="biz_header_logo header_logo"><a href="/biz/"><span class="blind">텐바이텐비즈</span></a></h1>
				<div class="util">
