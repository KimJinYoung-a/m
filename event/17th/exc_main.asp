...
.life-main {position:relative; min-height:221rem; background:#ea7786 url(http://webimage.10x10.co.kr/fixevent/event/2018/17th/88938/m/bg_main_full_v8.jpg) no-repeat 0 0; background-size:100%;}
...
.intro {width:100%; height:221rem; position:absolute; top:0; left:0; z-index:50; background:url(http://webimage.10x10.co.kr/fixevent/event/2018/17th/88938/m/bg_main_full_v7.jpg) no-repeat 0 0; background-size:100%;}
...
.main-cont .btn-wrapper i {display:inline-block; position:absolute; top:-3.4rem; right:0; z-index:5; width:7.51rem; height:3.84rem; background:url(http://webimage.10x10.co.kr/fixevent/event/2018/17th/88938/m/img_cmt_boy_v2.gif) no-repeat 0 0; background-size:100%; content:' ';}
.main-cont .share {position:relative; width:100%; height:7.936rem; padding:0 .85rem 0 1.71rem; background-color:#3db4ce;}
...
.coupon-slide .dc1 {width:4.05rem; height:4.1rem; top:7.77rem; left:5.54rem; z-index:5; background-image:url(http://webimage.10x10.co.kr/fixevent/event/2018/17th/88938/m/img_earth_2.png);}
...
$(function(){
	...
	<% end if %>
	// animation
	$('.coupon-slide .dc2').addClass('twinkle');
...
function linkMycoupon(){
	...
	return false;
			...
			<div class="ten-life life-main">
				<!-- INTRO -->
				<div class="intro">
					<h2><img src="http://webimage.10x10.co.kr/fixevent/event/2018/17th/88938/m/tit_ten_life_v2.png" alt="슬기로운텐텐생활" /></h2>
				</div>
				...
				<div class="main-cont">
					...
					<p class="btn-wrapper">	
						<a href="#ten-comment" class="btn-cmt">
							<img src="http://webimage.10x10.co.kr/fixevent/event/2018/17th/88938/m/btn_go_cmt.png?v=1.02" alt="코멘트이벤트로 이동" />							
						</a>
						<i></i>
					</p>
						...
						<div id="swiper-wrap">							
								...
								<% end if %>
										<div class="on">
											...
											<div class="planet">
												<img src="http://webimage.10x10.co.kr/fixevent/event/2018/17th/88938/m/img_diary_v2.png?v=1.02" alt="" />
					...
					<div class="share">
						...
						<ul>
							...
							<% if isApp then %>
							<li>
								<a href="" onclick="callNativeFunction('copyurltoclipboard', {'url':'<%=snpLink2%>','message':'링크가 복사되었습니다. 원하시는 곳에 붙여넣기 하세요.'}); return false;"><img src="http://webimage.10x10.co.kr/fixevent/event/2018/17th/88938/m/img_url.png" alt="url공유" /></a>
							</li>
							<% end if %>
						</ul>
					</div>
