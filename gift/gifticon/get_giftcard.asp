...
<style>
.giftcon-terms .gift-card {position:relative; margin:0 18.13% 2.56rem;}
.giftcon-terms .gift-card p{position:absolute; bottom:0; left:50%; margin-left:-6.61rem; width:13.22rem; height:3.67rem; background-color:#fff; border:solid .26rem #000; border-radius:.85rem; font-size:1.45rem; line-height:3.5rem; font-family:'AvenirNext-DemiBold', 'AppleSDGothicNeo-SemiBold'; font-weight:bold; text-align:center;}
.giftcon-terms .gift-card p em {color:#ff3131; font-size:1.62rem; line-height:1.32; font-family:'AvenirNext-Bold', 'AppleSDGothicNeo-Bold'; font-weight:bold;}
.giftcon-terms .gift-card img{background-color:transparent; box-shadow: 0 .34rem .6rem 0 rgba(0, 0, 0, 0.21); border-radius:1.5rem;}
</style>
</head>
<body class="default-font body-sub bg-grey category-item">
	...
	<div id="content" class="content gifticon giftcon-terms">
		<div class="gifticon-section">
			<div class="gift-card">
				<img src="http://fiximage.10x10.co.kr/web2015/giftcard/img_giftcard_type_38.png" alt="">
			...
			<!--//텐바이텐 기프트카드 이용약관 -->
			<!-- 비활성화 일 경우: btn-line-grey, 활성화시 btn-line-red -->
			<div class="btn-group">
				<p class="btn btn-block btn-xlarge btn-line-grey"><input type="checkbox" id="agree-yes" /> <label for="agree-yes">이용약관을 확인하였으며 이에 동의합니다.</label></p>
