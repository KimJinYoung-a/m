...
dim currenttime, userid, i, sqlstr
	...
	currenttime =  now()
	'currenttime = #06/26/2015 09:00:00#
...
If mode = "add" Then '//응모버튼 클릭
	...
	If event_userCell_Selection(evtUserCell, Left(currenttime, 10), eCode) > 0 Then
		...
		Response.write "SUCCESS!@#<div class='present'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_present_coupon_a.jpg' alt='내커피는 바로 여기에! 리버스 보틀' /><div class='btncoupon'><a href='' onclick='fnAPPpopupProduct(1295175); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_get.png' alt='바로 구매하러가기' /></a></div></div><div class='bnr'><a href='' onclick='fnAPPpopupEvent(63608); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_bnr_01.jpg' alt='6월의 더치박스 GO! BORMI' /></a></div><button type='button' class='btnclose'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_close.png' alt='닫기' /></button>"
		dbget.close()	:	response.End
	End If
	...
	if line1="A" then
		...
		if line2="A" then
			...
			if clng(coffe_event_subscripttotalcount) >= clng(limitcoffecnt) then
				...
				If clng(renloop) < clng(winnumber) Then
					...
					Response.write "SUCCESS!@#<div class='present'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_present_jaws_a.jpg' alt='잠이 달아나는 한방! 스타벅스 아이스 아메리카노 톨' /><div class='mobile'><strong>"& evtUserCell &"</strong><a href='' onclick='fnAPPpopupBrowserURL(""마이텐바이텐"",""http://m.10x10.co.kr/apps/appCom/wish/web2014/my10x10/mymain.asp""); return false;' class='btnmodify'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_modify.png' alt='수정' /></a></div></div><div class='bnr'><a href='' onclick='fnAPPpopupEvent(63608); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_bnr_01.jpg' alt='6월의 더치박스 GO! BORMI' /></a></div><button type='button' class='btnclose'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_close.png' alt='닫기' /></button>"
					dbget.close()	:	response.End
				else
					rvalue = fnSetItemCouponDown(userid, coupon2)	'/itemcoupon 처리
					sqlstr = "INSERT INTO [db_event].[dbo].[tbl_event_subscript] (evt_code , userid , sub_opt1 , sub_opt2, sub_opt3, regdate, device)" + vbcrlf
		...
		elseif line2="B" then
			...
			if clng(machine_event_subscripttotalcount) >= clng(limitmachinecnt) then
				...
				Response.write "SUCCESS!@#<div class='present'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_present_coupon_b.jpg' alt='내려! 하우스 커피 세트! THE GOLDEN THINGS' /><div class='btncoupon'><a href='' onclick='fnAPPpopupProduct(1243936); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_get.png' alt='바로 구매하러가기' /></a></div></div><div class='bnr'><a href='' onclick='fnAPPpopupEvent(63719); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_bnr_02.jpg' alt='동남아의 그 유명한 코코넛워터!' /></a></div><button type='button' class='btnclose'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_close.png' alt='닫기' /></button>"
				dbget.close()	:	response.End
				...
				If clng(renloop) < clng(winnumber) Then
					...
					Response.write "SUCCESS!@#<div class='present'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_present_ban8_a.jpg' alt='찐하게 한번 마셔봐? 레꼴뜨 반8' /></div><div class='bnr'><a href='' onclick='fnAPPpopupEvent(63719); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_bnr_02.jpg' alt='동남아의 그 유명한 코코넛워터!' /></a></div><button type='button' class='btnclose'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_close.png' alt='닫기' /></button>"
					dbget.close()	:	response.End
				else
					rvalue = fnSetItemCouponDown(userid, coupon1)	'/itemcoupon 처리
					sqlstr = "INSERT INTO [db_event].[dbo].[tbl_event_subscript] (evt_code , userid , sub_opt1 , sub_opt2, sub_opt3, regdate, device)" + vbcrlf
	...
	elseif line1="B" then
		...
		if line2="A" then
			...
			if clng(coffe_event_subscripttotalcount) >= clng(limitcoffecnt) then
				...
				Response.write "SUCCESS!@#<div class='present'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_present_coupon_c.jpg' alt='호주머니 속에 더치커피! 보르딘 더치커피 세트' /><div class='btncoupon'><a href='' onclick='fnAPPpopupProduct(1037113); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_get.png' alt='바로 구매하러가기' /></a></div></div><div class='bnr'><a href='' onclick='fnAPPpopupEvent(63991); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_bnr_03.jpg' alt='시원한 티타임 함께 하실래요?' /></a></div><button type='button' class='btnclose'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_close.png' alt='닫기' /></button>"
				dbget.close()	:	response.End
				...
				If clng(renloop) < clng(winnumber) Then
					...
					Response.write "SUCCESS!@#<div class='present'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_present_jaws_b.jpg' alt='물인듯 커피인듯 스타벅스 아이스 아메리카노 톨' /><div class='mobile'><strong>"& evtUserCell &"</strong><a href='' onclick='fnAPPpopupBrowserURL(""마이텐바이텐"",""http://m.10x10.co.kr/apps/appCom/wish/web2014/my10x10/mymain.asp""); return false;' class='btnmodify'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_modify.png' alt='수정' /></a></div></div><div class='bnr'><a href='' onclick='fnAPPpopupEvent(63991); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_bnr_03.jpg' alt='시원한 티타임 함께 하실래요?' /></a></div><button type='button' class='btnclose'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_close.png' alt='닫기' /></button>"
					dbget.close()	:	response.End
				else
					rvalue = fnSetItemCouponDown(userid, coupon4)	'/itemcoupon 처리
					sqlstr = "INSERT INTO [db_event].[dbo].[tbl_event_subscript] (evt_code , userid , sub_opt1 , sub_opt2, sub_opt3, regdate, device)" + vbcrlf
		...
		elseif line2="B" then
			...
			if clng(machine_event_subscripttotalcount) >= clng(limitmachinecnt) then
				...
				Response.write "SUCCESS!@#<div class='present'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_present_coupon_d.jpg' alt='함께라면 어디든 카페! 플라밍고 티코스터' /><div class='btncoupon'><a href='' onclick='fnAPPpopupProduct(1052172); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_get.png' alt='바로 구매하러가기' /></a></div></div><div class='bnr'><a href='' onclick='fnAPPpopupEvent(63995); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_bnr_04.jpg' alt='세상에서 가장 작은 카페' /></a></div><button type='button' class='btnclose'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_close.png' alt='닫기' /></button>"
				dbget.close()	:	response.End
				...
				If clng(renloop) < clng(winnumber) Then
					...
					Response.write "SUCCESS!@#<div class='present'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_present_ban8_b.jpg' alt='부드러운 내스타일 커피 레꼴뜨 반8' /></div><div class='bnr'><a href='' onclick='fnAPPpopupEvent(63995); return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/tteokbokki/img_bnr_04.jpg' alt='세상에서 가장 작은 카페' /></a></div><button type='button' class='btnclose'><img src='http://webimage.10x10.co.kr/eventIMG/2015/63739/coffee/btn_close.png' alt='닫기' /></button>"
					dbget.close()	:	response.End
				else
					rvalue = fnSetItemCouponDown(userid, coupon3)	'/itemcoupon 처리
					sqlstr = "INSERT INTO [db_event].[dbo].[tbl_event_subscript] (evt_code , userid , sub_opt1 , sub_opt2, sub_opt3, regdate, device)" + vbcrlf
