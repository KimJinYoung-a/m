						...
						<div id="tab01" class="tabCont">
							...
							<div class="policyCont">
								...
								<section id="terms07">
									...
									<h4>부칙(2016.9.5)</h4>
									<p>본 약관은 2016년 10월 5일부터 적용됩니다.</p>
									<p class="tPad05"><a href="" onclick="fnOpenModal('/member/pop_viewUsageTerms.asp'); return false;" style="text-decoration:underline;">개정 후 서비스 약관 보기</a></p>
								</section>
							</div>
						</div>
					</div>
