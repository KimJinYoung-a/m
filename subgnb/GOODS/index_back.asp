...
snpTitle	= Server.URLEncode("[텐바이텐]\n PLAY GOODS")
snpLink		= Server.URLEncode("http://m.10x10.co.kr/subgnb/goods/")
snpPre		= Server.URLEncode("10x10 이벤트")
snpImg		= Server.URLEncode("")
appfblink	= "http://m.10x10.co.kr/subgnb/goods/"
...
Dim kakaolink_url 
	kakaolink_url = "http://m.10x10.co.kr/subgnb/goods/"
%>
<style>
...
function jsGoComPage(iP){	
	location.replace('<%=appUrlPath%>/subgnb/goods/?pagereload=on&iCC=' + iP);
}
...
function jsSubmitComment(frm){	
	...
	<% Else %>
		<% If isApp="1" or isApp="2" Then %>
			...
			return false;
		<% else %>
			jsChklogin_mobile('','/subgnb/goods/');
			return false;
		<% end if %>
	<% End IF %>
}
	...
	<div id="content" class="content">
		<div class="detail-cont">
            ...
            <div class="life-586">
                ...
                <div class="section swiper01"> <!-- 181101 -->
                    <a href="/apps/appCom/wish/web2014/category/category_itemprd.asp?itemid=2130233&pEtr=90239"  onclick="fnAPPpopupProduct('2130233&pEtr=90239');" class="mApp">
					...
					<a href="/category/category_itemprd.asp?itemid=2130233&pEtr=90239" class="mWeb">
						<div class="swiper-container">
							<div class="swiper-wrapper">
									<div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/play/life/586/img_04_slide_01.png" alt="" /></div>
									<div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/play/life/586/img_04_slide_02.png" alt="" /></div>
                ...
                <div class="section area05">
                    ...
                    <a href="/category/category_itemprd.asp?itemid=2130233&pEtr=90239" class="mWeb alink02">구매하기</a>
                    <a href="/apps/appCom/wish/web2014/category/category_itemprd.asp?itemid=2130233&pEtr=90239"  onclick="fnAPPpopupProduct('2130233&pEtr=90239');" class="mApp alink02">구매하기</a>
					<a href="/category/category_itemprd.asp?itemid=2130233&pEtr=90239" class="mWeb alink02s">구매하기</a> 
                    <a href="/apps/appCom/wish/web2014/category/category_itemprd.asp?itemid=2130233&pEtr=90239"  onclick="fnAPPpopupProduct('2130233&pEtr=90239');" class="mApp alink02s">구매하기</a>
				</div>
                <!-- comment -->
                    ...
                    <div class="comment-head">
                        ...
                        <div class="comment-write">
                            <div>
								...
								<input type="hidden" name="returnurl" value="<%= appUrlPath %>/subgnb/goods/?pagereload=ON">
