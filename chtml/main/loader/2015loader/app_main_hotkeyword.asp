...
Dim gaParam : gaParam = "&gaparam=todaymain_C"

sFolder = "/chtml/main/xml/main_banner/"
mainFile = "main_hotkeyword.xml"
CtrlDate = now() 
...
%>
<section class="todayHotKwdV15">
	<h2><span><em class="cRd1">HOT</em> KEYWORD</span></h2>
	<ul>
<%
...
%>
		<li>
			<a href="" onclick="fnAPPpopupCustomUrl('<% If appdiv = "4" Then Response.write appcate Else Response.write kurl_app End If %>','<%=appdiv%>');return false;">
				<div class="pPhoto"><span></span><img src="<%= getThumbImgFromURL(vHotKeyImg,400,400,"true","false") %>" alt="<%=ktitle%>" /></div>
				<p>#<%=ktitle%></p>
			</a>
		</li>
<%
