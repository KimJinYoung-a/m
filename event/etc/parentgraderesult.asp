...
IF Not rsget.Eof Then
    ...
    masterIdx = rsget("idx")
Else
    response.write "<script>alert('모의고사 참여 정보가 없습니다.');location.href='https://m.10x10.co.kr/event/etc/parentmocktest.asp';</script>"
    response.end
End If
rsget.close
...
'// SNS 공유용
	...
	'head.asp에서 출력
	strOGMeta = strOGMeta & "<meta property=""og:title"" content=""" & snpTitle & """>" & vbCrLf
	strOGMeta = strOGMeta & "<meta property=""og:type"" content=""website"" />" & vbCrLf
	strOGMeta = strOGMeta & "<meta property=""og:url"" content=""" & snpLink & """ />" & vbCrLf
	strOGMeta = strOGMeta & "<meta property=""og:image"" content=""" & snpImg & """>" & vbCrLf
	strOGMeta = strOGMeta & "<meta property=""og:description"" content=""" & "[텐바이텐] 이벤트 - " & snpTitle & """>" & vbCrLf
%>
...
.mEvt102078 .lyr-inner {position:relative; top:50%; transform:translateY(-50%);}
...
.step1 input[type=radio]:checked {border:0; background:#e04a4a;  opacity:1 !important;}
...
.step1 li.q11 .answer input[type=radio] {position:absolute; border:0; width:8%; height:24%; background:transparent; opacity:1 !important;}
...
.lyr-love {position:fixed; left:0; right:0; top:0; bottom:0; z-index:30; width:100%; height:100%; background:rgba(0,0,0,.6);}
	...
	<% end if %>
			...
			<div class="mEvt102078">
							...
							<div class="quiz">
								...
								<ol>
									...
									<li class="q11">
										...
										<a href="http://m.10x10.co.kr/apps/appCom/wish/web2014/event/family2020/" class="mApp">부모님 선물 구경하기</a>
									</li>
								</ol>
							</div>
						</div>					
				...
				<div class="evt-banner">
					<a href="/event/eventmain.asp?eventid=101795" class="mWeb"><img src="//webimage.10x10.co.kr/fixevent/event/2020/102078/m/bnr1.jpg" alt="5월의 크리스마스를 준비하세요"></a>
					<a href="http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=101795" class="mApp"><img src="//webimage.10x10.co.kr/fixevent/event/2020/102078/m/bnr1.jpg" alt="5월의 크리스마스를 준비하세요"></a>

					<a href="/event/eventmain.asp?eventid=102084" class="mWeb"><img src="//webimage.10x10.co.kr/fixevent/event/2020/102078/m/bnr2.jpg" alt="진짜 꽃을 보내준다구요? 그럼요, 도전해보세요!"></a>
					<a href="http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=102084" class="mApp"><img src="//webimage.10x10.co.kr/fixevent/event/2020/102078/m/bnr2.jpg" alt="진짜 꽃을 보내준다구요? 그럼요, 도전해보세요!"></a>
				</div>
			</div>
			<!-- //mEvt102078 부모님 모의고사 -->
