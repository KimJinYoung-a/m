...
%>
			<li onclick="javascript:location.href='/category/category_itemPrd.asp?itemid=<%=itemid%>'" class="<%=chkiif(LimitYn="Y" And limitno <= 10 And limitdispyn = "Y" ,"hurryUp","")%>">
