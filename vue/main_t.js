// json - apiurl
var data_mainbanner = "/chtml/main/loader/2016loader/json_main_loader_T.asp?poscode=2063";
var data_mktbanner = "/chtml/main/loader/2016loader/json_main_loader_T.asp?poscode=2065";
...
var data_imgbanA = "/chtml/main/loader/2016loader/json_main_loader_T.asp?poscode=2067";
var data_imgbanB = "/chtml/main/loader/2016loader/json_main_loader_T.asp?poscode=2068";
var data_imgbanC = "/chtml/main/loader/2016loader/json_main_loader_T.asp?poscode=2073";
var data_brand = "/chtml/main/loader/2016loader/json_main_loader_T.asp?poscode=2069";
var data_exhibition = "/chtml/main/loader/2016loader/json_exhibition.asp";
var data_PCHdata = "/chtml/main/loader/2016loader/json_main_loader_T.asp?poscode=2071";
...
//						</p>\
//						</div>\
//						<div class="thumbnail" v-if="index < 1"><img :src="item.imgsrc" :alt="item.socname_kor" /></div>\
//						<div class="thumbnail" v-else><img v-lazy="item.imgsrc" :alt="item.socname_kor" /></div>\
//					</a>\
//				</div>\
//				<div class="swiper-slide" v-else>\
//					<a :href="item.link">\
...
//			this.items = '';
//			var vm =  this;
//			axios.get(data_hotkeyword)
//			.then(function (response){
//				vm.items = response.data;
//			})
//			.catch(function (error){
//				vm.items = 'an error occured.' + error;
//			});
//		}
//	}
	data: {
...
//			this.items = '';
//			var vm =  this;
//			axios.get(data_todayenjoy)
//			.then(function (response){
//				vm.items = response.data;
//			})
//			.catch(function (error){
//				vm.items = 'JSON data not Loaded.' + error;
//			});
//		}
//	}
	data: {
		...
		this.$nextTick(function() {
			setTimeout(function(){
				var swiper3 = new Swiper("#mdPick .swiper-container", {
					...
					,onImagesReady:function(){
						chkSwiper++;
						setTimeout(function(){rectPosition('#mdPick');},200);
					}
				});
			},300);
		});
		...
		this.$nextTick(function() {
			setTimeout(function(){
				var swiper4 = new Swiper("#newArrival .swiper-container", {
					...
					,onImagesReady:function(){
						chkSwiper++;
						setTimeout(function(){rectPosition('#newArrival');},200);
					}
				});
			},300);
		});
		...
		this.$nextTick(function() {
			setTimeout(function(){
				var swiper5 = new Swiper("#bestSeller .swiper-container", {
					...
					,onImagesReady:function(){
						chkSwiper++;
						setTimeout(function(){rectPosition('#bestSeller');},200);
					}
				});
			},300);
		});
		...
		this.$nextTick(function() {
			setTimeout(function(){
				var swiper6 = new Swiper("#onSale .swiper-container", {
					...
					,onImagesReady:function(){
						chkSwiper++;
						setTimeout(function(){rectPosition('#onSale');},200);
					}
				});
			},300);
		});
		...
		this.$nextTick(function() {
			setTimeout(function(){
				var swiper8 = new Swiper("#exhibition01 .swiper-container", {
					...
					,onImagesReady:function(){
						chkSwiper++;
						setTimeout(function(){rectPosition('#exhibition01');},200);
					}
				});
			},300);
		});
		...
		this.$nextTick(function() {
			setTimeout(function(){
				var swiper9 = new Swiper("#exhibition02 .swiper-container", {
					...
					,onImagesReady:function(){
						chkSwiper++;
						setTimeout(function(){rectPosition('#exhibition02');},200);
					}
				});
			},300);
		});
