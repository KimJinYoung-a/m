...
if mode="coupondown" then
	...
	if subscriptcount>0 or itemcouponcount>0 then
		''// <!-- 이미 발급 받은 경우 -->
		cLayerValue = cLayerValue & " <img src='http://webimage.10x10.co.kr/eventIMG/2016/69628/m/img_layer_buy_02.png' alt='이미 쿠폰이 발급되었습니다' /> "
	Else
		cLayerValue = cLayerValue & " <img src='http://webimage.10x10.co.kr/eventIMG/2016/69628/m/img_layer_buy_01.png' alt='쿠폰이 발급되었습니다' /> "
	End If
	cLayerValue = cLayerValue & " </a> "
	cLayerValue = cLayerValue & " <button class='btnClose' onclick='poplayerclose();return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2016/69628/m/btn_close.png' alt='닫기' /></button> "
