...
<div class="layerPopup" style="background-color:#f4f7f7;">
						...
						<div class="tabcontainer">
							...
							<div id="tabcont1" class="tabcont">
								...
								<div class="result" id="resultJibun" style="display:none;">
									...
									<%' pagination %>
									<div class="pagingV15a" id="addrpaging"></div>
								</div>
									...
									<legend>우편번호, 시/도, 시/군/구 및 도로명 또는 지번, 상세주소 입력 폼</legend>
										<ul>
											<li>
												...
												<input type="tel" id="zipcode" onkeyup='removeChar()' style='ime-mode:disabled;' class="frmInputV16" maxlength="7" />
											</li>
											<li>
