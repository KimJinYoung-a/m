...
class cevent_list
	...
	public sub fevent_list()
        ...
        sqlStr = sqlStr & " evt_code, evt_name, evt_comment, regdate, startdate, enddate, evt_type, image_barner2, image_barner3, evt_kind, image_list "
	...
	public sub fevent_top5_list()
		...
		'목록 접수
        sqlStr = "Select top 5 evt_code, evt_name, evt_comment, regdate, startdate, enddate, evt_type, image_barner2, image_barner3, evt_kind, image_list "
		sqlStr = sqlStr & "	,(select count(idx) from db_culture_station.dbo.tbl_culturestation_event_comment as c "
		sqlStr = sqlStr & "	where isusing='Y' and c.evt_code = e.evt_code) as comCnt "
        sqlStr = sqlStr & " From db_culture_station.dbo.tbl_culturestation_event as e "
        sqlStr = sqlStr & addSql
