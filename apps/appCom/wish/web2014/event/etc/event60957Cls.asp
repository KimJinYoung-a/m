...
function currenttime()
	...
	tmpcurrenttime = now()
'	tmpcurrenttime = #04/07/2015 00:05:00#
...
'//텐바이텐 구매내역 조회 상품단위
function get10x10onlineorderdetailcount60957(userid, startdate, enddate, sitename, rdsite, beadaldiv, cancelyn, detailcancelyn, itemid, makerid)
	dim sqlstr, tmp10x10onlineorderdetailcount
	
	if startdate="" or enddate="" then
		get10x10onlineorderdetailcount60957=0
		exit function
	end if
	...
	get10x10onlineorderdetailcount60957 = tmp10x10onlineorderdetailcount
end function
%>