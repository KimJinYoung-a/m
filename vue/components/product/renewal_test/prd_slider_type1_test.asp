...
<%
'####################################################
' Description : 상품 슬라이더 type1 테스트 페이지
...
<!-- 핵심 JS -->
<script src="../prd_slider_type1.js?v=1.0"></script>
<script src="./store_prd_slider_type1_test.js?v=1.0"></script>
<!-- //핵심 JS -->
...
<script>
	var app = new Vue({
		...
		template: `
			<div>
			    <Product-Slider-Type1
                    @trans_end_slider="change_slider"
        ...
        methods : {
		    // 슬라이더가 슬라이드 되었을 때 처리
		    change_slider : function(product) {
		        console.log(product);
		    }
        }
	});
