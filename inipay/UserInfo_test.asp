					...
					<div class="orderInfoV16a">
						...
						<div class="cartGrpV16a" id="i_paymethod">
							...
							<% If G_PG_TOSSPAYNEW_ENABLE And Not(vlsOnlyHanaTenPayExist) Then %>
								...
								<!--div class="bnr-toss" ><img src="//fiximage.10x10.co.kr/m/2019/inipay/bg_toss.png" alt=""><p><strong>토스 <b>2,000원</b> 추가 할인!</strong><em>25,000원 이상 결제 시 자동적용 (토스 계정당 1회만)</em></p></div-->
							<% End If %>
