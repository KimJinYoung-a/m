...
<section class="evtBnrV15">
	...
	<span class="goMore"><a href="" onclick="fnAPPselectGNBMenu('event','http://m.10x10.co.kr/apps/appCom/wish/web2014/shoppingtoday/shoppingchance_allevent.asp');return false;">이벤트 메인 바로가기</a></span>
<%
...
%>
		<div onclick="fnAPPpopupEvent_URL('http://m.10x10.co.kr/apps/appCom/wish/web2014<%=linkurl%><%=gaParam%>');">
