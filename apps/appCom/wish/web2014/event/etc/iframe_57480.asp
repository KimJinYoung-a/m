...
%>
	...
	<div class="mEvt57476">
		...
		<div class="cardList">
			...
			<p><a href="" onclick="fnAPPpopupEvent('<%= dispcodeeCode %>');return false;" target="_top"><img src="http://webimage.10x10.co.kr/eventIMG/2014/57476/btn_send_card.gif" alt="스타워즈 모바일 카드 보내러 가기" /></a></p>
		</div>
		<% End If %>
	</div>
	<!--// 스타워즈 모바일카드 보내기(M) -->
	...
	function jsDelComment(cidx)	{
		<% If IsUserLoginOK() Then %>
			...
			if(confirm("삭제하시겠습니까?")){
				var str = $.ajax({
					type: "GET",
					url: "/apps/appCom/wish/web2014/event/etc/doEventSubscript57480.asp",
			...
			<% If getnowdate>="2014-12-08" and getnowdate<"2014-12-31" Then %>
				...
				<% else %>
					...
					if (str==''){
						...
						Kakao.Link.sendTalkLink({
							  ...
							  webLink: {
								<% IF application("Svr_Info") = "Dev" THEN %>
									text: 'http://testm.10x10.co.kr/event/eventmain.asp?eventid=<%= eCode %>&upin='+evtcom_idx,
									url: 'http://testm.10x10.co.kr/event/eventmain.asp?eventid=<%= eCode %>&upin='+evtcom_idx 		// 앱 설정의 웹 플랫폼에 등록한 도메인의 URL이어야 합니다.
								<% else %>
									text: 'http://m.10x10.co.kr/event/eventmain.asp?eventid=<%= eCode %>&upin='+evtcom_idx,
									url: 'http://m.10x10.co.kr/event/eventmain.asp?eventid=<%= eCode %>&upin='+evtcom_idx 		// 앱 설정의 웹 플랫폼에 등록한 도메인의 URL이어야 합니다.
								<% end if %>
							  }
						});
						...
						<% if isApp=1 then %>
							setTimeout("parent.location.href='/apps/appCom/wish/web2014/event/eventmain.asp?eventid=<%= dispcodeeCode %>'",1000);
							return false;
						<% else %>
			...
			<div class="mEvt57476">
				...
				<div class="swMenu">
					<ul>
						...
						<li><a href="/apps/appCom/wish/web2014/event/eventmain.asp?eventid=57478" target="_top">크리스마스 선물</a></li>
						<li><a href="/apps/appCom/wish/web2014/event/eventmain.asp?eventid=57479" target="_top">에피소드7 미리보기</a></li>
						<li class="on"><a href="/apps/appCom/wish/web2014/event/eventmain.asp?eventid=57480" target="_top">모바일카드 보내기</a></li>
					</ul>
