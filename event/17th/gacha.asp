...
''head.asp에서 출력
strOGMeta = strOGMeta & "<meta property=""og:title"" content=""[텐바이텐 17주년] - 100원으로 인생역전!"">" & vbCrLf
strOGMeta = strOGMeta & "<meta property=""og:type"" content=""website"" />" & vbCrLf
strOGMeta = strOGMeta & "<meta property=""og:url"" content=""http://m.10x10.co.kr/event/eventmain.asp?eventid=89309"" />" & vbCrLf
strOGMeta = strOGMeta & "<meta property=""og:image"" content=""http://webimage.10x10.co.kr/eventIMG/2018/89308/etcitemban20180917180913.JPEG"">" & vbCrLf
strOGMeta = strOGMeta & "<meta property=""og:description"" content=""10/10 ~ 17, 100원으로 엄청난 상품을 살 수 있는 뽑기에 도전해보세요!"">" & vbCrLf
...
Function doubletime(v)
	Select Case CStr(v)
		...
		Case "2018-10-24"
			doubletime = "<p><img src='http://webimage.10x10.co.kr/fixevent/event/2018/17th/88940/m/txt_next_1023.png' alt='' /></p><span></span>"
		Case "2018-10-25"
		...
		Case "2018-10-26" , "2018-10-27" , "2018-10-28" 
			doubletime = "<p><img src='http://webimage.10x10.co.kr/fixevent/event/2018/17th/88940/m/txt_next_1025.png' alt='' /></p><span></span>"
		Case "2018-10-29"
		...
		Case "2018-10-30"
			doubletime = "<p><img src='http://webimage.10x10.co.kr/fixevent/event/2018/17th/88940/m/txt_next_1029.png' alt='' /></p><span></span>"
		Case "2018-10-31"
		...
		Case Else
			doubletime = "<p><img src='http://webimage.10x10.co.kr/fixevent/event/2018/17th/88940/m/txt_next_1010.png' alt='' /></p><span></span>"
	end Select
End Function
...
function noplay(v)
	Select Case CStr(v)
		...
		Case "2018-10-12" , "2018-10-13" , "2018-10-14" , "2018-10-17" , "2018-10-19" , "2018-10-20" , "2018-10-21" , "2018-10-22" , "2018-10-24" , "2018-10-26" , "2018-10-27" , "2018-10-30"
...
.challenge .btn-area button {display:block; background-color:transparent;}
.challenge .btn-area .btns {position:absolute; top:8.3%; left:22%; width:100%; animation:shake 1s 50;}
.challenge .btn-area .btn-submit {width:56.5%;}
.challenge .btn-area span {display:block; width:55.5%;}
...
$(function(){
	// amplitude init
	fnAmplitudeEventMultiPropertiesAction('view_17th_100win_app','','');
...
function checkmyprize(){
	fnAmplitudeEventMultiPropertiesAction('click_17th_100win_action','','');
...
function sharesns(snsnum) {
	fnAmplitudeEventMultiPropertiesAction('click_17th_100win_sns','','');
	<% If vUserID = "" Then %>
		<% if isApp=1 then %>
			calllogin();
			return false;
