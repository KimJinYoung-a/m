...
function AddEval1(OrdSr,itID,OptCd){
	//location.href = '/apps/appCom/wish/web2014/my10x10/goodsUsingWrite1.asp?orderserial=' + OrdSr + '&itemid=' + itID + '&optionCD=' + OptCd + '';
	fnAPPpopupBrowser(OpenType.FROM_RIGHT, [], '상품후기', [], '<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/goodsUsingWrite1.asp?orderserial=' + OrdSr + '&itemid=' + itID + '&optionCD=' + OptCd + '');
}
</script>
</head>
<body>
