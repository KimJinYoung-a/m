...
<%
	...
	eventEndDate	= cdate("2020-12-10")		'이벤트 종료일 + 1
	currentDate	= date()
	...
	Select Case currentDate
		...
		Case "2020-11-30"
            ...
            if selectedPdt = 4 then
                chkWinTime "11:42", 30, winStartTimeLine, winEndTimeLine
			end if
            if selectedPdt = 5 then
                chkWinTime "14:54", 30, winStartTimeLine, winEndTimeLine
			end if
		...
		Case "2020-12-02"
            ...
            if selectedPdt = 2 then
                chkWinTime "16:41", 30, winStartTimeLine, winEndTimeLine
			end if
            if selectedPdt = 8 then
		...
		Case "2020-12-07"
            if selectedPdt = 6 then
                chkWinTime "12:47", 30, winStartTimeLine, winEndTimeLine
			end if
            if selectedPdt = 4 then
		...
		Case "2020-12-08"
            ...
            if selectedPdt = 8 then
                ...
                chkWinTime "00:16", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "00:20", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "00:38", 30, winStartTimeLine, winEndTimeLine
    	...
    	Case "2020-12-09"
            if selectedPdt = 8 then
                ...
                chkWinTime "00:11", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "00:39", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "07:14", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "07:21", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "07:47", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "07:53", 30, winStartTimeLine, winEndTimeLine
                ...
                chkWinTime "10:07", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "10:13", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "10:15", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "11:48", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "12:00", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "12:24", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "12:58", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "13:02", 30, winStartTimeLine, winEndTimeLine
                ...
                chkWinTime "18:46", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "19:05", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "19:25", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "19:44", 30, winStartTimeLine, winEndTimeLine
                chkWinTime "20:17", 30, winStartTimeLine, winEndTimeLine
			end if
	End select
