...
<div class="heightGrid" id="main">
	...
	<div class="mainSection" style="padding:0px;">
		<div class="container">
			...
			<%
				...
				if chkDt="" then
					Server.Execute("/chtml/preview/make_main_xml.asp")
				end if

				'## 메인 템플릿 로드
				server.Execute("/chtml/preview/mainLoader.asp")
			%>
			</div>
		</div>
		<!-- //content area -->
