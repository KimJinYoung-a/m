	...
	<div class="container popWin">
		...
		<div class="content" id="contentArea">
			<div class="heySomething">
				<div class="get">
					<div class="item">
						<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/68133/m/img_get_school.jpg" alt="WOOUF Laptop Banana 구매하기" /></p>
						<%' for dev msg : 상품 링크 %>
						<ul>
							<li>
								<% If isApp="1" Then %>
							...
							<li>
								<% If isApp="1" Then %>
									<a href="" onclick="fnAPPpopupProduct('1403592'); return false;">
								<% Else %>
									<a href="/category/category_itemPrd.asp?itemid=1403592&amp;pEtr=68133">
								<% End If %>
							...
							<li>
								<% If isApp="1" Then %>
									<a href="" onclick="fnAPPpopupProduct('1385750'); return false;">
								<% Else %>
									<a href="/category/category_itemPrd.asp?itemid=1385750&amp;pEtr=68133">
								<% End If %>
									<span></span>iPad
								</a>
							</li>
							<li>
								<% If isApp="1" Then %>
									<a href="" onclick="fnAPPpopupProduct('1385766'); return false;">
								<% Else %>
									<a href="/category/category_itemPrd.asp?itemid=1385766&amp;pEtr=68133">
								<% End If %>
									<span></span>iPad Mini
								</a>
							</li>
