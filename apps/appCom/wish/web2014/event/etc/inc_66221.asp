...
function checkform(){
	...
	<% If vUserID <> "" Then %>
		...
		<% Else %>
			var str = $.ajax({
				type: "GET",
				url: "/apps/appCom/wish/web2014/event/etc/doEventSubscript66221.asp",
				data: "mode=add",
				dataType: "text",
				async: false
			}).responseText;
...
<div class="mEvt66221">
	<article>
		<div class="topic">
			...
			<div class="btncoupon">
				<a href="" title="만원 쿠폰 다운받기" onclick="checkform();return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2015/66221/btn_coupon.png" alt="만원 쿠폰 5만원 이상 구매시 사용 가능하며 9월 16일 수요일부터9월 20일 일요일까지 일간 앱에서만 사용 가능합니다." /></a>
			</div>
		</div>
