...
<div class="evtTopBnr">
	<div class="swiper-container">
		<div class="swiper-wrapper">
			...
			%>
			<div class="swiper-slide">
				<a href="" onclick="fnAPPpopupBrowserURL('쿠폰북','<%=wwwUrl%>/apps/appCom/wish/web2014/shoppingtoday/couponshop.asp');return false;"><img src="http://fiximage.10x10.co.kr/m/2014/common/topbnr_coupon_book2.png" alt="텐바이텐의 할인상품을 한눈에! COUPON BOOK" /></a>
			</div>
		</div>
	</div>
	<% If isArray(arrMktevt) and not(isnull(arrMktevt)) Then  %>
