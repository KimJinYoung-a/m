...
function checkform(){
	...
	<% If vUserID <> "" Then %>
		...
		<% Else %>
			...
			$.ajax({
				type:"GET",
				url:"/apps/appcom/wish/web2014/event/etc/doeventsubscript/doEventSubscript64256.asp",
...
<body>
	...
	<div class="mEvt64256">
		<div class="topic">
			<h1><img src="http://webimage.10x10.co.kr/eventIMG/2015/64256/tit_password.png" alt="말할 수 없는 비밀번호 비밀번호를 넣으면 놀라운 선물이!" /></h1>
			...
			<button type="button" onclick="alert('<%=sKey%>')" class="btnforgot"><span>혹시 비밀번호를 잊으셨나요?</span><img src="http://webimage.10x10.co.kr/eventIMG/2015/64256/btn_review.png" alt="" /></button>
			<% If totalbonuscouponcount >= 2000 Then %>
