...
.presentbox {position:absolute; top:19%; right:0; width:14.5%; padding-bottom:26%;}
...
.presentbox a {background-image:url(http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/btn_present_table_off.png);}
.presentbox span {background-image:url(http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/btn_present_table_on.png);}
...
<div class="evtCont evtView">
	...
	<div class="xmasNight">
		<div class="hgroup">
			<span class="deco animated fadeIn"><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/img_deco_table.png" alt="" /></span>
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/txt_party_table.gif" alt="소중한 사람들과 한해를 돌아보는 시간을 가져요" /></p>
		</div>
		...
		<div class="find-presentbox">
			...
			<div><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/img_table.jpg" alt="" /></div>
			...
			<div id="lyPresent">
				<div class="lyPresent window">
					<div class="present">
						...
						<div class="coupon"><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/img_xmas_coupon_03.gif" alt="크리스마스 아이템 쿠폰 크리스마스 단독상품 구매시 5% 할인" /></div>
