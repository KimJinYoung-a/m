...
.swiperWrap {position:relative; background:url(http://webimage.10x10.co.kr/eventIMG/2015/61493/bg_slide.gif) left top no-repeat; background-size:100% 100%;}
.swiper {position:relative; }
.swiper .swiper-container {overflow:hidden;}
.swiper .swiper-slide {float:left;}
.swiper .hPagination {position:absolute; bottom:0; left:0; width:100%; height:10px; text-align:center; z-index:100;}
.swiper .hPagination span {display:inline-block; position:relative; width:10px; height:10px; margin:0 4px; border-radius:50%; background:#fff; cursor:pointer; vertical-align:top;}
.swiper .hPagination .swiper-active-switch {background:#703f26;}
.swiper button {border:0; background:none;}
.swiper .btnNav {display:block; position:absolute; top:36%; width:12.8%; z-index:10; color:#fff; }
...
function jsSubmitComment(){
	...
	frm.mode.value = "inst";
	frm.action = "/event/etc/doEventSubscript61493.asp";
	frm.submit();
	return;
	<% end if %>
}
...
<body>
<div class="vipGift">
	<h2><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/tit_love_honey.gif" alt="단지 널 사랑해" /></h2>
	<div class="swiperWrap">
		<div class="swiper">
			<div class="swiper-container swiper1">
				<div class="swiper-wrapper">
					<div class="swiper-slide"><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/img_slide01.png" alt="" /></div>
					<div class="swiper-slide"><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/img_slide02.png" alt="" /></div>
					<div class="swiper-slide"><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/img_slide03.png" alt="" /></div>
					<div class="swiper-slide"><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/img_slide04.png" alt="" /></div>
					<div class="swiper-slide"><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/img_slide05.png" alt="" /></div>
				</div>
				<div class="hPagination"></div>
			</div>
			<button type="button" class="btnNav arrowPrev"><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/btn_swipe_prev.png" alt="이전" /></button>
			<button type="button" class="btnNav arrowNext"><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/btn_swipe_next.png" alt="다음" /></button>
		</div>
	</div>
	...
	<div class="goEvt">
		<a href="/event/eventmain.asp?eventid=61488" target="_top" class="mw"><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/btn_go_event.gif" alt="사월의 꿀맛 메인으로 가기" /></a>
		<a href="#" onclick="fnAPPpopupEvent('61488'); return false;" class="ma"><img src="http://webimage.10x10.co.kr/eventIMG/2015/61493/btn_go_event.gif" alt="사월의 꿀맛 메인으로 가기" /></a>
	</div>
</div>
</body>
</html>
