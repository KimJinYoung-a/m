...
<div class="wrapper" id="btwRcmd"><!-- for dev msg : 원뎁스별 해당 ID 추가(비트윈추천:btwRcmd/카테고리:btwCtgy/마이페이지:btwMypage) -->
	<div id="content">
		...
		<div class="cont">
			<div class=""><!-- for dev msg : 타겟별 다른 클래스 추가(남:targetM/여:targetF) -->
				<div class="bnrForTheme">
					<h2><img src="http://fiximage.10x10.co.kr/m/webview/between/main/@temp_bnr_plan_03.jpg" alt="마음에 꼭~ 들 센스만점 생일선물 추천" /></h2><!-- for dev msg : 기획전 이름으로 Alt값 넣어주세요. -->
				</div>

				<!-- Product List -->
				<div class="pdtListWrap">
					<h3 style="background-color:#14c1c7; color:#fff;">구분자명1</h3><!-- for dev msg : 관리자에서 배경과 폰트 색상 등록 -->
					...
					<h3 style="background-color:#14c1c7; color:#fff;">구분자명2</h3>
					<ul class="pdtList list03 boxMdl">
						<li>
							<div>
								<a href="">
