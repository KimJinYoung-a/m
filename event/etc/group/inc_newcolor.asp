...
'#######################################################################
	...
	If vEventID = "112368" Then '// 7월
		vStartNo = "0"
	ElseIf vEventID = "112726" Then '// 8월
		vStartNo = "0"
...
<div id="navigator" class="navigator">
	<div class="swiper-container">
		<ul class="swiper-wrapper">
			...
			<% Else %>
			<li class="swiper-slide <%=CHKIIF(vEventID="112368"," current","")%>"><a href="<%=eventUrl%>=112368">July</a>
			<% End If %>
			</li>

			<% if currentdate < "2021-08-02" then %>
			<li class="swiper-slide"><span>coming</span>
			<% Else %>
			<li class="swiper-slide <%=CHKIIF(vEventID="112726"," current","")%>"><a href="<%=eventUrl%>=112726">August</a>
			<% End If %>
			</li>

			<% if currentdate < "2021-09-05" then %>
			<li class="swiper-slide"><span>coming</span>
			<% Else %>
			...
			<% if currentdate < "2021-10-05" then %>
			<li class="swiper-slide"><span>coming</span>
			<% Else %>
			<li class="swiper-slide <%=CHKIIF(vEventID="000000"," current","")%>"><a href="<%=eventUrl%>=000000">coming</a>
			<% End If %>
