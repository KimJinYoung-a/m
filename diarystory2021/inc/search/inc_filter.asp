			...
			<div class="modal_cont_inner">
				<section class="filter_type1">
					<ul class="filter_main">
						...
						<li data-subfilter="filter_sub1"><span>종류</span></li> <%'!-- 다이어리 구분 --%>
						<li data-subfilter="filter_sub2"><span>스타일</span></li> <%'!-- 다이어리 스타일 --%>
						<li data-subfilter="filter_sub3"><span>커버</span></li> <%'!-- 다이어리 재질, 다이어리 제본, 컬러 --%>
						<li data-subfilter="filter_sub4"><span>날짜</span></li> <%'!-- 다이어리 날짜, 다이어리 기간, 다이어리 내지구성 --%>
					</ul>
					<div class="filter_sub">
						<%'!-- 종류 --%>
						<div id="filter_sub1" class="filter_sub_cont on diary-attr">
                            <div class="diary-attr">
                                <ul>
                                    <li><div class="checkbox"><input type="checkbox" value="301001" id="opt1_a1"><label for="opt1_a1">다이어리</label></div></li>
                                    <li><div class="checkbox"><input type="checkbox" value="301002" id="opt1_a2"><label for="opt1_a2">스터디</label></div></li>
                                    <li><div class="checkbox"><input type="checkbox" value="301003" id="opt1_a3"><label for="opt1_a3">가계부</label></div></li>
                                </ul>
                            </div>
						</div>
						<%'!-- 스타일 --%>
						<div id="filter_sub2" class="filter_sub_cont">
                            <div class="diary-attr">
                                <ul>
                                    <li><div class="checkbox"><input type="checkbox" value="302001" id="opt2_a1"><label for="opt2_a1">심플</label></div></li>
                                    <li><div class="checkbox"><input type="checkbox" value="302002" id="opt2_a2"><label for="opt2_a2">일러스트</label></div></li>
                                    <li><div class="checkbox"><input type="checkbox" value="302003" id="opt2_a3"><label for="opt2_a3">패턴</label></div></li>
                                    <!--<li><div class="checkbox"><input type="checkbox" value="302004" id="opt2_a4"><label for="opt2_a4">포토</label></div></li>-->
                                </ul>
                            </div>
						</div>
						<%'!-- 커버 (재질, 제본, 컬러) --%>
						...
						<div id="filter_sub4" class="filter_sub_cont">
							<div class="filter_sub_inner diary-attr">
								...
								<ul>
									<li><div class="checkbox"><input type="checkbox" value="303003" id="opt4_a1"><label for="opt4_a1">2021 날짜형</label></div></li>
...
function fnFilterTitleChance() {
    ...
    $(".btn_dr_srch_type2").addClass('on').html(returnMessage);
    $(".bbl_blk").show();
	$('.filterclear').addClass('on');
}
