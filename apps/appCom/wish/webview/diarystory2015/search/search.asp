...
function goSearchDiary()
{
	...
	document.frm_search1.action = "/apps/appcom/wish/webview/diarystory2015/list.asp";
	document.frm_search1.submit();
}

function fnCloseModal()
{
	$("#modalCont").attr("style","display:none");
}

</script>
</head>
<body>
<div class="layerPopup modal">
	<div class="popWin">
		<div class="header">
			<h1>다이어리 검색</h1>
			<p class="btnPopClose"><button class="pButton" onclick="fnCloseModal();">닫기</button></p>
			<p class="btnPopRefresh"><button  class="pButton" id="refChkBox" onclick="#">새로고침</button></p>
		</div>
			...
			<div id="scrollarea">
				...
				<div class="filterListup">
					...
					<section class="checkType">
						<ul>
							<li><input type="checkbox" id="optD01" name="design" value="10" <%= getchecked(ArrDesign,10) %> class="check"  /> <label for="optD01">SIMPLE</label></li>
							<li><input type="checkbox" id="optD02" name="design" value="20" <%= getchecked(ArrDesign,20) %> class="check" /> <label for="optD02">ILLUST</label></li>
							<li><input type="checkbox" id="optD03" name="design" value="30" <%= getchecked(ArrDesign,30) %> class="check" /> <label for="optD03">PATTERN</label></li>
							<li><input type="checkbox" id="optD04" name="design" value="40" <%= getchecked(ArrDesign,40) %> class="check" /> <label for="optD04">PHOTO</label></li>
						</ul>
					</section>
					<!--// DESIGN -->
					...
					<section class="checkType col-three">
						<ul>
							<li><input type="checkbox" id="optCt01" name="contents" value="'only 2015'" <%= getchecked(arrcontents,"'only 2015'") %> class="check" /> <label for="optCt01">Only 2015</label></li>
							<li><input type="checkbox" id="optCt02" name="contents" value="'만년'" <%= getchecked(arrcontents,"'만년'") %> class="check" /> <label for="optCt02">만년 diary</label></li>
							<li><input type="checkbox" id="optCt03" name="contents" value="'half diary'" <%= getchecked(arrcontents,"'half diary'") %> class="check" /> <label for="optCt03">Half diary</label></li>
							<li><input type="checkbox" id="optCt04" name="contents" value="'yearly'" <%= getchecked(arrcontents,"'yearly'") %> class="check" /> <label for="optCt04">Yearly</label></li>
							<li><input type="checkbox" id="optCt05" name="contents" value="'monthly'" <%= getchecked(arrcontents,"'monthly'") %> class="check" /> <label for="optCt05">Monthly</label></li>
							<li><input type="checkbox" id="optCt06" name="contents" value="'weekly'" <%= getchecked(arrcontents,"'weekly'") %> class="check" /> <label for="optCt06">Weekly</label></li>
							<li><input type="checkbox" id="optCt07" name="contents" value="'daily'" <%= getchecked(arrcontents,"'daily'") %> class="check" /> <label for="optCt07">Daily</label></li>
							<li><input type="checkbox" id="optCt08" name="contents" value="'cash'" <%= getchecked(arrcontents,"'cash'") %> class="check" /> <label for="optCt08">Cash</label></li>
							<li><input type="checkbox" id="optCt09" name="contents" value="'pocket'" <%= getchecked(arrcontents,"'pocket'") %> class="check" /> <label for="optCt09">Pocket</label></li>
							<li><input type="checkbox" id="optCt10" name="contents" value="'band'" <%= getchecked(arrcontents,"'band'") %> class="check" /> <label for="optCt10">Band</label></li>
							<li><input type="checkbox" id="optCt11" name="contents" value="'pen holder'" <%= getchecked(arrcontents,"'pen holder'") %> class="check" /> <label for="optCt11">Pen holder</label></li>
						</ul>
					</section>
					<!--// CONTENTS -->
					...
					<section class="checkType">
						<ul>
							<li><input type="checkbox" id="optCv01" name="keyword" value="37" <%= getchecked(arrkeyword,"37") %> class="check" /> <label for="optCv01">Paper soft</label></li>
							<li><input type="checkbox" id="optCv02" name="keyword" value="38" <%= getchecked(arrkeyword,"38") %> class="check" /> <label for="optCv02">Paper hard</label></li>
							<li><input type="checkbox" id="optCv03" name="keyword" value="39" <%= getchecked(arrkeyword,"39") %> class="check" /> <label for="optCv03">Leather style</label></li>
							<li><input type="checkbox" id="optCv04" name="keyword" value="40" <%= getchecked(arrkeyword,"40") %> class="check" /> <label for="optCv04">PVC</label></li>
							<li><input type="checkbox" id="optCv05" name="keyword" value="42" <%= getchecked(arrkeyword,"42") %> class="check" /> <label for="optCv05">Fabric</label></li>
						</ul>
					</section>
