...
function goPage(page) {
	location.replace('awardvip.asp?cpg='+page);
}
	...
	<div class="container popWin" style="background-color:#e7eaea;">
		...
		<div class="content" id="contentArea">
			<ul class="commonTabV16a">
				<li class="current" name="tab01" style="width:25%;" onclick="location.replace('awardVIP.asp');return false;">VIP</li><!--for dev msg : 해당탭에 클래스 current 추가됩니다. -->
			...
			<div class="vipBestV15">
				<div class="bestListV15">
					<ul>
						...
						<% For i=sNo to eNo %>
						<li class="<%=CHKIIF(oaward.FItemList(i).IsSoldOut,"soldOut","")%>" onclick="TnGotoProduct('<%=oaward.FItemList(i).FItemID%>');">
							<p class="ranking"><span><%= i+1 %></span></p>
							<div class="pPhoto" onclick="TnGotoProduct('<%=oaward.FItemList(i).FItemID%>');">
