...
public function GetCouponDiscountStr()
	Select Case coupontype
		Case "1"
			GetCouponDiscountStr =CStr(couponvalue) + "%"
		Case "2"
			GetCouponDiscountStr = formatNumber(couponvalue,0) + "원 할인"
		Case "3"
...
%>
		...
		<!-- <a href="/category/category_itemPrd.asp?itemid=<%=itemid%>&ldv=<%=templdv%>"> -->
		<a href="/chance/">
			<div class="dealPdt">
				<div class="pic">
...
<%
	...
	Set cTmpl = Nothing
%>
		<p class="btnViewItem"><span><a href="/chance/">찬스! 더보기</a></span></p>
	</section>
<%
End If
'//랜덤 view
