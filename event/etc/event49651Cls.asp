...
Class Cevent49651_list
	...
	public Sub getMyWishList()
		...
		sqlStr = sqlStr + " group by f.itemid, i.itemname, i.sellcash, i.orgprice"
		sqlStr = sqlStr + " , (Case When isNull(i.frontMakerid,'')='' then i.makerid else i.frontMakerid end)"
		sqlStr = sqlStr + " , i.brandname , i.sellyn, i.sailyn, i.itemgubun, i.limityn, limitno, limitsold, i.listimage"
		sqlStr = sqlStr + " , i.icon1Image, i.icon2Image, i.listimage120, i.smallimage, i.sailprice, i.optioncnt, i.evalcnt"
		sqlStr = sqlStr + " , i.specialuseritem , i.itemcouponyn, i.itemcoupontype, i.itemcouponvalue, i.curritemcouponidx , i.regdate"
		sqlStr = sqlStr + " , i.itemdiv, i.deliverytype, t.favcount "
