			...
			<div class="content" id="contentArea">
				...
				<!-- // 주문 성공 -->
					...
					<div class="giftcardSnsV15a">
						<ul>
							<li class="kakaotalk"><a href="" onClick="event_sendkakao('텐바이텐 기프트카드' ,'<%=vTitle%>', '<%=vImg%>' , '<%=vLink%>' );return false;"><span></span>카카오톡</a></li>
							<script>
								//카카오 SNS 공유 v2.0
					...
					<% end if %>
					<div class="btnGroupV15a" style="padding:0 1rem;">
						<div class="button btB1 btRed cWh1 w100p"><a href="<%=wwwUrl%>/my10x10/giftcard/giftCardList.asp">주문확인 하기</a></div>
