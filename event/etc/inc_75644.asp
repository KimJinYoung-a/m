...
<script>
$(function(){
	window.$('html,body').animate({scrollTop:$(".mEvt75644").offset().top}, 0);
});
...
function jsvipgo(){
	...
	<% if Not(Now() > #01/16/2017 00:00:00# And Now() < #01/22/2017 23:59:59#) then %>
		alert("이벤트 기간이 아닙니다.");
		return false;
	<% end if %>
...
function jsSubmitComment(){
	...
	frm.mode.value = "inst";
	frm.action = "/event/etc/doeventsubscript/doEventSubscript75644.asp";
	frm.submit();
	return;
}
...
<div class="mEvt75644 vipGift">
	<div class="topic">
		<p><img src="http://webimage.10x10.co.kr/eventIMG/2017/75644/m/txt_vip_gift.jpg" alt="감사의 마음을 담아 VIP고객님만을 위한 특별한 선물을 드립니다" /></p>
	...
	<div class="apply">
		<div class="row">
			...
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2017/75644/m/txt_way_apply.png" alt="VIP Gift 신청대상은 1월 현재 VVIP, VIP 골드, VIP 실버 고객이며 2016년 12월 VIP Gift를 신청하신 분들은 대상에서 제외됩니다. 주소확인 기간은 2017년 1월 16일 월요일부터 22일 일요일까지며, 2017년 1월 23일 월요일부터 순차적으로 배송되며, 한정 수량으로 조기 종료될 수 있습니다." /></p>
