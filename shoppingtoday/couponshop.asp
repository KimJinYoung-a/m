...
function changetab(stab,stype){
   self.location.href = "/shoppingtoday/couponshop.asp?stab="+stab+"&stype="+stype;
}
...
function PopItemCouponAssginList(iidx){
	...
	//popwin.focus();
	top.location.href='/my10x10/Pop_CouponItemList.asp?itemcouponidx=' + iidx + '&tab=Y'
}
