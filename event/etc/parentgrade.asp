...
.card-list .c11 .lyr-again {display:none; position:fixed; left:0; right:0; top:0; bottom:0; z-index:30; width:100%; height:100%; padding:0 6%; background:rgba(0,0,0,.6);}
.card-list .c11 .lyr-inner {position:relative; top:50%; transform:translateY(-50%);}
