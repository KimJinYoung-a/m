...
$(function(){
	...
	//초기 상품목록 세팅
	getEvtItemList('nav02',<%=chkIIF(application("Svr_Info")="Dev","135312","145120")%>);
...
function getEvtItemList(no,egc) {
	...
	$.ajax({
		type:"POST",
		url: "/event/etc/inc_63082_itemlist.asp",
		data: "eGC="+egc,
		cache: false,
...
function jsSubmitComment(frm){
	<% If IsUserLoginOK() Then %>
		<% If not( left(currenttime,10)>="2015-06-01" and left(currenttime,10)<"2015-07-01" ) Then %>
...
<div class="mEvt63082">
	...
	<div class="coolItem">
		...
		<ul class="navigator">
			...
			<li><a href="" id="nav01" onclick="getEvtItemList('nav01',<%=chkIIF(application("Svr_Info")="Dev","135312","145119")%>); return false;"><span></span>3만원 미만 <img src="http://webimage.10x10.co.kr/eventIMG/2015/63082/bg_tab_on.png" alt="" /></a></li>
			<li><a href="" id="nav02" onclick="getEvtItemList('nav02',<%=chkIIF(application("Svr_Info")="Dev","135313","145120")%>); return false;"><span></span>5만원 미만 <img src="http://webimage.10x10.co.kr/eventIMG/2015/63082/bg_tab_on.png" alt="" /></a></li>
			<li><a href="" id="nav03" onclick="getEvtItemList('nav03',<%=chkIIF(application("Svr_Info")="Dev","135314","145121")%>); return false;"><span></span>10만원 미만 <img src="http://webimage.10x10.co.kr/eventIMG/2015/63082/bg_tab_on.png" alt="" /></a></li>
		</ul>
	...
	<div class="commentevt" id="commentlist">
		<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/63082/txt_comment.jpg" alt="이 더위를 날려버릴 나만의 꿀팁을 공개해주세요! 베스트 팁을 남겨주신 20분을 추첨하여 조쿠 트리플 퀵팝 메이커를 드립니다. 이벤트 기간은 2015년 6월 1일부터 6월 15일까지며 당첨자 발표는 2015년 6월 17일입니다." /></p>
		<div class="field">
			<form action="">
				<fieldset>
					<div class="inner">
