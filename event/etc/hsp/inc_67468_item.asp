		...
		<div class="content" id="contentArea">
			<div class="heySomething">
				<div class="get">
					...
					<% Else %>
						<a href="/category/category_itemPrd.asp?itemid=1387369" class="link">
					<% End If %>
							<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_big_v1.jpg" alt="WOOL KNIT MUFFLER 구매하기" />
							<div class="option">
								<% 
								...
								<% if oItem.FResultCount > 0 then %>
									...
									<% End If %>
									<em class="name"><span>SKYBLUE</span></em>
								<% End If %>
							</div>
						</a>
					</div>
					...
					<div class="item">
						<a href="" onclick="jsViewItem('1387369'); return false;">
							<ul>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_01.jpg" alt="" />
								...
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_02.jpg" alt="" />
									<span class="color">PINK</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_03.jpg" alt="" />
									<span class="color">SKYBLUE</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_04.jpg" alt="" />
									<span class="color">GRAY</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_05.jpg" alt="" />
									<span class="color">BROWN</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_06.jpg" alt="" />
									<span class="color">KHAKI</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_07.jpg" alt="" />
									<span class="color">BLUE</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_08.jpg" alt="" />
									<span class="color">NAVY</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_09.jpg" alt="" />
									<span class="color">WINE</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/67468/m/img_thumb_10.jpg" alt="" />
