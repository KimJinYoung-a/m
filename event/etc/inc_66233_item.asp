...
.item {overflow:hidden; position:absolute; top:15%; left:50%; z-index:10; width:100%; margin-left:-50%;}
.item a {overflow:hidden; display:block; position:relative; height:0; margin:0 5%; padding-bottom:125.25%; color:transparent; font-size:11px; line-height:11px; text-align:center;}
	...
	<div class="container popWin">
		...
		<div class="content" id="contentArea">
			<div class="heySomething">
				<div class="get">
					<img src="http://webimage.10x10.co.kr/eventIMG/2015/66233/m/img_get.jpg" alt="" />
					<div class="option">
						<%
						...
						<em class="name"><span>210-270mm/발볼 1-3단계/굽 3.5cm</span></em>
					</div>
					<div class="item">
						<% if isApp then %>
						...
						<span></span>BURGUNDY, WHITE, BEIGE, RED BROWN, BLACK</a>
					</div>
				</div>
			</div>
