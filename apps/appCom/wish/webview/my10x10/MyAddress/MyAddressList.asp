    ...
    <div class="wrapper myinfo">
        ...
        <header id="header">
            <div class="tabs type-c">
                <a href="MyAddressList.asp" class="active">국내 주소록</a>
                <a href="SeaAddressList.asp">해외 주소록</a>
            </div>
        </header><!-- #header -->
        ...
        <div id="content">
            ...
            <div class="inner">
                <div class="main-title">
                    <h1 class="title"><span class="label">나의 국내  주소록</span></h1>
                </div>
            </div>
                ...
                <ul class="address-list">
                    ...
                    <li class="bordered-box">
                        ...
                        <div class="address-info">
                            ...
                            <p class="phone">
                                <%=obj.Items(i).reqPhone%> / <%=obj.Items(i).reqHp%>
                            </p>
                            <p class="address">
            ...
            <div class="form-actions highlight">
                <button class="btn type-a full-size" onclick="location.href='<%=conSaveURL%>&openerYN=N';">국내 주소록 신규등록</button>
            </div>
        </div><!-- #content -->
