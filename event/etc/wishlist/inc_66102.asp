...
<%
'####################################################
' Description :  위시리스트 - 내가 꿈꾸는 거실
' History : 2015-09-03 원승현 생성
'####################################################
%>
...
.mEvt66102 {background:#e1faf0 url(http://webimage.10x10.co.kr/eventIMG/2015/66102/m/bg_stripe_pattern.png) repeat-y 50% 0; background-size:100% auto;}
.mEvt66102 .topic {padding-bottom:5%;}
.mEvt66102 .topic h2 {overflow:hidden; visibility:hidden; position:absolute; top:-1000%; width:0; height:0; line-height:0;}
...
.myWhisList ul {overflow:hidden; margin:7% auto 0; width:286px; height:188px; background:url(http://webimage.10x10.co.kr/eventIMG/2015/66102/m/bg_nodata.png) no-repeat 50% 0; background-size:100% 100%;}
...
.friendsWishList h4 span {padding-left:17px; background:url(http://webimage.10x10.co.kr/eventIMG/2015/66102/m/ico_cart.png) left top no-repeat; background-size:13px auto;}
...
.shareSns li {position:absolute; bottom:14.5%; width:16%; height:22%;}
...
function jsSubmit()
{
	<% If IsUserLoginOK() Then %>
		<% If Now() > #09/20/2015 23:59:59# Then %>
			alert("이벤트가 종료되었습니다.");
			return;
		<% Else %>
			<% If date() >= "2015-09-14" and date() < "2015-09-21" Then %>
...
<div class="mEvt66102">
	<article>
		<div class="topic">
			<h2>내가 꿈꾸는 거실</h2>
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/m/txt_my_dream_house.jpg" alt="내가 꿈꾸는 거실 폴더에 꿈꾸는 위시 상품을 담아주세요. 5분께 텐바이텐 기프트카드 10만원권을 선물로 드립니다. 이벤트 기간은 9월 14일부터 9월 20일까지며, 당첨자 발표는 9월 21일 입니다." /></p>
		</div>
		<div class="wishBox">
			<div class="btnEvent"><a href="" onclick="jsSubmit(); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/m/btn_event.png" alt="내가 꿈꾸는 거실 위시폴더 만들고 이벤트 참여하기" /></a></div>
			<% If IsUserLoginOK() Then %>
			<% if vCount > 0 then %>
				<div class="myWhisList">
					<h3><span><strong><%= userid %></strong> 님의 &lt;내가 꿈꾸는 거실&gt;위시 폴더</span></h3>
					<ul>
				...
				<% else %>
				<p class="process" style="display:block;"><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/m/txt_process.png" alt="이벤트를 통해서 내가 꿈꾸는 거실 폴더를 자동 생성한 후 원하는 상품의 상세 페이지에서 위시아이콘을 클릭, 내가 꿈꾸는 거실 폴더에 여러분이 꿈꾸는 신혼집이 위시 상품을 담아주시면 이벤트에 참여하실 수 있습니다. 기본에 있는 폴더명을 수정하거나 수동으로 만드는 폴더는 응모대상에서 제외 됩니다." /></p>
				<% end if %>
			<% else %>
				<p class="process" style="display:block;"><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/m/txt_process.png" alt="이벤트를 통해서 내가 꿈꾸는 거실 폴더를 자동 생성한 후 원하는 상품의 상세 페이지에서 위시아이콘을 클릭, 내가 꿈꾸는 거실 폴더에 여러분이 꿈꾸는 신혼집이 위시 상품을 담아주시면 이벤트에 참여하실 수 있습니다. 기본에 있는 폴더명을 수정하거나 수동으로 만드는 폴더는 응모대상에서 제외 됩니다." /></p>
			<% end if %>
		...
		<div class="friendsWishList">
			<h3><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/m/tit_friends_wish.png" alt="다른 친구들의 &lt;내가 꿈꾸는 거실&gt; 폴더를 둘러보세요!" /></h3>
			<div class="itemlist">
		...
		<div class="noti">
			...
			<ul>
				<li>참여하기 클릭 시, 위시리스트에 &lt;내가 꿈꾸는 거실&gt; 폴더가 자동 생성됩니다.</li>
				<li>본 이벤트에서 참여하기를 클릭하셔야만 이벤트 참여가 가능합니다.</li>
				<li>수동으로 생성하시거나 기존에 있던 폴더의 이름을 수정하면 이벤트 참여가 불가합니다.</li>
				<li>위시리스트에 &lt;내가 꿈꾸는 거실&gt; 폴더는 한 ID당 1개만 생성이 가능합니다.</li>
				...
				<li>본 이벤트는 종료일인 9월 20일 23시59분59초까지 담겨진 상품을 기준으로 선정합니다.</li>
			</ul>
		</div>
		...
		<%
			...
			Dim kakaoimage : kakaoimage = "http://webimage.10x10.co.kr/eventIMG/2015/65972/m/btn_event.png"
		...
		%>
		<div class="shareSns">
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/66102/m/txt_sns.png" alt="당첨 확률을 높여요!" /></p>
			<ul>
