...
<%
dim eCode, userid, referer,refip, returnurl, vQuery, vVoteTour, totalVoteCnt, refererURL, refererQueryString, maChk
	...
	If IsUserLoginOK() Then
		...
		response.write "<script>alert('로그인 후에 응모 하실 수 있습니다.');history.back(-1);</script>"
	...
	If IsUserLoginOK() Then 
		...
		'// 해당 투표내역 집어넣는다.
		vQuery = "INSERT INTO [db_event].[dbo].[tbl_event_subscript](evt_code, userid, device) VALUES('" & eCode & "', '" & userid & "', '"&maChk&"')"
