...
Class CEvaluateSearcher
	...
	public sub getItemEvalList()
		...
		sqlStr = "exec [db_board].[dbo].sp_Ten_Evaluate '" +  CStr(FPageSize) + "','" + CStr(FCurrPage) + "','" + Cstr(FRectItemID) + "','" + Cstr(FRectStartPoint) + "','" + Cstr(Fidx) + "','" + Cstr(FsortMethod) + "','" + Cstr(FRectOption) + "'" + vbcrlf
