...
{
	var url = "/my10x10V2/orderPopup/popSongjang.asp?asid=<%=CsAsID%>&songjangDiv=<%=mycslist.FoneItem.FsongjangDiv%>&songjangNo=<%=mycslist.FoneItem.FsongjangNo%>&sendSongjangNo=<%= detailSongjangNo %>";
