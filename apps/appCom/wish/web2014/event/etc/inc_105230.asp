...
'// SNS 공유용
	...
	snpImg		= Server.URLEncode("http://webimage.10x10.co.kr/eventIMG/2020/105230/img_kakao.jpg")
	appfblink	= "http://m.10x10.co.kr/event/eventmain.asp?eventid="& moECode

	'// 카카오링크 변수
	Dim kakaotitle : kakaotitle = "[마일리지 지급 이벤트]"
	Dim kakaodescription : kakaodescription = "서둘러 받아가세요. 단 2일간 마일리지 2,222p 무료 나눔!"
	Dim kakaooldver : kakaooldver = "서둘러 받아가세요. 단 2일간 마일리지 2,222p 무료 나눔!"
	Dim kakaoimage : kakaoimage = "http://webimage.10x10.co.kr/eventIMG/2020/105230/img_kakao.jpg"
...
<div class="evt-mileage">
    <h2><img src="//webimage.10x10.co.kr/eventIMG/2020/105230/tit_2222.png?v=2" alt="마일리지 2222"></h2>
    <!-- for dev msg : 마일리지 받기 -->
    <button type="button" onclick="doAction();" class="btn-get"><img src="//webimage.10x10.co.kr/eventIMG/2020/105230/btn_mileage.png" alt="마일리지 받기"></button>
    <div class="tip">
        <h3><img src="//webimage.10x10.co.kr/eventIMG/2020/105230/txt_tip.png" alt="마일리지 알차게 사용하는 Tip!"></h3>
        <a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=104988');" target="_blank"><img src="//webimage.10x10.co.kr/eventIMG/2020/105230/btn_benefit_1.png" alt="지금 신한카드로 결제하면 추가로 3,000원 더 할인 받을 수 있어요!"></a>
        <a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=105209');" target="_blank"><img src="//webimage.10x10.co.kr/eventIMG/2020/105230/btn_benefit_2.png" alt="단 2일간 디지털 베스트 상품을 ~62% 특가에 득템하세요!"></a>
    </div>
    <p><img src="//webimage.10x10.co.kr/eventIMG/2020/105230/txt_guide.png" alt="마일리지는 결제 시, 현금처럼 사용할 수 있습니다."></p>
    <!-- for dev msg : 공유하기 -->
    <button type="button" onclick="snschk('kt');" class="btn-share"><img src="//webimage.10x10.co.kr/eventIMG/2020/105230/btn_share.png" alt="공유하기"></button>
    <% ' 카카오 공유 이미지 http://webimage.10x10.co.kr/eventIMG/2020/105230/img_kakao.jpg %>
    <p><img src="//webimage.10x10.co.kr/eventIMG/2020/105230/txt_noti.png" alt="유의사항"></p>
</div>
<!-- // MKT 마일리지 2222 -->
