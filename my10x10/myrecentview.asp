...
function AddShoppingBag(bool, itemid){	
	...
	if(bool === "True"){//옵션 있는 상품
		location.href="/category/category_itemprd.asp?itemid="+itemid+"&gaparam=recentview_product_1";
	}else{//옵션 없는 상품
...
<body style="background-color:#ededed;" class="body-sub body-1depth">
...
<div class="heightGrid">
	<div class="mainSection" style="background:#ededed;">
		<div class="container">
