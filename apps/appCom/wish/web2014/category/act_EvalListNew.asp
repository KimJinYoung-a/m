            ...
            <div class="review-conts">
                ...
                <% If oEval.FItemList(i).Flinkimg1<>"" And oEval.FItemList(i).Flinkimg2<>"" And oEval.FItemList(i).Flinkimg3<>"" Then %>
                    ...
                    <div class="photo photo-3">
                        <a href="" onclick="fnAPPpopupBrowserURL('포토후기','<%=wwwUrl%>/apps/appCom/wish/web2014/category/pop_ItemEvalPhotoDetail.asp?itemid=<%=itemid%>&idx=<%=oEval.FItemList(i).Fidx%>'); return false;">
