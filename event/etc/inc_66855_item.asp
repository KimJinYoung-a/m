			...
			<div class="heySomething">
				<div class="get">
					<div class="big">
						...
						<% End If %>
							<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/66855/m/txt_get.jpg" alt="lona 슈즈 구매하기" />
							<div class="option">
								<% 
								...
								<% if oItem.FResultCount > 0 then %>
									...
									<% End If %>
									<em class="name"><span>Red / Green</span></em>
								<% End If %>
							</div>
						</a>
					</div>
						...
						<ul>
							<li>
								...
								<% Else %>
									<a href="/category/category_itemPrd.asp?itemid=<%=itemid%>">
								<% End If %>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/66855/m/img_thumb_01.jpg" alt="" />
							...
							<li>
								...
								<% Else %>
									<a href="/category/category_itemPrd.asp?itemid=<%=itemid%>">
								<% End If %>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/66855/m/img_thumb_02.jpg" alt="" />
