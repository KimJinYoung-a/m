...
<div id="content" class="content diary2021 dr_list_prd new-type">
	...
	<section class="cat-top">
		<header class="sect_head">
			<h2 class="ttl-top" id="listtitle">나에게 찰떡인</h2>
            <div class="ttl-sub" id="listtitle2">
                <a class="tab active" id="di" onclick="setSubShopGroupCode2('di');">다이어리</a>
                <a class="tab" id="dk" onclick="setSubShopGroupCode2('dk');">다꾸템</a>
            </div>
		</header>
		<div class="cate_swiper swiper-container sub-swiper">
			<div class="swiper-wrapper">
                ...
                <div class="swiper-slide cat-prd10" id="c100106" style="display:none" onclick="setSubShopGroupCode('100106');return false;"><a href=""><span>팬/색연필</span></a></div>
                <div class="swiper-slide cat-prd11" id="c100104" style="display:none" onclick="setSubShopGroupCode('100104');return false;"><a href=""><span>스티커</span></a></div>
                <div class="swiper-slide cat-prd12" id="c100105" style="display:none" onclick="setSubShopGroupCode('100105');return false;"><a href=""><span>떡메모지</span></a></div>
			</div>
		</div>
	</section>
...
var category2name = [
    {code:"101102101101",name:"심플"},
    {code:"101102101102",name:"일러스트"},
    {code:"101102101104",name:"패턴"},
    {code:"101102101103",name:"포토"},
    {code:"101102101109",name:"3공/6공"},
    {code:"101102101106",name:"다이어리 커버"},
    {code:"101102101105",name:"리필속지"},
    {code:"101102103106",name:"심플"},
    {code:"101102103107",name:"심플"},
    {code:"101102104101",name:"탁상달력"},
    {code:"101102104102",name:"벽걸이달력"},
    {code:"101102104105",name:"일력"},
    {code:"101102104106",name:"포스터/엽서달력"},
    {code:"101102104107",name:"디데이 달력"},
    {code:"101102104108",name:"프로젝트 달력"},
    {code:"101102104103",name:"스티커 달력"},
    {code:"101107102101",name:"스티커 세트"},
    {code:"101107102102",name:"빅포인트"},
    {code:"101107102103",name:"스몰데코"},
    {code:"101107102104",name:"손글씨"},
    {code:"101107102105",name:"패턴/그래픽"},
    {code:"101107102106",name:"포토"},
    {code:"101107102107",name:"라벨/인덱스"},
    {code:"101107102111",name:"네임"},
    {code:"101107103101",name:"마스킹테이프"},
    {code:"101107103102",name:"종이테이프"},
    {code:"101107103103",name:"박스테이프"},
    {code:"101107103104",name:"패브릭테이브"},
    {code:"101107103106",name:"레이스테이프"},
    {code:"101107103105",name:"다이모/리필"},
    {code:"101104101105",name:"필기구세트"},
    {code:"101104101102",name:"볼펜"},
    {code:"101104101104",name:"색연필"},
    {code:"101104101107",name:"형광펜"},
    {code:"101104101109",name:"데코펜"},
    {code:"101104101108",name:"지워지는 펜"},
    {code:"101104101114",name:"네임펜/보드마카"},
    {code:"101103108101",name:"떡메모지"},
    {code:"101103108102",name:"점착메모지"}
]
...
var sortchangename = [
    ...
    {code:'be',name:'best'}, 
    {code:'hs',name:'sale'}, 
    {code:'hp',name:'highprice'}, 
    {code:'lp',name:'lowprice'}
]
    ...
    function getDiaryItems(vpage){
        ...
        category2name.forEach(function(item){
            if(item.code==cateCode){
                catename2=item.name;
            }
        });
        sortchangename.forEach(function(item){
            if(item.code==srm){
                sortname=item.name;
            }
        });
        ...
        attArr.forEach(function(item){
            if(item=="303004" || item=="303002" || item=="304001" || item=="304002" || item=="304003" || item=="304004" || item=="305001" || item=="305002" || item=="305003"){
                attDate = item;
            }else if(item=="306001" || item=="306002" || item=="306003" || item=="306004" || item=="306005"){
                attCover = item;
            }else if(item=="307006" || item=="307007" || item=="307008"){
                attBinding = item;
            }
        });
        ...
        fnAmplitudeEventMultiPropertiesAction('view_diarystory_list','type|category_code|category_name1|category_name2|sort|filter_date|filter_cover|filter_binding|option|paging_index',dataObject.diarytype + '|' + subShopGroupCode + '|' + catename + '|' + catename2 + '|' + sortname + '|' + attDate + '|' + attCover + '|' + attBinding + '|' + attOption + '|' + vpage);
