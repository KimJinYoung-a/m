...
$(function(){
	...
	$(".commonTabV16a li").click(function() {
		$(this).siblings("li").removeClass("current");
		$(this).addClass("current");
		$(this).closest(".commonTabV16a").nextAll(".tabContainer:first").find(".tabCont").hide();
	...
	<div class="popWin">
		...
		<div class="content" id="layerScroll">
			<div id="scrollarea">
				<!-- 이용약관 -->
				<div>
					<div class="tabContainer inner5">
						<div id="tab01" class="tabCont">
							<ul class="policyList box2">
								<li><a href="#terms01" onclick="myScroll.scrollToElement('#terms01',500);return false;">[제 1 장 총칙]</a></li>
								<li><a href="#terms02" onclick="myScroll.scrollToElement('#terms02',500);return false;">[제 2 장 회사의 서비스]</a></li>
								<li><a href="#terms03" onclick="myScroll.scrollToElement('#terms03',500);return false;">[제 3 장 회원가입 계약]</a></li>
								<li><a href="#terms04" onclick="myScroll.scrollToElement('#terms04',500);return false;">[제 4 장 구매계약 및 대금 결제]</a></li>
								<li><a href="#terms05" onclick="myScroll.scrollToElement('#terms05',500);return false;">[제 5장 계약당사자의 의무]</a></li>
								<li><a href="#terms06" onclick="myScroll.scrollToElement('#terms06',500);return false;">[제 6장 부가서비스의 이용]</a></li>
								<li><a href="#terms07" onclick="myScroll.scrollToElement('#terms07',500);return false;">[제 7장 기타]</a></li>
							</ul>
