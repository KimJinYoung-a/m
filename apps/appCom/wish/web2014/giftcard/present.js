...
// 크롭 처리
function fnCheckCropProc(cX, cY, cW, cH) {
...
function fnAPPuploadImage(comp,tuid) {
    _selComp = comp;
    
    var paramname = comp.name;
    var upurl = vUpUrl+"/linkweb/giftcard/doUserGiftCardImgReg_App.asp?tuid="+encodeURIComponent(tuid)+"&paramname="+paramname;
