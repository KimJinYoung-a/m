...
If Left(currentDate,10) < "2021-06-21" Then
    If isApp="1" Then
...
'엠디 상품 오픈 차수
If currentDate >= #2021-06-21 09:00:00# and currentDate < #2021-06-22 00:00:00# Then
    mdItemRound = 1
    if episode = 2 then
        mdItemsArr = "3896146,3637559,3895901,3894536,3896147,3471385,3893469,3896978,3897634,3896424"
    elseif episode = 3 then
        mdItemsArr = "3894536,3896147,3471385,3893469,3896978,3897634,3896424,3896146,3637559,3895901"
    elseif episode = 4 then
        mdItemsArr = "3893469,3896978,3897634,3896424,3896146,3637559,3895901,3894536,3896147,3471385"
    else
        mdItemsArr = "3896978,3897634,3896424,3896146,3637559,3895901,3894536,3896147,3471385,3893469"
    end if
elseIf currentDate >= #2021-06-22 09:00:00# and currentDate < #2021-06-23 00:00:00# Then
    mdItemRound = 2
    if episode = 2 then
...
elseIf currentDate >= #2021-06-23 09:00:00# and currentDate < #2021-06-24 00:00:00# Then
    mdItemRound = 3
    if episode = 2 then
        mdItemsArr = "3754803,3905200,3902758,3844400,3900787,3905184,3905530,2824172,3905065,3905005"
    elseif episode = 3 then
        mdItemsArr = "3844400,3900787,3905184,3905530,2824172,3905065,3905005,3754803,3905200,3902758"
    elseif episode = 4 then
        mdItemsArr = "3905530,2824172,3905065,3905005,3754803,3905200,3902758,3844400,3900787,3905184"
    else
        mdItemsArr = "2824172,3905065,3905005,3754803,3905200,3902758,3844400,3900787,3905184,3905530"
    end if
end if
...
function fnSendToKakaoMessage() {
    ...
    $.ajax({
        type:"GET",
        url:"/event/etc/doeventSubscript111787.asp",
                ...
                <div class="time-ing">
                    ...
                    <div class="list-wrap">
                        ...
                        <div class="special-item">
                            ...
                            <% If currentDate >= #06/21/2021 00:00:00# and currentDate < #06/22/2021 00:00:00# Then %>
                                <% 
                                    episode1Itemid = "3895072"
                                    episode2Itemid = "3896038"
                                    episode3Itemid = "3899114"
                                    episode4Itemid = "3894268"
                                %>
                                <% if episode=1 or episode=0 then%>
                                <li class="<% if episode=0 then %>not-open<% elseIf getitemlimitcnt(episode1Itemid) < 1 then %>sold-out<% End If %>">
                                    ...
                                    <div class="product-inner">
                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mItemImage/202106/deal_mItemImage20210617152648.jpg" alt="소니 WH-1000XM4 노이즈 캔슬링 헤드폰 실버"></div>
                                        <div class="desc">
                                            <p class="name">소니 WH-1000XM4 노이즈 캔슬링 헤드폰 실버</p>
                                            <div class="price"><s>359,100</s> 100,000 <span class="p-won">원</span><span class="sale">72%</span></div>
                                ...
                                <li class="<% If getitemlimitcnt(episode2Itemid) < 1 then %>sold-out<% End If %>">
                                    ...
                                    <% end if %>
                                    <div class="product-inner">
                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mItemImage/202106/deal_mItemImage20210617175313.jpg" alt="스누피 리유저블 콜드컵 5개세트 4,900원 특가!"></div>
                                        <div class="desc">
                                            <p class="name">스누피 리유저블 콜드컵 5개세트 4,900원 특가!</p>
                                ...
                                <li class="<% If getitemlimitcnt(episode3Itemid) < 1 then %>sold-out<% End If %>">
                                    ...
                                    <% end if %>
                                    <div class="product-inner">
                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mItemImage/202106/deal_mItemImage20210617175507.jpg" alt="[클레어] 무선선풍기"></div>
                                        <div class="desc">
                                            <p class="name">[클레어] 무선선풍기</p>
                                            <div class="price"><s>248,000</s> 10,000 <span class="p-won">원</span><span class="sale">96%</span></div>
                                        </div>
                                        <span class="num-limite"><em>5</em>개 한정</span>
                                    </div>
                                    </a>
                                ...
                                <li class="<% If getitemlimitcnt(episode4Itemid) < 1 then %>sold-out<% End If %>">
                                    ...
                                    <% end if %>
                                    <div class="product-inner">
                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mItemImage/202106/deal_mItemImage20210617175750.jpg" alt="헤이릴렉스캄다운 코퍼비치 캔버스 릴렉스체어 (Beige)"></div>
                                        <div class="desc">
                                            <p class="name">헤이릴렉스캄다운 코퍼비치 캔버스 릴렉스체어 (Beige)</p>
                                            <div class="price"><s>89,800</s> 13,900 <span class="p-won">원</span><span class="sale">85%</span></div>
                                        </div>
                                ...
                                <% end if %>
                            <% elseIf currentDate >= #06/22/2021 00:00:00# and currentDate < #06/23/2021 00:00:00# Then %>
                                <% 
                                ...
                                <% end if %>
                            <% elseIf currentDate >= #06/23/2021 00:00:00# and currentDate < #06/24/2021 00:00:00# Then %>
                                <% 
                                    episode1Itemid = "3894183"
                                    episode2Itemid = "3896083"
                                    episode3Itemid = "3894267"
                                    episode4Itemid = "3893865"
                                %>
                                <% if episode=1 or episode=0 then%>
                                <li class="<% if episode=0 then %>not-open<% elseIf getitemlimitcnt(episode1Itemid) < 1 then %>sold-out<% End If %>">
                                    <% if episode=0 then%>
                                    ...
                                    <% end if %>
                                    <div class="product-inner">
                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mItemImage/202106/deal_mItemImage20210622095945.jpg" alt="[스탠리공식유통사] 클래식 런치 박스 9.4L"></div>
                                        <div class="desc">
                                            <p class="name">[스탠리공식유통사] 클래식 런치 박스 9.4L</p>
                                            <div class="price"><s>75,000</s> 9,900 <span class="p-won">원</span><span class="sale">87%</span></div>
                                            <p class="buy_now"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111787/m/btn_purchase.png" alt="바로 구매"></p>
                                        </div>
                                        <span class="num-limite"><em>20</em>개 한정</span>
                                    </div>
                                ...
                                <li class="<% If getitemlimitcnt(episode2Itemid) < 1 then %>sold-out<% End If %>">
                                    ...
                                    <% end if %>
                                    <div class="product-inner">
                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mItemImage/202106/deal_mItemImage20210622100114.jpg" alt="디즈니 푸 토스터기 9,900원 특가!"></div>
                                        <div class="desc">
                                            <p class="name">디즈니 푸 토스터기 9,900원 특가!</p>
                                            <div class="price"><s>69,000</s> 9,900 <span class="p-won">원</span><span class="sale">86%</span></div>
                                        </div>
                                        <span class="num-limite"><em>20</em>개 한정</span>
                                    </div>
                                    </a>
                                ...
                                <li class="<% If getitemlimitcnt(episode3Itemid) < 1 then %>sold-out<% End If %>">
                                    ...
                                    <% end if %>
                                    <div class="product-inner">
                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mItemImage/202106/deal_mItemImage20210622100227.jpg" alt="스마트미 2S 스탠드 무선선풍기 리모컨포함"></div>
                                        <div class="desc">
                                            <p class="name">스마트미 2S 스탠드 무선선풍기 리모컨포함</p>
                                            <div class="price"><s>129,000</s> 50,000 <span class="p-won">원</span><span class="sale">92%</span></div>
                                        </div>
                                        <span class="num-limite"><em>5</em>개 한정</span>
                                    </div>
                                    </a>
                                ...
                                <li class="<% If getitemlimitcnt(episode4Itemid) < 1 then %>sold-out<% End If %>">
                                    ...
                                    <% end if %>
                                    <div class="product-inner">
                                        <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mItemImage/202106/deal_mItemImage20210622100340.jpg" alt="[BRAUN] 브라운 제모의료기기 PL 5124"></div>
                                        <div class="desc">
                                            <p class="name">[BRAUN] 브라운 제모의료기기 PL 5124</p>
                                            <div class="price"><s>549,000</s> 99,000 <span class="p-won">원</span><span class="sale">82%</span></div>
                                        </div>
                                        <span class="num-limite"><em>5</em>개 한정</span>
                                    </div>
                                    </a>
                        ...
                        <div class="product-list">
                            ...
                            <% If currentDate >= #06/21/2021 00:00:00# and currentDate < #06/22/2021 00:00:00# Then %>
                                ...
                                <li>
                                    ...
                                    <div class="product-inner">
                                        <img src="//webimage.10x10.co.kr/eventIMG/deal_mTzImage/202106/deal_mTzImage20210617175313.jpg" alt="스누피 리유저블 콜드컵 5개세트 4,900원 특가!">
                                        <span class="num-limite"><em>20</em>개 한정</span>
                                    </div>
                                </li>
                                <% end if %>
                                ...
                                <li>
                                    ...
                                    <div class="product-inner">
                                        <img src="//webimage.10x10.co.kr/eventIMG/deal_mTzImage/202106/deal_mTzImage20210617175507.jpg" alt="[클레어] 무선선풍기">
                                ...
                                <li>
                                    ...
                                    <div class="product-inner">
                                        <img src="//webimage.10x10.co.kr/eventIMG/deal_mTzImage/202106/deal_mTzImage20210617175750.jpg" alt="헤이릴렉스캄다운 코퍼비치 캔버스 릴렉스체어 (Beige)">
                                        <span class="num-limite"><em>5</em>개 한정</span>
                                    </div>
                                </li>
                                <% end if %>
                            ...
                            <% elseIf currentDate >= #06/23/2021 00:00:00# and currentDate < #06/24/2021 00:00:00# Then %>
                                ...
                                <li>
                                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/111787/m/time_header_02.png" alt="오전 12시">
                                    <div class="product-inner">
                                        <img src="//webimage.10x10.co.kr/eventIMG/deal_mTzImage/202106/deal_mTzImage20210622100114.jpg" alt="디즈니 푸 토스터기 9,900원 특가!">
                                        <span class="num-limite"><em>20</em>개 한정</span>
                                    </div>
                                </li>
                                <% end if %>
                                ...
                                <li>
                                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/111787/m/time_header_03.png" alt="오후 3시">
                                    <div class="product-inner">
                                        <img src="//webimage.10x10.co.kr/eventIMG/deal_mTzImage/202106/deal_mTzImage20210622100227.jpg" alt="스마트미 2S 스탠드 무선선풍기 리모컨포함">
                                        <span class="num-limite"><em>5</em>개 한정</span>
                                    </div>
                                </li>
                                <% end if %>
                                ...
                                <li>
                                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/111787/m/time_header_04.png" alt="오후 6시">
                                    <div class="product-inner">
                                        <img src="//webimage.10x10.co.kr/eventIMG/deal_mTzImage/202106/deal_mTzImage20210622100340.jpg" alt="[BRAUN] 브라운 제모의료기기 PL 5124">
                                        <span class="num-limite"><em>5</em>개 한정</span>
                                    </div>
                                </li>
                                <% end if %>
                            ...
                            <div class="swiper-container">
                                ...
                                <% If currentDate >= #06/21/2021 00:00:00# and currentDate < #06/22/2021 00:00:00# Then %>
                                    <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode1Itemid) < 1 then %> sold-out<% End If %>">
                                        <div class="tit-prd">
                                            <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mSoldoutImage/202106/deal_mSoldoutImage20210617152648.png" alt="상품1"></div>
                                            <div class="desc">
                                                <p class="name">A소니 WH-1000XM4 노이즈 캔슬링 헤드폰 실버</p>
                                                <div class="price"><s>359,100</s> 100,000 <span class="p-won">원</span><span class="sale">72%</span></div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode2Itemid) < 1 then %> sold-out<% End If %>">
                                        <div class="tit-prd">
                                            <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mSoldoutImage/202106/deal_mSoldoutImage20210617175313.png" alt="상품2"></div>
                                            <div class="desc">
                                                <p class="name">스누피 리유저블 콜드컵 5개세트 4,900원 특가!</p>
                                                <div class="price"><s>24,000</s> 4,900 <span class="p-won">원</span><span class="sale">80%</span></div>
                                            </div>
                                    ...
                                    <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode3Itemid) < 1 then %> sold-out<% End If %>">
                                        <div class="tit-prd">
                                            <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mSoldoutImage/202106/deal_mSoldoutImage20210617175507.png" alt="상품3"></div>
                                            <div class="desc">
                                                <p class="name">[클레어] 무선선풍기</p>
                                                <div class="price"><s>248,000</s> 10,000 <span class="p-won">원</span><span class="sale">96%</span></div>
                                            </div>
                                    ...
                                    <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode4Itemid) < 1 then %> sold-out<% End If %>">
                                        <div class="tit-prd">
                                            <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mSoldoutImage/202106/deal_mSoldoutImage20210617175750.png" alt="상품4"></div>
                                            <div class="desc">
                                                <p class="name">헤이릴렉스캄다운 코퍼비치 캔버스 릴렉스체어 (Beige)</p>
                                                <div class="price"><s>89,800</s> 13,900 <span class="p-won">원</span><span class="sale">85%</span></div>
                                            </div>
                                ...
                                <% elseIf currentDate >= #06/23/2021 00:00:00# and currentDate < #06/24/2021 00:00:00# Then %>
                                    <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode1Itemid) < 1 then %> sold-out<% End If %>">
                                        <div class="tit-prd">
                                            <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mSoldoutImage/202106/deal_mSoldoutImage20210622095945.png" alt="상품1"></div>
                                            <div class="desc">
                                                <p class="name">[스탠리공식유통사] 클래식 런치 박스 9.4L</p>
                                                <div class="price"><s>75,000</s> 9,900 <span class="p-won">원</span><span class="sale">87%</span></div>
                                            </div>
                                    ...
                                    <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode2Itemid) < 1 then %> sold-out<% End If %>">
                                        <div class="tit-prd">
                                            <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mSoldoutImage/202106/deal_mSoldoutImage20210622100114.png" alt="상품2"></div>
                                            <div class="desc">
                                                <p class="name">디즈니 푸 토스터기 9,900원 특가!</p>
                                                <div class="price"><s>69,000</s> 9,900 <span class="p-won">원</span><span class="sale">86%</span></div>
                                            </div>
                                    ...
                                    <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode3Itemid) < 1 then %> sold-out<% End If %>">
                                        <div class="tit-prd">
                                            <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mSoldoutImage/202106/deal_mSoldoutImage20210622100227.png" alt="상품3"></div>
                                            <div class="desc">
                                                <p class="name">스마트미 2S 스탠드 무선선풍기 리모컨포함</p>
                                                <div class="price"><s>129,000</s> 50,000 <span class="p-won">원</span><span class="sale">92%</span></div>
                                            </div>
                                    ...
                                    <li class="swiper-slide sold-prd<% If getitemlimitcnt(episode4Itemid) < 1 then %> sold-out<% End If %>">
                                        <div class="tit-prd">
                                            <div class="thum"><img src="//webimage.10x10.co.kr/eventIMG/deal_mSoldoutImage/202106/deal_mSoldoutImage20210622100340.png" alt="상품4"></div>
                                            <div class="desc">
                                                <p class="name">[BRAUN] 브라운 제모의료기기 PL 5124</p>
                                                <div class="price"><s>549,000</s> 99,000 <span class="p-won">원</span><span class="sale">82%</span></div>
                                            </div>
                    ...
                    <% If currentDate >= #06/21/2021 00:00:00# and currentDate < #06/23/2021 00:00:00# Then %>
