	...
	<div class="modal popup" id="modalReaffirmationPassword">
		<div class="box" style="top:50%;margin-top:-120px;">
			<header class="modal-header">
				...
				<a href="" onclick="fnCloseModal(); return false;" class="btn-close">&times;</a>
			</header>
				...
				<div class="inner">
					...
					<div class="input-block">
						...
						<div class="input-controls">
							<input type="password" name="userpass" maxlength="32" id="pwd" class="form full-size">
						</div>
					</div>
					<div class="diff-10"></div>
				</div>
			...
			<footer class="modal-footer t-c">
				<button type="button" onclick="TnConfirmlogin(frmLoginConfirm,'<%= strTarget %>'); return false;" class="btn type-a full-size">확인</button>
			</footer>
		</div>
