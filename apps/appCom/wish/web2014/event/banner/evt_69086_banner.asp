...
.appFrontBanner .goEvt {position:absolute; left:5%; bottom:2.5%; width:90%; height:14%;}
...
function app_mainchk(){
	var str = $.ajax({
		...
		data: "mode=app_main&ecode=69086",
		dataType: "text",
		async: false
	}).responseText;
	if (str == "OK"){
		fnAPPpopupEvent_URL('<%=wwwUrl%>/apps/appcom/wish/web2014/event/eventmain.asp?eventid=69086');
		return false;
	}else{
		alert('오류가 발생했습니다.');
		return false;
...
<body>
	<div class="appFrontBanner">
		<h2><img src="http://webimage.10x10.co.kr/eventIMG/2016/69086/img_front_banner.jpg" alt="특별한 당신에게 보이는 사대천왕" /></h2>
