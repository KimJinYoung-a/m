...
<div class="heightGrid">
	<div class="container popWin">
		<div class="header">
			<h1>필터</h1>
			<p class="btnPopClose"><button class="pButton" onclick="goBack('<%=wwwUrl%>/search/search_item.asp?disp=101'); return false;">닫기</button></p>
			<p class="btnPopRefresh"><button  class="pButton" onclick="goReload()">새로고침</button></p>
		</div>
		<!-- content area -->
		<form name="sFrm" id="listSFrm" method="get" action="search_item.asp" style="margin:0px;">
		...
		<div class="floatingBar">
			<div class="btnWrap">
				<div class="ftBtn"><span class="button btB1 btRed cWh1 w100p"><input type="button" value="검색필터 적용하기" onClick="goCategorySearch();" class="btRed" /></span></div>
			</div>
		</div>
		<!-- //content area -->
	</div>
