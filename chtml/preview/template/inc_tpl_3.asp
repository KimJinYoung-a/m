...
%>
	<div class="<%=chkIIF((tmpOrder mod 2)=1,"timelineRt","timelineLt")%>">
		...
		<% end if %>
				...
				%>
				<div class="templateB" style="background-color:<%=chkIIF(instr(subNodes.getElementsByTagName("bgcolor").item(0).text,"#")>0,subNodes.getElementsByTagName("bgcolor").item(0).text,"#" & subNodes.getElementsByTagName("bgcolor").item(0).text)%>;">
