...
<%
'####################################################
' Description : 2020 득템의 기회 이벤트
' History : 2020-10-12 정태훈
'####################################################
...
eventEndDate 	= cdate("2020-10-20")		'이벤트 종료일
...
snpImg		= Server.URLEncode("http://webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_kakao.jpg")
appfblink	= "http://m.10x10.co.kr/event/eventmain.asp?eventid="& moECode

'// 카카오링크 변수
Dim kakaotitle : kakaotitle = "[득템의 기회]"
Dim kakaodescription : kakaodescription = "마샬스피커가 59,000원? 지금 바로 원하는 상품에 도전하세요!"
Dim kakaooldver : kakaooldver = "마샬스피커가 59,000원? 지금 바로 원하는 상품에 도전하세요!"
Dim kakaoimage : kakaoimage = "http://webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_kakao.jpg"
...
.mEvt106511 .winner .thumb {width:10.24rem; height:10.24rem; background:#ffab27; border-radius:50%;}
...
function getEvtItemList(){
	$.ajax({
		type: "GET",
		url:"/event/etc/realtimeevent/realtimeEvent106511Proc.asp",
		data: "mode=evtobj",
		dataType: "json",
...
function eventTry(s){
	...
	<% else %>
		...
		if(numOfTry == '2'){
			<% If (currentDate >= #10/21/2020 00:00:00#) Then %>
...
function popResult(returnCode, itemid, selectedPdt){
	...
	if(returnCode[0] == "B"){		
		...
		$("#itemid").val(itemid);	
		$("#winImg").attr("src", "//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/pop_win_0"+ selectedPdt +".jpg?v=1.01")
			...
			if (item.isOpen){
				if(item.leftItems <= 0){ //open
					info = '\
                        <li>\
                            <div class="item item'+ item.itemcode +'">\
                                <img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_item'+ item.itemcode +'_out.jpg?v=1.05" alt="sold out">\
					...
					info = '\
						<li>\
                            <div class="item item'+ item.itemcode +'">\
                                <img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_item'+ item.itemcode +'.jpg?v=1.04" alt="">\
...
function renderWinners(data){
	...
	data.forEach(function(winner){
		tmpEl = '<div class="swiper-slide">\
			<div class="thumb"><img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_win_0'+ winner.code +'.png" alt=""></div>\
    ...
    if(data.length<3){
        for(var ix=0; ix<(3-data.length); ix++){
            tmpEl = '<div class="swiper-slide">\
                <div class="thumb"><img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_win_blank.png" alt=""></div>\
            </div>\
            '
            itemEle += tmpEl
        }
...
function jsPickingUpPushSubmit(){
    ...
    $.ajax({
        type:"GET",
        url:"/event/etc/realtimeevent/realtimeEvent106511Proc.asp?mode=pushadd",
        dataType: "json",
        ...
        error:function(err){
			...
			<div class="mEvt106511">
				<div class="topic">
					<h2><img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/tit_gotcha.jpg" alt="득템할 기회"></h2>
					<div class="slider">
						<div class="swiper-wrapper">
							<div class="swiper-slide"><img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_topic_01.png" alt=""></div>
							<div class="swiper-slide"><img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_topic_02.png" alt=""></div>
							<div class="swiper-slide"><img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_topic_03.png" alt=""></div>
							<div class="swiper-slide"><img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/img_topic_04.png" alt=""></div>
						</div>
					</div>
				</div>
				<div class="item-list">
				...
				<div class="notice">
					...
					<div class="txt-notice"><img src="//webimage.10x10.co.kr/fixevent/event/2020/19th/106511/m/txt_notice.png" alt=""></div>
				</div>
