...
function paging_ajax(){
	...
	var str = $.ajax({
			type: "GET",
	        url: "/apps/appCom/between/my10x10V2/order/myorderlist_ajax.asp",
						...
						<li>
							...
							<div class="btnCont">
                            	...
                            	<% if (myorder.FItemList(i).IsWebOrderInfoEditEnable) then %>
                            		<span class="btn02 cnclGry"><a href="/apps/appCom/between/my10x10V2/order/myorderchangeaddr.asp?orderserial=<%= myorder.FItemList(i).FOrderSerial %>">배송지변경</a></span>
		                    	<% end if %>
