...
.input-box {position:absolute; left:50%; top:26.5%; width:76%; height:30%; margin-left:-38%; background:url(http://webimage.10x10.co.kr/eventIMG/2018/84256/m/bg_input.png) no-repeat 50% 50%; background-size:100%; font-size:2.8rem; line-height:1.2; color:#000; text-align:left; font-weight:bold; vertical-align:top;}
...
.noti {padding:4.27rem 2.56rem 4.86rem; background-color:#1b196c;}
.noti h3 {position:relative; color:#fff; font-size:1.62rem; font-weight:bold; text-align:center;}
.noti h3:after {content:' '; display:block; position:absolute; bottom:-0.6rem; left:50%; width:6.78rem; height:2px; margin-left:-3.39rem; background-color:#5650d8;}
.noti ul {margin-top:2.39rem;}
.noti ul li {position:relative; padding-left:1rem; margin:0.65rem 0; color:#fff; font-size:1.11rem; line-height:1.688em;}
.noti ul li:after {content:'·'; display:block; position:absolute; top:.05rem; left:0; color:#fff;}
...
//-->
			...
			<div class="mEvt84256">
				<div class="headline">
					<h2><img src="http://webimage.10x10.co.kr/eventIMG/2018/84256/m/tit_medal.png" alt="메달갯수를 맞혀라" /></h2>
					<img src="http://webimage.10x10.co.kr/eventIMG/2018/84256/m/bg_headline.png" alt="우리나라 메달 최종 총 개수를 맞추신 분들께 메달 개수 x 100마일리지 적립!" />
				</div>
				<div class="event-view">
					<div class="count-view real-num">
						...
						<img src="http://webimage.10x10.co.kr/eventIMG/2018/84256/m/img_real.png" alt="현재 우리나라 총 메달 개수" />
					</div>
					<div class="count-view mine-num">
						<div class="counter-area" id="mymedal">
							<div class="counter2"><%=MedalCnt%></div> 개
						</div>
						<img src="http://webimage.10x10.co.kr/eventIMG/2018/84256/m/img_mine.png" alt="내가 예상하는 메달 개수" />
					</div>
				</div>
				<div class="event-input">
					<form action="" method="" name="" id="">
						<div class="input-box">
							<p><input type="number" id="counting" name="medalcnt" maxlength="3" style="background:url('http://webimage.10x10.co.kr/eventIMG/2018/84256/m/cursor.gif') 100% 50% no-repeat; background-size:auto 100%;" onFocus="this.style.backgroundImage='url(none)';" /> 개</p>
							<% If userid<>"" Then %>
								<% If MedalCnt <> 0 Then %>
									<button type="button" onClick="fnGoEnter();"><img src="http://webimage.10x10.co.kr/eventimg/2018/84256/m/btn_edit.png" alt="수정하기" /></button>
								<% Else %>
									<button type="button" onClick="fnGoEnter();"><img src="http://webimage.10x10.co.kr/eventIMG/2018/84256/m/btn_input.png" alt="입력하기" /></button>
								<% End If %>
							<% Else %>
								<button type="button" onClick="fnlogin();"><img src="http://webimage.10x10.co.kr/eventIMG/2018/84256/m/btn_input.png" alt="입력하기" /></button>
							<% End If %>
						</div>
					</form>
					<img src="http://webimage.10x10.co.kr/eventIMG/2018/84256/m/txt_event.png" alt="예상하는 우리나라 최종 메달 개수는?" />
				</div>
				<div class="noti">
					<div class="inner">
						<h3>유의사항</h3>
