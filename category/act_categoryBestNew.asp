...
<div class="itemAddWrapV16a ctgyBestV16a">
	<div class="bxLGy2V16a">
		<h3>카테고리 베스트</h3>
		<a href="/category/category_list.asp?srm=be&disp=<%=catecode%>" class="btnMore"><span>더보기</span></a>
	</div>
	<div class="bxWt1V16a">
...
%>				
				<li>
					<a href="/category/category_itemPrd.asp?itemid=<%= oCBDoc.FItemList(i).Fitemid %>&rc=item_cate_<%=ichk%>">
