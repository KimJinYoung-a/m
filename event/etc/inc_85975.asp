...
%>
<style type="text/css">
.double-mileage {background-color:#00a354;}
...
.noti {text-align:center; padding:3.5rem 6.4%; color:#fff; background:#494949;}
...
function jsSubmitComment(){
	...
	<% End If %>
			...
			<!-- 더블 마일리지 -->
			<div class="mEvt85975 double-mileage">
				<h2><img src="http://webimage.10x10.co.kr/eventIMG/2018/85975/m/tit_double_mileage.png?v=1" alt="X2 마일리지 - 오늘 하루 동안 상품후기 작성하면 마일리지 2배 적립!" /></h2>
				<p><img src="http://webimage.10x10.co.kr/eventIMG/2018/85975/m/txt_mileage.png" alt="상품후기를 쓰면 200마일리지, 첫 상품후기를 쓰면 400마일리지 적립" /></p>
				<!-- 예상 마일리지 확인하기 -->
				<div class="my-mileage">
					...
					<% If IsUserLoginOK Then %>
						...
						<% End If %>
						<img src="http://webimage.10x10.co.kr/eventIMG/2018/85975/m/btn_review.png" alt="상품후기 쓰러 가기" /></a>
					<% Else %>
						<a href="" onClick="jsSubmitComment(); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2018/85975/m/btn_login.png" alt="로그인하기" /></a>
					<% End If %>
					</div>
				</div>
				<!--// 예상 마일리지 확인하기 -->
				<div class="noti">
					...
					<ul>
						<li>이벤트 기간 내에 새롭게 작성하신 상품후기에<br />한해서만 더블 마일리지가 적용됩니다.</li>
						<li>기존에 작성했던 상품후기 수정은 적용되지 않습니다.</li>
						<li>상품후기가 삭제된 경우에는 마일리지 지급이 되지 않습니다.</li>
						<li>상품후기는 배송정보 [출고완료] 이후부터 작성하실 수<br />있습니다.</li>
