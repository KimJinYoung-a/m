...
Class CCSReturnAddress
    ...
    Private Sub Class_Initialize()
        ...
        Freturnhp       = ""
        FreturnZipcode  = "132-010"
        FreturnZipaddr  = "서울 도봉구"
        FreturnEtcaddr  = "도봉동 63번지 여인닷컴 3층"
        Fsongjangdiv    = "24"
        Fsongjangno     = ""
...
Class CCSASList
    ...
    public Sub GetCSASMasterList()
        ...
        sqlStr = "exec [db_etcmall].[dbo].sp_Between_CsAsCount 1,'" & FRectUserID & "','" & FRectOrderSerial & "','" & FRectDivCd & "' "
        ...
        sqlStr = "exec [db_etcmall].[dbo].sp_Between_CsAsList " & CStr(FPageSize*FCurrPage) & ",1,'" & FRectUserID & "','" & FRectOrderSerial & "','" & FRectDivCd & "' "
    ...
    public Sub GetOneCSASMaster()
        ...
        sqlStr = "exec [db_etcmall].[dbo].sp_between_CsAsOne " & CStr(FRectCsAsID) & ",1,'" & FRectUserID & "','" & FRectOrderSerial & "'"
		...
		'// 추가정보
        sqlStr = "exec [db_etcmall].[dbo].sp_Between_CsAsOneAddInfo " & CStr(FRectCsAsID) & ",1,'" & FRectUserID & "','" & FRectOrderSerial & "'"
	...
	public Sub GetOrderDetailWithReturnDetail()
		...
		sqlStr = sqlStr + " i.smallimage, i.brandname, i.brandname, i.itemdiv" + VbCrlf
		sqlStr = sqlStr + " ,s.divname,s.findurl, s.tel deliveryTel, p.asId " + VbCrlf
		sqlStr = sqlStr + " ,IsNULL(P.regno,0) as regitemno " + VbCrlf
