	...
	<div class="mainSection">
		<div class="container">
					...
					<% For i = 1 To UBound(obj.Items) %>
						<li>
							...
							<div class="boxCont">
								...
								<p><%=obj.Items(i).countryNameEn%><br /><%=obj.Items(i).reqPhone%></p>
			...
			<div class="floatingBar">
				<div class="btnWrap">
					<div class="ftBtn"><span class="button btB1 btRed cWh1 w100p"><a href="" onclick="jsAddAddr();return false;">해외주소록 신규등록</a></span></div>
				</div>
			</div>
			<!-- //content area -->
