...
<body class="default-font body-sub bg-grey category-item">
	<div class="content" id="contentArea" style="padding-bottom:6rem;">
		...
		<% If clsDiaryPrdCheck.FResultCount > 0 then %>
			<% If Left(Now(), 10) > "2017-10-16" and Left(Now(), 10) < "2018-01-01" Then %>
				<%'다이어리 배너 추가(10/04)%>
				<a href="" onclick="fnAPPpopupBrowserURL('다이어리','<%=wwwUrl%>/apps/appCom/wish/web2014/diarystory2018/'); return false;"><img src="http://fiximage.10x10.co.kr/web2017/diary2018/m/bnr_detail_diary_v3.jpg"  class="vTop" alt="DIARY STORY 2018" /></a>
			<% end if %>
		<% end if %>
		...
		<div class="item-etc-info">
			<ul>
				...
				<% else %>
				<li><span class="icon icon-gifttalk"></span>선물 골라주세요! <a href="" onClick="if(confirm('로그인이 필요한 서비스입니다.\n로그인 하시겠습니까?') == true){location.href = '<%=M_SSLUrl%>/apps/appCom/wish/web2014/login/login.asp?backpath=<%=Server.URLEncode(CurrURLQ())%>&mode=wr';}; return false;">기프트톡 쓰기</a></li>
				<% end if %>
				...
				<li><span class="icon icon-offline"></span>
					...
					<a href="" onclick="fnAPPpopupBrowserURL('매장안내','<%=wwwUrl%>/apps/appcom/wish/web2014/category/pop_SaleStoreList.asp?itemid=<%=itemid%>'); return false;">판매 매장정보</a>
				</li>
				<% end if %>
			</ul>
		</div>
			...
			<% Select Case Trim(itemid) %>
					...
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|휴대용선풍기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('휴대용선풍기');}});return false;"># 휴대용선풍기</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|선풍기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('선풍기');}});return false;"># 선풍기</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|탁상용선풍기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('탁상용선풍기');}});return false;"># 탁상용선풍기</a></li>
								
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|스탠드선풍기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('스탠드선풍기');}});return false;"># 스탠드선풍기</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|USB선풍기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('USB선풍기');}});return false;"># USB선풍기</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미니선풍기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('미니선풍기');}});return false;"># 미니선풍기</a></li>
							<ul>
						</div>
					</div>
				<% Case "1971903" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								...
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|핸디선풍기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('핸디선풍기');}});return false;"># 핸디선풍기</a></li>
				...
				<% Case "1685329" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword','<%=itemid%>|휴대용선풍기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('휴대용선풍기');}});return false;"># 휴대용선풍기</a></li>
				...
				<% Case "1965839" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('잠옷');}});return false;"># 잠옷</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷세트|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('잠옷세트');}});return false;"># 잠옷세트</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|여름잠옷|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('여름잠옷');}});return false;"># 여름잠옷</a></li>
								
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|파자마|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('파자마');}});return false;"># 파자마</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|파자마세트|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('파자마세트');}});return false;"># 파자마세트</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|여름파자마|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('여름파자마');}});return false;"># 여름파자마</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1919807" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁기크리너|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁기크리너');}});return false;"># 세탁기크리너</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁기청소|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁기청소');}});return false;"># 세탁기청소</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조크리너|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁조크리너');}});return false;"># 세탁조크리너</a></li>
								
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조청소|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁조청소');}});return false;"># 세탁조청소</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁조');}});return false;"># 세탁조</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조세제|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁조세제');}});return false;"># 세탁조세제</a></li>
							<ul>
						</div>
					</div>
					...
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								...
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|유카타잠옷|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('유카타잠옷');}});return false;"># 유카타잠옷</a></li>
								
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷가운|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('잠옷가운');}});return false;"># 잠옷가운</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|로브|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('로브');}});return false;"># 로브</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1926844" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|생리통초콜릿|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('생리통초콜릿');}});return false;"># 생리통초콜릿</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|스위스초콜릿|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('스위스초콜릿');}});return false;"># 스위스초콜릿</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|초콜릿|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('초콜릿');}});return false;"># 초콜릿</a></li>
								
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|초콜렛|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('초콜렛');}});return false;"># 초콜렛</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1967223" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|밀키머그|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('밀키머그');}});return false;"># 밀키머그</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|무지머그|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('무지머그');}});return false;"># 무지머그</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|머그|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('머그');}});return false;"># 머그</a></li>
								
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|머그컵|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('머그컵');}});return false;"># 머그컵</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1945551" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|수세미|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('수세미');}});return false;"># 수세미</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|일회용수세미|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('일회용수세미');}});return false;"># 일회용수세미</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|주방수세미|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('주방수세미');}});return false;"># 주방수세미</a></li>
								
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|생활공작소|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('생활공작소');}});return false;"># 생활공작소</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1191473" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|공기청정기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('공기청정기');}});return false;"># 공기청정기</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|공기정화기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('공기정화기');}});return false;"># 공기정화기</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미세먼지공기청정기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('미세먼지공기청정기');}});return false;"># 미세먼지공기청정기</a></li>
								
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미니공기청정기|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('미니공기청정기');}});return false;"># 미니공기청정기</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1971052" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|폴라로이드|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('폴라로이드');}});return false;"># 폴라로이드</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword','<%=itemid%>|즉석카메라|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('즉석카메라');}});return false;"># 즉석카메라</a></li>

								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|포토프린터|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('포토프린터');}});return false;"># 포토프린터</a></li>
								
								<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|LG포켓포토|top',function(bool){if(bool) {fnAPPpopupSearchOnNormal('LG포켓포토');}});return false;"># LG포켓포토</a></li>
							<ul>
						</div>
					</div>
			<% End Select %>
		...
		<div class="itemPrdV16a itemPrdV17">
				...
				<% Select Case Trim(itemid) %>
					<% Case "1971902" %>
						<div class="related-item related2">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|휴대용선풍기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('휴대용선풍기');}});return false;"># 휴대용선풍기</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|선풍기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('선풍기');}});return false;"># 선풍기</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|탁상용선풍기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('탁상용선풍기');}});return false;"># 탁상용선풍기</a></li>
									
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|스탠드선풍기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('스탠드선풍기');}});return false;"># 스탠드선풍기</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|USB선풍기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('USB선풍기');}});return false;"># USB선풍기</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미니선풍기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('미니선풍기');}});return false;"># 미니선풍기</a></li>
								<ul>
							</div>
						</div>
					<% Case "1971903" %>
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									...
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|핸디선풍기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('핸디선풍기');}});return false;"># 핸디선풍기</a></li>
					...
					<% Case "1685329" %>
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword','<%=itemid%>|휴대용선풍기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('휴대용선풍기');}});return false;"># 휴대용선풍기</a></li>
					...
					<% Case "1965839" %>
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('잠옷');}});return false;"># 잠옷</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷세트|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('잠옷세트');}});return false;"># 잠옷세트</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|여름잠옷|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('여름잠옷');}});return false;"># 여름잠옷</a></li>
									
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|파자마|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('파자마');}});return false;"># 파자마</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|파자마세트|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('파자마세트');}});return false;"># 파자마세트</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|여름파자마|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('여름파자마');}});return false;"># 여름파자마</a></li>
								<ul>
							</div>
						</div>
					...
					<% Case "1919807" %>
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁기크리너|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁기크리너');}});return false;"># 세탁기크리너</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁기청소|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁기청소');}});return false;"># 세탁기청소</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조크리너|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁조크리너');}});return false;"># 세탁조크리너</a></li>
									
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조청소|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁조청소');}});return false;"># 세탁조청소</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁조');}});return false;"># 세탁조</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조세제|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('세탁조세제');}});return false;"># 세탁조세제</a></li>
								<ul>
							</div>
						</div>
						...
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									...
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|유카타잠옷|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('유카타잠옷');}});return false;"># 유카타잠옷</a></li>
									
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷가운|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('잠옷가운');}});return false;"># 잠옷가운</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|로브|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('로브');}});return false;"># 로브</a></li>
								<ul>
							</div>
						</div>
					...
					<% Case "1926844" %>
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|생리통초콜릿|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('생리통초콜릿');}});return false;"># 생리통초콜릿</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|스위스초콜릿|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('스위스초콜릿');}});return false;"># 스위스초콜릿</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|초콜릿|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('초콜릿');}});return false;"># 초콜릿</a></li>
									
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|초콜렛|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('초콜렛');}});return false;"># 초콜렛</a></li>
								<ul>
							</div>
						</div>
					...
					<% Case "1967223" %>
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|밀키머그|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('밀키머그');}});return false;"># 밀키머그</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|무지머그|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('무지머그');}});return false;"># 무지머그</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|머그|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('머그');}});return false;"># 머그</a></li>
									
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|머그컵|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('머그컵');}});return false;"># 머그컵</a></li>
								<ul>
							</div>
						</div>
					...
					<% Case "1945551" %>
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|수세미|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('수세미');}});return false;"># 수세미</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|일회용수세미|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('일회용수세미');}});return false;"># 일회용수세미</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|주방수세미|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('주방수세미');}});return false;"># 주방수세미</a></li>
									
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|생활공작소|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('생활공작소');}});return false;"># 생활공작소</a></li>
								<ul>
							</div>
						</div>
					...
					<% Case "1191473" %>
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|공기청정기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('공기청정기');}});return false;"># 공기청정기</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|공기정화기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('공기정화기');}});return false;"># 공기정화기</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미세먼지공기청정기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('미세먼지공기청정기');}});return false;"># 미세먼지공기청정기</a></li>
									
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미니공기청정기|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('미니공기청정기');}});return false;"># 미니공기청정기</a></li>
								<ul>
							</div>
						</div>
					...
					<% Case "1971052" %>
						<div class="related-item related1">
							...
							<div class="swiper-container">
								<ul class="swiper-wrapper">
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|폴라로이드|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('폴라로이드');}});return false;"># 폴라로이드</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword','<%=itemid%>|즉석카메라|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('즉석카메라');}});return false;"># 즉석카메라</a></li>

									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|포토프린터|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('포토프린터');}});return false;"># 포토프린터</a></li>
									
									<li class="swiper-slide"><a href="" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|LG포켓포토|bottom',function(bool){if(bool) {fnAPPpopupSearchOnNormal('LG포켓포토');}});return false;"># LG포켓포토</a></li>
								<ul>
							</div>
						</div>
				<% End Select %>
			...
			<% ''If (Not IsTicketItem) Then '티켓아닌경우 - 일반상품 %>
				...
				<% End If %>
				<!--// Event Item //-->
				<!-- #Include virtual="/apps/appCom/wish/web2014/category/_inc_ItemEventList.asp" -->
			<% ''end if %>
		</div>
	</div>
