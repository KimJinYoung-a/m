...
<style type="text/css">
.mEvt57478 img {width:100%; vertical-align:top;}
.mEvt57478 .swMenu {position:relative;}
.mEvt57478 .swMenu ul {position:absolute; left:0; bottom:0; overflow:hidden; width:100%; height:100%; z-index:30;}
.mEvt57478 .swMenu li {float:left; width:25%; height:63%; margin-top:11%;}
.mEvt57478 .swMenu li a {display:block; width:100%; height:100%; background:url(http://webimage.10x10.co.kr/eventIMG/2014/55406/blank.png) left top repeat; background-size:100% 100%; text-indent:-9999em;}
.mEvt57478 .swMenu li.on {height:100%; margin-top:0;}
.mEvt57478 .selectGift {background:url(http://webimage.10x10.co.kr/eventIMG/2014/57474/bg_select_area.jpg) left top repeat; background-size:100% 100%;}
.mEvt57478 .selectGift ul {overflow:hidden; padding:20px 10px 10px;}
.mEvt57478 .selectGift li {float:left; width:50%; padding:0 5px 18px; text-align:center;}
.mEvt57478 .selectGift li input {margin-top:8px}
.mEvt57478 .selectGift .apply {display:block; width:65%; margin:0 auto;}
.mEvt57478 .benefit {position:relative;}
.mEvt57478 .benefit .apply {display:block; position:absolute; right:4%; bottom:15%; width:23%;}
@media all and (min-width:480px){
	.mEvt57478 .selectGift li {padding:0 8px 27px;}
	.mEvt57478 .selectGift li input {margin-top:12px}
}
</style>
...
<body>
	<div class="evtCont">
		...
		<div class="mEvt57478">
			...
			<div class="swMenu">
				<ul>
					<li><a href="/apps/appCom/wish/web2014/event/eventmain.asp?eventid=57473" target="_top">아이템</a></li>
					<li class="on"><a href="/apps/appCom/wish/web2014/event/eventmain.asp?eventid=57478" target="_top">크리스마스 선물</a></li>
					<li><a href="/apps/appCom/wish/web2014/event/eventmain.asp?eventid=57479" target="_top">에피소드7 미리보기</a></li>
					<li><a href="/apps/appCom/wish/web2014/event/eventmain.asp?eventid=57480" target="_top">모바일카드 보내기</a></li>
				</ul>
			...
			<!-- 선물 선택 -->
			<form name="frmcom" method="post" action="doEventSubscript57478.asp" style="margin:0px;" target="prociframe">
			...
			<% If Left(Now(), 10) >= "2014-12-15" Then %>
				<div class="benefit">
					...
					<a class="apply" href="" onclick="fnAPPpopupExternalBrowser('http://m.gsshop.com/event/2014_12/apply_starwarsmovie.jsp');return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2014/57474/btn_apply02.png" alt="참여하기" /></a>
				</div>
			<% End If %>
