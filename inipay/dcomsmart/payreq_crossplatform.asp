...
<%
    ...
    ' */
    LGD_CASNOTEURL             = "http://testm.10x10.co.kr/inipay/dcomsmart/cas_noteurl.asp"

    '/*
    ' * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
    ' */    
    LGD_RETURNURL				= "http://testm.10x10.co.kr/inipay/dcomsmart/returnurl.asp"
	
	'/*
    ' * ISP 카드결제 연동중 모바일ISP방식(고객세션을 유지하지않는 비동기방식)의 경우, LGD_KVPMISPNOTEURL/LGD_KVPMISPWAPURL/LGD_KVPMISPCANCELURL를 설정하여 주시기 바랍니다. 
    ' */    
    LGD_KVPMISPNOTEURL       = "http://testm.10x10.co.kr/inipay/dcomsmart/note_url.asp"
    LGD_KVPMISPWAPURL		= "http://testm.10x10.co.kr/inipay/dcomsmart/mispwapurl.asp?LGD_OID=" + LGD_OID
    LGD_KVPMISPCANCELURL     = "http://testm.10x10.co.kr/inipay/dcomsmart/cancel_url.asp"
...
<!--
	...
	function setLGDResult(){
		...
		if(document.getElementById('LGD_RESPCODE').value == '0000' ){
			...
			getFormObject().action = "payres.asp";
...
<table>
    ...
    <tr>
        <td colspan="2">* 추가 상세 결제요청 파라미터는 메뉴얼을 참조해 주시기 바랍니다.</td>
    </tr>
    <tr>
        <td colspan="2"></td>
    </tr>    
