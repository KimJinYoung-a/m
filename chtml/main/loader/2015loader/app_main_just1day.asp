...
%>
		...
		<div class="weekBnr"><img src="<%=extraimg%>" alt="주말/휴일대체용 이미지" width="100%" onclick="fnAPPpopupEvent_URL('http://m.10x10.co.kr/apps/appCom/wish/web2014<%=extraurl %><%=gaParam%>');"/></div>
<%
			else
%>
		<div class="todayPdt">
