...
<%
	...
	If nowdate >= "2015-04-13" And nowdate < "2015-04-17" Then
		response.write "<script>parent.location.href='/event/eventmain.asp?eventid=60933'</script> "
		response.End
	End If
...
<!--
	...
	function gotoDownload(){
		parent.top.location.href='http://m.10x10.co.kr/apps/link/?3920150412';
		return false;
	};
...
function kakaosendcall(){
	<% If IsUserLoginOK Then %>
		parent_kakaolink('[텐바이텐] 셋콤 달콤!\n4월에 꿀맛 제대로 느껴보세요!\n\n-지니 30일 무제한 감상권!\n-요기요 7,000원 식권!\n-메가박스 영화 예매권!\n\n텐바이텐 APP에서 당신의 손으로 직접 당첨을 확인하세요!' , 'http://webimage.10x10.co.kr/eventIMG/2015/60930/60930kakao.jpg' , '200' , '200' , 'http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=61549' );
		return false;
	<% Else %>
...
<div class="evtCont">
	...
	<div class="threeSweets">
		...
		<div class="todaygift">
			...
			<% Else %>
				<p class="date">
					...
					<% If nowdate >= "2015-04-17" And nowdate < "2015-04-20" Then %>
		...
		<div class="applyEvt">
			...
			<!-- 당첨자에게만 노출<p class="viewNum"><a href="#"><img src="http://webimage.10x10.co.kr/eventIMG/2015/60931/btn_view_number.jpg" alt="요기요 당첨번호 다시 보기" /></a></p> -->
		</div>
