...
<script src="/vue/components/common/functions/common_mixins.js?v=1.2"></script>
...
<!-- Product Components -->
<script src="/vue/components/product/prd_slider_type2.js?v=1.0"></script>
<script src="/vue/components/product/prd_slider_type5.js?v=1.0"></script>
...
<!-- Brand Components -->
<script src="/vue/components/brand/brd_set_type2.js?v=1.1"></script>
<!-- //Brand Components -->

<!-- Core -->
<script src="/vue/list/new/summary_store.js?v=1.1"></script>
<script src="/vue/list/new/summary.js?v=1.6"></script>
<!-- //Core -->