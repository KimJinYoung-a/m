...
<%
	...
	if checkNotValidTxt(vMessage) then		
		Response.Write "<script type='text/javascript'>alert('내용에 유효하지 않은 글자가 포함되어 있습니다. 다시 작성 해주세요.'); location.href='/my10x10/order/myorderdetail.asp?idx="&vOrderserial&"&packopen=packopen';</script>"
	...
	Response.Write "<script type='text/javascript'>alert('저장되었습니다.'); location.href='/my10x10/order/myorderdetail.asp?idx="&vOrderserial&"&packopen=packopen'; window.close();</script>"
	dbget.close() : Response.End
%>
