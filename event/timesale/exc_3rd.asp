...
dim currentDate : currentDate = "2019-11-25" '// 이벤트일
...
.sale-timer {padding-top:3.41rem; padding-bottom:3.41rem; padding-left:8%; font-size:5.14rem; font-family:'AvenirNext-Bold', 'AppleSDGothicNeo-Bold'; font-weight:bold;}
.sale-timer p {margin-bottom:1.28rem; font-size:2.43rem;}
.btn-alarm {width:32rem; height:4.27rem; margin-top:1.71rem; background:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/btn_alarm.png) no-repeat 50% 0/100%; text-indent:-999em;}
.btn-alarm2 {display:inline-block; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/btn_alarm2.png)}

.time-top {position:relative; padding-top:3.5rem; background:#121b42 url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/bg_top.jpg)no-repeat 50% 50%/100% 100%;}
.time-top h2 {position:relative;}
.time-top h2:after {display:inline-block; position:absolute; top:2.35rem; right:6.06rem; width:.64rem; height:.64rem; background-color:#ff6600; border-radius:50%; content:'';}
...
.time-nav .time {width:4.69rem; height:4.8rem; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_time1_1.png); background-repeat:no-repeat; background-position:0 0; background-size:4.69rem 18.35rem; text-indent:-999em;}
.time-nav .time2 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_time1_2.png);}
.time-nav .time3 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_time1_3.png);}
.time-nav .time4 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_time1_4.png);}
...
.alarm .time-nav .time {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_time2_1.png);}
.alarm .time-nav .time2 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_time2_2.png);}
.alarm .time-nav .time3 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_time2_3.png);}
.alarm .time-nav .time4 {background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_time2_4.png);}
...
.time-sale .price em {font-family:'AvenirNext-Bold', 'AppleSDGothicNeo-Bold'; font-weight:bold; font-size:1.54rem; letter-spacing:-.08rem;}
...
.time-sale .price .sale {display:inline-block; margin-right:.8rem; color:#ff3823; font-size:1.8rem; font-family:'AvenirNext-Bold', 'AppleSDGothicNeo-Bold'; font-weight:bold;}
...
.thumbnail .label-box {position:absolute; bottom:-.48rem; left:.43rem; z-index:10;}
.thumbnail .label {display:inline-block; height:1.59rem; padding:0 .8rem; background-color:#222;color:#fff; font-size:1.02rem; line-height:1.8rem; font-family:'AvenirNext-Medium', 'AppleSDGothicNeo-Medium'; border-radius:.84rem;}
...
.time-ing .time-items-on .thumbnail .label {height:2.14rem; padding:0 1.5rem; font-size:1.28rem; line-height:2.35rem; border-radius:1.28rem;}

.time-ing .time-items-on .desc {margin-top:2.57rem;}
.time-ing .time-items-on .name {font-size:1.58rem;}
.time-ing .time-items-on .price {justify-content:flex-start; margin-top:1.28rem;}
.time-ing .time-items-on .price b {width:auto; font-size:1.48rem;}
.time-ing .time-items-on .price em {display:inline-block; margin-left:.5rem; font-size:2.13rem;}
...
.lyr-fair .btn-get2,
.lyr-fair .btn-get3,
.lyr-fair .btn-get4 {position:absolute; top:0; left:0;}
...
.lyr-fair #notRobot4 + label {display:inline-block; position:relative; width:17.45rem; height:2.86rem; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/98760/m/txt_chck.png?v=1.02); background-repeat:no-repeat; background-size:100% 100%;}

.lyr-fair #notRobot1:checked + label,
...
.lyr-fair .btn-get2,
.lyr-fair .btn-get3,
.lyr-fair .btn-get4 {width:26.53%;}

.lyr-alarm p {padding-top:7.98rem;}
.lyr-alarm .input-box {display:flex; justify-content:space-between; align-items:center; width:70.67%; margin-left:8%; margin-top:5.97rem; color:#ff6600; font-size:1.5rem; font-weight:bold;}
.lyr-alarm .input-box input {width:33%; height:3rem; padding:0; margin:0 .2rem; background-color:transparent; border:0; border-bottom:solid .17rem #ff9023; border-radius:0; color:#cbcbcb; font-size:1.45rem; font-family:'AvenirNext-DemiBold', 'AppleSDGothicNeo-SemiBold'; font-weight:bold; text-align:center;}
.lyr-alarm .input-box .btn-submit {width:4.69rem; margin-left:.5rem; color:#ff9023; font-size:1.45rem; font-family:'AvenirNext-Bold', 'AppleSDGothicNeo-Bold'; font-weight:bold;}
...
<% end if %>
        ...
        <div class="inner">
            <%'!-- for dev msg [time-nav] 의 탭 클릭시 해당 타임세일의 종료된 상품 노출 --%>
                ...
                <div class="time-items" style="display:none;">
                    <p class="txt-time"><img src="//webimage.10x10.co.kr/fixevent/event/2019/98760/m/tit_time2_<%=oTimeSale.FitemList(loopInt).Fround%>.png" alt="<%=oTimeSale.FitemList(loopInt).Fround%>회 세일"></p>
                    <ul>
                <%
                        END IF
                %>
    ...
    <div class="lyr lyr-alarm" style="display:none;">
        <div class="inner">
            <p><img src="//webimage.10x10.co.kr/fixevent/event/2019/98760/m/txt_push.png" alt="기회를 놓치지 않는 가장 확실한 방법"></p>
    ...
    <div class="related-evt">
        <p><img src="//webimage.10x10.co.kr/fixevent/event/2019/98760/m/tit_related_evt.png" alt="잠깐 찬스, 하나더 아니, 세개 더"></p>
        	<ul>
                <li><a href="/christmas/" onclick="fnAPPpopupEvent_URL('http://m.10x10.co.kr/apps/appCom/wish/web2014/christmas/');return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_related1.jpg?v=1.01" alt="지금부터 준비하세요! 크리스마스 소품의 모든 것"></a></li>
                <li><a href="/event/eventmain.asp?eventid=98620" onclick="jsEventlinkURL(98620);return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_related2.jpg?v=1.01" alt="지금 텐바이텐에서  가장 인기 많은 BEST 20"></a></li>
                <li><a href="/event/eventmain.asp?eventid=97607" onclick="jsEventlinkURL(97607);return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_related3.jpg?v=1.02" alt="오마이걸"></a></li>
                <li><a href="/event/eventmain.asp?eventid=98339" onclick="jsEventlinkURL(98339);return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2019/98760/m/img_related4.jpg?v=1.01" alt="오마이걸"></a></li>
            </ul>
    </div>
</div>
