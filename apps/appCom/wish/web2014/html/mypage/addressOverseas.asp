		...
		<div class="content mypage" id="contentArea">
			...
			<div id="content">
					...
					<ul class="address-list">
						<li class="bordered-box">
							...
							<div class="address-info">
								...
								<p class="phone">
									02-1111-2222 / 010-1111-2222
								</p>
								<p class="address">
									GREECE<br>01-0619-6773-0675<br>KOCEN EURO GmbH #KX151<br>Ober der Roeth 4,<br>Schwalbach, 65824
								</p>
								<div class="actions">
									<button class="btn type-e small">수정</button>
				...
				<div class="form-actions highlight tMar20">
					<button class="btn type-a full-size">해외 주소록 신규등록</button>
				</div>
			</div><!-- #content -->
		</div>
		<!-- //content area -->
