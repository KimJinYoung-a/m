...
<%
    ...
    if Not(IsUserLoginOK) then
        Response.write "<script>alert('로그인하셔야 사용할 수 있습니다.');fnCloseModal();</script>"
        dbget.close()
        Response.End
    end if
    ...
    if oTenCash.Fcurrentdeposit = 0 then 
        Response.Write "<script>alert('예치금이 0원 입니다.');fnCloseModal();</script>"
        dbget.close()
        Response.End
    end if
...
<div class="layerPopup">
	<div class="popWin">
        ...
        <div class="content pop-deposit" style="margin-top:45px;" id="scrollarea">
            <div>
                ...
                <form name="frmReturnToBankCash" method="post" action="/my10x10/deposit/depositproc.asp" style="margin:0px;">
                <input type="hidden" name="orderserial" value="">
                <div class="return-deposit">
