...
<%
	...
	FOR i=0 to ubound(arrTenjoy,2)
		evtimg				= staticImgUrl & "/mobile/enjoyevent" + db2Html(arrTenjoy(4,i))
...
%>
		<div>
			<a href="" onclick="fnAPPpopupEvent_URL('http://m.10x10.co.kr/apps/appCom/wish/web2014<%=linkurl%>');return false;">
