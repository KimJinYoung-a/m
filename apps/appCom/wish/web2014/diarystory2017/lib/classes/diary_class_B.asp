...
class cdiary_list
    ...
    public Sub getDiaryMdpick()
		...
		dim rsMem : set rsMem = getDBCacheSQL(dbget,rsget,"DIAMD",sqlStr,180)
        if (rsMem is Nothing) then Exit Sub ''추가
	...
	Public Sub getOneDailynot()
		...
		sqlStr = sqlStr & " from ("
		sqlStr = sqlStr & " 	select top 3 pi.evt_code as itemid, pi.linkpath, pi.imagepath"
		...
		dim rsMem : set rsMem = getDBCacheSQL(dbget,rsget,"DIAE",sqlStr,180)
        if (rsMem is Nothing) then Exit Sub ''추가
	...
	Public Sub getOneplusOneDaily()
		...
		sqlStr = sqlStr & " , i.limitsold, i.itemname, i.SailYn as SaleYn, i.orgprice, i.sailprice,i.basicimage, i.icon1image"
		sqlStr = sqlStr & " , i.icon2image, i.sellcash, i.itemcouponyn ,i.sellyn , i.itemCouponValue , i.itemCouponType"
		sqlStr = sqlStr & " , o.itemid, o.image1, o.image2, o.imageend, o.endlink, o.explain, o.plustype, c.socname, o.mimage1 " +vbcrlf
...
public Function fnGetBrandSpecialimg()
	...
	sqlStr = "SELECT top 1 momainbrandimg FROM [db_diary2010].[dbo].[tbl_diaryspecial_brand] WHERE isusing='Y' and momainbrandimg<>'' order by idx desc"
	rsget.CursorLocation = adUseClient
