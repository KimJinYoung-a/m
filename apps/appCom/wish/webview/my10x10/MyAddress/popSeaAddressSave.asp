    ...
    <div class="wrapper myinfo">
        ...
        <div id="content">
            ...
            <div class="well filled">
                <ul class="txt-list">
                    <li><strong class="red">해외 배송지의 모든 정보는 꼭 영문 작성이 필요합니다.<br>
(배송지명은 한글 가능) </strong></li>
                </ul>
            </div>  
            <div class="diff"></div>
            ...
            <div class="inner">                
                ...
                <div class="input-block">
                    <label for="email" class="input-label">이메일</label>
                     <div class="input-controls">
                        <input type="text" name="reqEmail" id="email" class="form full-size" value="<%=doubleQuote(obj.Item.reqEmail)%>">
                    </div>
                </div>
				...
				<div class="input-block">
                    ...
                    <div class="input-controls country">
                        ...
                        <div><input name="countryCode" type="text" id="country2" class="form full-size" value="<%=obj.Item.countryCode%>" maxlength="2" readOnly ></div>
                        <div><input name="emsAreaCode" type="text" id="country3" class="form full-size" value="<%=obj.Item.emsAreaCode%>" maxlength="1" readOnly ></div>
                    </div>
                </div>
