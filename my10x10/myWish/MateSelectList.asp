...
<%
	...
	vErrBackLocationUrl = "/my10x10/myWish/mywish.asp?ucid="&Server.Urlencode(tenEnc(vTargetUserid))
...
<div class="heightGrid">
	<div class="container popWin">
		<div class="header">
			<h1>메이트</h1>
			<p class="btnPopPrev"><a href="<%=vErrBackLocationUrl%>"  class="pButton">이전으로</a></p>
		</div>
		<!-- content area -->
