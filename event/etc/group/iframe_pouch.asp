...
'#######################################################################
	...
	If vEventID = "000000" Then '//7월
		vStartNo = "0"
	ElseIf vEventID = "116853" Then '// 8월
		vStartNo = "0"
	ElseIf vEventID = "000000" Then '// 9월
		vStartNo = "1"
	ElseIf vEventID = "" Then '// 10월
		vStartNo = "2"
	ElseIf vEventID = "5" Then '// 11월
		vStartNo = "3"
	ElseIf vEventID = "" Then '// 10월
		vStartNo = "4"
	ElseIf vEventID = "" Then '// 10월
		vStartNo = "5"
	ElseIf vEventID = "1" Then '// 10월
		vStartNo = "6"
	End If
%>
...
<div class="monthTab">
	<div class="swiper-container">
		<ul class="swiper-wrapper">
			...
			<li class="swiper-slide"><span>#1월의<em>파우치</em></span>
			<% Else %>
			<li class="swiper-slide <%=CHKIIF(vEventID="000000"," current","")%>"><a href="/event/eventmain.asp?eventid=000000" target="_top"><p>#1월의<em>파우치</em></p></a>
			<% End If %>
			</li>

			<% if currentdate < "2022-02-15" then %>
			<li class="swiper-slide"><span>#2월의<em>파우치</em></span>
			<% Else %>
			<li class="swiper-slide <%=CHKIIF(vEventID="116853"," current","")%>"><a href="/event/eventmain.asp?eventid=116853" target="_top"><p>#2월의<em>파우치</em></p></a>
			<% End If %>
			</li>

			<% if currentdate < "2022-09-01" then %>
			<li class="swiper-slide"><span>#3월의<em>파우치</em></span>
			<% Else %>
			<li class="swiper-slide <%=CHKIIF(vEventID="000000"," current","")%>"><a href="/event/eventmain.asp?eventid=000000" target="_top"><p>#3월의<em>파우치</em></p></a>
			<% End If %>
			</li>
