...
$(function() {
	$('.policyList li a').click(function(){
		myScroll.scrollToElement($(this).attr("href"),50);
		return false;
	});
});
</script>
			...
			<div id="scrollarea">
				...
				<div class="inner5 cardTerms">
					<ul class="policyList box2">
						...
						<li><a href="#terms04">제4조 - 포토 기프트카드의 이용 및 제한</a></li>
						<li><a href="#terms05">제5조 - 기프트카드의 인터넷사용 등록</a></li>
						<li><a href="#terms06">제6조 - 기프트카드의 소득공제 등록</a></li>
						<li><a href="#terms07">제7조 - 기프트카드의 환불 및 잔액환급</a></li>
						<li><a href="#terms08">제8조 - 기프트카드의 유효기한</a></li>
						<li><a href="#terms09">제9조 - 기프트카드의 재발급</a></li>
						<li><a href="#terms10">제10조 - 기프트카드의 도난ㆍ분실 등에 따른 책임</a></li>
						<li><a href="#terms11">제11조 - 기프트카드 위/변조 등에 대한 책임</a></li>
						<li><a href="#terms12">제12조 - 이용약관의 효력 및 변경</a></li>
						<li><a href="#terms13">제13조 - 이 약관에서 정하지 아니한 사항</a></li>
						<li><a href="#terms14">제14조 - 관할법원</a></li>
					</ul>
