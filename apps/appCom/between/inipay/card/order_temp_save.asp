...
<%
	...
	vQuery1 = vQuery1 & "SELECT '" & vIdx & "', userKey, isLoginUser, itemid, itemoption, itemea, requiredetail, regdate, lastupdate, chkOrder, requiredetailUTF8 " & vbCrLf
	vQuery1 = vQuery1 & "FROM [db_my10x10].[dbo].[tbl_my_baguni] "
...
%>
	...
	<% IF application("Svr_Info")="Dev" THEN %>
		...
		************************************************************************************-->
		<input type="hidden" name="P_NEXT_URL" value="http://testm.10x10.co.kr/apps/appCom/between/inipay/card/mx_rnext.asp">

		<!--************************************************************************************
		ISP, 가상계좌 필수항목 - 이 URL로 ISP 승인결과 및 가상계좌 입금정보가 리턴됨
		************************************************************************************-->
		<% if (vAppName="") and (flgDevice="I") then '' 아이폰 웹결제 %>
			<input type="hidden" name="P_NOTI_URL" value="http://testm.10x10.co.kr/apps/appCom/between/inipay/card/mx_rnoti.asp">
			<input type="hidden" name="P_RETURN_URL" value="http://testm.10x10.co.kr/apps/appCom/between/inipay/card/mx_rreturn.asp?idx=<%=vIdx%>">
    ...
    <% ELSE %>
		...
		안심클릭, 가상계좌, 휴대폰, 문화상품권, 해피머니 사용시 필수 항목 - 인증결과를 해당 url로 post함, 즉 이 URL이 화면상에 보여지게 됨
		************************************************************************************-->
		<input type="hidden" name="P_NEXT_URL" value="http://m.10x10.co.kr/apps/appCom/between/inipay/card/mx_rnext.asp">

		<!--************************************************************************************
		ISP, 가상계좌 필수항목 - 이 URL로 ISP 승인결과 및 가상계좌 입금정보가 리턴됨
		************************************************************************************-->
		<% if (vAppName="") and (flgDevice="I") then '' 아이폰 웹결제 %>
			<input type="hidden" name="P_NOTI_URL" value="http://m.10x10.co.kr/apps/appCom/between/inipay/card/mx_rnoti.asp">
			<input type="hidden" name="P_RETURN_URL" value="http://m.10x10.co.kr/apps/appCom/between/inipay/card/mx_rreturn.asp?idx=<%=vIdx%>">
			<INPUT TYPE="HIDDEN" name="P_RESERVED" value="">
		<% else %>
			<input type="hidden" name="P_NOTI_URL" value="">
			<input type="hidden" name="P_RETURN_URL" value="">
		...
		<!--&app_scheme=tenwishapp://m.10x10.co.kr/apps/appCom/between/inipay/card/mx_rreturn.asp?idx=<%=vIdx%>-->
	<% END IF %>
