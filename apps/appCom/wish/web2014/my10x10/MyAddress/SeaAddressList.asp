...
<div class="heightGrid my-address-list">
	<div class="container popWin">
			...
			<div class="inner10">
					<div class="tab02 tMar10">
						<ul class="tabNav tNum2 noMove">
							<li><a href="MyAddressList.asp">국내 주소록</a></li>
							<li class="current"><a href="SeaAddressList.asp">해외 주소록</a></li>
						</ul>
					</div>
					...
					<% Else %>
						...
						<li>
							...
							<div class="boxCont">
								...
								<p><%=obj.Items(i).reqPhone%></p>
								<p class="bPad10"><%=obj.Items(i).countryNameEn%><br><%=obj.Items(i).reqZipaddr%><br><%=obj.Items(i).reqAddress%></p>
		...
		<div class="floatingBar">
			<div class="btnWrap">
				<div class="ftBtn"><span class="button btB1 btRed cWh1 w100p"><a href="" onclick="popMyAddress('<%=conSaveURL%>&openerYN=N'); return false;">해외주소록 신규등록</a></span></div>
			</div>
		</div>
		<!-- //content area -->
	</div>
