				...
				<div class="customer_info">
					...
					<div class="info_applier">
						<dl>
							...
							<dt>주소</dt>
							<dd>
								<p><input type="text" name="buyZip1" ReadOnly class="input_tel" value="<%= Splitvalue(oUserInfo.FOneItem.FZipCode,"-",0) %>" style="width:24%"> -
								<input name="buyZip2" type="text" ReadOnly class="input_tel" value="<%= Splitvalue(oUserInfo.FOneItem.FZipCode,"-",1) %>" style="width:24%">
							<!--	<img src="http://fiximage.10x10.co.kr/m/kakaotalk/btn_postnum.png" class="tm-4" width="82" height="27" style="margin:-3px 0 0 5px;cursor:pointer;"  onClick="searchzipBuyer('frmorder')"> -->
								...
								<p style="padding-top:7px;"><input name="buyAddr1" type="text" ReadOnly maxlength="100" class="input_address" value="<%= doubleQuote(oUserInfo.FOneItem.FAddress1) %>" style="width:95%;"></p>
								<p style="padding-top:7px;"><input name="buyAddr2" type="text" maxlength="60" class="input_address" value="<%= doubleQuote(oUserInfo.FOneItem.FAddress2) %>" style="width:95%;"></p>
							</dd>
							<% end if %>
						</dl>
					</div>
					...
					<div class="info_address">
						<div class="sType">
							<% if (IsUserLoginOK) then %>
							<label><input type="radio" name="rdDlvOpt" id="rdDlvOpt" value="O"  onClick="copyDefaultinfo(this);" /> 요청 고객 정보와 동일</label>
						...
						<dl>
							...
							<!--<div class="postcode_layer">
									...
									<p class="tMar05"><input type="text" name="txAddr1" ReadOnly maxlength="100" value="" class="text" style="width:95%;" /></p>
									<p class="tMar05"><input type="text" name="txAddr2" class="text" maxlength="60" value="" style="width:95%;" /></p>
							</dd>
								<dt>배송 유의 사항</dt>
