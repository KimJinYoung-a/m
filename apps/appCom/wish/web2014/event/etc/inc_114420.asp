...
eventStartDate  = cdate("2021-09-29")		'이벤트 시작일
eventEndDate 	= cdate("2021-10-05")		'이벤트 종료일

LoginUserid		= getencLoginUserid()

if mktTest then
    currentDate = cdate("2021-09-29")
else
    currentDate = date()
end if
...
myorder.FRectStartDate = FormatDateTime("2021-08-01",2)
myorder.FRectEndDate = FormatDateTime("2021-09-01",2)
...
.mEvt113327 .section02 .order .order_info02 .order_name {
    padding: 0 5vw;
    font-size: 1.2rem;
    font-family: 'CoreSansCBold', 'AppleSDGothicNeo-Bold', 'NotoSansKRBold';
    line-height: 1.3;
}
...
.mEvt113327 .popup .bg_dim{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0,0,0,0.6);z-index:9;}
...
function doAction() {
    ...
    <% If IsUserLoginOK() Then %>
        ...
        $.ajax({
            type: "POST",
            url:"/apps/appcom/wish/web2014/event/etc/doeventsubscript/doEventSubscript114420.asp",
            data: {
                mode: 'add',
    ...
    return false;
            ...
            <input type="hidden" id="orderprice">
				<section class="section section01">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/114420/m/top.jpg?v=2" alt="">
                    <div class="coin">
                    ...
                    <div class="text">
                        ...
                        <p class="txt02 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/114420/m/txt02.png" alt=""></p>
                        ...
                        <p class="txt05 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/114420/m/txt05.png" alt=""></p>
                ...
                <% if LoginUserid<>"" then %>
                    ...
                    <div class="login">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114420/m/receipt.jpg" alt="">
                    ...
                    <% else %>
                    <div class="order_one">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114420/m/order01.jpg" alt="">
                        <p class="user"><span><%=LoginUserid%></span>님의</p>
                    </div>
                    <% end if %>
                <% else %>
                    <div class="logout">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114420/m/login.jpg" alt="">
                        <a href="" class="go_login" onclick="jsSubmitlogin();return false;"></a>
                    </div>
                <% end if %>
                </section>
                <section class="section section03">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/114420/m/notice.jpg" alt="">
                </section>
                <section class="section section4">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/114420/m/alert.jpg" alt="">
                    <a href="" class="go_alert" onclick="doAlarm();return false;"></a>
                </section>
                <div class="popup">
                    <div class="bg_dim"></div>
                    <div class="pop">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114420/m/popup.png" alt="">
                        <div class="final">
                ...
                <div class="popup popup02">
                    <div class="bg_dim"></div>
                    <div class="pop win">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/pop_win.png" alt="당첨자 발표">
