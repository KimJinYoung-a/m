			...
			<div class="swiper-wrapper">
				<article class="swiper-slide prd_item">
					...
					<div class="prd_info">
						...
						<div class="prd_name ellipsis2">코드나인 무선 미니가코드나인 무선 미니가코드나인 무선 미니가습기 제제</div>
					</div>
