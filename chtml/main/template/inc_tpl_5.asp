								...
								%>
									<div class="swiper-slide">
										<a href="/category/category_itemPrd.asp?itemid=<%=subNodes.getElementsByTagName("itemid").item(0).text%>">
											...
											<div>
												<p>
													<% if subNodes.getElementsByTagName("saleYn").item(0).text="Y" then %><img src="http://fiximage.10x10.co.kr/m/2013/common/tag_sale.png" alt="SALE" style="height:14px;" class="rMar02" /><% end if %>
													<% if subNodes.getElementsByTagName("NewYn").item(0).text="Y" then %><img src="http://fiximage.10x10.co.kr/m/2013/common/tag_new.png" alt="NEW" style="height:14px;" class="rMar02" /><% end if %>
													<% if subNodes.getElementsByTagName("LimitYn").item(0).text="Y" then %><img src="http://fiximage.10x10.co.kr/m/2013/common/tag_limit.png" alt="한정" style="height:14px;" class="rMar02" /><% end if %>
													<% if subNodes.getElementsByTagName("GiftYn").item(0).text="Y" then %><img src="http://fiximage.10x10.co.kr/m/2013/common/tag_gift.png" alt="GIFT" style="height:14px;" class="rMar02" /><% end if %>
												</p>
