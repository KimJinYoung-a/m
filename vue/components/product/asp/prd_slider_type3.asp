...
<script>
$(function() {
	var prdSwiper3 = new Swiper('.prd_slider_type3 .swiper-container', {
		speed: 500,
		slidesPerView: 'auto',
		centeredSlides: true
	});
...
<body>
	<p class="ref"><strong>type3</strong>
		<br>750 기준 640
		<br>e.g. SALE - 세일 상품 메인 롤링
		<br>상품명 1줄 / 원가 (o_price)
        <br>type1~3의 경우 그림자 때문에 swiper-container에 임의 패딩값 필요
	</p>
	<div class="prd_slider_type3">
