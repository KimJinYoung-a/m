...
<script type="text/javascript">
    $(function(){
        ...
        setTimeout(function(){fnAmplitudeEventMultiPropertiesAction('view_event_101393','loginstatus','<%=IsUserLoginOK%>');}, 100);
    });

    // 마일리지 발급 및 푸시 알림 그만받기 신청
    function regAlram(act) {
        setTimeout(function(){fnAmplitudeEventMultiPropertiesAction('click_event_submit_101393','loginstatus','<%=IsUserLoginOK%>');}, 100);
        ...
        <% else %>
            ...
            var str = $.ajax({
                type: "post",
                url:"/apps/appCom/wish/web2014/event/etc/doeventsubscript/doEventSubscript101392.asp",
                data: {
                    eCode: <%=issueCode%>,
...
<body>
    ...
    <div class="mEvt101084">
        ...
        <div class="noti"><img src="//webimage.10x10.co.kr/eventIMG/2020/101392/txt_noti.png?v=2" alt="이벤트 유의사항" /></div>
    </div>
    <%'// 101393 마일리지이벤트(신청) %>
