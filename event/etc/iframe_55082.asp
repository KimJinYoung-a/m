...
//	if (isiOS) {
//		top.location.href='tenwishapp://http//m.10x10.co.kr/apps/appcom/wish/webview/event/eventmain.asp?eventid=55084';
//	} else {
					...
					<div class="swiper-container">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								<!--<a href="/category/category_itemPrd.asp?itemid=<%= dateitemval(left(currenttime,10)) %>" target="_top">-->
