...
%>
<script src="/apps/appcom/wish/web2014/lib/js/shoppingbag_script.js"></script>
<script src="/apps/appcom/wish/web2014/lib/js/sortable.js"></script>
<script>
$(function(){
	/* List with handle */
	...
	<div class="wishFolderV16">
		...
		<div class="edit">
			...
			<div class="list listA">
				...
				<form name="frmS" method="post" action="/apps/appcom/wish/web2014/my10x10/myfavorite_folderProc.asp" target="wishproc" style="margin:0px;">
