...
Function callsearchitemtojson(SearchText,knum)
	...
	Set obj("search"&knum+1) = jsArray()
		...
		obj("klink"&knum+1) = "/search/search_result2020.asp?keyword="& SearchText &"&gaparam=trend_keyword"&chkiif(knum+1=1,"a","b")&"_0"
	'//json 생성
	For i=0 To oDoc.FResultCount-1
		
			kgubun		= knum
			itemurl		= "/category/category_itemPrd.asp?itemid="& oDoc.FItemList(i).FItemID & "&gaparam=trend_keyword"& chkiif(kgubun+1=1,"a","b")&"_"&i+1
