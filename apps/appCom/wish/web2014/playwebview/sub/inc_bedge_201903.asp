...
<%
'####################################################
' Description : 띵 배지 3월 (수작업)
' History : 2019-03-08 최종원
'####################################################
dim oItem
...
eventStartDate = Cdate("2019-03-11")
evnetEndDate = Cdate("2019-03-17")
presentDay = #03/17/2019 23:59:59#
...
<article class="playDetailV16 thingthing">
	<div class="hgroup">
		<div>
			...
			<h2 style="margin-bottom:0.3rem;">다시 돌아가고<br>싶은 때가 있나요?</h2>
		</div>
	</div>			
	<div class="badge-detail">
		<div id="thingRolling" class="swiperFull">
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide"><a href="/category/category_itemPrd.asp?itemid=2259543" onclick="TnGotoProduct('2259543');return false;"><img src="//webimage.10x10.co.kr/fixevent/play/badge/img_badge_201903_1.jpg" alt=""></a></div>
					<div class="swiper-slide"><a href="/category/category_itemPrd.asp?itemid=2259543" onclick="TnGotoProduct('2259543');return false;"></a><img src="//webimage.10x10.co.kr/fixevent/play/badge/img_badge_201903_2.jpg" alt=""></a></div>
					<div class="swiper-slide"><a href="/category/category_itemPrd.asp?itemid=2259543" onclick="TnGotoProduct('2259543');return false;"></a><img src="//webimage.10x10.co.kr/fixevent/play/badge/img_badge_201903_3.jpg" alt=""></a></div>
				</div>
				<div class="paginationDot"></div>
			</div>
		</div>
		<div class="itemDesc" style="background-color:#7bddb2;">
		<% if now() <= presentDay then %>
			<p>새로운 일들이 시작되는 요즘<br>문득 예전이 그리워질 때가 있나요?<br>10년 전, 아니 바로 어제라도<br>다시 돌아가고 싶은 때가 있다면<br>언제인가요?</p>
		<% else %>
			<p>돌아가고 싶은 소중한 시간을<br>공유해 주셔서 감사합니다.<br>평범한 것 같은 오늘도<br>빛나는 시간으로 기억되길 바라요.<br>다음 달에도 재미있는 주제로 함께<br>이야기하고 띵배지도 받으세요!</p>
		<% end if %>
			<div class="btnGet">
				<a href="/category/category_itemPrd.asp?itemid=2259543" onclick="TnGotoProduct('2259543');return false;">배지 구매하러가기</a>
			</div>
		</div>
		...
		<% if now() <= presentDay then %>
			<div class="desc">
				<p class="msg" style="color:#7bddb2;">돌아가고 싶은 소중한 시간을<br>적어주신 분들 중 30분에게<br>3월의 THING배지.시계를 드립니다.<br>(12자 이내로 짧게 적어주세요!)</p>
				<p class="date">응모기간 : 2019.3.11 ~ 3.17 <span>|</span> 발표 : 3.18</p>
			</div>
			<div class="form">
				...
				<input type="hidden" name="spoint"/>						
					...
					<legend class="hidden">코멘트 등록</legend>
						<input type="text" maxlength="12" id="txtcomm" onClick="jsCheckLimit();" name="txtcomm" title="코멘트 등록" placeholder="예) 대학교1학년개강날" style="border-color:#7bddb2;" />
						<input type="button" onclick="jsSubmitComment(document.frmcom);return false;" value="등록하기" style="background-color:#7bddb2; color:#fff; margin-top:0.75rem;" />
					</fieldset>								
				</form>		
		...
		<div class="other">
			<h3>나, 다시 돌아간다면?</h3>
			<ul>
				<li><span style="border-color:#7bddb2; color:#7bddb2;">내가 쉽게 써버린 어제</span></li>
				<li><span style="border-color:#7bddb2; color:#7bddb2;">초등학교수업끝나고놀때</span></li>
				<li><span style="border-color:#7bddb2; color:#7bddb2;">핸드폰떨어뜨리기30초전</span></li>
				<li><span style="border-color:#7bddb2; color:#7bddb2;">다시, 20살</span></li>
				<li><span style="border-color:#7bddb2; color:#7bddb2;">짝사랑집에초대된날</span></li>
				<li><span style="border-color:#7bddb2; color:#7bddb2;">할머니와 시장가던날</span></li>
			</ul>
		</div>
		<% end if %>						
		</div>
		...
		<div class="listComment" id="comment">
			...
			<ul>
				...
				<li>
					<span><em style="color:#7bddb2;"><%=ReplaceBracket(db2html(arrCList(1,intCLoop)))%></em>
