	...
	<div class="cont">
		<div class="detail">
			...
			<div class="itemDesc" style="background-color:#<%=vBGColor%>;">
				...
				<% If vCa42Item <> "" Then %>
				<div class="btnGet">
					<a href="javascript:fnAPPpopupProduct_URL('http://m.10x10.co.kr/apps/appCom/wish/web2014/category/category_itemPrd.asp?itemid=<%=vCa42Item %>&gaparam=playing_<%=vCate%>_<%=vDIdx%>');">뱃지 구매하러가기</a>
				</div>
				<% End If %>
			</div>
		...
		<div class="bnr">
			<a href="" onClick="jsPlayingOpenLinkPopup('<%=fnPlayImageSelect(vImageList,vCate,"22","l")%>'); return false;" alt="" /><img src="<%=fnPlayImageSelect(vImageList,vCate,"22","i")%>" alt="" /></a>
		</div>
		<% End If %>
