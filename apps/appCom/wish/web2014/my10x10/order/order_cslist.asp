		...
		<div class="returnWrap">
            ...
            <% if mycslist.FResultCount > 0 Then %>
                <ul class="myOdrList">
                    <% for i = 0 to (mycslist.FResultCount - 1) %>
                        <li>
                            <a href="/apps/appCom/wish/web2014/my10x10/order/order_csdetail.asp?CsAsID=<%=mycslist.FItemList(i).Fid%>">
                                <div class="odrInfo">
            ...
            <% Else %>
                <div class="nodata-list">
                    ...
                    <a href="" onclick="fnAPPpopupBrowserURL('내가 신청한 서비스','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/order/order_cslist.asp','right','','sc'); return false;" class="btn-counsel">1:1 상담하기</a>
                </div>
            <% End If %>
		</div>
	</div>
