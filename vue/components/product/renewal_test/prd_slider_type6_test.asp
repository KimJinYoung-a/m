...
<%
'####################################################
' Description : 상품 슬라이더 type5 테스트 페이지
' History : 2020-10-15 이전도 생성
'####################################################
%>
...
<!-- Product JS -->
<script src="../prd_img_svg.js?v=1.0"></script>
<script src="../../common/wish.js?v=1.0"></script>
<script src="../../common/functions/item_mixins.js?v=1.0"></script>
<script src="../../common/functions/common.js?v=1.0"></script>
<!-- //Product JS -->

<!-- 핵심 JS -->
<script src="../prd_slider_type6.js?v=1.0"></script>
<script src="./store_prd_slider_type6_test.js?v=1.0"></script>
<!-- //핵심 JS -->
		...
		template: `
			<div>
			    <Product-Slider-Type6
                    :slider_id="'test_slider'" :products="items"
                ></Product-Slider-Type6>
			</div>
		`,
		computed : {
