		...
		<div class="floatingBar boxMdl cartIn <% If oItem.Prd.IsSoldOut Then %><% Else %>optIs<% End If %>">
			<div class="inner">
				<div class="btnWrap">
					...
					<% Else %>
						<p class="btn01 btnCart"><a href="javascript:TnAddShoppingBag(true);" class="btw">장바구니<em id="lyrCartCnt" class="newIco tenRed" <%=chkIIF(GetBetweenCartCount>0,"","style=""display:none;""")%>><%=GetBetweenCartCount()%></em></a></p>
