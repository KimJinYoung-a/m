...
<div class="inner10">
	<ul class="myWishList wishCollectList">
		<li class="subTit">
			...
			<p><a href="/my10x10/myWish/myWish.asp?ucid=<%=Server.UrlEncode(tenEnc(vUserId))%>&vlg=flist">폴더 리스트 보기</a></p>
		</li>
		<% If oDoc.FResultCount>0 Then %>
			<% For i=0 To oDoc.FResultCount-1 %>
				<li value="<%=oDoc.FWishPrdList(i).FRectItemId%>">
					<a href="/category/category_itemprd.asp?itemid=<%=oDoc.FWishPrdList(i).FRectItemId%>&gaparam=<%=CHKIIF(isViewingChk,"wishlist","wishlist_a")%>">
