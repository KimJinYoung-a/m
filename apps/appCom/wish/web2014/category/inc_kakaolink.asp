...
<script>
	...
	Kakao.Link.createTalkLinkButton({
	  ...
	  appButton: {
		...
		execParams :{
			android : {"url":"http://m.10x10.co.kr/apps/appCom/wish/web2014/category/category_itemprd.asp?itemid=<%=itemid%>"},
			iphone : {"url":"http://m.10x10.co.kr/apps/appCom/wish/web2014/category/category_itemprd.asp?itemid=<%=itemid%>"}
		}
      },
	  installTalk : true
	});
