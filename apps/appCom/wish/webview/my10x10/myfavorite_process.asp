	...
	If Now() > #09/22/2014 00:00:00# AND Now() < #10/01/2014 00:00:00# Then
		IF isArray(arrList) THEN
			For intLoop = 0 To UBound(arrList,2)
				If trim(arrList(1,intLoop)) = "담고받고즐기고!" AND CStr(arrList(0,intLoop)) = CStr(fidx) Then
					vWishEventOX = "o"
				End If
				If trim(arrList(1,intLoop)) = "담고받고즐기고!" AND CStr(arrList(0,intLoop)) = CStr(oldfidx) AND mode="Change" Then
					vWishEventOX = "c"
				End If
			Next
		End If
