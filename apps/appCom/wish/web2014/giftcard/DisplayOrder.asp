			...
			<div class="content" id="contentArea">
				...
				<!-- // 주문 실패 -->
					...
					<div class="btnGroupV15a" style="padding:0 1rem;">
						<div class="button btB1 btRed cWh1 w100p"><a href="<%=M_SSLUrl%>/apps/appCom/wish/web2014/giftcard/">다시 주문하기</a></div>
					</div>
				<% else %>
				<!-- // 주문 성공 -->
					<div class="description">
						<span><img src="http://fiximage.10x10.co.kr/m/2016/giftcard/img_giftcard.png" alt="" /></span>
						<p><b><%=chkIIF(myorder.FOneItem.Faccountdiv="7","정상적으로 주문되었습니다.","정상적으로 발송되었습니다.")%></b></p>
								...
								Else
									...
									Else
										if Right(CStr(myorder.FOneItem.FdesignId),2) > 46 then
											vImg = "http://fiximage.10x10.co.kr/web2018/giftcard/img_giftcard_type_" & Right(CStr(myorder.FOneItem.FdesignId),2) & ".png"
										Else
					...
					<% end if %>
					<div class="btnGroupV15a" style="padding:0 1rem;">
						<div class="button btB1 btRed cWh1 w100p"><a href="#" onclick="fnAPPpopupBrowserURL('마이텐바이텐','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/giftcard/giftCardList.asp');return false;">주문확인 하기</a></div>
						<div class="button btB1 btRedBdr cWh1 w100p"><a href="<%=M_SSLUrl%>/apps/appCom/wish/web2014/giftcard/">추가 선물하기</a></div>
					</div>
				<% end if %>
				</div>
			</div>
