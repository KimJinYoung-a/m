...
<%
'#######################################################
'	Description : 나의 회원등급 정보 (Native Popup)
...
$(function(){
	...
	$('.mFRIENDS .grTxtV16a').text('FRIENDS');
...
function fnGotoVIPLounge() {
	fnAPPpopupBrowserURL("VIP LOUNGE","<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/viplounge.asp");
}
</script>
</head>
<body>
<div id="content" class="content">
	<!-- content area -->
	<div class="content" style="background-color:#e7eaea;">
		<div class="gradeBenefitWrapV16a" style="position:static;">
				...
				<div class="gradeListV16a">
					<dl class="showHideV16a mVVIP">
						...
						<dd class="bxWt1V16a infoUnitV16a tglContV16a">
							...
							<div class="btnAreaV16a"><!-- for dev msg : mVVIP/mVIPGOLD/mVIPSILVER 등급 회원에게만 노출됩니다. css로 적용되게 해두었습니다. -->
