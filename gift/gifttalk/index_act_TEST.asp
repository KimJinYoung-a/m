...
<%
Dim vUserID
Dim vCurrPage, vSelectUserID, i, j, vSort, UserProfileImg, cTalkComm, PageSize
dim vtmpitemid, vtmpImageBasic, vtmpidx, vtmpTalkIdx, vtmpSelectoxab, vtmpgood, vtmpTalkIdx_P
...
<% Else %>
	...
	%>
		...
		if vtmpitemid<>"" and (CStr(vtmpTalkIdx_P)=CStr(cTalk.FItemList(i).FTalkIdx))  then
		%>
