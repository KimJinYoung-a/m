...
<%
'####################################################
' Description : 클리어런스 상품 상세 (공통)
' History : 2020-10-23 이종화
'####################################################
%>
...
<%
	...
	if( isNull(disp) or len(trim(disp)) = 0 ) then
        disp = "0"
    end if
%>
<style>[v-cloak] { display: none; }</style>
<script>
    const disp = Number('<%=disp%>'); // 카테고리 코드
</script>
...
<script src="/vue/components/common/functions/modal_mixins.js?v=1.64"></script>
...
<%'!-- store component--%>
<script src="/vue/list/clearance/detail_store.js?v=1.0"></script>
<script src="/vue/list/clearance/clearance_filter.js?v=1.4"></script>
<%'!-- store component--%>

<%'!-- main component--%>
<script src="/vue/list/clearance/clearance_detail.js?v=1.8"></script>
<%'!-- main component--%>
