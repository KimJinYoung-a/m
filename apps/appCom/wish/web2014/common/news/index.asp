	...
	<div id="content" class="content">
		...
		<div  class="news-list">
            ...
            <ul>
                ...
                <li>
                    <a href="javascript:fnAPPpopupBrowserURL('공지사항','<%=wwwUrl%>/apps/appCom/wish/web2014/common/news/news_view.asp?type=<%=ntype%>&idx=<%= oBoardNotice.FItemList(ibb).Fid %>','right','','sc');">
                        <p><%= chrbyte(oBoardNotice.FItemList(ibb).Ftitle,60,"Y") %></p>
