...
<title>10x10: 상품 상세 보기</title>
<script type="text/javascript">
$(function(){
	fnAPPchangPopCaption('상품 <%=viewnum%>');
	/* slide content */
...
//alert(itemid);
	location.href="/apps/appCom/wish/web2014/deal/deal_view.asp?itemid="+itemid+"&viewnum="+viewnum+"&dealitemid=<%=dealitemid%>";
}
// 쿠폰 받기
			...
			<div class="slide">
				...
				<section class="items item-detail">
					...
					<div class="desc">
						...
						<span class="brand"><a href="#" onclick="fnAPPpopupBrand('<%= oItem.Prd.FMakerid %>'); return false;"><%= UCase(oItem.Prd.FBrandName) %></a></span>
				...
				<div class="item-etc-info">
					<ul>
						...
						<li><span class="icon icon-shipping"></span>업체무료배송 <a href="#" onclick="fnAPPpopupBrand('<%= oItem.Prd.FMakerid %>'); return false;">배송비 절약 상품</a></li>
						<% end if %>
