...
If vCardNo = "" Then
	Response.Write "<script>alert('잘못된 카드번호 입니다.');location.href='/apps/appcom/wish/web2014/offshop/point/cardregister.asp';</script>"
	Response.End
End If
