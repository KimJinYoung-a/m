...
Else
	...
	If countryCode = "KR" Then
		response.write "location.replace('/my10x10/MyAddress/MyAddressList.asp');" & vbCrLf
		'response.write "opener.location.reload();" & vbCrLf
	Else
		response.write "location.replace('/my10x10/MyAddress/SeaAddressList.asp');" & vbCrLf
		'response.write "opener.location.reload();" & vbCrLf
	End IF
