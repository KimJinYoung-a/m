...
function FIDAjaxPopFollower(uid, tid)
{
	...
	sUrlpopFollower = "/apps/appcom/wish/web2014/my10x10/mywish/FFInsDelProcessAjax.asp?Fuid="+uid+"&Tuid="+tid+"&gubun="+sgubunpopFollower;
			...
			%>
				<li>
					<div class="wishProfile">
						<a href="" onclick="fnAPPpopupBrowserURL('위시 프로필','<%=wwwUrl%>/apps/appcom/wish/web2014/my10x10/myWish/myWish.asp?ucid=<%=Server.UrlEncode(tenEnc(oDoc.FWishPrdList(i).Fuserid))%>');return false;"><%' 클릭시 프로필 페이지로 이동 %>
