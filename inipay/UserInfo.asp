...
if (userid<>"") and (userid="dlwjseh" or userid="corpse2" or ((Not IsKBRdSite) and (Not IsRsvSiteOrder) and (Not IsPresentOrder))) then
...
If isRentalCheck Then
	If oshoppingbag.FShoppingBagItemCount = 1 Then
		response.redirect "/inipay/userinfoRental.asp"
		response.end
	Else
		If oshoppingbag.FShoppingBagItemCount > 1 Then
                    ...
                    <div class="cartV16a">
                        ...
                        <div class="orderInfoV16a">
                            ...
                            <div class="cartGrpV16a delivery-index">
                                <div class="bxLGy2V16a grpTitV16a">
                                    <h2>배송방법 선택</h2>
                                    <p class="rt"><button type="button" class="btnV16a btnLGryV16a" onclick="fnOpenModal('/category/popQuickGuide.asp'); return false;" >바로배송 안내</button></p>
                                </div>
                                <div class="bxWt1V16a infoUnitV16a">
                                        ...
                                        <dd>
                                            <p>
                                                ...
                                                <span class="flexAreaV16a vTop lPad0-5r">
                                                    <a class="btnV16a btnLGryV16a" style="width:100%;" href="https://unipass.customs.go.kr/csp/persIndex.do" target="_blank">발급안내</a>
                                                </span>
                                            </p>
                                        </dd>
                                    </dl>
                            ...
                            <div class="cartGrpV16a" id="SaleInfoDiv"  <%=CHKIIF(Trim(userid)="","style=""display:none;""","")%>>
                                <div class="bxLGy2V16a grpTitV16a">
                                    <h2>할인 정보</h2>
                                </div>
                                <div class="bxWt1V16a infoUnitV16a">
                                            ...
                                            <dd class="fs1-2r">
                                                ...
                                                <% if (vaildItemcouponCount<1) then %>
                                                    <p class="cMGy1V16a">적용 가능한 상품쿠폰이 없습니다.</p>
                                                        ...
                                                        document.getElementById('frmorder').itemcouponOrsailcoupon[0].checked=true;
                                                        <% End If %>
                                                        document.getElementById('frmorder').itemcouponOrsailcoupon[1].disabled=true;
                                                    </script>
                                                <% end if %>
                                            </dd>
                                        </dl>
                            ...
                            <div class="cartGrpV16a freebiesV16a diarystoryGift">
                                ...
                                <div class="bxWt1V16a freebieSltV16a">
                                    <div class="bxWt1V16a">2021.09.01 AM 11:00 ~ 12.31<!--※ 선물 증정은 재고 소진 시 조기 종료됩니다//--></div>
                                    <%
                                    for i=0 to oDiaryOpenGift.FResultCount-1
                                    ...
                                    <div>
                                        ...
                                        <div id="paymethod_desc1_190" class="bxLGy1V16a cartNotiV16a" style="display:none;">
                                            <ul>
                                                ...
                                                <!--<br><br>
                                                <a target="_blank" href="/event/eventmain.asp?eventid=85155">텐바이텐 비바G 하나 체크카드 발급안내 &gt;</a>-->
                                            </ul>
                                        </div>
                                        <% '// 하나10x10 관련 안내문구 추가 %>
                                        <!-- 무통장 선택시에만 노출 -->
                        ...
                        <% If Trim(userid)="" Then %>
                            ...
                            <div class="bxWt1V16a payMethodV16a cartNotiV21">
                                ...
                                <div class="btnAreaV16a tMar1r"><button type="button" class="btnV16a btnRed2V16a" onclick="PayNext(document.getElementById('frmorder'),'<%= iErrMsg %>'); return false;">결제하기</button></div>
                            </div>
                        <% else %>
                            <div class="bxWt1V16a payMethodV16a cartNotiV21">
                                <div class="bMar20">
