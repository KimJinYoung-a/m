		...
		<input type="hidden" name="flag" value="fd">
			...
			<div class="qnaWrite inner10">
				...
				<div class="overHidden tMar10">
					...
					<p class="ftLt lPad10"><input type="email" class="w100p" name="usermail" value="<% = usermail %>" maxlength="128" /></p>
				</div>
...
<!-- 					<p class="ftLt lPad10"><input type="tel" class="w100p" name="userhp" value="<% = userhp %>" maxlength="128" /></p> -->
<!-- 				</div> -->
				<div class="tMar10">
