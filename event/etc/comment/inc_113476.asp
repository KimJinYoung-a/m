...
snpImg		= Server.URLEncode("http://webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_kakao.jpg")
...
Dim kakaoimage : kakaoimage = "http://webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_kakao.jpg"
...
.box-tape h2 .tit {position:absolute; left:50%; top:17%; width:63.33vw; margin-left:-32vw; opacity:0; transform:translateY(5%); transition:all 1s;}
.box-tape h2 .txt {position:absolute; left:50%; top:29%; width:64.40vw; margin-left:-32vw; opacity:0; transform:translateY(5%); transition:all 1s .3s;}
.box-tape h2 .txt.on,
.box-tape h2 .tit.on {opacity:1; transform:translateY(0);}
.box-tape .section-01 {position:relative;}
.box-tape .section-01 .txt01 {position:absolute; left:50%; top:15%; width:53.33vw; margin-left:-26.5vw;}
.box-tape .section-01 .txt02 {position:absolute; left:50%; top:50%; width:43.07vw; margin-left:-21.5vw;}
.box-tape .section-01 .txt03 {position:absolute; left:50%; top:73%; width:75.33vw; margin-left:-37.5vw;}
.box-tape .btn-detail {position:relative;}
.box-tape .btn-detail .icon {width:0.93rem; height:0.59rem; position:absolute; left:50%; top:63%; margin-left:5.3rem;}
.box-tape .noti {display:none;}
.box-tape .noti.on {display:block;}
.box-tape .icon.on {transform: rotate(180deg);}
...
.box-tape .pagingV15a span.arrow {display:inline-block; position:absolute; top:50%; transform:translateY(-50%); width:5.87vw; height:2.31rem; padding:0;}
...
.box-tape .pagingV15a span.arrow.prevBtn a{background-image:url(//webimage.10x10.co.kr/fixevent/event/2021/113476/m/icon_arrow_left.png);}
.box-tape .pagingV15a span.arrow.nextBtn a{background-image:url(//webimage.10x10.co.kr/fixevent/event/2021/113476/m/icon_arrow_right02.png);}
...
.box-tape .pop-container .pop-inner .btn-close {position:absolute; right:2.73rem; top:3.60rem; width:1.73rem; height:1.73rem; background:url(//webimage.10x10.co.kr/fixevent/event/2021/113347/m/icon_close.png) no-repeat 0 0; background-size:100%; text-indent:-9999px;}
.box-tape .pop-container .pop-contents {position:relative;}
.box-tape .pop-container .pop-contents .copy {position:absolute; left:50%; top:25%; transform:translate(-50%,0); overflow:hidden; margin:0 auto; padding:0; border:0; background:transparent; text-align:center; font-size:1.49rem; color:#fff; width:calc(100% - 6.82rem); height:2.98rem; line-height:3rem;}
...
$(function(){
    ...
    // btn more
	$('.mEvt113476 .btn-detail').click(function (e) { 
		$(this).next().toggleClass('on');
        $(this).find('.icon').toggleClass('on');
	});
    //팝업
    /* 팝업 닫기 */
    $('.mEvt113476 .btn-close').click(function(){
...
function fnClosePop(){
    location.href="<%= appUrlPath %>/event/eventmain.asp?eventid=<%= eCode %>&pagereload=ON";
			...
			<div class="mEvt113476 box-tape">
				<h2>
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_main.jpg" alt="텐바이텐 박스테이프 카피 공모전" />
                    <div class="tit"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/tit_num.png" alt="제6회" /></div>
                    <div class="txt"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/tit_main.png" alt="박스테이프 카피 공모전" /></div>
                </h2>
                <div class="section-01">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_sub01.jpg" alt="" />
                    <div class="txt01 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/txt_sub01.png" alt=""></div>
                    <div class="txt02 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_box.png" alt=""></div>
                    <div class="txt03 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/txt_sub02.png" alt=""></div>
                </div>
                <div class="section-02"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_sub02.jpg" alt="" /></div>
				<div class="contest">
					<ul class="tab-nav">
						<li name="info1">주제</li>
						<li name="info2">일정</li>
					...
					<div class="tab-container">
						<div id="info1" class="tab-content"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/txt_tab01.jpg" alt="응모기간 : 8 ~18 / 8 ~ 29" /></div>
						<div id="info2" class="tab-content"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/txt_tab02.jpg" alt="상금" /></div>
						<div id="info3" class="tab-content"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/txt_tab03.jpg" alt="선정방식" /></div>
					</div>
				</div>
                <div>
                    <button type="button" class="btn-detail">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/btn_noti.jpg" alt="유의사항 자세히 보기">
                        <span class="icon"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/icon_arrow_down.png" alt=""></span>
                    </button>
                    <div class="noti"><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_noti.jpg" alt=""></div>
                </div>
                ...
                <input type="hidden" name="spoint"/>
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_sub03.jpg" alt="카피를 작성하고 응모해주세요." />
                    <div class="apply-input">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_input.jpg" alt="" />
                        <input type="text" placeholder="여기에 작성해주세요!" id="txtcomm" name="txtcomm" onClick="jsCheckLimit();" maxlength="18">
                    </div>
                    <div class="apply-area">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_sub04.jpg" alt="응모하기" />
                        <!-- 응모하기 버튼 -->
                        <button type="button" onclick="jsSubmitComment(document.frmcom);return false;" class="btn-apply"></button>
                    </div>
                </form>
                </div>
				...
				<div class="cmt-section">
					<h3><img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_sub06.jpg" alt="참여 카피 리스트" /></h3>
				...
				<div class="box-font">
					<img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/img_font.jpg" alt="제6회 박스테이프 글꼴은?" />
                ...
                <div class="pop-container done">
                    <div class="pop-inner">
                        <div class="pop-contents">
                            <img src="//webimage.10x10.co.kr/fixevent/event/2021/113476/m/pop_done.png" alt="참여완료">
                            <!-- 카피 문구 노출 -->
                            <div class="copy">
                                <%=evtcom_txt%>
                            </div>
