...
eventStartDate  = cdate("2021-12-24")		'이벤트 시작일
eventEndDate 	= cdate("2021-12-31")		'이벤트 종료일

LoginUserid		= getencLoginUserid()

if mktTest then
    currentDate = cdate("2021-12-24")
else
    currentDate = date()
end if
...
.mEvt113327 .section01 .text .txt02{width:23.89rem;position:absolute;left:50%;margin-left:-11.94rem;top:21rem;}
.mEvt113327 .section01 .text .txt03{width:16.43rem;position:absolute;left:50%;margin-left:-8.22rem;top:49rem;}
.mEvt113327 .section01 .text .txt04{width:17.92rem;position:absolute;left:50%;margin-left:-8.96rem;top:55rem;}
.mEvt113327 .section01 .text .line{width:86.7vw;position:absolute;left:50%;margin-left:-43.35vw;top:63rem;}
.mEvt113327 .section01 .text .txt05{width:20.82rem;position:absolute;left:50%;margin-left:-10.41rem;top:68rem;}
.mEvt113327 .section01 .text .txt06{width:18.48rem;position:absolute;left:50%;margin-left:-9.24rem;top:77rem;}
...
/* section02 */
.mEvt113327 .section02{background:#e1432c;}
.mEvt113327 .section02 .user{position:absolute;top:8rem;color:#fff;text-align:center;width:100%;font-size:2rem;font-family:'CoreSansCBold', 'AppleSDGothicNeo-Bold', 'NotoSansKRBold';}
.mEvt113327 .section02 .user span{text-decoration: underline;}
.mEvt113327 .section02 .order{position:relative;width:86.7vw;height:12rem;display:block;margin-left:6.65vw;background:url(//webimage.10x10.co.kr/fixevent/event/2021/116209/m/order.png?v=2)no-repeat 0 0;background-size:100%;}
.mEvt113327 .section02 .order.on{background:url(//webimage.10x10.co.kr/fixevent/event/2021/116209/m/order_on.png)no-repeat 0 0;background-size:100%;}
...
.mEvt113327 .section02 .order .order_info02{position:absolute;top:4rem;width:100%;color:#111;}
...
.mEvt113327 .section02 .order_one .user{position:absolute;top:8rem;color:#fff;text-align:center;width:100%;font-size:2rem;font-family:'CoreSansCBold', 'AppleSDGothicNeo-Bold', 'NotoSansKRBold';}
...
.mEvt113327 .popup .pop{position:fixed;top:20rem;width:86.7vw;left:50%;margin-left:-43.35vw;z-index:160;}
...
function doAction() {
    ...
    <% If IsUserLoginOK() Then %>
        ...
        $.ajax({
            type: "POST",
            url:"/apps/appcom/wish/web2014/event/etc/doeventsubscript/doEventSubscript116209.asp",
            data: {
                mode: 'add',
    ...
    return false;
            ...
            <input type="hidden" id="orderprice">
				<section class="section section01">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/top.jpg?v=2" alt="">
                    <div class="coin">
                    ...
                    <div class="text">
                        <p class="txt01"><img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/txt01.png" alt=""></p>
                        <p class="txt02 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/txt02.png" alt=""></p>
                        <p class="txt03 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/txt03.png?v=2" alt=""></p>
                        <p class="txt04 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/txt04.png" alt=""></p>
                        <p class="line animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/line.png" alt=""></p>
                        <p class="txt05 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/txt05.png" alt=""></p>
                        <p class="txt06 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/txt06.png" alt=""></p>
                    </div>
                <section class="section section02">
                <% if LoginUserid<>"" then %>
                    <% if myorder.FResultCount > 0 then%>
                    <div class="login">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/receipt.jpg" alt="">
                        ...
                        <% next %>
                        <a href="" onclick="doAction();return false;" class="submit"><img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/submit.jpg" alt=""></a>
                    </div>
                    <% else %>
                    <div class="order_one">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/order01.jpg" alt="">
                        <p class="user"><span><%=LoginUserid%></span>님의</p>
                    </div>
                    <% end if %>
                <% else %>
                    <div class="logout">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/login.jpg" alt="">
                        <a href="" class="go_login" onclick="jsSubmitlogin();return false;"></a>
                    </div>
                <% end if %>
                </section>
                <section class="section section03">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/notice.jpg" alt="">
                </section>
                <section class="section section4">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/alert.jpg" alt="">
                    <a href="" class="go_alert" onclick="doAlarm();return false;"></a>
                </section>
                <div class="popup">
                    <div class="bg_dim"></div>
                    <div class="pop">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/popup.png" alt="">
                        <div class="final">
                ...
                <div class="popup popup02">
                    <div class="bg_dim"></div>
                    <div class="pop win">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/116209/m/popup_on.png" alt="당첨자 발표">
                        ...
                        <a href="" onclick="fnAPPpopupBrowserURL('기획전','https://m.10x10.co.kr/shoppingtoday/shoppingchance_allevent.asp?scTgb=mktevt'); return false;" class="mApp go_link"></a>
                    </div>
                </div>
            </div>
<%  set myorder = nothing %>
