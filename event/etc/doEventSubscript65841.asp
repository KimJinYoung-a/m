		...
		Case "list"
			...
			If Not(rsget.bof Or rsget.eof) Then
				...
				Do Until rsget.eof
					...
					Else
						If rsget("userchk") >= 1 Then
							vListContents = vListContents & "						<button type='button' id='btn"&rsget("evtcom_idx")&"' class='on' style='outline:none;' onclick='goVoteChk("""&rsget("evtcom_idx")&""", """&ReceiveDate&""","""&vUserVoteChk&""");return false;'>투표하기</button> "
						Else
