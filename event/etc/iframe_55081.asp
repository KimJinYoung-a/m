...
<%
 Dim evttotalCnt, vQuery

	vQuery = " SELECT count(*) as cnt From db_event.dbo.tbl_event_subscript Where evt_code='55502' "
...
<title>생활감성채널, 텐바이텐 > 이벤트 > [13주년] 즐겨라,텐바이텐_ 쌓여라! 스페셜혜택</title>
<style type="text/css">
.mEvt55081 {}
.mEvt55081 img {vertical-align:top; width:100%;}
		...
		<div class="anniversary13th">
				...
				<ul>
					<li class="appBenefit">
						...
						<div>
							...
							<img src="http://webimage.10x10.co.kr/eventIMG/2014/55081/img_benefit00.png" alt="선착순 20,000명 500 마일리지 지급" />
						</div>
						<% if evttotalCnt>20000 then %><p class="finish"></p><% end if %>
					</li>
					<li>
						<h4><img src="http://webimage.10x10.co.kr/eventIMG/2014/55081/subtit_benefit01.png" alt="5만원 이상 구매시" /></h4>
						<% if isApp=1 then %>
							<p><a href="" onClick="fnAPPpopupProduct('1135428');"><img src="http://webimage.10x10.co.kr/eventIMG/2014/55081/5_cup_off_m.gif" alt="13주년 머그컵 1개(색상 랜덤)" /></a></p>
						<% else %>
							<p><a href="<%=appUrlPath%>/category/category_itemPrd.asp?itemid=1135428"><img src="http://webimage.10x10.co.kr/eventIMG/2014/55081/5_cup_off_m.gif" alt="13주년 머그컵 1개(색상 랜덤)" /></a></p>
						<% end if %>
					...
					<li>
						...
						<% if isApp=1 then %>
							<p><a href="" onClick="fnAPPpopupProduct('1135428');"><img src="http://webimage.10x10.co.kr/eventIMG/2014/55081/10_cup_off_m.gif" alt="13주년 머그컵 2개(색상 랜덤)" /></a></p>
						<% else %>
							<p><a href="<%=appUrlPath%>/category/category_itemPrd.asp?itemid=1135428"><img src="http://webimage.10x10.co.kr/eventIMG/2014/55081/10_cup_off_m.gif" alt="13주년 머그컵 2개(색상 랜덤)" /></a></p>
						<% end if %>
					...
					<li>
						...
						<% if isApp=1 then %>
							<p><a href="" onClick="fnAPPpopupProduct('1135428');"><img src="http://webimage.10x10.co.kr/eventIMG/2014/55081/20_cup_m_off.gif" alt="13주년 머그컵 4개" /></a></p>
						<% else %>
							<p><a href="<%=appUrlPath%>/category/category_itemPrd.asp?itemid=1135428"><img src="http://webimage.10x10.co.kr/eventIMG/2014/55081/20_cup_off_m.gif" alt="13주년 머그컵 4개" /></a></p>
						<% end if %>
			...
			<div class="mileageCheck">
				...
				<div class="notiCt">
					...
					<p class="mileageshopBtn"><a href="/my10x10/mileage_shop.asp" target="_top"><img src="http://webimage.10x10.co.kr/eventIMG/2014/55081/btn_mileage.png" alt="마일리지샵 구경가기" /></a></p>
				</div>
