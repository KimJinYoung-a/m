...
<div class="heightGrid bgGry">
	<div class="container popWin bgGry">
		<!-- content area -->
		<div class="content certPhone" id="contentArea">
			<div class="inner5 tPad20">
				<div class="box1">
					...
					<div class="enterNum">
						<input type="number" name="crtfyNo" id="crtfyNo" pattern="[0-9]*" maxlength="6" placeholder="인증번호 입력" />
						<span class="button btB2 btRed cWh1 w25p"><a href="" onclick="refnConfirmSMS(); return false;">확인</a></span>
					</div>
				</div>
