...
dim eCode, vUserID, cMil, vMileValue, vMileArr
	...
	If Now() > #11/06/2018 00:00:00# AND Now() < #11/12/2018 00:00:00# Then
		vMileValue = 200
	Else
		vMileValue = 100
	End If
...
%>
<style type="text/css">
.double-mileage {background-color:#df8734;}
...
<div class="mEvt88837 double-mileage">
    <h2><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/m/tit_double_mileage.png" alt="가장 기다렸던 이벤트! 11.6 ~ 11.11 단 6일간 상품 후기를 완성하면 마일리지 2배 적립!" /></h2>
    <p><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/m/txt_mileage.png" alt="상품후기를 쓰면 200마일리지, 포토후기 작성시 추가 200마일리지 포함 400마일리지 지급" /></p>
    <%' 예상 마일리지 확인하기 %>
    <div class="my-mileage">
        ...
        <div class="btn-group">
            <% If IsUserLoginOK Then %>
                <%' 로그인 후 %>
                <% If isApp="1" Then %>                            
                    <a href="" onclick="fnAPPpopupBrowserURL('상품후기','<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/goodsusing.asp'); return false;"><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/m/btn_review.png" alt="상품후기 쓰러 가기" /></a>
                <% Else %>
                    <a href="/my10x10/goodsusing.asp"><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/m/btn_review.png" alt="상품후기 쓰러 가기" /></a>
                <% End If %>
            <% Else %>
                <%' 로그인 전 %>
                <a href="" onClick="jsSubmitComment(); return false;"><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/m/btn_login.png" alt="로그인하기" /></a>
            <% End If %>
        </div>
    </div>
    <!--// 예상 마일리지 확인하기 -->
    <div class="noti">
        <h3><img src="http://webimage.10x10.co.kr/fixevent/event/2018/90279/m/tit_noti.png" alt="이벤트 유의사항" /></h3>
        <ul>
            ...
            <li>포토후기의 추가지급 마일리지(200point)는 11월 13일(화) 일괄지급 될 예정입니다.</li>
        </ul>
    </div>
</div>
<%'// 더블 마일리지 %>		
