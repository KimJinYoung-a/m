	...
	ElseIf result="2" Then
		If renloop = 300 Then
			...
			If secret_cnt2 < 2 Then	'### 2명만
				...
				aa = "<img src='http://webimage.10x10.co.kr/eventIMG/2013/46483/46483_gift03.png' alt='시크릿선물' style='width:100%;' /> <p class='okBtn'><a href='/event/eventmain.asp?eventid=46483' target='_top'><img src='http://webimage.10x10.co.kr/eventIMG/2013/44416/44416_btn02.png' alt='확인' style='width:100%;' /></a></p>"
			else
				aa = "<img src='http://webimage.10x10.co.kr/eventIMG/2013/46483/46483_gift01.png' alt='3000원 할인쿠폰' style='width:100%;' /> <p class='okBtn'><a href='/event/eventmain.asp?eventid=46483' target='_top'><img src='http://webimage.10x10.co.kr/eventIMG/2013/44416/44416_btn02.png' alt='확인' style='width:100%;' /></a></p>"
				sqlStr = "insert into db_user.dbo.tbl_user_coupon " &_
						...
						" select '475','" & loginid & "','2','3000','뿔난 애인을 달래주세요!(3,000원 할인쿠폰)','20000','2013-11-04 00:00:00' ,'2013-11-12 23:59:59','',0,'system'"
	...
	ElseIf result="4" Then
		If renloop = 300 Then
			...
			If secret_cnt4 < 3 Then	'### 3명만
				...
				aa = "<img src='http://webimage.10x10.co.kr/eventIMG/2013/46483/46483_gift02.png' alt='무료배송쿠폰' style='width:100%;' /> <p class='okBtn'><a href='/event/eventmain.asp?eventid=46483' target='_top'><img src='http://webimage.10x10.co.kr/eventIMG/2013/44416/44416_btn02.png' alt='확인' style='width:100%;' /></a></p>"

				sqlStr = "insert into db_user.dbo.tbl_user_coupon " &_
						" (masteridx,userid,coupontype,couponvalue,couponname,minbuyprice,startdate,expiredate,targetitemlist,couponmeaipprice,reguserid) " &_
						" select '476','" & loginid & "','3','2000','뿔난 애인을 달래주세요!(무료배송쿠폰)','20000','2013-11-04 00:00:00' ,'2013-11-12 23:59:59','',0,'system'"
