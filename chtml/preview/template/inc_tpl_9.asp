							...
							<div class="swiper-wrapper">
								...
								%>
											<li>
												...
												<% else %>
												<p><img src="<%=subNodes.getElementsByTagName("itemImg200").item(0).text%>" alt="<%=replace(subNodes.getElementsByTagName("itemname").item(0).text,"""","")%>" style="width:100%;" /></p>
												<% end if %>
								...
								<%
											'그룹구분
											if (i mod 9)=0 and i<cSub.length then
