...
<%
	...
	evt_option1 = requestCheckVar(Request("itemid"),8)		'이벤트 코드
	...
	If IsNumeric(evt_option1) Then
		...
		response.write "<script>" &_
						...
						"top.location.href='/event/eventmain.asp?eventid=49170';" &_
						"</script>"
			...
			'키트 당첨
				...
				response.write "<script>" &_
					"alert('오늘의 응모회수는 "& 2-cnt &"회 남았습니다.\n당첨자 발표일은 2월 18일 입니다.');" &_
					"top.location.href='/event/eventmain.asp?eventid=49170';" &_
					"</script>"
				dbget.close()	:	response.End
		End If
