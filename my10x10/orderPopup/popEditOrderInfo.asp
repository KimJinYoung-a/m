...
if (Not IsWebEditEnabled) then
    response.write "<script>alert('주문/배송정보 수정 가능 상태가 아닙니다. 고객센터로 문의해 주세요.');location.replace('/my10x10/order/myorderdetail.asp?idx="&orderserial&"');</script>"
...
<div class="heightGrid">
	<form name="frmorder" method="post" action="/my10x10/orderPopup/EditOrderInfo_process.asp" onsubmit="return false;">
					...
					<form action="">
						...
						<legend>구매자 정보변경</legend>
							<dl class="infoInput">
								...
								<dd><input type="text" id="[on,off,2,16][주문자]" name="buyname" value="<%= myorder.FOneItem.FBuyname %>" maxlength="16" style="width:100%;" /></dd>
							</dl>
							<dl class="infoInput">
								<dt><label for="email">이메일주소</label></dt>
								<dd><input type="email" id="[on,off,3,100][주문자이메일]" name="buyemail" value="<%= myorder.FOneItem.Fbuyemail %>" maxlength="100" style="width:100%;" /></dd>
							</dl>
							<dl class="infoInput">
								<dt>전화번호</dt>
								<dd>
									<p>
										<span><input type="number" id="[on,on,2,3][주문자전화1]" name="buyphone1" value="<%= SplitValue(myorder.FOneItem.Fbuyphone,"-",0) %>" maxlength="3" title="전화번호 앞자리" class="ct" style="width:100%;" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span style="width:30%;"><input type="number" id="[on,on,3,4][주문자전화2]" name="buyphone2" value="<%= SplitValue(myorder.FOneItem.Fbuyphone,"-",1) %>" maxlength="4" title="전화번호 가운데자리" class="ct" style="width:100%;" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span style="width:30%;"><input type="number" id="[on,on,3,4][주문자전화3]" name="buyphone3" value="<%= SplitValue(myorder.FOneItem.Fbuyphone,"-",2) %>" maxlength="4" title="전화번호 뒷자리" class="ct" style="width:100%;" /></span>
									</p>
								</dd>
							</dl>
							<dl class="infoInput">
								...
								<dd>
									<p>
										<span><input type="number" id="[on,on,2,3][주문자핸드폰1]" name="buyhp1" value="<%= SplitValue(myorder.FOneItem.Fbuyhp,"-",0) %>" maxlength="3" title="휴대전화 앞자리" style="width:100%;" class="ct" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span style="width:30%;"><input type="number" id="[on,on,3,4][주문자핸드폰2]" name="buyhp2" value="<%= SplitValue(myorder.FOneItem.Fbuyhp,"-",1) %>" maxlength="4" title="휴대전화 가운데자리" class="ct" style="width:100%;" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span style="width:30%;"><input type="number" id="[on,on,3,4][주문자핸드폰3]" name="buyhp3" value="<%= SplitValue(myorder.FOneItem.Fbuyhp,"-",2) %>" maxlength="4" title="휴대전화 뒷자리" class="ct" style="width:100%;" /></span>
									</p>
								</dd>
							</dl>
					...
					<legend><%= captionTitle %></legend>
						...
						%>
							<dl class="infoInput">
								...
								<dd><input type="text" id="[on,off,2,16][수령인]" name="reqname" value="<%= myorder.FOneItem.Freqname %>" style="width:100%;" /></dd>
							</dl>
							<dl class="infoInput">
								<dt><label for="receiver">이메일</label></dt>
								<dd><input type="text" id="[on,off,4,100][수령인E-mail]" name="reqemail" value="<%= myorder.FOneItem.FreqEmail %>" style="width:100%;" /></dd>
							</dl>
							<dl class="infoInput">
								<dt>전화번호 (Tel. No)</dt>
								<dd>
									<p>
										<span><input type="number" id="[on,on,2,4][수령인전화1]" name="reqphone1" value="<%=SplitValue(myorder.FOneItem.Freqphone,"-",0) %>" onkeydown="onlyNumber(this,event);" title="전화번호" class="ct" style="width:100%;" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span><input type="number" id="[on,on,2,4][수령인전화1]" name="reqphone2" value="<%=SplitValue(myorder.FOneItem.Freqphone,"-",1) %>" onkeydown="onlyNumber(this,event);" title="전화번호" class="ct" style="width:100%;" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span><input type="number" id="[on,on,2,4][수령인전화1]" name="reqphone3" value="<%=SplitValue(myorder.FOneItem.Freqphone,"-",2) %>" onkeydown="onlyNumber(this,event);" title="전화번호" class="ct" style="width:100%;" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span><input type="number" id="[on,on,2,4][수령인전화1]" name="reqphone4" value="<%=SplitValue(myorder.FOneItem.Freqphone,"-",3) %>" onkeydown="onlyNumber(this,event);" title="전화번호" class="ct" style="width:100%;" /></span>
									</p>
								</dd>
							</dl>
							<dl class="infoInput">
								<dt><label for="receiver">우편번호 (Zip code)</label></dt>
								<dd><input type="text" id="[on,off,3,20][우편번호]" name="emsZipCode" value="<%=myorder.FOneItem.FemsZipCode%>" onkeydown="onlyNumber(this,event);" style="width:100%;" /></dd>
							</dl>
							<dl class="infoInput">
								<dt><label for="receiver">상세주소 (Address)</label></dt>
								<dd><input type="text" id="[on,off,1,100][상세주소 (Address)]" name="txAddr2" value="<%= myorder.FOneItem.Freqaddress %>" style="width:100%;" /></dd>
							</dl>
							<dl class="infoInput">
								<dt><label for="receiver">도시 및 주 (City/State)</label></dt>
								<dd><input type="text" id="[on,off,1,100][도시 및 주 (City/State)]" name="txAddr1" value="<%= myorder.FOneItem.Freqzipaddr %>" style="width:100%;" /></dd>
							</dl>
						...
						%>
							...
							<dl class="infoInput">
								...
								<dd>
									<p>
										<span><input type="number" id="[on,on,2,4][수령인전화1]" name="reqphone1" value="<%=SplitValue(myorder.FOneItem.Freqphone,"-",0) %>" onkeydown="onlyNumber(this,event);" title="전화번호 앞자리" class="ct" style="width:100%;" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span style="width:30%;"><input type="number" id="[on,on,2,4][수령인전화2]" name="reqphone2" value="<%=SplitValue(myorder.FOneItem.Freqphone,"-",1) %>" onkeydown="onlyNumber(this,event);" title="전화번호 가운데자리" class="ct" style="width:100%;" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span style="width:30%;"><input type="number" id="[on,on,2,4][수령인전화3]" name="reqphone3" value="<%=SplitValue(myorder.FOneItem.Freqphone,"-",2) %>" onkeydown="onlyNumber(this,event);" title="전화번호 뒷자리" class="ct" style="width:100%;" /></span>
									</p>
								</dd>
							</dl>
							<dl class="infoInput">
								...
								<dd>
									<p>
										<span><input type="number" name="reqhp1" id="[on,on,2,4][수령인휴대폰1]" value="<%=SplitValue(myorder.FOneItem.Freqhp,"-",0) %>" onkeydown="onlyNumber(this,event);" title="휴대전화 앞자리" style="width:100%;" class="ct" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span style="width:30%;"><input type="number" name="reqhp2" id="[on,on,2,4][수령인휴대폰2]" value="<%=SplitValue(myorder.FOneItem.Freqhp,"-",1) %>" onkeydown="onlyNumber(this,event);" title="휴대전화 가운데자리" class="ct" style="width:100%;" /></span>
										<span>&nbsp;-&nbsp;</span>
										<span style="width:30%;"><input type="number" name="reqhp3" id="[on,on,2,4][수령인휴대폰3]" value="<%=SplitValue(myorder.FOneItem.Freqhp,"-",2) %>" onkeydown="onlyNumber(this,event);"  title="휴대전화 뒷자리" class="ct" style="width:100%;" /></span>
									</p>
								</dd>
							</dl>
							<dl class="infoInput">
						...
						%>
							...
							<% if Not (IsTicketOrder and TicketDlvType="1") then %>
								<dl class="infoInput">
									...
									<dd>
										<p>
											<span style="width:25%;"><input type="text" id="[on,off,5,10][우편번호]" name="txZip" value="<%= myorder.FOneItem.Freqzipcode %>" readonly title="우편번호" class="ct" style="width:100%;" /></span>
											&nbsp;<span class="button btS1 btGry cBk1"><!--a href="" onclick="TnFindZipNew('frmorder',''); return false;">우편번호 검색</a-->
											<a href="" onclick="searchZipKakao('searchZipWrap','frmorder'); return false;">우편번호 검색</a></span>
										</p>
										...
										<p class="tPad05">
											<textarea name="txAddr1" id="[on,off,1,100][주소1]" title="주소" ReadOnly class="inp-box" ><%= myorder.FOneItem.Freqzipaddr %></textarea>
										</p>										
										<p class="tPad05">
											<input type="text" id="[off,off,0,100][주소2]" name="txAddr2" value="<%= myorder.FOneItem.Freqaddress %>" maxlength="100" title="상세 주소" style="width:100%;" />
										</p>
									</dd>
								</dl>
							<% end if %>
							...
							<% if Not(myorder.FOneItem.IsReceiveSiteOrder or (IsTicketOrder and TicketDlvType="1")) then %>
								<dl class="infoInput">
									...
									<dd><input type="text" id="[off,off,off,off][배송유의사항]" name="comment" value="<%= myorder.FOneItem.Fcomment %>" maxlength="100" style="width:100%;" /></dd>
								</dl>
							<% end if %>
						<% end if %>
					...
					<form action="">
						...
						<legend>플라워 정보변경</legend>
							<dl class="infoInput">
								...
								<dd><input type="text" id="[off,off,off,16]보내는 사람" name="fromname" value="<%= myorder.FOneItem.Ffromname %>" maxlength="16" style="width:100%;" /></dd>
							</dl>
							<dl class="infoInput">
								<dt>희망배송일</dt>
								<dd>
							...
							<dl class="infoInput">
								...
								<dd>
									<p>
										<textarea id="[off,off,off,100]메세지 내용" name="message" cols="50" rows="5" style="width:100%; height:100px;"><%= myorder.FOneItem.Fmessage %></textarea>
									</p>
								</dd>
							</dl>
