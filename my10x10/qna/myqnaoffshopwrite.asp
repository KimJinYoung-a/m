...
dim orderserial, itemid, qadiv, itemno, itemnoInput, userid, i, tmpqadivname, tmpqadivcnt, offshopqna, qnatitle
	...
	offshopqna = requestCheckVar(request("offshopqna"),16)
	If offshopqna<>"" Then
		qnatitle = "[매장문의] " + offshopqna +" 문의드립니다."
	End If 
