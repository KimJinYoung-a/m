...
'// SNS 공유용
	...
	Dim kakaodescription : kakaodescription = "단 2일간! 스페셜 마일리지를 받아보세요!"
	Dim kakaooldver : kakaooldver = "단 2일간! 스페셜 마일리지를 받아보세요!"
	Dim kakaoimage : kakaoimage = "http://webimage.10x10.co.kr/fixevent/event/2019/95733/share.png"
...
%>
<style type="text/css">
.mEvt95733 > div {position:relative;}
.mEvt95733 .btn-mileage {position:absolute; left:50%; bottom:7%; width:71.2%; margin-left:-35%; background:none; animation:bounce .7s 40;}
@keyframes bounce { 50% {transform:translateX(-.5rem);} }
</style>
...
<body>
			...
			<div class="mEvt95733">
				<div>
					<img src="//webimage.10x10.co.kr/fixevent/event/2019/95733/m/img_mileage_v1.jpg" alt="3333 마일리지">
					<button type="button" class="btn-mileage" onclick="doAction();"><img src="//webimage.10x10.co.kr/fixevent/event/2019/95733/m/btn.png" alt="마일리지 받기"></button>
				</div>
				<p><img src="//webimage.10x10.co.kr/fixevent/event/2019/95733/m/txt_guide.jpg" alt="현금처럼 사용할 수 있습니다"></p>
				<p><img src="//webimage.10x10.co.kr/fixevent/event/2019/95733/m/txt_noti.jpg" alt="이벤트 유의사항"></p>
				<a href="javascript:snschk();"><img src="//webimage.10x10.co.kr/fixevent/event/2019/95733/m/kakao.jpg" alt="카카오톡 공유하기"></a>
				<a href="/event/eventmain.asp?eventid=95554" onclick="fnAPPpopupEvent_URL('http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=95554');return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2019/95733/m/bnr_1.jpg" alt="바로배송"></a>
				<a href="/event/eventmain.asp?eventid=94973" onclick="fnAPPpopupEvent_URL('http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=94973');return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2019/95733/m/bnr_2.jpg" alt="리빙 위시"></a>
			</div>
			<!-- // 3333마일리지 -->
