...
%>
		<div class="inner5"><a href="#" onclick="fnAPPpopupEvent_URL('http://m.10x10.co.kr/apps/appCom/wish/web2014<%= link %>'); return false;"><img src="<%= image %>" alt="<%= altname %>" /></a></div>
<%
			i = i + 1
