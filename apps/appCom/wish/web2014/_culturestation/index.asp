...
<body class="default-font">
	...
	<div id="content" class="content cult-station">
			...
			<div class="swiper">
				<div class="swiper-container">
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide" onclick="fnGoUrlCul('<%=wwwUrl%>/apps/appCom/wish/web2014/culturestation/culturestation_event.asp?evt_code=<%=oeventtop.FItemList(i).fevt_code%>');return false;">
		...
		<div class="bnr-wrap">
			<div class="bnr bnr-thank">
				<a href="#" onclick="fnAPPpopupBrowser(OpenType.FROM_RIGHT, [], '고마워 텐바이텐', [], '<%=wwwUrl%>/apps/appCom/wish/web2014/cscenter/thanks10x10.asp');return false;">고마워, 텐바이텐!<em>텐바이텐을 칭찬해주세요</em><span class="icon"></span></a>
			</div>
		</div>
		...
		<div class="cult-conts nav-wrap">
				...
				<div class="option-right">
					<div class="styled-selectbox-default styled-selectbox">
						<select class="select" title="검색결과 리스트 정렬 선택옵션" id="sortview" onChange="TnSelectSortView()">
							<option value="new"<% If sortMtd="new" Then Response.write " selected"%>>최신순</option><!-- 최신순 : 디폴트 -->
			...
			<div class="cult-list list">
				<ul>
					...
					<li>
						<a href="#" onclick="fnGoUrlCul('<%=wwwUrl%>/apps/appCom/wish/web2014/culturestation/culturestation_event.asp?evt_code=<%=oevent.FItemList(i).fevt_code%>');return false;">
							<div class="inner">
								<div class="thumbnail">
				...
				<% If not(IsUserLoginOK()) Then %>
					<% if isApp=1 then %>
				<div class="bnr-myhistory"><a href="javascript:parent.calllogin();">내가 응모한 컬쳐스테이션이 궁금하다면? 〉</a></div>
					<% else %>
				<div class="bnr-myhistory"><a href="javascript:parent.jsChklogin_mobile('','<%=Server.URLencode("/culturestation/")%>');">내가 응모한 컬쳐스테이션이 궁금하다면? 〉</a></div>
					<% end if %>
				<% else %>
				<div class="bnr-myhistory"><a href="#" onclick="fnAPPpopupBrowser(OpenType.FROM_RIGHT, [], '당첨안내', [], '<%=wwwUrl%>/apps/appCom/wish/web2014/my10x10/myeventmaster.asp?pagegubun=j');return false;">내가 응모한 컬쳐스테이션이 궁금하다면? 〉</a></div>
				<% End IF %>
				<ul>
				<% End If %>
					<% Next %>
