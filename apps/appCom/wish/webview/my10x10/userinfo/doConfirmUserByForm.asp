...
''패스워드없이 쿠키로만 들어온경우
if (userpass="") then
	response.redirect wwwUrl & "/apps/appcom/wish/webview/my10x10/userinfo/confirmuser.asp"
    response.end    
end if
...
if (Not checkedPass) then
    response.redirect wwwUrl & "/apps/appcom/wish/webview/my10x10/userinfo/confirmuser.asp?errcode=1"
    response.end
end if
...
response.redirect wwwUrl & "/apps/appcom/wish/webview/my10x10/userinfo/modiUserInfo.asp"
response.end
'''end if
%>
