...
.mEvt116051 .topic .number {position:absolute; right:1.52rem; top:43%; width:9.82rem; background:transparent; z-index:10;}
.mEvt116051 .section-01,
.mEvt116051 .section-02 {position:relative;}
.mEvt116051 .section-01 .go-link {position:absolute; left:50%; bottom:20%; transform:translate(-50%,0); width:25.57rem; background:transparent;}
...
.mEvt116051 .slide-area {position:absolute; left:0; bottom:31%; width:100%;}
.mEvt116051 .slide-area .swiper-wrapper {transition-timing-function:linear;}
.mEvt116051 .swiper-wrapper .swiper-slide {width:14.78rem; padding:0 0.56rem;}
</style>
