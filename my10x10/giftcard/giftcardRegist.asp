...
function jsPopTerms(){
	location.href = "/my10x10/giftcard/giftcardTerms.asp?reurl=giftcardRegist";
}
</script>
</head>
<body>
	...
	<div class="mainSection">
		<div class="container">
			...
			<div class="content myGiftcardV15a" id="contentArea">
				...
				<a href="/gift/gifticon/" class="btn-giftchange"><img src="//fiximage.10x10.co.kr/m/2019/my10x10/btn_giftchange.jpg" alt="기프티콘 상품 교환하기"></a>
			</div>
			<!-- //content area -->
