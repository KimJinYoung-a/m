...
'	nowdate = "2015-06-20 10:00:00"
	...
	'// 마일리지 로그 테이블에 넣는다.
	vQuery = " insert into db_user.dbo.tbl_mileagelog(userid , mileage , jukyocd , jukyo , deleteyn) values ('"&userid&"', '+5000','"&eCode&"', '6월 마일리지를 부탁해! 5000마일리지 지급','N') "
	dbget.Execute vQuery
