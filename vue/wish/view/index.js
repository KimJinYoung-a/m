...
var list = new Vue({
    el : "#wishlist",
    template : '<div class="wish-list"><p><img src="//webimage.10x10.co.kr/fixevent/event/2019/97105/m/tit_wish.png" alt="지금 실시간으로 위시를 받은 상품들!"></p><ul><wish-list v-for="(item,index) in sliced" :key="index" :item="item" :isApp="isApp"></wish-list></ul></div>',
    data : function() {
        return {
