...
function goCategorySearch(){
    ...
    var sMtxt = document.getElementById("sMtxt").value;  //$("form[name=sFrm] > input[name=sMtxt]").val();  //V3추가
    
    //alert(sMtxt)
    var isreset = "false";
    if ((minPrc*1==_orgminPrice*1)&&(maxPrc*1==_orgmaxPrice*1)&&(iccd=="")&&(deliType=="")&&(sMtxt=="")){
        isreset = "true";
    }
	...
	var ifilter = {"pricelimitlow":minPrc,"pricelimithigh":maxPrc,"color":color,"delitp":deliType,"rstxt":sMtxt,"reset":isreset};
