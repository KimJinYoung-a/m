...
<!-- #include virtual="/lib/classes/enjoy/_shoppingchanceCls_B.asp" -->
				...
				$.ajax({
					...
					success: function(message) {
						if(message!="") {
							...
							var ctbnr = "<li class='culture-bnr' id='ctbnr'><a href=''><span class='icon icon-culture'></span><b>컬쳐 스테이션</b> <span class='subcopy'>감성을 채우는 문화정거장</span></a></li>"
