...
if mode = "pushadd" Then
    ...
    if pushdiv = "2" then
        pushDate = cdate("2021-08-08")
    elseif pushdiv = "3" then
        pushDate = cdate("2021-08-09")
    elseif pushdiv = "4" then
        pushDate = cdate("2021-08-15")
    elseif pushdiv = "5" then
        pushDate = cdate("2021-08-16")
    elseif pushdiv = "6" then
        pushDate = cdate("2021-08-22")
    elseif pushdiv = "7" then
        pushDate = cdate("2021-08-23")
    elseif pushdiv = "8" then
        pushDate = cdate("2021-08-29")
    else
        pushDate = cdate("2021-08-08")
    end if
