	...
	<div class="container popWin">
		...
		<div class="content" id="contentArea">
			<div class="heySomething">
				<div class="get">
					<% if isApp then %>
						<a href="" onclick="fnAPPpopupProduct('1358365'); return false;" class="link" >
					<% else %>
						<a href="/category/category_itemPrd.asp?itemid=1358365" class="link">
					<% end if %>

						<div class="big">
							<img src="http://webimage.10x10.co.kr/eventIMG/2015/66382/m/txt_get.jpg" alt="" />
							<div class="option">
								<%
								...
								<em class="name"><span>Warm Sand</span></em>
							</div>
						</div>
						...
						<div class="item">
							<ul>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/66382/m/img_thumb_01.jpg" alt="" />
								...
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/66382/m/img_thumb_02.jpg" alt="" />
									<span class="color">INSIGNIA</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/66382/m/img_thumb_03.jpg" alt="" />
									<span class="color">CHOCOLATE BROWN</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
								<li>
									<img src="http://webimage.10x10.co.kr/eventIMG/2015/66382/m/img_thumb_04.jpg" alt="" />
									<span class="color">VINTAGE RED</span>
									<span class="price"><%= FormatNumber(oItem.Prd.FSellCash,0) & chkIIF(oItem.Prd.IsMileShopitem,"Point","won") %></span>
								</li>
							</ul>
						</div>
