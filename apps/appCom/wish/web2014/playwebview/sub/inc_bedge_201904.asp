...
<%
'####################################################
' Description : 띵 배지 4월 (수작업)
' History : 2019-04-04 최종원
'####################################################
dim oItem
...
eventStartDate = Cdate("2019-04-04")
evnetEndDate = Cdate("2019-04-14")
presentDay = #04/14/2019 23:59:59#
...
<article class="playDetailV16 thingthing">
	<div class="hgroup">
		<div>
			...
			<h2 style="margin-bottom:0.3rem;">나도 모르게 흥얼거리는 <br>노래가 있나요?</h2>
		</div>
	</div>			
	<div class="badge-detail">
		<div id="thingRolling" class="swiperFull">
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide"><a href="/category/category_itemPrd.asp?itemid=2281310" onclick="TnGotoProduct('2281310');return false;"><img src="//webimage.10x10.co.kr/fixevent/play/badge/img_badge_201904_1.jpg" alt=""></a></div>
					<div class="swiper-slide"><a href="/category/category_itemPrd.asp?itemid=2281310" onclick="TnGotoProduct('2281310');return false;"></a><img src="//webimage.10x10.co.kr/fixevent/play/badge/img_badge_201904_2.jpg" alt=""></a></div>
					<div class="swiper-slide"><a href="/category/category_itemPrd.asp?itemid=2281310" onclick="TnGotoProduct('2281310');return false;"></a><img src="//webimage.10x10.co.kr/fixevent/play/badge/img_badge_201904_3.jpg" alt=""></a></div>
				</div>
				<div class="paginationDot"></div>
			</div>
		</div>
		<div class="itemDesc" style="background-color:#b746c4;">
		<% if now() <= presentDay then %>
			<p>'봄빠람 휘날리, 며↗♬'<br>이 계절만 되면<br>자연스레 흘러나오는 노래가 있죠?<br>요즘 나도 모르게 흥얼거리는<br>노래가 있다면 공유해 주세요.</p>
		<% else %>
			<p>요즘 귓가에 맴도는 노래를<br>공유해 주셔서 감사합니다.<br>다음 달에도 재밌는 주제로 함께<br>이야기하고 띵배지도 받으세요!</p>
		<% end if %>
			<div class="btnGet">
				<a href="/category/category_itemPrd.asp?itemid=2281310" onclick="TnGotoProduct('2281310');return false;">배지 구매하러가기</a>
			</div>
		</div>
		...
		<% if now() <= presentDay then %>
			<div class="desc">
				<p class="msg" style="color:#b746c4;">귓가에 맴도는 중독성 있는 노래를<br>공유해주신 분들 중 30분에게<br>4월의 THING배지.카세트테이프를<br>드립니다. (12자 이내로 짧게 적어주세요!)</p>
				<p class="date">응모기간 : 2019.4.8 ~ 4.14 <span>|</span> 발표 : 4.15</p>
			</div>
			<div class="form">
				...
				<input type="hidden" name="spoint"/>						
					...
					<legend class="hidden">코멘트 등록</legend>
						<input type="text" maxlength="12" id="txtcomm" onClick="jsCheckLimit();" name="txtcomm" title="코멘트 등록" placeholder="예) 벚꽃엔딩" style="border-color:#b746c4;" />
						<input type="button" onclick="jsSubmitComment(document.frmcom);return false;" value="등록하기" style="background-color:#b746c4; color:#fff; margin-top:0.75rem;" />
					</fieldset>								
				</form>		
		...
		<div class="other">
			<h3>봄날, 귓가에 맴도는 노래</h3>
			<ul>
				<li><span style="border-color:#b746c4; color:#b746c4;">봄이와</span></li>
				<li><span style="border-color:#b746c4; color:#b746c4;">10cm, 봄이 좋냐?</span></li>
				<li><span style="border-color:#b746c4; color:#b746c4;">우리오늘만날까</span></li>
				<li><span style="border-color:#b746c4; color:#b746c4;">걷자, 집앞이야</span></li>
				<li><span style="border-color:#b746c4; color:#b746c4;">너의 의미</span></li>
				<li><span style="border-color:#b746c4; color:#b746c4;">Comethru</span></li>
			</ul>
		</div>
		<% end if %>						
		</div>
		...
		<div class="listComment" id="comment">
			...
			<ul>
				...
				<li>
					<span><em style="color:#b746c4;"><%=ReplaceBracket(db2html(arrCList(1,intCLoop)))%></em>
