...
<%
'#######################################################
' PageName : make_topkeyword_xml.asp
...
For j=1 to cInt(vTerm2)
	...
	sqlStr = sqlStr + " from db_sitemaster.dbo.tbl_mobile_cate_topkeyword as t "
	...
	if vTotalCount>0 then
		...
		Do Until rsget.EOF
			...
			objXMLv.childNodes(0).text = staticImgUrl & "/mobile/topkeyword" + db2Html(rsget("kwimg"))
	...
	'// xml 최종 생성 DB-update
	sqlStr = "Update [db_sitemaster].[dbo].tbl_mobile_cate_topkeyword " &_
