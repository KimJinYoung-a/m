					...
					<div class="comment-write">
                        ...
                        <input type="hidden" name="spoint" value="1">
							...
							<legend>코멘트 작성 폼</legend>
								<h2><img src="http://webimage.10x10.co.kr/eventIMG/2018/89309/txt_cmt_evt.jpg" alt="축하는 셀프! 캐릭터를 골라 텐바이텐의 17주년을 축하해주세요! 총 10분에게 기프트카드 5,000권을 선물로 드립니다! 이벤트 기간은 10월 10일 월요읿 부터 31일 수요일 까지입니다. 당첨자 발표일은 11월 5일 월요일 입니다." /></h2>
								<div class="inner">
									<ul class="choice">
