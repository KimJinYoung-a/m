...
<title>10x10: 이벤트당첨 안내</title>
	...
	function PopOpenEventSongjangEdit(id){
		if(id==""){return;}
		location.href = '/my10x10/myeventmasteredit.asp?id=' + id + '';
	}
	//티켓승인
	function PopOpenEventTicket(id){
		location.href = '/my10x10/myevent_ticket.asp?ePC=' + id + '';
	}
	//배송지 입력
	...
	function PopOpenEventTicketView(id){
		location.href = '/my10x10/myevent_ticketView.asp?ePC=' + id + '';
	}
	//-->
	</script>
</head>
			...
			<div class="content" id="contentArea">
				...
				<div id="my2">
					...
					<ul class="tabItem tMar20">
						<li class="w50 <%=chkiif(vPageGubun="p","on","")%>"><a href="myeventmaster.asp?pagegubun=p">당첨 이벤트<span class="elmBg"></span></a></li>
						<li class="w50 <%=chkiif(vPageGubun="j","on","")%>"><a href="myeventmaster.asp?pagegubun=j">참여 이벤트<span class="elmBg"></span></a></li>
					</ul>
				</div>
				<div id="myevent">
					<!--당첨된 이벤트 리스트-->
					<% If vPageGubun = "p" Then %>
					<form name="frmPrize" method="post" action="myeventmaster.asp">
