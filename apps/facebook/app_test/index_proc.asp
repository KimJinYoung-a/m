...
<%
	...
	Dim fbuname , fbuphoto , fbsubopt1 , fbsubopt2 , fbsubopt3 , uname , uphone , fbuserid
	...
	fbsubopt3 = requestCheckVar(Request("type"),1)		'fb 옵션3
	uname = requestCheckVar(Request("uname"),30)		'개인정보 이름
	uphone = requestCheckVar(Request("uphone"),13)		'개인정보 연락처
	fbuserid = requestCheckVar(Request("fbuid"),50)		'fb userid

	referer = request.ServerVariables("HTTP_REFERER")

	sqlStr = "Insert into db_event.dbo.tbl_event_facebook " &_
			" (fbevtcode, fbuname, fbuphoto, fbsubopt1 , fbsubopt2 , fbsubopt3 , uname , uphone ,fbuserid) values " &_
			" (" & evt_code &_
			",'" & fbuname & "'" &_
			",'" & fbuphoto & "'" &_
			",'" & fbsubopt1 & "'" &_
