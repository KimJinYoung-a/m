...
function imgreg(){
	...
	if (ret){
		...
		if (rstStr == "2"){
			...
			location.replace('/my10x10/mymain.asp');
		}else{
			alert('오류가 발생했습니다.');
			return false;
		}
	...
	<div class="mainSection">
		<div class="container bgGry">
			...
			<div class="content" id="contentArea">
				...
				<!--<h2 class="tit01">프로필 이미지</h2> -->
				<!--<p class="cGy1 fs12 lh14 tMar10">원하는 프로필 이미지를 선택해 주세요.<br />프로필 이미지는 언제든지 변경이 가능합니다.</p> -->
			...
			<div class="floatingBar">
				<div class="btnWrap">
					<div class="ftBtn"><span class="button btB1 btRed cWh1 w100p"><input type="submit" onclick="imgreg();" value="저장" class="btRed" /></span></div>
				</div>
			</div>
			<!-- //content area -->
