	...
	<div id="content">
		...
		<div class="cont">
			<div class="hWrap hrBlk">
				<h1 class="headingA">이용약관</h1>
			</div>

			<div class="legal terms">
				<h2>[제1장총칙]</h2>
				<h3>제 1 조 (목적)</h3>
				<p>이 약관은 텐바이텐주식회사(이하 "회사") 가 운영하는 인터넷 사이트를 통하여 제공하는 전자상거래 관련 서비스(이하 "서비스")를 이용함에 있어 회사와 이용자의 권리•의무 및 책임사항을 규정함을 목적으로 합니다.</p>
				...
				<h3>제 12조 (수신확인통지&middot;구매신청 변경 및 취소)</h3>
				...
				<p>3. 제2항 제2호 내지 제4호의 경우에는 "회사"가 사전에 청약 철회 등이 제한되는 사실을 소비자가 쉽게 알 수 있는 곳에 명기하거나 시용 상품을 제공하는 등의 조치를 하지 않았다면 이용자의 청약 철회 등이 제한되지 않습니다.</p>
				...
				<h2>[제 5장 계약당사자의 의무]</h2>
				<h3>제 17조 (개인정보보호 및 이용)</h3>
				<p>1. "회사"는 이용자의 정보 수집시 서비스의 제공에 필요한 최소한의 정보를 수집합니다. 다음 사항을 필수사항으로 하며 그 외 사항은 선택사항으로 합니다.</p>
				<ul>
					<li>① 성명</li>
				...
				<p>4. "회사"가 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집 목적 및 이용 목적, 제3자에 대한 정보 제공 관련 사항(제공 받은 자, 제공 목적 및 제공할 정보의 내용) 등 정보통신망 이용 촉진 등에 관한 법률 제22조 등에서 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.</p>
				...
				<p>8. "회사"가 회원의 개인정보를 수집, 이용, 제공 등을 할 경우에는 정보통신망 이용촉진 및 정보보호 등에 관한 법률에 따라 회원의 동의를 받습니다.</p>
				...
				<p>3. "회사"는 판매하는 상품이나 용역에 대하여 「표시&middot;광고의 공정화에 관한 법률」 제3조 의 규정에 위반하는 표시•광고행위를 함으로써 이용자가 손해를 입은 때에는 이를 배상할 책임을 부담합니다.</p>
				<p>4. "회사"는 수신거절의 의사를 명백히 표시한 이용자에 대해서는 영리목적의 광고성 이메일을 발송하지 않습니다.</p>

				<h3>제 19조 (회원의 ID 및 비밀번호에 대한 의무)</h3>
				...
				<ul>
					...
					<li>6. 외설 또는 폭력적인 메시지&middot;화상&middot;음성 기타 공서양속에 반하는 정보를 화면에 공개 또는 게시하는 행위</li>
				</ul>

				<h2>[제 6장 부가서비스의 이용]</h2>
				<h3>제 21조 (마일리지)</h3>
				...
				<p>3. 부여된 마일리지는 5년간 유효하며, 기한 내 사용하지 않은 마일리지는 소멸됩니다.</p>
				...
				<p>4. Gift카드의 유효기한은 5년이고, 유효기한이 경과된 Gif 카드는 사용하실 수 없습니다.</p>
				...
				<h2>[제 7장 기타]</h2>
				<h3>제 26조 (저작권의 귀속 및 게시물 이용 제한)</h3>
				...
				<h3>제 30조 (분쟁해결)</h3>
				<p>1. "회사"는 이용자가 제기하는 정당한 의견이나 불만을 반영하고 그 피해를 보상처리하기 위하여 피해보상처리기구인 고객행복센터를 설치&middot;운영합니다.</p>
