...
dim email_10x10, email_way2way, smsok, smsok_fingers, socno, socname
...
//	}
	...
	if(confirm('회원가입 신청 후 최대 24시간 내 가입 승인이 이루어지며 승인 후 모든 서비스를 이용하실 수 있습니다.')){
			...
			<div class="content" id="contentArea">
				<div class="section simpleJoinForm">
                    ...
                    <div class="login-form">
                        ...
                        <input type="hidden" name="socno" value="<%=socno%>">
                        <input type="hidden" name="socname" value="<%=socname%>">
                            <fieldset>
                            <legend class="hidden">회원가입 폼</legend>
                                <div class="form-group first">
                                    <input type="text" name="txuserid" id="txuserid" maxlength="15" placeholder="아이디" onKeyDown="DuplicateIDCheck(this);keyCodeCheckID(event,this);" onKeyUp="DuplicateIDCheck(this);" onClick="DuplicateIDCheck(this);" onBlur="isToLowerCase(this,0); DuplicateIDCheck(this);" autocorrect="off" autocapitalize="off">
                                ...
                                <div class="form-group">
                                    <input type="text" name="txName" id="txName" maxlength="30" placeholder="이름" onblur="inputLengthCheck(this);" onKeyDown="inputLengthCheck(this);" onKeyUp="inputLengthCheck(this);">
                                    <!-- <label for="txName" id="uname">이름</label> -->
                                ...
                                <div class="form-group">
                                    <input type="email" name="usermail" id="email" maxlength="80" placeholder="이메일" onKeyDown="keyCodeCheckEmail(event);" onKeyUp="DuplicateEmailCheck();" onClick="DuplicateEmailCheck();">
                                ...
                                <div class="form-group">
                                    <input type="password" name="txpass1" id="txpass1" maxlength="32" placeholder="비밀번호" onKeyDown="fnCheckPwd();" onKeyUp="fnCheckPwd();" onClick="fnCheckPwd();">
                                ...
                                <div class="form-group">
                                    <input type="password" name="txpass2" id="txpass2" maxlength="32" placeholder="비밀번호 확인" onKeyDown="chkMemPwd();"  onKeyUp="chkMemPwd();" onClick="chkMemPwd();">
                    ...
                    <div class="btnGroup">
                        ...
                        <input type="submit" class="btnV16a btnRed2V16a btnLarge btnBlock" onclick="FnJoin10x10();" value="회원가입 신청하기">
                    </div>
				</div>
			</div>
			<!-- //content area -->
