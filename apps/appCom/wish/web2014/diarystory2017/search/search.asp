...
<%
'####################################################
' Description : (APP)다이어리스토리2017 검색레이어
...
function goSearchDiary()
{
	...
	var vpara;
	vpara = "arrds="+document.frm_search1.arrds.value+"&arrcont="+document.frm_search1.arrcont.value+"&arrkey="+document.frm_search1.arrkey.value+"&iccd="+document.frm_search1.iccd.value+"&cpg="+document.frm_search1.cpg.value+"&srm="+document.frm_search1.srm.value;

	fnAPPopenerJsCallClose("goSearchAppsModal(\""+vpara+"\")");
...
<body>
	...
	<!-- content area -->
	<div class="content diarySearch">
		<div class="filterListup" style="padding-bottom:5rem;">
			...
			<section>
				...
				<h3>+ DATE TYPE</h3>
				<ul>
					<li><input type="checkbox" id="contents01" name="contents" value="'only 2017'" <%= getchecked(arrcontents,"'only 2016'") %> class="check" /> <label for="contents01">Only 2017</label></li>
		...
		<div class="floatingBar">
			<div class="btnWrap">
				<div class="ftBtn"><span class="button btRed cWh1 w100p btnFind"><input type="submit" onclick="goSearchDiary(); return false" value="찾기" /></span></div>
