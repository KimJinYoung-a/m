...
<script src="/apps/appCom/wish/web2014/lib/js/adultAuth.js?v=1.31"></script>
<link rel="stylesheet" type="text/css" href="/lib/css/newV15a.css" />
<script type="text/javascript">
$(function() {
	fnAPPchangPopCaption("SALE");
	swiper = new Swiper('.topicV19 .tabwrap', {
		slidesPerView:'auto',
...
function jsGoUrl(sP, catecode, flo1, flo2){
    location.href = "/apps/appcom/wish/web2014/sale/saleitem.asp?disp="+catecode+"&sP="+sP+"&flo1="+flo1+"&flo2="+flo2;
}

//무배
function chkfree(flo1,flo2){
	if(document.all.chksearchfree.checked==true){
		location.href = "/apps/appcom/wish/web2014/sale/saleitem.asp?disp=<%=vDisp%>&sP=<%=sPercent%>&flo1="+flo1+"&flo2="+flo2;
	}
	if(document.all.chksearchfree.checked==false){
		location.href = "/apps/appcom/wish/web2014/sale/saleitem.asp?disp=<%=vDisp%>&sP=<%=sPercent%>&flo1=&flo2="+flo2;
	}
}
...
function chklimit(flo1,flo2){
	...
	if(document.all.chksearchlimit.checked==false){
		location.href = "/apps/appcom/wish/web2014/sale/saleitem.asp?disp=<%=vDisp%>&sP=<%=sPercent%>&flo1="+flo1+"&flo2=";
	}
}
		...
		<div class="titwrap">
			<div class="tit-area">
				<div class="nav nav-stripe">
					<ul class="grid2">
						<li><a href="/apps/appcom/wish/web2014/sale/saleitem.asp" class="on">세일</a></li>
						<li><a href="/apps/appcom/wish/web2014/clearancesale/">클리어런스</a></li>
					</ul>
				</div>
				<h2>NOW ON SALE</h2>
			</div>
