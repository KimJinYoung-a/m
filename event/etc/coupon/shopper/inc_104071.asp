...
<%
dim eCode : eCode = chkiif(application("Svr_Info") = "Dev","102194","104071")
%>
<style type="text/css">
...
<%'!-- MKT 텐X텐 쿠폰 --%>
<div class="mEvt104071 tenten-cpn">
    <div class="topic">
        <h2>
            <span class="t1"><img src="//webimage.10x10.co.kr/fixevent/event/2020/104071/m/img_tenten.png" alt="텐바이텐"></span>
            <span class="t2"><img src="//webimage.10x10.co.kr/fixevent/event/2020/104071/m/img_shopper.png" alt="텐텐쇼퍼"></span>
            <p class="t3"><img src="//webimage.10x10.co.kr/fixevent/event/2020/104071/m/tit_coupon.jpg" alt="텐X텐 쿠폰"></p>
        </h2>
        <div class="coupon">
            <img src="//webimage.10x10.co.kr/fixevent/event/2020/104071/m/img_coupon.png" alt="할인쿠폰">
            <input type="text" id="couponname" placeholder="쿠폰 코드를 입력해주세요!">
            <button type="button" onclick="jsDownCustomCoupon();" class="btn-cpn"><img src="//webimage.10x10.co.kr/fixevent/event/2020/104071/m/btn_coupon.png" alt="쿠폰 발급받기"></button>
        </div>
    </div>
    <p><img src="//webimage.10x10.co.kr/fixevent/event/2020/104071/m/txt_howto.jpg" alt="쿠폰 등록 방법"></p>
    <p><img src="//webimage.10x10.co.kr/fixevent/event/2020/104071/m/txt_noti.jpg" alt="이벤트 유의사항"></p>
</div>
<%'!-- // MKT 텐X텐 쿠폰 --%>
<script>
