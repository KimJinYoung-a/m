...
'// SNS 공유용
    ...
    Dim kakaodescription : kakaodescription = "10,000 마일리지를 받을 수 있는 기회! 텐바이텐 메일 수신하고 행운의 편지를 받아보세요!"
    Dim kakaooldver : kakaooldver = "10,000 마일리지를 받을 수 있는 기회! 텐바이텐 메일 수신하고 행운의 편지를 받아보세요!"
...
%>
<style type="text/css">
.mEvt96333 button {background-color:transparent;}
...
.topic h2 button,
.topic h2,
.topic > span {display:inline-block; position:absolute; left:4.4%; top:53.5%;}
...
.intro {width:95%; top:70%; left:2.5%;}
...
.noti {padding-bottom:3.41rem; background:url(//webimage.10x10.co.kr/fixevent/event/2019/96333/m/bg_noti.jpg) repeat 0 0; background-size:100%;}
...
.noti ul li a {color:#fe5468; text-decoration:underline;}

.layer {display:none; position:fixed; top:0; left:0; z-index:20; width:100%; height:100%; background-color: rgba(255, 164, 176, .8);}
...
$(function() {
    ...
    $(".mEvt96333 .btn-detail").click(function(){
        $('.mEvt96333 .layer-detail').fadeIn();
    });
    $(".mEvt96333 .layer").click(function(){
        $(this).fadeOut();
    });
});
</script>
...
<body>            
			...
			<div class="mEvt96333">
                <div class="topic">
                    <h2>
                        <img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/tit_lucky.png" alt="행운의 편지">
                        <!--<button class=btn-detail><img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/btn_detail.png" alt="자세히보기"></button>-->
                    </h2>
                    <span><img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/img_envelope.png" alt=""></span>
                    <p class="intro"><img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/txt_intro.png" alt="텐바이텐 메일을 수신 동의한 고객 중  추첨을 통해 행운의 편지를 보내드립니다 "></p>
                    <img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/bg_lucky.jpg" alt="">
                </div>
                <div class="evt-conts">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/txt_conts.jpg" alt="참여방법 1위 버튼 클릭하고 텐바이텐 이메일 수신 동의하기! 2 매달 첫 번째 월요일 행운의 편지 기다리기!">
                    <button class="btn-agree" type="button" onclick="chkLogin();">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/btn_agree.png" alt="이메일 수신 동의하러가기">
                        <i><img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/txt_click.png" alt="클릭"></i>
                    </button>
                </div>

                <!-- 공유하기 -->
                <div class="share">
                    <a href="javascript:snschk();"><img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/img_share.jpg" alt="행운의 편지 이벤트를 친구에게도 알려주세요!"></a>
                </div>

                <div class="noti">
                    <h3><img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/tit_noti.jpg" alt="이벤트 유의사항"></h3>
                    <ul>
                        <li>본 이벤트는 텐바이텐 메일 수신 동의한 고객이라면 자동으로 응모되는 이벤트 입니다.</li>
                        <li>이벤트 당첨자는 메일을 통해 행운의 편지가 발송 될 예정입니다.</li>
                        <li>메일 주소가 정확하지 않은 경우, 메일 발송이 불가합니다. <br>MY 회원정보 페이지에서 메일 주소를 확인해주세요.</li>
                ...
                <div class="layer layer-agree">
                    <div class="inner">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/txt_agree.png" alt="이메일 수신동의 텐바이텐 이메일 수신 동의를 하시면 다양한 할인 혜택과 이벤트 ,신상품 등의 정보를 빠르게 만나실 수 있습니다. 텐바이텐 이메일로 다양한 정보를 받아 보시겠습니까?
                        ">
                        <div class="btn-group">
                            <button onclick="doAction();" type="button"><img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/btn_yes.png" alt="예"></button>
                            <button><img src="//webimage.10x10.co.kr/fixevent/event/2019/96333/m/btn_no.png" alt="아니오"></button>
                        </div>
                    </div>
                </div>
            </div>
