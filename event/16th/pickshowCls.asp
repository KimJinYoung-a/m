...
'		Response.end
	...
	public Function fnGetEventGpcode0
		Dim strSql
		IF  FEGCode = "" THEN FEGCode = 0
		strSql ="EXEC [db_event].[dbo].sp_Ten_eventitem_grouppcode0 "&FECode&""
		rsget.Open strSql, dbget, adOpenForwardOnly, adLockReadOnly, adCmdText
		IF Not (rsget.EOF OR rsget.BOF) THEN
	...
	public Function fnGetEventGroupTop
		Dim strSql
		IF  FEGCode = "" THEN FEGCode = 0
		strSql ="EXEC [db_event].[dbo].sp_Ten_eventitem_group_top1 "&FECode&""
		rsget.Open strSql, dbget, adOpenForwardOnly, adLockReadOnly, adCmdText
		IF Not (rsget.EOF OR rsget.BOF) THEN
	...
	public Function fnGetRedRibbonRecentCode
		...
		strSql ="EXEC [db_giftplus].[dbo].ten_giftplus_RecentEvent '"&frectekind&"' "
	...
	public Function fnGetSlideTemplate_main
		Dim strSql
		IF FECode = "" THEN Exit Function
		strSql = "EXEC [db_event].[dbo].[sp_Ten_event_slidetemplate] "&FECode&", 'W'"
		rsget.Open strSql, dbget, adOpenForwardOnly, adLockReadOnly, adCmdText
			IF Not (rsget.EOF OR rsget.BOF) THEN
				FSidx		= rsget("idx")
	...
	public Function fnGetSlideTemplate_sub
		Dim strSql
		If FECode = "" THEN Exit Function
		strSql ="EXEC [db_event].[dbo].[sp_Ten_event_slidetemplate_addimg] "&FECode&", 'W'"
		rsget.Open strSql, dbget, adOpenForwardOnly, adLockReadOnly, adCmdText
		IF Not (rsget.EOF OR rsget.BOF) THEN
...
Class ClsEvtItem
	...
	public Function fnGetEventItem
		...
		strSql ="EXEC [db_item].[dbo].sp_Ten_event_GetItem_pickshow "&FECode&","&FEGCode&","&FEItemCnt&","&FItemsort&",1"
		rsget.Open strSql, dbget, adOpenForwardOnly, adLockReadOnly, adCmdText
		IF Not (rsget.EOF OR rsget.BOF) THEN
