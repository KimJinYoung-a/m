...
Else
	eCode = 85340
	getbonuscoupon = 1042	'3,000/20,000
End If
...
if mode = "cpok" Then
	...
	dim vUsr
	strSql = "Select count(*) as cnt from db_temp.[dbo].[tbl_temp_Send_UserSMS] with (noLock) where yyyymmdd='20180326' and div in ('A','C') and userid='" & userid & "' "
