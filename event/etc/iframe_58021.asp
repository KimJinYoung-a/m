...
'// 앱일경우 변경
If isApp="1" Then
	response.redirect "/apps/appCom/wish/web2014/event/etc/iframe_58131.asp"
End If
...
%>
<style type="text/css">
.constellation {padding-bottom:25px; background:url(http://webimage.10x10.co.kr/eventIMG/2014/58021/bg_cont.gif) left top no-repeat #464b69; background-size:100% auto;}
...
@media all and (min-width:480px){
	.constellation  {padding-bottom:38px;}
	...
	.myFortune li.t05 {padding-bottom:23px;}
...
function goViewHoroScope(horodate)
{
	...
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=01";
	}
	if ($("#horoscope").val()=="2015-02-19")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=02";
	}
	if ($("#horoscope").val()=="2015-03-21")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=03";
	}
	if ($("#horoscope").val()=="2015-04-20")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=04";
	}
	if ($("#horoscope").val()=="2015-05-21")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=05";
	}
	if ($("#horoscope").val()=="2015-06-22")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=06";
	}
	if ($("#horoscope").val()=="2015-07-23")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=07";
	}
	if ($("#horoscope").val()=="2015-08-23")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=08";
	}
	if ($("#horoscope").val()=="2015-09-24")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=09";
	}
	if ($("#horoscope").val()=="2015-10-23")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=10";
	}
	if ($("#horoscope").val()=="2015-11-23")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=11";
	}
	if ($("#horoscope").val()=="2015-12-25")
	{
		parent.location.href="/event/eventmain.asp?eventid=<%=vLinkECode%>&vScope=12";
	}
...
<div class="evtCont">
	...
	<div class="mEvt58021">
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=869744" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=1163066" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=939478" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=1180489" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=917667" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=434693" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=199993" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=1182122" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=839916" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=658353" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=928455" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=1144847" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=443114" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=45979" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=261066" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=45990" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=546397" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=816538" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=1110058" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=1148508" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=1131176" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=1128640" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=291678" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=1178386" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=1173830" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=1187492" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=1163169" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=1183448" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=1065301" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=1154407" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=1184593" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=1176641" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=975854" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=1153760" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=1169165" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=1152661" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=1183721" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=1127887" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=1060249" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=1174709" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=1174707" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=922672" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=1111255" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=644571" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=803595" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=932431" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=1144950" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=803606" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=115125" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=1122476" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=1007016" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=1115185" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=480384" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=956188" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=738813" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=1184206" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=1075017" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=883659" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=977749" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=1005276" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=1133435" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=1133573" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=1133431" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=705272" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=745222" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=385030" target="_blank" class="item06">행운의 아이템6</a>
				...
				<div class="consView">
					<ul class="myFortune">
						...
						<li class="t05">
							...
							<div class="luckyItem">
								<a href="/category/category_itemPrd.asp?itemid=405996" target="_blank" class="item01">행운의 아이템1</a>
								<a href="/category/category_itemPrd.asp?itemid=380146" target="_blank" class="item02">행운의 아이템2</a>
								<a href="/category/category_itemPrd.asp?itemid=831301" target="_blank" class="item03">행운의 아이템3</a>
								<a href="/category/category_itemPrd.asp?itemid=1003376" target="_blank" class="item04">행운의 아이템4</a>
								<a href="/category/category_itemPrd.asp?itemid=695875" target="_blank" class="item05">행운의 아이템5</a>
								<a href="/category/category_itemPrd.asp?itemid=1133544" target="_blank" class="item06">행운의 아이템6</a>
		...
		<%
			...
			snpTitle = Server.URLEncode("별에서 온 운세")
			snpLink = Server.URLEncode("http://m.10x10.co.kr/event/eventmain.asp?eventid="&vLinkECode)
			snpPre = Server.URLEncode("10x10 이벤트")

			'기본 태그
			snpTag = Server.URLEncode("텐바이텐 " & Replace("별에서 온 운세"," ",""))
			snpTag2 = Server.URLEncode("#10x10")

			'// 카카오링크 변수
			Dim kakaotitle : kakaotitle = "[텐바이텐] 별에서 온 운세"
			Dim kakaoimage : kakaoimage = "http://webimage.10x10.co.kr/eventIMG/2014/58021/tit_constellation.gif"
			Dim kakaoimg_width : kakaoimg_width = "200"
			Dim kakaoimg_height : kakaoimg_height = "150"
			Dim kakaolink_url
			kakaolink_url = "http://m.10x10.co.kr/event/eventmain.asp?eventid="&vLinkECode

		%>

		<div class="shareSns">
			<a href="" onclick="popSNSPost('tw','<%=snpTitle%>','<%=snpLink%>','<%=snpPre%>','<%=snpTag2%>'); return false;" class="sns01">twitter</a>
			<a href="" onclick="popSNSPost('fb','<%=snpTitle%>','<%=snpLink%>','',''); return false;" class="sns02">facebook</a>
			<a href="" onclick="parent.parent_kakaolink('<%=kakaotitle%>','<%=kakaoimage%>','<%=kakaoimg_width%>','<%=kakaoimg_height%>','<%=kakaolink_url%>'); return false;" id="kakao-link-btn"  class="sns03" >kakao talk</a>
