...
// play
//$(function(){
//	$('.todayPlayV15 ul').children('li').each(function(){
//		$('.playPagingV15').append('<span></span>');
//	});
//	$('.todayPlayV15 ul li').hide();
//	$('.todayPlayV15 ul li').eq(<%=renview%>).show();//'랜덤
//	$('.playPagingV15 span').eq(<%=renview%>).addClass('active');//'랜덤버튼
//});
