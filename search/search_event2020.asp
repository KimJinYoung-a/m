...
<script src="/vue/components/event/evt_list_mkt.js?v=1.1"></script>
<script src="/vue/components/event/evt_img.js?v=1.0"></script>
<script src="/vue/components/event/evt_info.js?v=1.0"></script>
<!-- //Exhibition Components -->

<!-- Core -->
<script src="/vue/search/Result/event_store.js?v=1.1"></script>
<script src="/vue/search/Result/event_result.js?v=1.01"></script>
<!-- //Core -->