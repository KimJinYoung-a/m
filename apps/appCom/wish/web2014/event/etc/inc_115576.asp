...
eventStartDate  = cdate("2021-11-23")		'이벤트 시작일
eventEndDate 	= cdate("2021-11-30")		'이벤트 종료일

LoginUserid		= getencLoginUserid()

if mktTest then
    currentDate = cdate("2021-11-23")
else
    currentDate = date()
end if
...
myorder.FRectOldjumun = "on"         '6개월 이후 주문 조회 시
myorder.FRectStartDate = FormatDateTime("2020-11-01",2)
myorder.FRectEndDate = FormatDateTime("2020-12-01",2)
...
.mEvt113327 .section01 .text .txt02{width:48.13vw;position:absolute;left:50%;margin-left:-24.06vw;top:21rem;}
...
.mEvt113327 .popup .pop.win {width:100%; padding: 2.47rem 1.73rem 4.17rem; top:50%; left:0; margin:0; z-index:150; transform:translateY(-50%);}
.mEvt113327 .popup .pop{position:fixed;top:20rem;width:86.7vw;left:50%;margin-left:-43.35vw;z-index:150;}
...
.mEvt113327 .popup .pop .final .name{font-size:1.5rem;letter-spacing:-0.08rem; color:#000d48;}
.mEvt113327 .popup .pop .final .name span{text-decoration: underline;}
.mEvt113327 .popup .pop .final .price{margin-top:1.5rem; color:#000d48;}
...
function doAction() {
    ...
    <% If IsUserLoginOK() Then %>
        ...
        $.ajax({
            type: "POST",
            url:"/apps/appcom/wish/web2014/event/etc/doeventsubscript/doEventSubscript115576.asp",
            data: {
                mode: 'add',
    ...
    return false;
            ...
            <input type="hidden" id="orderprice">
				<section class="section section01">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/top.jpg?v=2" alt="">
                    <div class="coin">
                    ...
                    <div class="text">
                        ...
                        <p class="txt02 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/txt02.png" alt=""></p>
                        <p class="txt03 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/txt03.png?v=2" alt=""></p>
                        ...
                        <p class="txt05 animate"><img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/txt05.png" alt=""></p>
                ...
                <% if LoginUserid<>"" then %>
                    ...
                    <div class="login">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/receipt.jpg" alt="">
                    ...
                    <% else %>
                    <div class="order_one">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/order01.jpg" alt="">
                        <p class="user"><span><%=LoginUserid%></span>님의</p>
                    </div>
                    <% end if %>
                <% else %>
                    <div class="logout">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/login.jpg" alt="">
                        <a href="" class="go_login" onclick="jsSubmitlogin();return false;"></a>
                    </div>
                <% end if %>
                </section>
                <section class="section section03">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/notice.jpg" alt="">
                </section>
                <section class="section section4">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/alert.jpg" alt="">
                ...
                <div class="popup popup02">
                    <div class="bg_dim"></div>
                    <div class="pop win">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/popup_on.png" alt="당첨자 발표">
