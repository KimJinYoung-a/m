	...
	<div class="mainSection">
		<div class="container bgGry">
			...
			<div class="content evtView" id="contentArea">
				...
				%>
					<li>
						<a href="/category/category_itemPrd.asp?itemid=<%= cPk.FCategoryPrdList(intI).Fitemid %>&flag=e&ldv=<%=cPk.FCategoryPrdList(intI).Fldv%>">
						<%
						...
						%>
							...
							<div class="dealPdt">
								...
								<span class="type"><%=labeltext(cPk.FCategoryPrdList(intI).Flabel)%></span>
							</div>
							<div class="pdtCont">
