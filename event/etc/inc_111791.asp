...
Else
    mktTest = False
End If
eventStartDate  = cdate("2021-05-31")		'이벤트 시작일
eventEndDate 	= cdate("2021-06-04")		'이벤트 종료일

if mktTest then
currentDate = cdate("2021-05-31")
else
currentDate = date()
end if
...
%>
<style type="text/css">
.double-mileage {position:relative; background:#00aeff;}
...
.double-mileage .sec-aram button {width:100%; height:10rem; position:absolute; left:0; top:58%; background:transparent;}
</style>
<script>
...
function eventTry(){
	...
	<% else %>
		...
		$.ajax({
			type:"POST",
			url:"/event/etc/doEventSubscript111791.asp",
			data: data,
			dataType: "JSON",
	...
	<% End If %>
			...
			<div class="mEvt88837 double-mileage">
				<h2><img src="//webimage.10x10.co.kr/fixevent/event/2021/111791/m/img_main.jpg" alt="더블 마일리지"></h2>
                ...
                <% End If %>
					...
					<div class="btn-group">
                    <% If IsUserLoginOK Then %>
						<a href="/my10x10/goodsusing.asp" target="_blank" class="mWeb"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111791/m/btn_goprd.png" alt="상품후기 쓰러 가기"></a>
                        <a href="" onclick="fnAPPpopupBrowserURL('기획전','http://m.10x10.co.kr/apps/appCom/wish/web2014/my10x10/goodsusing.asp');return false;" class="mApp"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111791/m/btn_goprd.png" alt="상품후기 쓰러 가기"></a>
					<% Else %>
                        <a href="" onClick="jsSubmitComment(); return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111791/m/btn_gologin.png" alt="로그인 하기"></a>
                    <% End If %>
					</div>
				</div>
                <div class="sec-aram">
                    <img src="//webimage.10x10.co.kr/fixevent/event/2021/111791/m/img_aram.jpg" alt="이벤트 안내">
                    <!-- 알림 받기 -->
                    <button type="button" onclick="eventTry();"></button>
                </div>
				<p><img src="//webimage.10x10.co.kr/fixevent/event/2021/111791/m/img_noti.jpg" alt="이벤트 유의사항"></p>
			</div>
