...
<div class="mEvt69727">
	...
	<div class="couponDownload">
		<div><img src="http://webimage.10x10.co.kr/eventIMG/2016/69727/m/img_coupon.png" alt="6만원 이상 구매 시 1만원 할인 쿠폰" /></div>
	<% if totalsubscriptcount1>=getlimitcnt1 or totalbonuscouponcount1>=getlimitcnt1 then %>
	...
	<div class="btnArea">
		<% if not(isApp=1) then %>
		<a href="/event/appdown/"><img src="http://webimage.10x10.co.kr/eventIMG/2016/69727/m/btn_app_down.png" alt="텐바이텐 APP 다운" /></a>
		<% End If %>
		<% If userid = "" Then %>
			<% if isApp=1 then %>
