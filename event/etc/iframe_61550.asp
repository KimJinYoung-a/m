...
<!--
	...
	function gotoDownload(){
		parent.top.location.href='http://m.10x10.co.kr/apps/link/?4020150412';
		return false;
	};
...
function kakaosendcall(){
	<% If IsUserLoginOK Then %>
		parent_kakaolink('[텐바이텐] 셋콤 달콤!\n4월에 꿀맛 제대로 느껴보세요!\n\n-지니 30일 무제한 감상권!\n-요기요 7,000원 식권!\n-메가박스 영화 예매권!\n\n텐바이텐 APP에서 당신의 손으로 직접 당첨을 확인하세요!' , 'http://webimage.10x10.co.kr/eventIMG/2015/60930/60930kakao.jpg' , '200' , '200' , 'http://m.10x10.co.kr/apps/appCom/wish/web2014/event/eventmain.asp?eventid=61550' );
		return false;
	<% Else %>
