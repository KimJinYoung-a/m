...
<!-- #include virtual="/event/etc/iframe_51209Cls.asp" -->
<%
'####################################################
' Description : 내가 SNS에서 제일 잘 나가 - mobile
...
<style type="text/css">
	.mEvt51209 {position:relative;}
	.mEvt51209 p {max-width:100%;}
	.mEvt51209 img {vertical-align:top; width:100%;}
...
<script>
	...
	<% if datediff("d",date(),"2014-05-10")>=0 then %>
		<% If IsUserLoginOK Then %>
			...
			frm.action = "doEventSubscript51209.asp";
			return true;
		<% Else %>
			parent.jsevtlogin();
		<% End If %>
...
<div class="mEvt51209">
			...
			<ul>
				...
				<li>
					<div>
						...
						<a href="/shopping/category_prd.asp?itemid=<%=ifr.FItemList(i).Fitemid%>" target="_top"><img src="<%=ifr.FItemList(i).FImageIcon1%>" alt="<%=ifr.FItemList(i).Fitemname%>" /></a>
					</div>
				</li>
				<% Next %>
			</ul>
	...
	<div class="event2">
		...
		<ul>
			<li><a href=""><img src="http://webimage.10x10.co.kr/eventIMG/2014/51209/btn_share_facebook.png" alt="페이스북- 텐바이텐 포스팅 공유하러 가기" /></a></li>
			<li><a href="http://t.co/IGHq37b8fg" target="_blank"><img src="http://webimage.10x10.co.kr/eventIMG/2014/51209/btn_share_twitter.png" alt="트위터- 텐바이텐 포스팅 공유하러 가기" /></a></li>
		</ul>
	</div>
	<!--// EVENT2 -->
</div>
