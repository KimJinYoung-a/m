...
<div class="addPdtList box1 tMar20 brandPdt">
	...
	<span class="moreBtn"><a href="/street/street_brand.asp?makerid=<%=vMakerid%>&srm=be">브랜드 인기상품 리스트로 이동</a></span>
...
%>
				<li>
					<a href="/category/category_itemPrd.asp?itemid=<%= oBBDoc.FItemList(i).Fitemid %>">
