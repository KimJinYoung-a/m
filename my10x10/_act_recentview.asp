...
<!-- #include virtual="/lib/classes/shopping/_todayshoppingcls.asp" -->
<%
'####################################################
				...
				<% Select Case Trim(myRecentView.FItemList(lp).Ftype) %>
						...
						<div class="section item" id="div<%=myRecentView.FItemList(lp).FIdx%>">
							<div class="inner">
								...
								<% End If %>
									...
									<div class="thumbnail"><img src="<%=myRecentView.FItemList(lp).FImageicon1%>" alt="" /></div>
									<div class="desc">
						...
						<div class="section brand" id="div<%=myRecentView.FItemList(lp).FIdx%>">
							<div class="inner">
								<% If myRecentView.FItemList(lp).FBrandUsing="N" Then %>
									<a href="" onclick="return false;">
								<% Else %>
									<a href="/street/street_brand.asp?makerid=<%=myRecentView.FItemList(lp).Fmakerid%>&gaparam=recentview_brand_1" target="_blank">
								<% End If %>
					...
					<% Case "rect" %>
						<div class="section searchword" id="div<%=myRecentView.FItemList(lp).FIdx%>">
							<div class="inner">
								<a href="/search/search_item.asp?cpg=1&rty=1&rect=<%=myRecentView.FItemList(lp).Frect%>&gaparam=recentview_search_1" target="_blank">
