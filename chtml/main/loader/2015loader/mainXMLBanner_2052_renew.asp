...
Dim image3, link3, startdate3, enddate3, altname3
...
If fileCont3 <> "" Then
	...
	For each tplNodes3 in cTmpl3
		...
		If CDate(CtrlDate3) >= CDate(startdate3) AND CDate(CtrlDate3) <= CDate(enddate3) Then
			...
			playYn = "ok"
			playHtml = "<div class=""swiper-slide""><a href="""& link3 & gaParam &"""><img src="""& image3 &""" alt="""& altname3 &""" /></a></div>"
...
If fileCont2 <> "" Then
	...
	For each tplNodes2 in cTmpl2
		...
		If CDate(CtrlDate2) >= CDate(startdate2) AND CDate(CtrlDate2) <= CDate(enddate2) Then
			...
			issueYN = "ok"
			issueHtml = "<div class=""swiper-slide""><a href="""& link2 & gaParam &"""><img src="""& image2 &""" alt="""& altname2 &""" /></a></div>"
...
%>
			<div class="swiper-slide">
				<a href="<%= link %><%=gaParam%>"><img src="<%= image %>" alt="<%= altname %>" /></a>
			</div>
<%
			i = i + 1
		End If
