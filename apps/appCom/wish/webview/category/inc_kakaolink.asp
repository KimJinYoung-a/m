...
<script>
	...
	Kakao.Link.createTalkLinkButton({
	  ...
	  appButton: {
        text: '10X10 앱으로 이동',
		execParams :{
			android : {"url":"http://m.10x10.co.kr/apps/appCom/wish/webview/category/category_itemprd.asp?itemid=<%=itemid%>&ldv=<%=cpid%>"},
			iphone : {"url":"http://m.10x10.co.kr/apps/appCom/wish/webview/category/category_itemprd.asp?itemid=<%=itemid%>&ldv=<%=cpid%>"}
		}
      },
	  installTalk : Boolean
	});
