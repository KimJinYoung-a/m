...
<%
'###########################################################
' Description : 버킷리스트 03 마이다노_다이어트
' History : 2019-01-29 최종원 생성
'###########################################################
%>
...
evtStartDate = Cdate("2019-01-29")
evtEndDate = Cdate("2019-02-13")
...
%>
<style type="text/css">
.mEvt91956 .botton {background-color:transparent;}
...
.cmt-area {background-color:#c1e1ee; text-align:center;}
...
.cmt-area .cmt-list ul {padding:1.71rem 8% 0;background-color:#b1d8e8;}
.cmt-area .cmt-list ul li {position:relative; margin-top:1.71rem; padding:2.05rem 2.99rem 2.56rem; text-align:left;}
...
.cmt-area .pagingV15a {margin-top:0rem; padding-top:2.13rem; padding-bottom:4.27rem; background-color:#b1d8e8;}
...
.cmt-area .pagingV15a .arrow a:after {left:0; top:0; width:2.77rem; height:2.77rem; margin:0; background-image:url(//webimage.10x10.co.kr/fixevent/event/2019/91956/m/btn_paging_next.png); background-size:100% 100%; background-position:0 0;}
...
$(function(){
	...
	$(".cmt-list li:nth-child(2n-1)").css('background-color', '#fff6d8');
	$(".cmt-list li:nth-child(2n)").css('background-color', '#ffe6ee');
});
</script>
...
<div class="mEvt91956">
    <%' 최상단 %>
    <div class="topic">
        <h2><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/m/tit_bucket.jpg" alt="MYDANO와 함께 다이어트"></h2>
        <p><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/m/img_winner.png" alt="총 당첨자 100명!"></p>
    </div>

    <%' 브랜드 소개 %>
    <div class="info">
        <h3><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/m/tit_info.jpg" alt="마이다노가 궁금해요!"></h3>
        <div class="rolling">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/event/2019/91956/m/img_slide_1.jpg" alt="굶는 다이어트는 이제 그만! 평생 유지 가능한 건강한 식습관 만들 수 있어요." /></div>
                    <div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/event/2019/91956/m/img_slide_2.jpg" alt="무리하게 운동하지 마세요! 하루 30분씩 짧지만 효과 좋은 운동을 즐길 수 있어요." /></div>
                    <div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/event/2019/91956/m/img_slide_3.jpg?v=1.01" alt="일상을 바꾸면 인생이 달려져요! 나에게 꼭 필요한  미션을 하다 보면 어느새 습관이 바뀌어요." /></div>
                    <div class="swiper-slide"><img src="http://webimage.10x10.co.kr/fixevent/event/2019/91956/m/img_slide_4.jpg" alt="국내 최대 규모 여성 코치진! 여성 다이어트만을 연구하는 여성 코치님들이 세심하게 관리해줘요." /></div>
                </div>
            </div>
    ...
    <%' 코멘트(6개씩 노출) %>
    <div class="cmt-area">
        <h4><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/m/tit_cmt_evt.jpg" alt="평소 다이어트를 할 때 고민이었던 점을 남겨주세요!"></h4>
        ...
        <div class="input-box">
            <img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/m/bg_txt_area.jpg" alt="">
        ...
        <button class="submit" onclick="jsSubmitComment(document.frmcom); return false;"><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/m/btn_submit.jpg" alt="등록하기"></button>        
        <p><img src="//webimage.10x10.co.kr/fixevent/event/2019/91956/m/txt_caution.jpg" alt="한 ID당 한번 참여 가능합니다. 통신예절에 어긋나는 글이나 상업적인 글은 이벤트 참여에 제한을 받을 수 있습니다."></p>
		</form>
    ...
    <div class="noti">
        ...
        <ul>
            ...
            <li>- 이벤트 당첨자는 2019년 2월 15일 금요일 텐바이텐 공지사항에 기재 및 개별 연락 드릴 예정입니다.</li>
        </ul>
    </div>
</div>
