	...
	<div class="container popWin">
		...
		<div class="content" id="contentArea">
			<div class="heySomething">
				<div class="get">
					<div class="item">
						<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/hey/68133/m/img_get_pineapple.jpg" alt="WOOUF Laptop Banana 구매하기" /></p>
						<%' for dev msg : 상품 링크 %>
						<ul>
							<li>
								<% If isApp="1" Then %>
							...
							<li>
								<% If isApp="1" Then %>
									<a href="" onclick="fnAPPpopupProduct('1403590'); return false;">
								<% Else %>
									<a href="/category/category_itemPrd.asp?itemid=1403590&amp;pEtr=68133">
								<% End If %>
							...
							<li>
								<% If isApp="1" Then %>
									<a href="" onclick="fnAPPpopupProduct('1385747'); return false;">
								<% Else %>
									<a href="/category/category_itemPrd.asp?itemid=1385747&amp;pEtr=68133">
								<% End If %>
									<span></span>iPad
								</a>
							</li>
							<li>
								<% If isApp="1" Then %>
									<a href="" onclick="fnAPPpopupProduct('1385764'); return false;">
								<% Else %>
									<a href="/category/category_itemPrd.asp?itemid=1385764&amp;pEtr=68133">
								<% End If %>
									<span></span>iPad Mini
								</a>
							</li>
