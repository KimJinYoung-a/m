	...
	//이중 옵션 인경우 필요(li 형식의 옵션)
	function CheckMultiLi(compid, compvalue, compname, compobj){
//		var frm = comp.form;
		var compid = compid;
		...
		//var optSelObj = eval(frm.name + "." + compname);
		var optSelObj = $(".optForm ul[name='" + compname + "']");
...
//		for (var member in PreSelObj){
//			alert(member+'='+PreSelObj[member]+'\n');
//		}
