                ...
                <li>
                    <a @click="itemUrl(isApp , item.itemid)">
                        ...
                        <div class="desc">
                            ...
                            <button class="btn-bag" @click.stop="addCart(isApp, item.itemid , item.itemoptioncount)"><img src="//webimage.10x10.co.kr/fixevent/event/2021/110079/m/btn_wish.png" alt="장바구니 담기"></button>
                        </div>
                    </a>
                </li>
                `,
