				...
				<div class="inner5">
					...
					<div class="policyCont">
						...
						<section id="terms07">
							...
							<h4>부칙(2016.5.27)</h4>
							<p>본 약관은 2016년 6월 7일부터 적용됩니다.</p>
							<p class="tPad05"><a href="" onclick="fnOpenModal('/member/pop_viewUsageTerms_20160607.asp'); return false;" style="text-decoration:underline;">이전약관 보기</a> <a href="" onclick="fnOpenModal('/member/pop_viewUsageTerms.asp'); return false;" style="text-decoration:underline;">개정 후 서비스 약관 보기</a></p>
						</section>
					</div>
				</div>
				<!--// 이용약관 -->
