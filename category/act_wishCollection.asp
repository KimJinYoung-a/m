	...
	<div class="swiper-container swiper2">
		<div class="swiper-wrapper">
			...
			<div class="swiper-slide">
				<div class="titWrap">
					<div class="pvtImg"><a href="/my10x10/myWish/myWish.asp?ucid=<%=server.Urlencode(tenEnc(oWishCol.FItemList(0).Fuserid))%>"><img src="http://fiximage.10x10.co.kr/web2015/common/img_profile_<%=Num2Str(getDefaultProfileImgNo(oWishCol.FItemList(0).Fuserid),2,"0","R")%>.png" alt="프로필 이미지" /></a></div>
				...
				%>
					<li>
						<a href="/category/category_itemPrd.asp?itemid=<%=oWishCol.FItemList(i).Fitemid%>">
			...
			<div class="swiper-slide">
				<div class="titWrap">
					<div class="pvtImg"><a href="/my10x10/myWish/myWish.asp?ucid=<%=server.Urlencode(tenEnc(oWishCol.FItemList(i+1).Fuserid))%>"><img src="http://fiximage.10x10.co.kr/web2015/common/img_profile_<%=Num2Str(getDefaultProfileImgNo(oWishCol.FItemList(i+1).Fuserid),2,"0","R")%>.png" alt="프로필 이미지" /></a></div>
					<h2>WISH COLLECTION</h2>
