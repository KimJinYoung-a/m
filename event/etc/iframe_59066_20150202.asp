...
.item ul {overflow:hidden; position:absolute; top:13%; left:0; width:100%; padding:0 4%;}
.item ul li {}
.item ul li a {display:block; padding:28% 0; font-size:11px; line-height:1.25em; text-align:center; text-indent:-999em;}
.item ul li:nth-child(2), .item ul li:nth-child(3) {float:left; width:50%; margin-top:3%;}
.item ul li:nth-child(2) a, .item ul li:nth-child(3) a {padding:55% 0; margin:0 1%;}
.item2 ul {top:13.5%;}
...
<div class="mEvt59067">
	<div class="topic">
		...
		<div id="mo">
			<div class="item">
				<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/59067/img_gift_01.jpg" alt ="7만원이상 구매시" /></p>
				<ul>
					<% if isApp=1 then %>
						<li><a href="" onclick="parent.fnAPPpopupProduct('1198446'); return false;">[곽명주x에이미] 초콜릿</a></li>
						<li><a href="" onclick="parent.fnAPPpopupProduct('1133680'); return false;">SMILES SWITCH LIGHT</a></li>
						<li><a href="" onclick="parent.fnAPPpopupProduct('1195675'); return false;">디스펜서 + 마스킹테이프</a></li>
					<% else %>
						<li><a href="/category/category_itemPrd.asp?itemid=1198446" target="_top">[곽명주x에이미] 초콜릿</a></li>
						<li><a href="/category/category_itemPrd.asp?itemid=1133680" target="_top">SMILES SWITCH LIGHT</a></li>
						<li><a href="/category/category_itemPrd.asp?itemid=1195675" target="_top">디스펜서 + 마스킹테이프</a></li>
					<% end if %>
				</ul>
			</div>
			<div class="item item2">
				<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/59067/img_gift_02.jpg" alt ="15만원이상 구매시 택 일" /></p>
				<ul>
					<% if isApp=1 then %>
						<li><a href="" onclick="parent.fnAPPpopupProduct('1195460'); return false;">샤오미 보조배터리</a></li>
						<li><a href="" onclick="parent.fnAPPpopupProduct('1171539'); return false;">써모머그 엄브렐러 보틀</a></li>
						<li><a href="" onclick="parent.fnAPPpopupProduct('961666'); return false;">Table talk WALLET</a></li>
					<% else %>
						<li><a href="/category/category_itemPrd.asp?itemid=1195460" target="_top">샤오미 보조배터리</a></li>
						<li><a href="/category/category_itemPrd.asp?itemid=1171539" target="_top">써모머그 엄브렐러 보틀</a></li>
						<li><a href="/category/category_itemPrd.asp?itemid=961666" target="_top">Table talk WALLET</a></li>
					<% end if %>					
				</ul>
			</div>
		</div>
