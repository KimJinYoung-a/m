...
<title>텐바이텐을 좋아요한 그 손 참 곱다~</title>
<style type="text/css">
.mEvt59413 {}
...
<script>
	...
	var frm = document.frm;
		...
		frm.action = "/event/etc/sns/59413_proc.asp";
...
<div class="mEvt59413">
	<div class="likeTenten">
		<h2><img src="http://webimage.10x10.co.kr/eventIMG/2015/59413/tit_like_tenten.gif" alt="텐바이텐을 좋아요한 그 손 참 곱다~" /></h2>
		...
		<div class="palm">
			...
			<span class="btnResult"><a href="#viewResult" onclick="jsSubmit();"><img src="http://webimage.10x10.co.kr/eventIMG/2015/59413/btn_view_result.gif" alt="결과확인" /></a></span>
		...
		<div class="openLayer">
			<!-- 페이스북 로그인 -->
			<div class="fbLogin" id="loginlayer">
				<div class="palmLyCont">
					...
					<a href="javascript:eventGo();" class="btnFb">페이스북 로그인하기</a>
				</div>
			</div>
	...
	<%
		...
		'// 카카오링크 변수
		Dim kakaotitle : kakaotitle = "[텐바이텐]이랑 친구하고 손금 보러 가자!"
		...
		Dim kakaolink_url
			If isapp = "1" Then '앱일경우
				kakaolink_url = "http://m.10x10.co.kr/apps/appcom/wish/web2014/event/eventmain.asp?eventid=59413"
			Else '앱이 아닐경우
				kakaolink_url = "http://m.10x10.co.kr/event/eventmain.asp?eventid=59413"
			end if 
	%>
	<div class="shareSns">
		...
		<a href="" onclick="parent.parent_kakaolink('<%=kakaotitle%>','<%=kakaoimage%>','<%=kakaoimg_width%>','<%=kakaoimg_height%>','<%=kakaolink_url%>');return false;" class="kakao">kakao talk</a>
	</div>
	<!--// sns 공유 -->
</div>
