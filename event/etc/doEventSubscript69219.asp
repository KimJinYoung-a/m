...
if mode="coupondown" then
	...
	'// 2월 23일만 오전 10시부터 응모 가능함 그다음은 0시부터 응모가능
	If Left(currenttime, 10) = "2016-02-23" Then
	...
	'//결과페이지 만듬
	cLayerValue = ""
	cLayerValue = cLayerValue & " <div class='layerCont'> "
	cLayerValue = cLayerValue & " <a href='' onclick='goDirOrdItem();return false;'> "
	if subscriptcount>0 or itemcouponcount>0 then
		'// <!-- 이미 발급 받은 경우 -->
		cLayerValue = cLayerValue & " <img src='http://webimage.10x10.co.kr/eventIMG/2016/69219/m/img_layer_buy_02.png' alt='이미 쿠폰이 발급되었습니다' /> "
	Else
		cLayerValue = cLayerValue & " <img src='http://webimage.10x10.co.kr/eventIMG/2016/69219/m/img_layer_buy_01.png' alt='쿠폰이 발급되었습니다' /> "
	End If
	cLayerValue = cLayerValue & " </a> "
	cLayerValue = cLayerValue & " <button class='btnClose' onclick='poplayerclose();return false;'><img src='http://webimage.10x10.co.kr/eventIMG/2016/69219/m/btn_layer_close.png' alt='닫기' /></button> "
	cLayerValue = cLayerValue & " </div> "


	if subscriptcount>0 or itemcouponcount>0 then
		Response.Write "04||"&cLayerValue
		dbget.close() : Response.End
	end if
