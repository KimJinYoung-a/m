...
Dim caText1,caText2, tempReferer
...
if mode="add" then
	...
	caText1 = requestCheckVar(request.Form("caText1"),128)
	caText2 = requestCheckVar(request.Form("caText2"),128)

	txtcomm = caText1&caText2
