...
response.write "<br><br>"&G_Uagent&"<bR>"&G_IsIE
...
<a href="http://m.10x10.co.kr/apps/appCom/wish/web2014/my10x10/mytodayshoppingTT.asp">최근본상품</a>
<br><br>
<input type="button" value="tenwishapp://" onClick="aa('tenwishapp://');">
<br><br>
<input type="button" value="tenwishapp://App_1" onClick="aa('tenwishapp://App_1');">
<br><br>
