...
<!-- Common Component -->
<script src="../../common/tgl_type1.js?v=1.0"></script>
<script src="../../product/prd_img.js?v=1.0"></script>
<!-- //Common Component -->

<!-- Review Component -->
<script src="../rv_info.js?v=1.0"></script>
<script src="../rv_list_type1.js?v=1.0"></script>
<!-- //Review Component -->
...
<script>
	var app = new Vue({
		...
		template: '\
			<div>\
				<Review-List-Type1 :reviews="reviews"></Review-List-Type1>\
			</div>\
		',
		computed : {
