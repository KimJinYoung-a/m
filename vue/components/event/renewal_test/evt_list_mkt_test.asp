...
<script src="../evt_list_mkt.js?v=1.0"></script>
<!-- //Event Component -->

<!-- 핵심 JS -->
<script src="store_mkt_test.js?v=1.0"></script>
<script>
	var app = new Vue({
		el: '#app',
		store: store,
		template: '\
			<div>\
				<Event-List-Marketing :events="events"></Event-List-Marketing>\
			</div>\
		',
		computed : {
			events : function() { // 이벤트 리스트
