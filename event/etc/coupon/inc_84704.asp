...
<style type="text/css">
.mEvt84704 {background-color:#6a77d9;}
...
function jsevtDownCoupon(stype,idx){
	<% If IsUserLoginOK() Then %>
		<% If now() > #02/26/2018 23:59:59# then %>
			alert("이벤트 기간이 아닙니다.");
			return;
		<% else %>
				var str = $.ajax({
					type: "POST",
					url: "/event/etc/coupon/couponshop_process_84704.asp",
...
<div class="mEvt84704">
	<h2><img src="http://webimage.10x10.co.kr/eventIMG/2018/84704/m/tit_benefit.jpg" alt="비정상 헤택 고객님, 고객님의 두번째 구매를 도와드릴 10% 할인 쿠폰을 드립니다!" /></h2>
	<div class="inner">
		<p class="oneday"><img src="http://webimage.10x10.co.kr/eventIMG/2018/84704/m/txt_oneday.png" alt="단 하루"/></p>
		<button onclick="jsevtDownCoupon('evtsel','<%= getbonuscoupon %>'); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2018/84704/m/txt_event_info.jpg?v=1" alt="1만원 이상 구매 시 10% 할인 쿠폰"/></button>
	</div>
	<div class="noti">
