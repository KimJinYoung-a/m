...
If oshoppingbag.FShoppingBagItemCount > 0 Then
	For r = 0 to oshoppingbag.FShoppingBagItemCount -1
		'GSShop WSC용
		gswscItem = gswscItem & chkIIF(gswscItem="","",",") & """" & oshoppingbag.FItemList(r).FItemID & """"
	Next
End If
if gswscItem<>"" then GSShopSCRIPT = "	var _wcsq = {pageType: ""CART"",cartItemList: [" & gswscItem & "],};"
...
<script type="text/javascript" src="/apps/appCom/wish/webview/js/shoppingbag_script.js?v=1.0"></script>
					...
					%>
                        <li>
                            ...
                            <div class="three-btns">
                                ...
                                <div class="col">
                                	<% if Not(oshoppingbag.FItemList(i).IsMileShopSangpum) then %><input type="button" class="btn type-b small" onClick="DirectOrder('<%= idx %>');" value="바로주문"><% end if %>
                                </div>
                            </div>
                            <div class="clear"></div>
                        </li>
