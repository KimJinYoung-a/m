...
%>
	<section class="todayMdPickV15">
		...
		<span class="goMore"><a href="/mdpicklist/">MD'S PICK 상품 더보기</a></span>
...
%>
				<li onclick="javascript:location.href='/category/category_itemPrd.asp?itemid=<%=itemid%><%=gaParam%>'" class="<%=chkiif(LimitYn="Y" And limitno <= 10 And limitdispyn = "Y" ,"hurryUp","")%>">
...
//				var rstStr = $.ajax({
//						type: "POST",
//						url: "/chtml/main/loader/2015loader/main_mdpick_B_ajax.asp",
//						data: "mode=add",
//						dataType: "text",
//						async: false
//					}).responseText;
...
//
//			}else{
//				location.href ='/mdpicklist/?gaparam=todaymain_E';
//			}
//		}
//		
//		function pageup(){
