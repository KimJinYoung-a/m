...
<%
dim eCode, com_egCode, bidx,Cidx, eLinkCode
dim userid, txtcomm, txtcommURL, mode, spoint
Dim qtext1,qtext2,qtext3
...
txtcomm = requestCheckVar(request.Form("txtcomm"),800)
...
referer = request.ServerVariables("HTTP_REFERER")&"#ToyCom"
...
'		response.write "<script>alert('설날엔 역시 텐바이텐!\n응모해주셔서 감사합니다.\n새해 복 많이 받으세요.');</script>"
