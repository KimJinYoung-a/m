	...
	$(window).scroll(function() {
		if ($(window).scrollTop() >= ($(document).height()-$(window).height())-512){
			if(vScrl) {
				...
				if(vPg <= <%=oGiftcard.FTotalPage%>){
					$.ajax({
						url: "giftcardRegistlist_act.asp?pgReg="+vPg,
						cache: false,
			...
			<div class="giftcardRegiListV15a inner10">
				<div class="tab02">
					<ul class="tabNavV15a tNum4">
						...
						<li class="current"><a href="/apps/appCom/wish/web2014/my10x10/giftcard/giftcardRegistlist.asp">등록내역</a></li>
