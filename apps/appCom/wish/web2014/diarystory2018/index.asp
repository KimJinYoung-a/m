...
$(function() {
	fnAPPchangPopCaption('2018 다이어리');
...
function searchlink(v){
	if (v == ""){
		fnAPPpopupBrowserURL('다이어리 리스트','<%=wwwUrl%>/apps/appCom/wish/web2014/diarystory2018/list.asp');
	}else{
		var listurl="<%=wwwUrl%>/apps/appCom/wish/web2014/diarystory2018/list.asp?arrds=" + v + ",";
...
function weeklink(v){
	if (v == ""){
		fnAPPpopupBrowserURL('다이어리','<%=wwwUrl%>/apps/appCom/wish/web2014/diarystory2018/index.asp');
	}else{
...
<body class="default-font body-<%=chkiif(gnbflag,"sub","main")%>">
	...
	<div id="content" class="content diary-main">
		...
		<!-- main rolling -->
		<div class="main-rolling" id="mainrolling">
				...
				<div class="swiper-wrapper">
					...
					<% if cDiaryE.FTotalCount > 0 then %>
						<% for i = 0 to cDiaryE.FTotalCount -1 %>
							<div class="swiper-slide">
								<a href="" onclick="weeklink('<%=cDiaryE.FItemList(i).Flinkpath%>'); return false;">
		...
		<!--<div class="diary-collabo"><a href="" onclick="fnAPPpopupBrowserURL('사은품','http://m.10x10.co.kr/apps/appCom/wish/web2014/diarystory2018/gift.asp'); return false;"><img src="http://fiximage.10x10.co.kr/web2017/diary2018/m/bnr_gift_v3.jpg" alt="구매금액별 사은품 + 무료배송" /></a></div>-->
		...
		<div class="category-item-content">
			<section class="category-item-list">
				...
				<div class="items">
					<ul>
						<!-- #include virtual="/apps/appcom/wish/web2014/diarystory2018/inc/inc_mdpick.asp" -->
					</ul>
				</div>
				<div class="btn-group">
					<a href="" onclick="fnAPPpopupBrowserURL('다이어리 리스트','<%=wwwUrl%>/apps/appCom/wish/web2014/diarystory2018/list.asp'); return false;" class="btn-plus color-blue"><span class="icon icon-plus icon-plus-blue"></span> 더 많은 다이어리</a>
				</div>
			</section>
		</div>
			...
			<section id="exhibitionList" class="exhibition-list">
				...
				<div class="list-card type-align-left">
					<ul>
						...
						<!-- #include virtual="/apps/appcom/wish/web2014/diarystory2018/inc/inc_event_main.asp" -->
					</ul>
				</div>
			</section>
			<div class="btn-group">
				<a href="" onclick="fnAPPpopupBrowserURL('다이어리 이벤트','<%=wwwUrl%>/apps/appCom/wish/web2014/diarystory2018/event.asp?gnbflag=1'); return false;" class="btn-plus color-blue"><span class="icon icon-plus icon-plus-blue"></span> 더 많은 다이어리 기획전</a>
			</div>
		</div>
		...
		<div class="event-bnr">
			...
			<ul>
				...
				<li class="event7">
					<a href="/street/street_brand.asp?makerid=midori2" class="mWeb">MIDORI</a>
					<a href="" onclick="fnAPPpopupBrand('midori2'); return false;" class="mApp">MIDORI</a>
				</li>
			</ul>
		...
		<div class="best-diary">
			<div class="best-items-list">
				...
				<div class="items type-list tenten-best-default">
					<ul>
						<!-- #include virtual="/apps/appcom/wish/web2014/diarystory2018/inc/inc_best.asp" -->
					</ul>
				</div>
			</div>
			<div class="btn-group">
