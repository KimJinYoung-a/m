...
<!-- #include virtual="/apps/appcom/wish/webview/event/etc/event54471Cls.asp" -->
...
<style type="text/css">
.mEvt54471 {position:relative; border-bottom:2px solid #9e2020;}
.mEvt54471 img {vertical-align:top; width:100%;}
.mEvt54471 p {max-width:100%;}
...
.wellorganized .sectionA .btnEvent {padding:0 10% 8%;}
.wellorganized .sectionB {background-color:#ffd2d2; text-align:left;}
	  ...
	  Kakao.Link.sendTalkLink({
		 ...
		 appButton: {
			...
			<% IF application("Svr_Info") = "Dev" THEN %>
				android: { url: encodeURIComponent('http://testm.10x10.co.kr:8080/apps/appCom/wish/webview/event/eventmain.asp?eventid=<%= getevt_code %>')},
				iphone: { url: 'http://testm.10x10.co.kr:8080/apps/appCom/wish/webview/event/eventmain.asp?eventid=<%= getevt_code %>'}
			<% Else %>
				android: { url: encodeURIComponent('http://m.10x10.co.kr/apps/appCom/wish/webview/event/eventmain.asp?eventid=<%= getevt_code %>')},
				iphone: { url: 'http://m.10x10.co.kr/apps/appCom/wish/webview/event/eventmain.asp?eventid=<%= getevt_code %>'}
			<% End If %>
			}
		  },
		  installTalk : Boolean
...
<div class="mEvt54471">
	<div class="wellorganized">
		<div class="section sectionA">
			...
			<div class="btnGo"><a href="/apps/appCom/wish/webview/event/eventmain.asp?eventid=54561" target="_top"><img src="http://webimage.10x10.co.kr/eventIMG/2014/54470/btn_go_play.gif" alt="텐바이텐 X 덴스 쇼퍼백 PLAY 바로가기" /></a></div>
			...
			<div class="btnEvent"><a href="/apps/appcom/wish/webview/event/eventmain.asp?eventid=54619" target="_top"><img src="http://webimage.10x10.co.kr/eventIMG/2014/54471/btn_go.png" alt="아쉽게 3만원이 안된다면 여기로 오라!" /></a></div>
		</div>
		...
		snpLink = Server.URLEncode("http://10x10.co.kr/event/54469")		' & ecode
