...
snpLink = Server.URLEncode("http://m.10x10.co.kr/event/eventmain.asp?eventid=74249")
...
function getcoupon(){
	<% If IsUserLoginOK() Then %>
		<% If Now() > #11/14/2016 10:00:00# and Now() < #11/18/2016 23:59:59# Then %>
			<% if isApp=1 then %>
				var result;
					$.ajax({
						type:"GET",
						url:"/apps/appcom/wish/web2014/event/etc/doeventsubscript/doEventSubscript74249.asp",
						data: "mode=I",
						dataType: "text",
						async:false,
						success : function(Data){
							...
							if (result.resultcode=="11"){
								...
								$("#lyWin").show();
								$("#dimmed").show();
								window.$('html,body').animate({scrollTop:550}, 500);
							}
...
<div>
	...
	<p>인스탁스 미니 8 카메라 (그레이프) : <font color="BLUE"><%=wincnt2%></font> / 남은수량 : <font color="RED"><% response.write 1 - wincnt2 %></font> </p>
	<p>히트템 레이디 (12개) : <font color="BLUE"><%=wincnt3%></font> / 남은수량 : <font color="RED"><% response.write 800 - wincnt3 %></font> </p>
	<p>눈꽃 전구 : <font color="BLUE"><%=wincnt4%></font> / 남은수량 : <font color="RED"><% response.write 700 - wincnt4 %></font> </p>
...
<div class="mEvt74249 happiness4000">
	<div class="topic">
		...
		<p><img src="http://webimage.10x10.co.kr/eventIMG/2016/74249/m/txt_four_thousand.png" alt="앱에서 처음 로그인한 분에게 드리는 4천원의 행복! 지금 응모하고 확인해보세요!" /></p>
	</div>
	<div class="item">
		<ul>
			<li>
				<a href="/apps/appCom/wish/web2014/category/category_itemPrd.asp?itemid=1164622&pEtr=74249" onclick="fnAPPpopupProduct('1164622&pEtr=74249');return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2016/74249/m/img_item_01.jpg" alt="리플렉트 에코히터" /></a>
			</li>
			<li>
				<a href="/apps/appCom/wish/web2014/category/category_itemPrd.asp?itemid=770217&pEtr=74249" onclick="fnAPPpopupProduct('770217&pEtr=74249');return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2016/74249/m/img_item_02.jpg" alt="인스탁스 미니 카메라" /></a>
			</li>
			<li>
				<a href="/apps/appCom/wish/web2014/category/category_itemPrd.asp?itemid=1378976&pEtr=74249" onclick="fnAPPpopupProduct('1378976&pEtr=74249');return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2016/74249/m/img_item_03.jpg" alt="히트템 레이디" /></a>
			</li>
			<li>
				<a href="/apps/appCom/wish/web2014/category/category_itemPrd.asp?itemid=1278817&pEtr=74249" onclick="fnAPPpopupProduct('1278817&pEtr=74249');return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2016/74249/m/img_item_04.jpg" alt="눈꽃전구" /></a>
			</li>
		</ul>
		<%' for dev msg : 응모하기 %>
		<a href="" id="btnGet" onclick="getcoupon();return false;" class="btnGet"><img src="http://webimage.10x10.co.kr/eventIMG/2016/74249/m/btn_get.png" alt="응모하기" /></a>
	</div>
	<%' for dev msg : layer %>
