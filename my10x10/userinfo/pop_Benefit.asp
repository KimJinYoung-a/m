...
<div class="heightGrid">
	<div class="container popWin">
		<div class="header">
			<h1>10X10 등급혜택</h1>
			<p class="btnPopClose"><button onclick="self.close();" class="pButton">닫기</button></p>
		</div>
		<!-- content area -->
		<div class="content" id="contentArea">
			<%
			'/ 등급별로 클래스 mVIPGOLD/mVIPSILVER/mBLUE/mGREEN/mYELLOW/mORANGE/mSTAFF 넣어주세요
			dim tmpCSLeftMenuUserLevel : tmpCSLeftMenuUserLevel = GetUserLevelCSSClass
			%>
			<div class="gradeBenefit <%= tmpCSLeftMenuUserLevel %>">
				<p class="mGrade"><span><em class="cBk1"><%=GetLoginUserName%></em>님은 <strong></strong>등급입니다.</span></p>
				<div class="inner5">
					<div class="box2">
						<dl class="g01">
