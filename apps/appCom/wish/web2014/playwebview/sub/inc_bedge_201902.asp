...
<%
'####################################################
' Description : 띵 배지 2월 (수작업)
' History : 2019-02-08 최종원
'####################################################
dim oItem
...
eventStartDate = Cdate("2019-02-08")
evnetEndDate = Cdate("2019-02-17")
presentDay = #02/17/2019 23:59:59#
...
if InStr(nowUrl,"/apps/appcom/wish/web2014/playwebview/detail.asp") > 0 then
	...
	returnUrl = appUrlPath & "/subgnb/thingbedge/?pagereload=ON"
end if
...
<article class="playDetailV16 thingthing">
	<div class="hgroup">
		<div>
			...
			<h2 style="margin-bottom:0.3rem; font-size: 1.7rem; letter-spacing: -0.1rem;">새 학기마다 사게 되는<br>물건이 있나요?</h2>
		</div>
	</div>			
	<div class="badge-detail">
		<div id="thingRolling" class="swiperFull">
			<div class="swiper-container">
				<div class="swiper-wrapper">
					<div class="swiper-slide"><img src="//webimage.10x10.co.kr/fixevent/play/badge/img_badge_201902_1.jpg" alt=""></div>
					<div class="swiper-slide"><img src="//webimage.10x10.co.kr/fixevent/play/badge/img_badge_201902_2.jpg" alt=""></div>
					<div class="swiper-slide"><img src="//webimage.10x10.co.kr/fixevent/play/badge/img_badge_201902_3.jpg" alt=""></div>
				</div> 
				<div class="paginationDot"></div>
			</div>
		</div>
		<div class="itemDesc" style="background-color:#864628;">
		<% if now() <= presentDay then %>
			<p>새 학기만 되면 노트 세트와<br>샤프를 다시 사곤 했어요.<br>여러분도 분명 어딘가에 있는데<br>새 학기만 되면 꼭 다시 사게 되는<br>물건이 있나요?</p>
		<% else %>
			<p>새 학기마다 사게 되는 아이템을<br/>공유해 주셔서 감사합니다.<br/>자꾸 구매하게 되는 건 그만큼<br/>꼭 필요한 물건이기 때문 아닐까요?<br/>다음 달에도 재미있는 주제로 함께<br/>이야기하고 띵배지도 받으세요 : )</p>
		<% end if %>
			<div class="btnGet">
				<a href="/category/category_itemPrd.asp?itemid=2223426" onclick="TnGotoProduct('2223426');return false;">배지 구매하러가기</a>
			</div>
		</div>
		...
		<% if now() <= presentDay then %>					
			<div class="desc">
				<p class="msg" style="color:#864628;">새 학기에 또 사게 되는 물건을<br/>적어주신 분들 중 20분에게<br/>2월의 THING배지를 드립니다.<br/>(12자 이내로 짧게 적어주세요!)</p>
				<p class="date">응모기간 : 2019.2.11 ~ 2.17 <span>|</span> 발표 : 2.18</p>
			</div>
			<div class="form">
				...
				<input type="hidden" name="spoint"/>						
					...
					<legend class="hidden">코멘트 등록</legend>
						<input type="text" maxlength="12" id="txtcomm" onClick="jsCheckLimit();" name="txtcomm" title="코멘트 등록" placeholder="예) 실내화" style="border-color:#864628;" />
						<input type="button" onclick="jsSubmitComment(document.frmcom);return false;" value="등록하기" style="background-color:#864628; color:#fff; margin-top:0.75rem;" />
					</fieldset>								
				</form>		
		...
		<div class="other">
			<h3>또 만나서 반가워</h3>
			<ul>
				<li><span style="border-color:#864628; color:#864628;">다신안보는오답노트</span></li>
				<li><span style="border-color:#864628; color:#864628;">네임스티커, 내꼬얌</span></li>
				<li><span style="border-color:#864628; color:#864628;">엄마가싫어하는흰양말</span></li>
				<li><span style="border-color:#864628; color:#864628;">색색깔펜있어도다시한번</span></li>
				<li><span style="border-color:#864628; color:#864628;">검은색 볼펜 몇 자루</span></li>
				<li><span style="border-color:#864628; color:#864628;">앗 실수 ..수정테이프</span></li>
			</ul>
		</div>						
		<% end if %>						
		</div>
		...
		<div class="listComment" id="comment">
			...
			<ul>
				...
				<li>
					<span><em style="color:#864628;"><%=ReplaceBracket(db2html(arrCList(1,intCLoop)))%></em>
