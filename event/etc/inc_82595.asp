...
dim eCode, vUserID, cMil, vMileValue, vMileArr
	...
	'vUserID = "10x10yellow"
	If Now() > #11/30/2017 00:00:00# AND Now() < #11/30/2017 23:59:59# Then
		vMileValue = 200
	Else
		vMileValue = 100
	End If
...
%>
<style type="text/css">
.double-mileage {background-color:#465795;}
...
.my-mileage h3 span {color:#eb3b34;}
...
<div class="mEvt82595 double-mileage">
	<h2><img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/m/tit_double_mileage.png" alt="X2 마일리지 - 오늘 하루 동안 상품후기 작성하면 마일리지 2배 적립!" /></h2>
	<p><img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/m/txt_mileage.png" alt="상품후기를 쓰면 200마일리지, 첫 상품후기를 쓰면 400마일리지 적립" /></p>
	<div class="my-mileage">
		...
		<div class="btn-group">
			<% If IsUserLoginOK Then %>
				...
				<% End If %>
				<img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/m/btn_mileage.png" alt="상품후기쓰고 더블 마일리지 받기" /></a>
			<% Else %>
				<a href="" onClick="jsSubmitComment(); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2017/82595/m/btn_login.png" alt="로그인하기" /></a>
			<% End If %>
		</div>
	</div>
	<div class="noti">
