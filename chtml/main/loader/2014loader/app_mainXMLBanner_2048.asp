...
%>
		<div class="inner5"><img src="<%= image %>" alt="<%= altname %>" onclick="fnAPPpopupPlay_URL('http://m.10x10.co.kr/apps/appCom/wish/web2014<%= link %>');return false;"/></div>
<%
			i = i + 1
