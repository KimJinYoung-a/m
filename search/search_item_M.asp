...
<!-- #include virtual="/lib/classes/search/searchcls_M2.asp" -->
<!-- #include virtual="/lib/classes/item/CategoryCls.asp" -->
<!-- #include virtual="/lib/util/pageformlib.asp" -->
<!-- #INCLUDE Virtual="/lib/chkDevice.asp" -->
<!-- #include virtual="/lib/util/memcacheLib2.asp" -->
<%
...
function popFilterSearch(){
	...
	fnOpenModal('/category/pop_Filter.asp?rect='+rect+'&disp='+disp+'&mkr='+mkr+'&iccd='+iccd+'&styleCd='+styleCd+'&attribCd='+attribCd+'&deliType='+deliType+'&minPrc='+minPrc+'&maxPrc='+maxPrc+'&lstDiv='+lstDiv);
}
</script>
</head>
<body>
