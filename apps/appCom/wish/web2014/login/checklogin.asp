...
'// 2008.06.25 정윤정 수정. post data 값 추가
	dim checklogin_backpath
  	dim strBackPath, strGetData, strPostData	
		...
		'If Trim(strPostData)="" Then
		'	response.write "<script>fnAPPpopupLogin();return false;</script>"
		'Else
			'Response.redirect "/apps/appCom/wish/web2014/login/login.asp?" + checklogin_backpath
			response.write "<script type='text/javascript'>"
			response.write "	location.href='/apps/appCom/wish/web2014/login/login.asp?"& checklogin_backpath &"';"
