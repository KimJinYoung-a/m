...
.discoveryTenbyten .buySum ul li .soldOut {display:none; position:absolute; left:0; top:0; width:100%;}
...
.discoveryTenbyten .note ul li strong, .discoveryTenbyten .note ul li em {color:#d60c0b;}
@media all and (max-width:480px){
		...
		<div class="buySum">
			...
			<ul>
				<li>
					...
					<span class="soldOut" style="display:block;"><img src="http://webimage.10x10.co.kr/eventIMG/2014/50694/img_sold_out_01.png" alt="Sold Out" /></span>
				</li>
				<li>
			...
			<ul>
				<li>
					...
					<span class="soldOut" style="display:block;"><img src="http://webimage.10x10.co.kr/eventIMG/2014/50694/img_sold_out_03.png" alt="Sold Out" /></span>
				</li>
				<li>
					<!--  style="display:block;" -->
