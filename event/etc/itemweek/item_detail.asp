...
.item_week .deal_list ul li .prd_num{font-size:0.94rem;line-height:0.94rem;letter-spacing:-0.01em;padding:0.74rem 0.64rem 0.34rem;border:1px solid #000;border-radius: 0.85rem;width:fit-content;margin:0 auto;margin-bottom:0.85rem;font-family:'CoreSansCRegular', 'AppleSDGothicNeo-Medium', 'NotoSansKRMedium';}
...
<script src="/vue/event/etc/itemweek/itemDetail.js?v=1.00"></script>
