...
If not( left(Now(),10)>="2016-07-27" and left(Now(),10)<"2016-08-01" ) Then
...
'// 마일리지 로그 테이블에 넣는다.
vQuery = " insert into db_user.dbo.tbl_mileagelog(userid , mileage , jukyocd , jukyo , deleteyn) values ('"&userid&"', '+1000','1000', '마일리지 돌려받기 이벤트 마일리지 지급','N') "
dbget.Execute vQuery
