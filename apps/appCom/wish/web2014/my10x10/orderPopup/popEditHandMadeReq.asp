...
function chmyorderdetail(orderserial){
	location.replace('/apps/appCom/wish/web2014/my10x10/order/myorderdetail.asp?idx='+orderserial);
}
			...
			<div class="userInfo userInfoEidt inner10">
				...
				<legend>주문제작 문구수정 변경</legend>
					<% if (myorderdetail.FResultCount>0) then %>
						<form name="frm" method="post" action="/apps/appCom/wish/web2014/my10x10/orderPopup/EditOrderInfo_process.asp" style="margin:0px;">
