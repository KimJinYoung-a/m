		...
		<div class="cont">
			...
			<div class="myStorage">
				<ul class="tabMenu">
					...
					<li class="order">
						<a href="/apps/appCom/between/my10x10V2/order/myorderlist.asp"><p>주문/배송 조회</p></a>
					</li>
				</ul>
				<!--
				<ul class="myList">
					<li><a href="/apps/appCom/between/my10x10V2/order/myordercancellist.asp"><p>취소/교환/반품 내역</p></a></li>
				</ul>
				-->
			</div>
			<!--// 내 보관함 -->
			...
			<div class="myGuide">
				<ul class="myList">
					<li><a href="/apps/appCom/between/my10x10V2/notice.asp"><p>공지사항</p> <%=Chkiif(WeekNotiCnt > 0, "<span class='newIco saleRed'>"&WeekNotiCnt&"</span>", "")%></a></li>
					<li><a href="/apps/appCom/between/my10x10V2/faq.asp"><p>FAQ</p></a></li>
					<li><a href="/apps/appCom/between/my10x10V2/cscenter.asp"><p>텐바이텐 고객센터</p></a></li>
				</ul>
			</div>
			<!--// 안내 -->
		</div>
