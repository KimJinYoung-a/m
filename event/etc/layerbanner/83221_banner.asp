<%
	If request.Cookies("evt83221")<>"x" then
%>
<style type="text/css">
.window {display:none;}
...
function hideLayer83221(){
	$('#boxes').hide();
	$('#boxes .window').hide();
	$('#mask').hide();

    var todayDate = new Date('2017/12/25 23:59:59'); 
    document.cookie = "evt83221=x; path=/; domain=10x10.co.kr; expires=" + todayDate.toGMTString() + ";" 
}
</script>
	...
	<div id="boxes">
		...
		<div class="window">
			<div class="lyFrontBnr">
				<div class="lyCont">
					<a href="/event/eventmain.asp?eventid=83221&gaparam=today_layerbanner_83221"><img src="http://webimage.10x10.co.kr/eventIMG/2017/83221/m/img_bnr_front.jpg?v=1.1" alt="연휴특가 ~74% 크리스마스연휴, 단 4일간의 혜택" /></a>
				</div>
				<div class="lyBtm">
					<div class="anymore"><input type="checkbox" id="closeToday" class="check"  onclick="hideLayer83221();"/> <label for="closeToday">다시보지 않기</label></div>
