...
.designFingers .form .choice li button {width:58px; height:58px; background:transparent url(http://webimage.10x10.co.kr/eventIMG/2015/66049/m/bg_ico.png) no-repeat 0 0; background-size:406px auto; font-size:11px; text-indent:-999em;}
...
.designFingers .form .choice li.ico5 {clear:left;}
...
.designFingers .form .choice li.ico6 button {background-position:-290px 0;}
.designFingers .form .choice li.ico6 button.on {background-position:-290px 100%;}
.designFingers .form .choice li.ico7 button {background-position:100% 0;}
.designFingers .form .choice li.ico7 button.on {background-position:100% 100%;}
...
.commentlist ul li strong {position:absolute; top:50%; left:0; width:58px; height:58px; margin-top:-29px; background:url(http://webimage.10x10.co.kr/eventIMG/2015/66049/m/bg_ico.png) no-repeat 0 0;background-size:406px auto; font-size:11px; text-indent:-999em;}
...
.commentlist ul li .ico6 {background-position:-290px 0;}
.commentlist ul li .ico7 {background-position:100% 0;}
...
@media all and (min-width:480px){
	.designFingers .form .choice li {float:left; width:87px; height:87px; margin:7px 6px;}
	.designFingers .form .choice li button {width:87px; height:87px; background-size:609px auto;}
	.designFingers .form .choice li.ico2 button {background-position:-87px 0;}
	.designFingers .form .choice li.ico2 button.on {background-position:-87px 100%;}
	.designFingers .form .choice li.ico3 button {background-position:-174px 0;}
	.designFingers .form .choice li.ico3 button.on {background-position:-174px 100%;}
	.designFingers .form .choice li.ico4 button {background-position:-261px 0;}
	.designFingers .form .choice li.ico4 button.on {background-position:-261px 100%;}
	.designFingers .form .choice li.ico5 button {background-position:-348px 0;}
	.designFingers .form .choice li.ico5 button.on {background-position:-348px 100%;}
	.designFingers .form .choice li.ico6 button {background-position:-435px 0;}
	.designFingers .form .choice li.ico6 button.on {background-position:-435px 100%;}
	.designFingers .form .choice li.ico7 button {background-position:100% 0;}
	.designFingers .form .choice li.ico7 button.on {background-position:100% 100%;}
	...
	.commentlist ul li {min-height:87px; padding:22px 0 22px 117px; font-size:16px;}
	.commentlist ul li strong {width:87px; height:87px; margin-top:-43px; background-size:609px auto;}
	.commentlist ul li .ico2 {background-position:-87px 0;}
	.commentlist ul li .ico3 {background-position:-174px 0;}
	.commentlist ul li .ico4 {background-position:-261px 0;}
	.commentlist ul li .ico5 {background-position:-348px 0;}
	.commentlist ul li .ico6 {background-position:-435px 0;}
	.commentlist ul li .ico7 {background-position:100% 0;}
	...
	<div class="container popWin">
		...
		<div class="content" id="contentArea">
			<div class="designFingers">
				<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/66049/m/txt_comment.png" alt="정성껏 코멘트를 남겨주신 5분을 추첨하여 HACOBO 수납박스를 선물로 드립니다. 기간은 2015년 9월 9일부터 9월 16일까지며, 발표는 9월 17일 입니다." /></p>
				...
				<input type="hidden" name="returnurl" value="/event/etc/inc_66049_comment.asp?isApp=<%=isApp %>">
