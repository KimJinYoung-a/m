                        ...
                        if (jqXHR.status == 200) {
                            if(Data!="") {
                                ...
                                if (res[0]=="OK")
                                {
                                    if (gb=="kakao") {
                                        <% if isapp then %>
                                            fnAPPshareKakao('etc','<%=kakaotitle%>\n<%=kakaodescription%>','<%=kakaolink_url%>','<%=kakaolink_url%>','','<%=kakaoimage%>','','','','');
                                            return false;
                                        <% else %>
...
.mEvt102078 .lyr-inner {position:relative; top:50%; transform:translateY(-55%);}
...
.step1 .terms .lyr-terms {position:fixed; left:0; right:0; top:0; bottom:0; z-index:30; width:100%; height:110%; padding:0 6%; background:rgba(0,0,0,.6);}
...
.step1 .lyr-save {position:fixed; left:0; right:0; top:0; bottom:0; z-index:30; width:100%; height:110%; padding:0 6%; background:rgba(0,0,0,.6);}
...
.lyr-ing {position:fixed; left:0; right:0; top:0; bottom:0; z-index:30; width:100%; height:110%; padding:0 6%; background:rgba(0,0,0,.6);}
.step2,
.lyr-ing,
