...
if InStr(ref,"10x10.co.kr/apps/appcom/wish/webview/my10x10/changecoupon.asp")>0 then
...
if (validsitename<>"") then
    if (validsitename="academy") then
	    ...
	    response.write "<script>alert('" & validsitename & " 에서 사용 가능한 상품권입니다. 해당 사이트에서 발급해주세요.');</script>"
	    response.write "<script>history.back();</script>"
	    response.end
    end if
...
<script language='javascript'>
	...
	location.replace('/apps/appcom/wish/webview/my10x10/couponbook.asp');
</script>
