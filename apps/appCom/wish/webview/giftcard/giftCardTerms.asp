...
<script>
$(function() {
	$('.policyList li a').click(function(){
		...
		<div class="content" id="contentArea">
			...
			<div class="inner5 cardTerms">
				<ul class="policyList box2">
					<li><a href="#terms01">제1조 - 텐바이텐 기프트카드 정의</a></li>
					<li><a href="#terms02">제2조 - 기프트카드의 구매 및 관리</a></li>
					<li><a href="#terms03">제3조 - 기프트카드의 이용 및 제한</a></li>
					<li><a href="#terms04">제4조 - 기프트카드의 인터넷사용 등록</a></li>
					<li><a href="#terms05">제5조 - 기프트카드의 소득공제 등록</a></li>
					<li><a href="#terms06">제6조 - 기프트카드의 환불 및 잔액환급</a></li>
					<li><a href="#terms07">제7조 - 기프트카드의 유효기한</a></li>
					<li><a href="#terms08">제8조 - 기프트카드의 재발급</a></li>
					<li><a href="#terms09">제9조 - 기프트카드의 도난ㆍ분실 등에 따른 책임</a></li>
					<li><a href="#terms10">제10조 - 기프트카드 위/변조 등에 대한 책임</a></li>
					<li><a href="#terms11">제11조 - 이용약관의 효력 및 변경</a></li>
					<li><a href="#terms12">제12조 - 이 약관에서 정하지 아니한 사항</a></li>
					<li><a href="#terms13">제13조 - 관할법원</a></li>
				</ul>
				...
				<div class="policyCont">
					...
					<section id="terms03">
						...
						<ol>
							...
							<li>④ 회사는 기프트카드가 사용중지 상태이거나, 아래 기타 사용제한이 요구되는 중대한 사유가 발생한 경우에는 고객의 기프트카드 사용을 제한할 수 있습니다.
								<ol class="lPad10">
					...
					<section id="terms09">
						<h3>제9조 - 기프트카드의 도난ㆍ분실 등에 따른 책임</h3>
					...
					<section id="terms10">
						<h3>제10조 - 기프트카드 위/변조 등에 대한 책임</h3>
						<ol>
