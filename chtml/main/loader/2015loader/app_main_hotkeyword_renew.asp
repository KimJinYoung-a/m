...
<%
	...
	For each tplNodes in cTmpl
		...
		If appdiv = "1" or appdiv = "2" Then
			kurl_app = kurl_app & gaParam
		End If 
...
%>
		<li>
			<a href="" onclick="fnAPPpopupCustomUrl('<% If appdiv = "4" Then Response.write appcate Else Response.write kurl_app End If %>','<%=appdiv%>');return false;">
				<div class="pPhoto"><span></span><img src="<%= getThumbImgFromURL(vHotKeyImg,300,300,"true","false") %>" alt="<%=ktitle%>" /></div>
