...
<body class="default-font body-sub bg-grey"><!-- for dev msg : GNB메뉴에서 들어갈때만 body-main클래스가 붙습니다. 그 이외의 페이지에서는 body-sub가 붙습니다. -->
    ...
    <script src="/event/lib/eventgroupitemlist2021.js?v=1.07"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/1.7.1/clipboard.min.js"></script>
    <script>const subscriptUserId = '<%=GetLoginUserID%>';</script>
    <script src="/lib/js/eventSubscript.js?v=1.02"></script>
</body>
</html>
