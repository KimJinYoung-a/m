...
%>
<!-- #include virtual="/apps/appCom/wish/webview/test/head_T.asp" -->
<!-- #include virtual="/apps/appCom/wish/webview/inipay/userinfo_javascript.asp" -->
</head>
<br><br>
<a href="javascript:alert('reload');document.location.reload()">reload</a>
<br>
<%= request.serverVariables("HTTP_USER_AGENT") %>
<body class="shop" style="position:relative;">
            ...
            <div class="inner">
                ...
                <div class="input-block">
                    ...
                    <div class="input-controls zipcode">
                        ...
                        <button type="button" class="btn type-c btn-findzipcode side-btn" onclick="searchzipBuyer('/apps/appcom/wish/webview/test/layer_searchzipNew_T.asp?strMode=appcheck1&target=frmorder');">우편번호검색</button>
                    </div>
                </div>
				...
				<% else %>
		                ...
		                <div class="input-block">
		                    <label for="memo" class="input-label">배송유의사항</label>
		                    <div class="input-controls">
		                        <input type="text" name="memo" id="deliveryAttention" name="comment" maxlength="60" class="form full-size">
		                    </div>
		                </div>
				<% end if %>
                ...
                <div class="input-block no-label" style="margin-left:100px;" <%= CHKIIF(IsRsvSiteOrder,"style='display:none'","")%>>
                    <div class="input-controls">
                        <select class="form full-size" name="sailcoupon" onChange="RecalcuSubTotal(this);" onblur="chkCouponDefaultSelect(this);">
				...
				%>
						...
						%>
	                        <li>
								...
								<% end if %>
								<% if oOpenGift.FItemList(i).IsGiftItemSoldOut or (optAllsoldOut) then %><img src="http://fiximage.10x10.co.kr/m/2012/order/wrap_gift_soldout.png" width="100" height="100"/><% end if %>
                ...
                <div class="input-controls" id="i_paymethod">
                	...
                	<tr>
		                ...
		                <% if flgDevice<>"I" then %><td style="padding:0 10px 20px 0;"><input type="radio" name="Tn_paymethod" id="mobile" value="400" OnClick="CheckPayMethod(this);" class="form type-c"> <span class="small"><label for="mobile">모바일결제</label></span></td><% end if %>
