...
if (ErrMsg <> "") then
    response.write "<script language='javascript'>alert('" + CStr(ErrMsg) + "');location.href='/apps/appCom/wish/web2014/my10x10/giftcard/giftCardList.asp';</script>"
...
if (mode="cancelorder") then
	...
	On Error Resume Next
        ...
        If (Err.Number = 0) and (ScanErr="") Then
            ...
            response.write "<script>alert('" + ResultMsg + " '); location.href='/apps/appCom/wish/web2014/my10x10/giftcard/giftCardList.asp';</script>"
        Else
            dbget.RollBackTrans
            ...
            response.write "<script>location.href='/apps/appCom/wish/web2014/my10x10/giftcard/giftCardList.asp';</script>"
            dbget.close()	:	response.End
        End If
	On error Goto 0
