...
dim eCode, cnt, sqlStr, couponkey, regdate, gubun, arrList, i, totalsum, linkeCode
...
.mEvt52552 .goBtn {display:inline-block; font-size:12px; padding:8px 12px 9px; line-height:1; font-weight:normal;}
...
.mEvt52552 .msg {font-size:12px; line-height:14px; font-weight:bold; color:#4b9b96;}
.mEvt52552 .msg em {color:#127286;}
.mEvt52552 .process {position:relative;}
.mEvt52552 .process .pBtn {position:absolute; left:0; bottom:13%; width:100%;}
@media all and (max-width:480px){
	...
	.mEvt52552 .msg {font-size:11px;}
	.mEvt52552 .goBtn {font-size:11px; padding:5px 8px 6px;}
	.mEvt52552 .process .pBtn {bottom:12%;}
}
</style>
		...
		<div class="composition">
			...
			<ul>
				<li>
					...
					<!--
					<a href="/category/category_itemPrd.asp?itemid=1047275" class="link01">여행용 파우치</a>
					<a href="/category/category_itemPrd.asp?itemid=1047277" class="link02">캐리어 태그</a>
					-->
				</li>
		...
		<div class="winList">
			...
			<% If getLoginUserEmail()<>"" Then %>
				<div class="msg">
					...
					<a href="" onclick="parent.location.href='/apps/appcom/wish/webview/my10x10/userinfo/modiUserInfo.asp'" class="goBtn myTenten">마이텐바이텐 바로가기 ▶</a>
				</div>
			<% End If %>
			<div class="process">
				<p><img src="http://webimage.10x10.co.kr/eventIMG/2014/52552/img_use_process.png" alt="이니스프리 온라인 쿠폰 사용방법" /></p>
				<p class="pBtn"><a href="#" onclick="openbrowser('http://m.innisfree.co.kr/mMypageCouponList.do');" class="goBtn useCoupon">쿠폰 번호 입력하여 발급 ▶</a></p>
			</div>
		</div>
		<!--// 당첨내역 -->
		<div class="evtNoti">
