...
function fnTeaserPutNumImg(fitm,no,param) {
	...
	frm.src="http://webimage.10x10.co.kr/eventIMG/2013/44582/ddodak_teaser_num" + no + ".gif?t="+param+"";
}
...
function fnPutNumImg(fitm,no,param) {
	var frm = document.getElementById(fitm);
	frm.src="http://webimage.10x10.co.kr/eventIMG/2013/44582/ddodak_num" + no + ".gif?t="+param+"";
}
