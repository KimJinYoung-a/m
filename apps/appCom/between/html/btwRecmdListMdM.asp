...
<div class="wrapper" id="btwRcmd"><!-- for dev msg : 원뎁스별 해당 ID 추가(비트윈추천:btwRcmd/카테고리:btwCtgy/마이페이지:btwMypage) -->
	<div id="content">
		...
		<div class="cont">
			<div class="targetM"><!-- for dev msg : 타겟별 다른 클래스 추가(남:targetM/여:targetF, 생일:typeA/100일:typeB/1주년:typeC/결혼기념일:typeD/발렌타인데이:typeE/화이트데이:typeF/빼빼로데이:typeG/크리스마스:typeH) -->
				<div class="bnrForTheme">
					<h2><img src="http://fiximage.10x10.co.kr/m/webview/between/main/@temp_bnr_plan_02_01.jpg" alt="여자마음을 잘 아는 MD's Pick!" /></h2><!-- for dev msg : 기획전 이름으로 Alt값 넣어주세요. -->
				</div>
