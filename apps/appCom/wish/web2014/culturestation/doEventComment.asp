...
elseif mode="edit" then
   ...
   IF returnValue = 1 THEN	
		response.write "<script language=javascript>top.location.href = '/apps/appcom/wish/web2014/culturestation/event_comment.asp?eventid=" & eCode & "&linkevt=" & LinkEvtCode & "&blnB=" & blnBlogURL & "';</script>"
		dbget.close()	:	response.End
   ELSE
		Alert_move "데이터처리에 문제가 발생했습니다. 관리자에게 문의해주세요","about:blank"
		dbget.close()	:	response.End
