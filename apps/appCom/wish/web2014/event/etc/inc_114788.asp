...
myorder.FRectStartDate = FormatDateTime("2020-10-01",2)
myorder.FRectEndDate = FormatDateTime("2020-11-01",2)
...
function doAction() {
    ...
    <% If IsUserLoginOK() Then %>
        ...
        $.ajax({
            type: "POST",
            url:"/apps/appcom/wish/web2014/event/etc/doeventsubscript/doEventSubscript114788.asp",
            data: {
                mode: 'add',
    ...
    return false;
            ...
            <input type="hidden" id="orderprice">
                ...
                <div class="popup popup02">
                    <div class="bg_dim"></div>
                    <div class="pop win">
                        <img src="//webimage.10x10.co.kr/fixevent/event/2021/114788/m/pop_win02.jpg" alt="당첨자 발표">
