...
function app_mainchk(){
	var str = $.ajax({
		...
		data: "mode=app_main&ecode=67097",
		dataType: "text",
		async: false
	}).responseText;
	if (str == "OK"){
		fnAPPpopupEvent_URL('<%=wwwUrl%>/apps/appcom/wish/web2014/event/eventmain.asp?eventid=67097');
		return false;
	}else{
		alert('오류가 발생했습니다.');
		return false;
...
<div class="bagManBanner">
	<h2><img src="http://webimage.10x10.co.kr/eventIMG/2015/67097/67097_main_banner2.jpg" alt="모여라 꿈동산" /></h2>
