...
IF oDoc.FResultCount > 0 then
    ...
    'oJson("pagingData")("totalpage")        = oDoc.FtotalPage
    'oJson("pagingData")("currpage")         = oDoc.FCurrPage
    'oJson("pagingData")("scrollpage")       = oDoc.StartScrollPage
    'oJson("pagingData")("scrollcount")      = oDoc.FScrollCount
    'oJson("pagingData")("totalcount")       = oDoc.Ftotalcount    
end if
