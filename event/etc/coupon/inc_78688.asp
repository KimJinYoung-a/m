...
%>
<style>
.mEvt78688 h2 {visibility:hidden; width:0; height:0;}
...
<div class="mEvt78688">
	...
	<div class="coupon">
		<div><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/img_coupon.png" alt="6만원이상 구매시 10,000할인, 10만원이상 구매시 15,000할인 쿠폰 한번에 다운 받기" /></div>
		<% If now() < #06/23/2017 23:59:59# then %>
			<% if couponcnt1 > 500 and couponcnt1 < 1000 then %>
				<!-- 마감임박 --><p class="hurry"><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/txt_hurryup.png" alt="마감임박" /></p>
			<% End If %>
			<% if couponcnt1 >= 1000 then %>
				<!-- 마감 --><p class="soldout"><a href="" onclick="jsevtDownCoupon('evttosel,','<%= getbonuscoupon1 %>,'); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/txt_finish.png" alt="쿠폰이 마감되었습니다. 다음에 다시 도전하세요!" /></a></p>
			<% Else %>
				<% If now() >= #06/22/2017 10:00:00# And now() <= #06/22/2017 23:59:59# then %>
				<!-- 쿠폰 다운로드 --><p class="download"><a href="" onclick="jsevtDownCoupon('evttosel,','<%= getbonuscoupon1 %>,'); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/btn_download.png" alt="쿠폰 다운받기" /></a></p>
				<% ElseIf now() >= #06/23/2017 10:00:00# And now() <= #06/23/2017 23:59:59# then %>
				<!-- 쿠폰 다운로드 --><p class="download"><a href="" onclick="jsevtDownCoupon('evttosel,','<%= getbonuscoupon1 %>,'); return false;"><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/btn_download.png" alt="쿠폰 다운받기" /></a></p>
				<% Else %>
				<!-- 오전10시 오픈 --><p class="open"><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/txt_open_10am.png" alt="오전 10시 오픈" /></p>
				<% End If %>
			<% End If %>
		<% Else %>
			<!-- 마지막날 --><p class="lastday"><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/txt_last.png" alt="쿠폰이 마감되었습니다. 다음에 다시 도전하세요!" /></p>
			<!-- 마감 --><p class="soldout"><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/txt_finish.png" alt="쿠폰이 마감되었습니다. 다음에 다시 도전하세요!" /></p>
		<% End If %>
	</div>
	<a href="javascript:gotoDownload();"><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/btn_app.png" alt="텐바이텐 APP 아직인가요? 텐바이텐 APP 다운받기" /></a>
	<div class="evtNoti">
		...
		<div><img src="http://webimage.10x10.co.kr/eventIMG/2017/78688/m/img_ex.png" alt="" /></div>
	</div>
</div>
<!--// 선착순 쿠폰 -->
<%
If GetencLoginUserID="greenteenz" Then
