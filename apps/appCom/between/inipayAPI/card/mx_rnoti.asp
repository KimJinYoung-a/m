...
'PG에서 보냈는지 IP로 체크  118.129.210.24, 192.168.187.140, 172.20.22.40, 127.0.0.1은 사내 네트웍에서 테스트하기 위한 용도임
	...
	''오류가 생겼을경우 계속 날라옴.
	IF (vIdx="173663") or (vIdx="147752") or (vIdx="137889") or (vIdx="138900") or (vIdx="97689") or (vIdx="4366") or (vIdx="11893") or (vIdx="15084") or (vIdx="121208") or (vIdx="212222") THEN
	    response.write "OK"
	    response.end
	END IF
    ...
    '''안되냐..
    ''response.reDirect "/inipayAPI/card/mx_rnoti_RET.asp?vIdx="&vIdx  '''안됨.
    SESSION("vIdx")=vIdx
    SERVER.EXECUTE("/inipayAPI/card/mx_rnoti_RET.asp")   '''OK
''''===========================================================================================================
'    dim uselevel
