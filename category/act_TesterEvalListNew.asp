            ...
            <div class="review-conts">
                ...
                <% If oEval.FItemList(i).Flinkimg1<>"" And oEval.FItemList(i).Flinkimg2<>"" And oEval.FItemList(i).Flinkimg3<>"" Then %>
                    ...
                    <div class="photo photo-3">
                        <a href="" onclick="window.open('/pop_ItemTesterEvalPhotoDetail.asp?itemid=<%=itemid%>&idx=<%=oEval.FItemList(i).Fidx%>'); return false;">
                ...
                <% Else %>
                    <% If oEval.FItemList(i).Flinkimg1<>"" Or oEval.FItemList(i).Flinkimg2<>"" Or oEval.FItemList(i).Flinkimg3<>"" Then %>
                        <div class="photo">
                            <a href="" onclick="window.open('/category/pop_ItemTesterEvalPhotoDetail.asp?itemid=<%=itemid%>&idx=<%=oEval.FItemList(i).Fidx%>'); return false;">                        
