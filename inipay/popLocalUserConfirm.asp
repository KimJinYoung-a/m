...
<div class="heightGrid">
	<div class="container popWin">
		...
		<div class="content" id="contentArea">
			<div class="popCont">
				<form name="frmauth" method="post" action="/inipay/popLocalUserConfirm.asp" onsubmit="confirmSMS();return false;">
					<div class="staff-confirm">
						<div class="step1">
							<p>인증번호 발송 휴대폰 번호 : <strong><%= usercell %></strong></p>
							<a href="" class="btn btn-xlarge btn-line-red btn-block" onclick="popSMSAuthNo();return false;">인증번호 발송</a>
						</div>
						<div class="step2" id="smsInput" style="display:<%=CHKIIF(smsconfirm<>"","","none")%>;">
							<p>
								<label for="certifyNo">인증번호 입력 </label>
								<input type="number" pattern="[0-9]*" inputmode="numeric" name="smsconfirm" title="인증번호를 입력해주세요." />
							</p>
							<a href="" class="btn btn-xlarge btn-red btn-block" onclick="confirmSMS();return false;">인증번호 확인</a>
						</div>
