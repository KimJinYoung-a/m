...
if mode="add" then
	...
	Set objCmd = Server.CreateObject("ADODB.COMMAND")
		...
		.CommandText = "{?= call [db_event].[dbo].sp_Ten_event_comment_insert("&eCode&","&com_egCode&",'"&userid&"','"&html2db(txtcomm)&"',"&spoint&","&bidx&",'"&refip&"','"&txtcommURL&"','M')}"
	...
	IF returnValue = 1 THEN	
		...
		response.write "<script>location.replace('/play/groundcnt/iframe_58990.asp?upin=ON');</script>"
		dbget.close()	:	response.End
