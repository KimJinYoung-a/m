...
dim currentdate
	...
	ElseIf vEventID = "110643" Then '// vol.5 커피한잔
		vStartNo = "2"
	ElseIf vEventID = "113347" Then '// vol.6 더레퍼런스
		vStartNo = "3"
	else
		vStartNo = "0"
	End IF
	...
	<div class="swiper-container">
		<ul class="swiper-wrapper">
			...
			<li class="swiper-slide coming">
				<span class="txt"></span>
			<% Else %>
			<li class="swiper-slide open current <%=CHKIIF(vEventID="113347"," current","")%>">
				<a href="" onclick="goEventLink('113347'); return false;">Vol.6</a>
			<% End If %>
			</li>
