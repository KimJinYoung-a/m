...
<style type="text/css">
.xmasLife {background-color:#f5f5f5;}
.xmasLife img {width:100%; vertical-align:top;}
.xmasLife .hgroup {position:relative;}
.xmasLife .deco {position:absolute; top:0; left:0; width:100%;}
.find-presentbox {position:relative;}
.presentbox {position:absolute; top:9.6%; right:1%; width:23.75%; padding-bottom:35%;}
...
.presentbox a {background-image:url(http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/btn_present_life_off.png);}
.presentbox span {background-image:url(http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/btn_present_life_on.png);}
...
<div class="evtCont evtView">
	...
	<div class="xmasLife">
		<div class="hgroup">
			<span class="deco animated fadeIn"><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/img_deco_life.png" alt="" /></span>
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/txt_christmas_life.gif" alt="거실 한켠에 크리스마스 공간을 만들어 보세요" /></p>
		</div>
		...
		<div class="find-presentbox">
			...
			<div><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/img_life.jpg" alt="" /></div>
			...
			<div id="lyPresent">
				<div class="lyPresent window">
					<div class="present">
						...
						<div class="coupon"><img src="http://webimage.10x10.co.kr/eventIMG/2014/x-mas/m/img_xmas_coupon_01.gif" alt="레드컬러의 HOT한 아이템 40% 할인" /></div>
