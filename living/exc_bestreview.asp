...
Dim gaParam : gaParam = "&gaparam=living_review0" '//GA 체크 변수
...
If timer > 10 And Cint(timer/60) < 6 Then
	cTime = 60*1
	dummyName = "LivingBR_"&Cint(timer/60)
Else
	cTime = 60*5
	dummyName = "LivingBR"
End If

sqlStr = "[db_sitemaster].[dbo].[usp_WWW_LivingBestReview_Data_Get_New]"
			...
			<li>
				...
				<% End If %>
					...
					<div class="review-desc">
						...
						<div class="review">
							<span class="id"><% If evauserid<>"" Then %><%= printUserId(evaUserid,2,"*") %><% End If %></span>
...
%>
		...
		<div class="btn-group">
			<% If isapp = "1" Then %>
			<a href="" onclick="fnAPPselectGNBMenu('best','http://m.10x10.co.kr/apps/appCom/wish/web2014/award/awarditem.asp?atype=vi&disp=121');return false;" class="btn-plus"><span class="icon icon-plus icon-plus-black"></span> 베스트 리뷰 더보기</a>
			<% Else %>
