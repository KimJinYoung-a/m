...
<%
	...
	snpTitle	= Server.URLEncode("[텐바이텐] 16주년 텐쇼 - 함께하쑈")
	...
	'기본 태그
	snpTag = Server.URLEncode("텐바이텐 16주년 텐쑈 함께하쑈")
	snpTag2 = Server.URLEncode("#10x10")
	kakaourl = "http://m.10x10.co.kr/apps/appcom/wish/web2014/event/16th/together.asp"
%>
