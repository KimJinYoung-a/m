...
%>
<!-- #include virtual="/apps/appCom/wish/web2014/lib/head_TEST.asp" -->
<% if (TRUE) then %>
<link rel="stylesheet" type="text/css" href="/apps/appCom/wish/web2014/lib/css/mypage2013.css">
<!--
<link rel="stylesheet" type="text/css" href="/apps/appCom/wish/web2014/my10x10/csstest1.css">
<link rel="stylesheet" type="text/css" href="/apps/appCom/wish/web2014/my10x10/csstest2.css">
<link rel="stylesheet" type="text/css" href="/apps/appCom/wish/web2014/my10x10/csstest3.css">
-->
<% end if %>
<style>
...
<div class="heightGrid">
	<div class="container">
		...
		<div class="content mypage" id="contentArea">
			<!--마이텐바이텐 START-->
			<!--
			<img src="/fiximage/web2013/cart/order_step01.gif" width="100">
			-->
			<br><br><br>
			<a href="javascript:location.href='http://m.10x10.co.kr/apps/appCom/wish/web2014/my10x10/mytodayshoppingtt.asp'">reload <%=Request.ServerVariables("REMOTE_ADDR")%>:<%=Request.ServerVariables("SERVER_PORT")%> (<%=application("Svr_Info")%>)</a>
			<br><br><br>
			<a href="javascript:location.href='https://m.10x10.co.kr/apps/appCom/wish/web2014/my10x10/mytodayshoppingtt.asp'">reload SSL </a>
			<br><br><br>
			
			<a href="javascript:location.href='https://m.10x10.co.kr/apps/appCom/wish/web2014/my10x10/mytodayshoppingtt.asp?itemarr=1318517,1318516,1318515'">reload SSL (상품) </a>
			<br><br><br>
			
			<a href="javascript:location.href='https://m.10x10.co.kr/apps/appCom/wish/web2014/inipay/shoppingbag.asp'">shoppingbag </a>
			<br><br><br>
			
			<a href="javascript:fnAPPpopupBaguni();">shoppingbag js</a>
			<br><br><br>
