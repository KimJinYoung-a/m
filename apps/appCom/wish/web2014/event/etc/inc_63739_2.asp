...
.topic ul li.nav2 {width:41.5%;}
.topic ul li.nav3 {width:30.5%;}
...
.topic ul li.nav1 strong {padding-bottom:55.25%;}
.topic ul li.nav2 strong {margin-left:2%; padding-bottom:33.25%;}
.topic ul li.nav3 strong {margin-left:2%; padding-bottom:45.25%; cursor:pointer;}
.topic ul li span {position:absolute; top:0; left:0; width:100%; height:100%; /*background-color:black; opacity:0.3;*/}

.make {padding-bottom:8%; background:#b6ecea url(http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/bg_pattern.png) repeat-y 50% 0; background-size:100% auto;}
...
.make .step ol li span button {display:block; background-color:transparent; background-image:url(http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/bg_place.jpg); background-repeat:no-repeat; background-position:0 0; background-size:279px auto;}
...
.make .step ol li.step2 button {background-image:url(http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/bg_style.jpg);}
.make .step ol li.step3 button {background-image:url(http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/bg_beverage.jpg);}
...
<script type="text/javascript">
	...
	function kakaosendcall(){
		...
		<% else %>
			var rstStr = $.ajax({
				type: "POST",
				url: "/apps/appCom/wish/web2014/event/etc/doEventSubscript63739_2.asp",
				data: "mode=KAKAO",
				dataType: "text",
				async: false
			}).responseText;
...
<div class="mEvt63739">
	...
	<section>
		<div class="topic">
			<h1><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/tit_i_love.png" alt="아이 러브 치킨" /></h1>
		...
		<div class="make">
			<div class="inner">
				<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/txt_choice.png" alt="원하는 취향을 클릭해주세요!" /></p>

				<div class="step">
					<ol>
						<li class="step1">
							<strong><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/txt_choice_01.png" alt="장소 선택" /></strong>
							<% '<!-- for dev msg : 진행중인 단계에는 클래스 ing / 선택시 클래스명 on 입니다. --> %>
							<span class="vs1"><button type="button" ID="select1" onclick="chselect('1');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/img_box_transprent.png" alt="배달" /></button></span>
							<span class="vs2"><button type="button" ID="select2" onclick="chselect('2');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/img_box_transprent.png" alt="매장" /></button></span>
						</li>
						<li class="step2">
							<strong><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/txt_choice_02.png" alt="스타일 선택" /></strong>
							<span class="vs1"><button type="button" ID="select3" onclick="chselect('3');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/img_box_transprent.png" alt="양념" /></button></span>
							<span class="vs2"><button type="button" ID="select4" onclick="chselect('4');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/img_box_transprent.png" alt="후라이드" /></button></span>
						</li>
						<li class="step3">
							<strong><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/txt_choice_03.png" alt="음료 선택" /></strong>
							<span class="vs1"><button type="button" ID="select5" onclick="chselect('5');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/img_box_transprent.png" alt="콜라" /></button></span>
							<span class="vs2"><button type="button" ID="select6" onclick="chselect('6');"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/img_box_transprent.png" alt="맥주" /></button></span>
						</li>
					</ol>
				</div>

				<a href="" onclick="goAvengers(); return false;" class="btnmake"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/btn_make.png" alt="만들어 주세요!" /></a>
				<!--button type="button" class="btnmake"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/btn_make.png" alt="만들어 주세요!" /></button-->
			</div>
		</div>
		...
		<div class="gift">
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/img_gift.jpg" alt="깜짝선물을 드려요! BBQ바사칸치킨 300명, 계란후라이타월 10명, 추천상품 할인 쿠폰 랜덤" /></p>
			<% '<!-- for dev msg : 계란후라이타월 링크 --> %>
			<a href="" onclick='fnAPPpopupProduct(1291377); return false;' class="linkarea"><span></span>계란후라이타월</a>
		</div>

		<!-- for dev msg : 카카오톡 -->
		<div class="kakao">
			<a href="" onclick="kakaosendcall(); return false;" title="카카오톡으로 친구에게 소문내기"><img src="http://webimage.10x10.co.kr/eventIMG/2015/63739/chicken/btn_kakao.png" alt="카카오톡으로 치킨을 선물해보세요! 친구에게 아이♥치킨 알려주기!" /></a>
		</div>
