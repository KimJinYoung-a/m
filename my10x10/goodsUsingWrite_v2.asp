...
dim userid,orderserial,itemid,ItemOption,EvaluatedYN,userlevel , refer
...
<% End If %>
			...
			<div class="content" id="contentArea">
				<div class="reviewFoamV17">
					<fieldset>
						<form name="FrmGoodusing" method="post" action="<%=staticImgUpUrl%>/linkweb/doevaluatewithimage_mobile_v2.asp?gaparam=<%=gaparam%>">
