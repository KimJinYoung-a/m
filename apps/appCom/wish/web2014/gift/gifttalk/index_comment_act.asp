...
<% If (cTalkComm.FResultCount > 0) Then %>											
	...
	<div class="btnWrap ct tPad15">
		<span class="button btM2 btRed cWh1 w30p"><a href="" onClick="fnAPPpopupBrowserURL('코멘트','<%=wwwUrl%>/apps/appCom/wish/web2014/gift/gifttalk/talk_view.asp?talkidx=<%=talkidx%>&wagubun=w'); return false;">쓰기</a></span>
		<span class="button btM2 btRedBdr cRd1 w30p"><a href="" onClick="fnAPPpopupBrowserURL('코멘트','<%=wwwUrl%>/apps/appCom/wish/web2014/gift/gifttalk/talk_view.asp?talkidx=<%=talkidx%>&wagubun=a'); return false;">전체보기</a></span>
	</div>
<% End if %>
