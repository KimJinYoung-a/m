<%
	...
	'// WebView URL
	Dim cstItemPrdUrl:		cstItemPrdUrl = mDomain & "/apps/appCom/wish/webview/category/category_itemPrd.asp"
	Dim cstBadgeInfoUrl:	cstBadgeInfoUrl = mDomain & "/apps/appCom/wish/webview/my10x10/badge/badgeInfo.asp"
%>