...
<%
    ...
    if mktTest then
        ...
        if request("testdate")<>"" then
            ...
            currentDate = CDate("2021-06-20 15:00:00")
        end if
    ...
    If (left(now(),10)<"2021-06-20") and not mktTest Then
        Response.Write "Err|알림 신청기간이 아닙니다."
        dbget.close() : Response.End
    elseIf (left(now(),10)>"2021-06-21") and not mktTest Then
        Response.Write "Err|알림 신청기간이 아닙니다."
        dbget.close() : Response.End
    End IF
    ...
    If mode="kamsg" Then
        ...
        if mktTest then
            ...
            If currentDate >= #06/20/2021 00:00:00# and currentDate < #06/21/2021 00:00:00# Then
                requestDate = formatdate(DateAdd("n",-40,#06/21/2021 09:00:00#),"0000.00.00 00:00:00")
                episode2=1
            else
                requestDate = formatdate(DateAdd("n",-40,#06/21/2021 09:00:00#),"0000.00.00 00:00:00")
                episode2=1
