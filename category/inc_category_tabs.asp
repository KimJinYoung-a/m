<div class="inner5 tabArea tMar20">
	...
	<div class="pdtListWrap box1 swiper-container">
		<div class="tabCont swiper-wrapper">
			...
			%>
						<li>
							<a href="/category/category_itemPrd.asp?itemid=<%= oMdpick.FItemList(intloop).FItemID %>">
								...
								<span class="price"><%If oMdpick.FItemList(intloop).Fitemcoupontype = "1" Then
			...
			%>
						<li>
							<a href="/category/category_itemPrd.asp?itemid=<%= oDoc.FItemList(i).FItemID %>">
			...
			%>	
							<li>
								<a href="/category/category_itemPrd.asp?itemid=<%= oaward.FItemList(iCb).Fitemid %>">
									<p>
									...
									<%
										If oaward.FItemList(iCb).IsSaleItem or oaward.FItemList(iCb).isCouponItem Then
											...
											elseif oaward.FItemList(iCb).IsCouponItem Then
												Response.Write "<span class=""price"">" & FormatNumber(oaward.FItemList(iCb).GetCouponAssignPrice,0) & "원<em class=""cGr1"">[" & oaward.FItemList(iCb).GetCouponDiscountStr & "]</em></span>"
											End IF
										Else
