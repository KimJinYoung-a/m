		...
		<div class="content" id="contentArea">
			...
			<div class="inner5">
				<ul class="policyList box2">
					...
					<li><a href="#personal03">제 3조 (개인정보의 수집목적 및 이용 목적)</a></li>
					<li><a href="#personal04">제 4조 (개인정보의 공유 및 제공)</a></li>
					<li><a href="#personal05">제 5조 (수집한 개인정보 처리 위탁)</a></li>
					<li><a href="#personal06">제 6조 (개인정보의 보유, 이용기간)</a></li>
					<li><a href="#personal07">제 7조 (개인정보의 파기 절차)</a></li>
					<li><a href="#personal08">제 8조 (개인정보 처리를 위한 기술적, 관리적 대책)</a></li>
					<li><a href="#personal09">제 9조 (링크사이트)</a></li>
					<li><a href="#personal10">제 10조 (게시물)</a></li>
					<li><a href="#personal11">제 11조 (이용자의 권리와 의무)</a></li>
					<li><a href="#personal12">제 12조 (이용자 및 법정 대리인의 권리와 그 행사방법)</a></li>
					<li><a href="#personal13">제 13조 (개인정보 자동 수집 장치의 설치, 운영 및 그 거부에 관한 사항)</a></li>
					<li><a href="#personal14">제 14조 (개인정보 보호문의처)</a></li>
					<li><a href="#personal15">제 15조 (개인정보보호책임자 및 담당자)</a></li>
					<li><a href="#personal16">제 16조 (광고성 정보 전송)</a></li>
					<li><a href="#personal17">제 17조 (고지의 의무)</a></li>
				</ul>
				...
				<div class="policyCont">
					...
					<ul class="startDate">
						...
						<li>- 개인정보처리방침 변경공고일자 : 2017년 9월 19일</li>
