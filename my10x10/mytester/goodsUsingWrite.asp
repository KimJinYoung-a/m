...
If vCheck <> "x" Then
	If vCheck = "o" Then
		If vIdx = "" Then
			Response.Write "<script language='javascript'>alert('등록하신 글이 있습니다.');history.back();</script>"
			dbget.close() : response.end
		End IF
	Else
		Response.Write "<script language='javascript'>alert('잘못된 경로입니다.');history.back();</script>"
		dbget.close() : response.end
	End If
End If
'####### 작성된 글이 있는지 체크 #######
		...
		<div class="container">
			...
			<div class="content myReview" id="contentArea">
				...
				<div class="inner10">
					...
					<form name="FrmGoodusing" method="post" action="<%=staticImgUpUrl%>/linkweb/do_test_evaluatewithimage_mobile.asp" EncType="multipart/form-data">
					...
					<div class="reviewWrite">
						...
						<div class="addImage">
							<p><input name="file1" id="file1" type="file" /> <button class="btnDel" onClick="delimage('file1');return false;"> <button class="btnDel" onClick="delimage('file1');return false;">파일 삭제</button></p>
