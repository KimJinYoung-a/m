...
if rstKwd<>"" then 
	...
	for i=0 to ubound(arrMyKwd)
		...
		Response.Write "<span onclick=""delMyKeyword('" & server.URLEncode(arrMyKwd(i)) & "');return false;"">&times;</span></a></li>" & vbCrLf
		if i>=4 then Exit For
	next
	Response.Write "<li class=""clearAllV15""><span onclick=""delMyKeywordAll();return false;"">전체삭제</span></li>" & vbCrLf
