...
<div class="content" id="contentArea">
	<div class="wishFolderV16">
		...
		<div id="lyMakeFloder" class="lyWishFloder">
			<form name="frmD" method="post" action="/my10x10/myfavorite_folderProc.asp" target="wishproc" style="margin:0px;">
			...
			<form name="frmF" method="post" action="/my10x10/myfavorite_folderProc.asp" target="wishproc" style="margin:0px;">
		...
		<div id="lyEditWishFloder<%=intLoop%>" class="lyWishFloder">
			<form name="frmU<%=intLoop%>" method="post" action="/my10x10/myfavorite_folderProc.asp" target="wishproc" style="margin:0px;">
