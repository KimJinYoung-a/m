...
<%
	...
	Select Case Trim(mode)
		Case "add"
			...
			vQuery = " insert into db_user.dbo.tbl_mileagelog(userid , mileage , jukyocd , jukyo , deleteyn) values ('"&userid&"', '+"&sumMileage&"','"&eCode&"', '케이크 출석체크 이벤트 (21.10.30까지 사용 가능)','N') "
			dbget.Execute vQuery
			...
			Response.Write "OK|"&TomorrowMileage&"P"&"|"&TodayCount&"|"&FormatNumber(TotalMileage, 0)&"|"&CurrentMileage&"P"
			Response.End
