...
<!-- 배송료 할인 이벤트 기간 중 노출 --><p class="price">바로배송 배송료 : <s>5,000원</s> <em class="color-red">2,500원</em><br /><span>(오픈기념 이벤트 할인중, 2018년 7월 18일까지)</span></p>										
                    ...
                    <%End if%>
                    <a href="#" onclick="fnAPPpopupBrowserURL('바로배송 리스트','<%=wwwUrl%>/apps/appCom/wish/web2014/shoppingtoday/quick_list.asp','right','','sc');" class="btn btn-xsmall color-black btn-radius btn-icon">바로배송 상품 전체보기<span class="icon icon-arrow"></span></a>                    
                </div>
                <div class="noti">
                    <h2>유의사항</h2>
                    <ul>
