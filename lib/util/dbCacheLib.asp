...
function fnDBCacheHashKey(ipreFix,iKey)
    ...
    IF (application("Svr_Info")	= "Dev") Then
        Set Obj = Server.CreateObject("TenCrypto.Crypto")  '' 2018/08/07 개발환경 구성
...
function SetDBCacheTxtVal(ikey,iVal,iQuery,icacheSec)
    ...
    cmd.Parameters.Append cmd.CreateParameter("@ival", adLongVarChar, adParamInput,LEN(iVal) , iVal)
