...
sub chkkey(k,d)
	If d = "2015-05-14" And k = "5231" Then
	ElseIf d = "2015-05-15" And k = "8687" then
	ElseIf d = "2015-05-18" And k = "0518" then
	ElseIf d = "2015-05-19" And k = "2116" then
	ElseIf d = "2015-05-20" And k = "6301" then
	ElseIf d = "2015-05-21" And k = "5397" then
	ElseIf d = "2015-05-22" And k = "3958" then
	ElseIf d = "2015-05-26" And k = "8519" then
	ElseIf d = "2015-05-27" And k = "8282" then
	ElseIf d = "2015-05-28" And k = "0528" then
	ElseIf d = "2015-05-29" And k = "7777" then
		'true
	Else
		Response.Write "{ "
