...
<%
	'해더 타이틀
	strHeadTitleName = "기프트카드 약관"
	
	Dim vReUrl
	vReUrl = requestCheckVar(request("reurl"),100)
	If vReUrl = "giftcardRegist" Then
		vReUrl = "/my10x10/giftcard/giftcardRegist.asp"
	End If
%>
<script type="text/javascript">
function jsGoDownG(a){
	$('html, body').animate({
...
<div class="heightGrid">
	<div class="container popWin">
		<div class="header">
			<h1>텐바이텐 기프트카드 약관</h1>
			<p class="btnPopClose"><button class="pButton" onclick="location.href='<%=vReUrl%>';">닫기</button></p>
		</div>
		<!-- content area -->
		<div class="content" id="contentArea">
			...
			<div class="inner5 cardTerms">
				<ul class="policyList box2">
					<li><a href="" onClick="jsGoDownG('terms01'); return false;">제1조 - 텐바이텐 기프트카드 정의</a></li>
					<li><a href="" onClick="jsGoDownG('terms02'); return false;">제2조 - 기프트카드의 구매 및 관리</a></li>
					<li><a href="" onClick="jsGoDownG('terms03'); return false;">제3조 - 기프트카드의 이용 및 제한</a></li>
					<li><a href="" onClick="jsGoDownG('terms04'); return false;">제4조 - 포토 기프트카드의 이용 및 제한</a></li>
					<li><a href="" onClick="jsGoDownG('terms05'); return false;">제5조 - 기프트카드의 인터넷사용 등록</a></li>
					<li><a href="" onClick="jsGoDownG('terms09'); return false;">제6조 - 기프트카드의 소득공제 등록</a></li>
					<li><a href="" onClick="jsGoDownG('terms07'); return false;">제7조 - 기프트카드의 환불 및 잔액환급</a></li>
					<li><a href="" onClick="jsGoDownG('terms08'); return false;">제8조 - 기프트카드의 유효기한</a></li>
					<li><a href="" onClick="jsGoDownG('terms09'); return false;">제9조 - 기프트카드의 재발급</a></li>
					<li><a href="" onClick="jsGoDownG('terms10'); return false;">제10조 - 기프트카드의 도난ㆍ분실 등에 따른 책임</a></li>
					<li><a href="" onClick="jsGoDownG('terms11'); return false;">제11조 - 기프트카드 위/변조 등에 대한 책임</a></li>
					<li><a href="" onClick="jsGoDownG('terms12'); return false;">제12조 - 이용약관의 효력 및 변경</a></li>
					<li><a href="" onClick="jsGoDownG('terms13'); return false;">제13조 - 이 약관에서 정하지 아니한 사항</a></li>
					<li><a href="" onClick="jsGoDownG('terms14'); return false;">제14조 - 관할법원</a></li>
				</ul>
