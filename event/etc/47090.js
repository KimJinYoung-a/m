...
function fnTeaserPutNumImg(fitm,no,param) {
	...
	frm.src="http://fiximage.10x10.co.kr/m/event/ddodak/ddodak_teaser_num" + no + ".gif?t="+param+"";
}
...
function fnPutNumImg(fitm,no,param) {
	var frm = document.getElementById(fitm);
	frm.src="http://fiximage.10x10.co.kr/m/event/ddodak/ddodak_num" + no + ".gif?t="+param+"";
}
