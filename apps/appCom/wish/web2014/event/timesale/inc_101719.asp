...
.time-items .price {margin-top:1vw; font-family:'CoreSansCBold', 'AppleSDGothicNeo-SemiBold', 'NotoSansKRMedium'; font-size:6.8vw; letter-spacing:-.1vw; white-space:nowrap;}
...
.time-items .price span {display:inline-block; margin-left:4vw; font-size:6vw; color:#ff3823;}
                            ...
                            <% END IF %>
									...
									<div class="desc">
                                        ...
                                        <% else %>
                                            ...
                                            <% ELSE %>
                                                <% if oTimeSale.FitemList(loopInt).Fsailyn="Y" then %>
