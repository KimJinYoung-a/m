...
{
	$.ajax({
		url: "/apps/appcom/wish/web2014/culturestation/event_commajax.asp?view=l&iCC="+page+"&eventid=<%=eCode%>",
		cache: false,
		async: false,
...
function cmtreg(cmtidx){
	...
	if (str.length=='2'){
		if (str=='i1'){
			location.href='/apps/appcom/wish/web2014/culturestation/event_comment.asp?view=l&eventid=<%=eCode%>';
			return;
		}else if (str=='99'){
			alert('로그인을 해주세요.');
			return;
...
<div class="heightGrid bgGry">
	<div class="content" id="contentArea">
		<div class="inner5 cmtCont">
			...
			<div class="tab01 noMove" id="writediv" style="display:<%=CHKIIF(vView="w","block","none")%>;">
				...
				<div class="tabContainer box1">
					<div id="cmtWrite" class="tabContent">
						<form method="post" action="/apps/appCom/wish/web2014/culturestation/doEventComment.asp" name="upcomment" target="iframeDB" style="margin:0px;">
			...
			<!--// 전체보기 -->
			<form name="frmactNew" id="frmactNew" method="post" action="/apps/appCom/wish/web2014/culturestation/doEventComment.asp" target="iframeDB" style="margin:0px;">
