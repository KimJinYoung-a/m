	...
	<div class="mainSection">
		<div class="container bgGry">
			...
			<div class="content" id="contentArea">
				<div class="wishMain">
					<div class="sorting">
						<p <% If vListGubun="TrendList" Then %>class="selected"<% End If %>><span class="button"><a href="WishMainList.asp">트랜드</a></span></p><%' for dev msg : 클릭시 selected 클래스 붙여주세요(작업시 퍼블리셔 문의) %>
						<p <% If vListGubun="FollowList" Then %>class="selected"<% End If %>><span class="button"><a href="WishMainList.asp?LstGun=FollowList">팔로우</a></span></p>
						<p <% If vListGubun="MateList" Then %>class="selected"<% End If %>><span class="button"><a href="WishMainList.asp?LstGun=MateList">메이트</a></span></p>
