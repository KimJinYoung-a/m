...
<div class="inner">
	...
	<div class="items type-card">
		<div class="desc">
			...
			<div class="etc">
				...
				<button class="tag wish btn-wish"><span class="icon icon-wish"><i class="hidden"> wish</i></span><span class="counting"><%= FormatNumber(oItem.Prd.FfavCount,0) %></span></button>
			</div>
		</div>
	</div>
	...
	<div class="btn-group">
		...
		<div class="btn-half"><a href="/category/category_itemPrd.asp?itemid=<%=itemid%>"><%=CHKIIF(oItem.Prd.FSellYn="Y","구매하기","상세보기")%></a></div>
	</div>
