...
<div id="content" class="content">
	...
	<%' 연관 상품 더보기 Test %>
		<% Select Case Trim(itemid) %>
			<% Case "1971902" %>
				<div class="related-item related1">
					<h2>연관 상품 더보기</h2>
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("휴대용선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|휴대용선풍기|top');"># 휴대용선풍기</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|선풍기|top');"># 선풍기</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("탁상용선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|탁상용선풍기|top');"># 탁상용선풍기</a></li>
							
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("스탠드선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|스탠드선풍기|top');"># 스탠드선풍기</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("USB선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|USB선풍기|top');"># USB선풍기</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("미니선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미니선풍기|top');"># 미니선풍기</a></li>
						<ul>
					</div>
				</div>
			<% Case "1971903" %>
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							...
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("핸디선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|핸디선풍기|top');"># 핸디선풍기</a></li>
			...
			<% Case "1685329" %>
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("휴대용선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword','<%=itemid%>|휴대용선풍기|top');"># 휴대용선풍기</a></li>
			...
			<% Case "1965839" %>
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("잠옷")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷|top');"># 잠옷</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("잠옷세트")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷세트|top');"># 잠옷세트</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("여름잠옷")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|여름잠옷|top');"># 여름잠옷</a></li>
							
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("파자마")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|파자마|top');"># 파자마</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("파자마세트")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|파자마세트|top');"># 파자마세트</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("여름파자마")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|여름파자마|top');"># 여름파자마</a></li>
						<ul>
					</div>
				</div>
			...
			<% Case "1919807" %>
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁기크리너")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁기크리너|top');"># 세탁기크리너</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁기청소")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁기청소|top');"># 세탁기청소</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁조크리너")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조크리너|top');"># 세탁조크리너</a></li>
							
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁조청소")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조청소|top');"># 세탁조청소</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁조")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조|top');"># 세탁조</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁조세제")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조세제|top');"># 세탁조세제</a></li>
						<ul>
					</div>
				</div>
				...
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							...
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("유카타잠옷")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|유카타잠옷|top');"># 유카타잠옷</a></li>
							
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("잠옷가운")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷가운|top');"># 잠옷가운</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("로브")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|로브|top');"># 로브</a></li>
						<ul>
					</div>
				</div>
			...
			<% Case "1926844" %>
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("생리통초콜릿")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|생리통초콜릿|top');"># 생리통초콜릿</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("스위스초콜릿")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|스위스초콜릿|top');"># 스위스초콜릿</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("초콜릿")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|초콜릿|top');"># 초콜릿</a></li>
							
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("초콜렛")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|초콜렛|top');"># 초콜렛</a></li>
						<ul>
					</div>
				</div>
			...
			<% Case "1967223" %>
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("밀키머그")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|밀키머그|top');"># 밀키머그</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("무지머그")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|무지머그|top');"># 무지머그</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("머그")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|머그|top');"># 머그</a></li>
							
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("머그컵")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|머그컵|top');"># 머그컵</a></li>
						<ul>
					</div>
				</div>
			...
			<% Case "1945551" %>
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("수세미")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|수세미|top');"># 수세미</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("일회용수세미")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|일회용수세미|top');"># 일회용수세미</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("주방수세미")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|주방수세미|top');"># 주방수세미</a></li>
							
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("생활공작소")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|생활공작소|top');"># 생활공작소</a></li>
						<ul>
					</div>
				</div>
			...
			<% Case "1191473" %>
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("공기청정기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|공기청정기|top');"># 공기청정기</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("공기정화기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|공기정화기|top');"># 공기정화기</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("미세먼지공기청정기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미세먼지공기청정기|top');"># 미세먼지공기청정기</a></li>
							
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("미니공기청정기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미니공기청정기|top');"># 미니공기청정기</a></li>
						<ul>
					</div>
				</div>
			...
			<% Case "1971052" %>
				<div class="related-item related1">
					...
					<div class="swiper-container">
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("폴라로이드")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|폴라로이드|top');"># 폴라로이드</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("즉석카메라")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword','<%=itemid%>|즉석카메라|top');"># 즉석카메라</a></li>

							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("포토프린터")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|포토프린터|top');"># 포토프린터</a></li>
							
							<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("LG포켓포토")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|LG포켓포토|top');"># LG포켓포토</a></li>
						<ul>
					</div>
				</div>
		<% End Select %>
	...
	<div class="itemPrdV16a itemPrdV17">
		...
		<%' 연관 상품 더보기 Test %>
			<% Select Case Trim(itemid) %>
				<% Case "1971902" %>
					<div class="related-item related2">
						<h2>연관 상품 더보기</h2>
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("휴대용선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|휴대용선풍기|bottom');"># 휴대용선풍기</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|선풍기|bottom');"># 선풍기</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("탁상용선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|탁상용선풍기|bottom');"># 탁상용선풍기</a></li>
								
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("스탠드선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|스탠드선풍기|bottom');"># 스탠드선풍기</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("USB선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|USB선풍기|bottom');"># USB선풍기</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("미니선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미니선풍기|bottom');"># 미니선풍기</a></li>
							<ul>
						</div>
					</div>
				<% Case "1971903" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								...
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("핸디선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|핸디선풍기|bottom');"># 핸디선풍기</a></li>
				...
				<% Case "1685329" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("휴대용선풍기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword','<%=itemid%>|휴대용선풍기|bottom');"># 휴대용선풍기</a></li>
				...
				<% Case "1965839" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("잠옷")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷|bottom');"># 잠옷</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("잠옷세트")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷세트|bottom');"># 잠옷세트</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("여름잠옷")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|여름잠옷|bottom');"># 여름잠옷</a></li>
								
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("파자마")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|파자마|bottom');"># 파자마</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("파자마세트")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|파자마세트|bottom');"># 파자마세트</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("여름파자마")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|여름파자마|bottom');"># 여름파자마</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1919807" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁기크리너")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁기크리너|bottom');"># 세탁기크리너</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁기청소")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁기청소|bottom');"># 세탁기청소</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁조크리너")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조크리너|bottom');"># 세탁조크리너</a></li>
								
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁조청소")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조청소|bottom');"># 세탁조청소</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁조")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조|bottom');"># 세탁조</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("세탁조세제")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|세탁조세제|bottom');"># 세탁조세제</a></li>
							<ul>
						</div>
					</div>
					...
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								...
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("유카타잠옷")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|유카타잠옷|bottom');"># 유카타잠옷</a></li>
								
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("잠옷가운")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|잠옷가운|bottom');"># 잠옷가운</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("로브")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|로브|bottom');"># 로브</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1926844" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("생리통초콜릿")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|생리통초콜릿|bottom');"># 생리통초콜릿</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("스위스초콜릿")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|스위스초콜릿|bottom');"># 스위스초콜릿</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("초콜릿")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|초콜릿|bottom');"># 초콜릿</a></li>
								
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("초콜렛")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|초콜렛|bottom');"># 초콜렛</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1967223" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("밀키머그")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|밀키머그|bottom');"># 밀키머그</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("무지머그")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|무지머그|bottom');"># 무지머그</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("머그")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|머그|bottom');"># 머그</a></li>
								
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("머그컵")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|머그컵|bottom');"># 머그컵</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1945551" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("수세미")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|수세미|bottom');"># 수세미</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("일회용수세미")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|일회용수세미|bottom');"># 일회용수세미</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("주방수세미")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|주방수세미|bottom');"># 주방수세미</a></li>
								
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("생활공작소")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|생활공작소|bottom');"># 생활공작소</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1191473" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("공기청정기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|공기청정기|bottom');"># 공기청정기</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("공기정화기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|공기정화기|bottom');"># 공기정화기</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("미세먼지공기청정기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미세먼지공기청정기|bottom');"># 미세먼지공기청정기</a></li>
								
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("미니공기청정기")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|미니공기청정기|bottom');"># 미니공기청정기</a></li>
							<ul>
						</div>
					</div>
				...
				<% Case "1971052" %>
					<div class="related-item related1">
						...
						<div class="swiper-container">
							<ul class="swiper-wrapper">
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("폴라로이드")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|폴라로이드|bottom');"># 폴라로이드</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("즉석카메라")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword','<%=itemid%>|즉석카메라|bottom');"># 즉석카메라</a></li>

								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("포토프린터")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|포토프린터|bottom');"># 포토프린터</a></li>
								
								<li class="swiper-slide"><a href="/search/search_item.asp?rect=<%=Server.URLEncode("LG포켓포토")%>&burl=<%=Server.URLEncode("http://m.10x10.co.kr")%>" onclick="fnAmplitudeEventMultiPropertiesAction('click_item_keyword_test','itemid|keyword|location','<%=itemid%>|LG포켓포토|bottom');"># LG포켓포토</a></li>
							<ul>
						</div>
					</div>
			<% End Select %>
