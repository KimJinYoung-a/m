...
'''======================================================================== /inipayAPI/card/order_temp_save.asp 동일
...
isCrossPlatform = TRUE
	...
	LGD_CUSTOM_SKIN            = "red"                               '상점정의 결제창 스킨 (red, blue, cyan, green, yellow, SMART_XPAY2)

    '/*
	' * LGD_RETURNURL 을 설정하여 주시기 바랍니다. 반드시 현재 페이지와 동일한 프로트콜 및  호스트이어야 합니다. 아래 부분을 반드시 수정하십시요.
	' */
	LGD_RETURNURL				= httpOrSSLTenURL&"/apps/appCom/between/inipayAPI/xpay/returnurl_submit.asp"


    '/*
    ' * 가상계좌(무통장) 결제 연동을 하시는 경우 아래 LGD_CASNOTEURL 을 설정하여 주시기 바랍니다.
    ' */
	'''LGD_CASNOTEURL             = httpOrSSLTenURL&"/apps/appCom/between/inipayAPI/xpay/cas_noteurl.asp"
	'/*
	' * ISP 카드결제 연동중 모바일ISP방식(고객세션을 유지하지않는 비동기방식)의 경우, LGD_KVPMISPNOTEURL/LGD_KVPMISPWAPURL/LGD_KVPMISPCANCELURL를 설정하여 주시기 바랍니다.
	' */
	'LGD_KVPMISPNOTEURL       = httpOrSSLTenURL&"/apps/appCom/between/inipayAPI/xpay/note_url.asp"
	'LGD_KVPMISPWAPURL		 = httpOrSSLTenURL&"/apps/appCom/between/inipayAPI/xpay/mispwapurl.asp?LGD_OID=" + LGD_OID    'ISP 카드 결제시, URL 대신 앱명 입력시, 앱호출함
	'LGD_KVPMISPCANCELURL     = httpOrSSLTenURL&"/apps/appCom/between/inipayAPI/xpay/cancel_url.asp"
