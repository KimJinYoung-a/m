	...
	<div class="swiper-container swiper3">
		<div class="swiper-wrapper">
			<ul class="relationWish swiper-slide">
				<li class="folderTit">
					<a href="/my10x10/myWish/myWish.asp?ucid=<%=server.Urlencode(tenEnc(oWishCol.FItemList(0).Fuserid))%>">
			...
			%>
				<li><a href="/category/category_itemPrd.asp?itemid=<%=oWishCol.FItemList(i).Fitemid%>"><img src="<%=getThumbImgFromURL(oWishCol.FItemList(i).FimageOrg,110,110,"true","false")%>" alt="<%=replace(oWishCol.FItemList(i).Fitemname,"""","")%>" /></a></li>
			<%
					'그룹 구분
			...
			<ul class="relationWish swiper-slide">
				<li class="folderTit">
					<a href="/my10x10/myWish/myWish.asp?ucid=<%=server.Urlencode(tenEnc(oWishCol.FItemList(i+1).Fuserid))%>">
