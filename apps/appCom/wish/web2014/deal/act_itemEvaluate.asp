...
//-->
						...
						<div class="bxWt1V16a">
							<ul class="btnBarV16a">
								<li <%=CHKIIF(tabno="3","class='current'","")%> name="cmtTab01" style="width:50%;"><div><a href="" onclick="tabchange('/apps/appcom/wish/web2014/deal/act_itemEvaluate.asp?itemid=<%=itemid%>&tcnt=<%=tcnt%>&cpg=1&tabno=3&tnm=<%=tabname%>');return false;">상품후기<span>(<%=oItem.Prd.FEvalCnt%>/<%=tcnt%>)</span></a></div></li>
								<li <%=CHKIIF(tabno="31","class='current'","")%> name="cmtTab02" style="width:50%;"><div><a href="" onclick="tabchange('/apps/appcom/wish/web2014/deal/act_itemEvaluate.asp?itemid=<%=itemid%>&tcnt=<%=tcnt%>&cpg=1&tabno=31&tnm=<%=tabname%>');return false;">포토후기<span>(<%=oItem.Prd.FEvalCnt_photo%>)</span></a></div></li>
							</ul>
						</div>
						...
						<div class="postContV16a" id="post01">
							...
							<div class="btnAreaV16a">
								<p><button type="button" class="btnV16a btnRed1V16a" onclick="fnAPPpopupBrowserURL('상품후기','<%=wwwUrl%>/apps/appcom/wish/web2014/category/pop_ItemEvalList.asp?itemid=<%=itemid%>&sortMtd=<% If tabno="21" Then Response.write "ph" End If %><% If tabno="22" Then Response.write "ne" End If %>'); return false;">전체보기</button></p>
							</div>
							<% End If %>
						</div>
						<% End If %>
