...
strHeadTitleName = "마일리지 내역"
	...
	if (getEncLoginUserID<>"") then ''추가2016/02/25
	If onoff = "o" Then
...
<div class="heightGrid">
	...
	<div id="content" class="content my-own-detail mileage-index">
        <div class="own-info">
            ...
            <div class="btn-membership-card"><a href="/offshop/point/popbarcode.asp">텐바이텐 멤버십카드 보기</a></div>
            <div class="btn-regist"><a href="/offshop/point/cardregister.asp"><span class="icon-plus icon-plus-white"></span></a></div>
        </div>
...
<!--
			<div class="content" id="contentArea">
				<div class="inner10 mgList">
					...
					<p class="ct tMar20"><span class="button btB1 btRed cWh1 w70p"><a href="" onclick="fnOpenModal('/offshop/point/popmileagechange.asp');return false;">온라인 마일리지로 전환</a></span></p>
					<div class="tab02 tMar20">
						<ul class="tabNav tNum2">
							<li class="<%=chkiif(onoff="o","current","")%>"><a href="?page=1&onoff=o">온라인(<%=FormatNumber(myMileage.FTotalMileage,0) %>p)</a></li>
							<li class="<%=chkiif(onoff="f","current","")%>"><a href="?page=1&onoff=f">오프라인(<%=FormatNumber(myOffMileage.FOffShopMileage,0) %>p)</a></li>
						</ul>
						<div class="tabContainer">
							...
							<% End If %>
							<form name="frm" method="get" action="mileagelist.asp" style="margin:0px;">
