	...
	Select Case Trim(mode)
		Case "add"
			...
			IF Not rsget.Eof Then
				If rsget(0) > 0 Then
					Response.Write "Err|오늘은 이미 출석 완료하였습니다"
					response.End
				End If
			End IF
			rsget.close
			...
			vQuery = " insert into db_user.dbo.tbl_mileagelog(userid , mileage , jukyocd , jukyo , deleteyn) values ('"&userid&"', '+"&sumMileage&"','"&eCode&"', '출석체크 이벤트 (21.11.29까지 사용 가능)','N') "
			dbget.Execute vQuery
			...
			Response.Write "OK|"&TomorrowMileage&"P"&"|"&TodayCount&"|"&FormatNumber(TotalMileage, 0)&"|"&CurrentMileage
			Response.End
