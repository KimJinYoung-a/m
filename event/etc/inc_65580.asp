...
<%
'####################################################
' Description : ## [타겟] 신데렐라쿠폰! 
' History : 2015-08-13 유태욱 생성
'####################################################
...
function checkform(){
	...
	<% If vUserID <> "" Then %>
		...
		<% Else %>
			var str = $.ajax({
				type: "GET",
				url: "/event/etc/doeventsubscript/doEventSubscript65580.asp",
				data: "mode=add",
				dataType: "text",
				async: false
			}).responseText;
...
alert(str);
	...
	<div class="mEvt65433">
		<div class="topic">
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/65580/txt_cinderella.png" alt="쿠폰 들고 돌아온 호박마차! 낮 버전 이벤트 기간은 8월 12일 수요일부터 8월 14일 금요일까지 진행합니다." /></p>
		...
		<div class="couponArea">
			...
			<p><img src="http://webimage.10x10.co.kr/eventIMG/2015/65580/txt_coupon.png" alt="토요일이 되면 사용하지 않는 쿠폰은 사라집니다. 쿠폰이 사라지기 전에 꼭 사용해주세요." /></p>
		</div>
		...
		<div class="noti">
			...
			<ul>
				...
				<li>쿠폰은 8월16일(일) 23시59분 59초까지 사용 할 수 있습니다.</li>
			</ul>
		</div>
	</div>
<script type="text/javascript">
