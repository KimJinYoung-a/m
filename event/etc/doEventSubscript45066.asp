	...
	ElseIf result="2" Then
		If renloop = 300 Then
			...
			sqlstr = "select count(case when sub_opt2='2' then sub_idx end) as cnt2 " &_
					"  from db_event.dbo.tbl_event_subscript where evt_code='"& evt_code &"' and sub_opt3='secret'"
					'response.write sqlstr
			rsget.Open sqlStr,dbget,1
				secret_cnt2 = rsget(0)
			rsget.Close
			If secret_cnt2 < 2 Then	'### 2명만
				sqlStr = "Update db_event.dbo.tbl_event_subscript set sub_opt2='" & result & "', sub_opt3='secret'" &_
						 " where userid='" & loginid & "' and sub_idx='"& sidx & "'"
				dbget.execute(sqlStr)

				aa = "<img src='http://webimage.10x10.co.kr/eventIMG/2013/45067/45067_gift03.png' alt='시크릿선물' style='width:100%;' /> <p class='okBtn'><a href='/event/eventmain.asp?eventid=45067' target='_top'><img src='http://webimage.10x10.co.kr/eventIMG/2013/44416/44416_btn02.png' alt='확인' style='width:100%;' /></a></p>"
			else
				aa = "<img src='http://webimage.10x10.co.kr/eventIMG/2013/45067/45067_gift01.png' alt='3000원 할인쿠폰' style='width:100%;' /> <p class='okBtn'><a href='/event/eventmain.asp?eventid=45067' target='_top'><img src='http://webimage.10x10.co.kr/eventIMG/2013/44416/44416_btn02.png' alt='확인' style='width:100%;' /></a></p>"
				sqlStr = "insert into db_user.dbo.tbl_user_coupon " &_
						...
						" select '448','" & loginid & "','2','3000','화난 직장인을 달래주세요!(3,000원 할인쿠폰)','20000','2013-09-02 00:00:00' ,'2013-09-10 23:59:59','',0,'system'"
	...
	ElseIf result="4" Then
		If renloop = 300 Then
			...
			If secret_cnt4 < 3 Then	'### 3명만
				...
				aa = "<img src='http://webimage.10x10.co.kr/eventIMG/2013/45067/45067_gift02.png' alt='무료배송쿠폰' style='width:100%;' /> <p class='okBtn'><a href='/event/eventmain.asp?eventid=45067' target='_top'><img src='http://webimage.10x10.co.kr/eventIMG/2013/44416/44416_btn02.png' alt='확인' style='width:100%;' /></a></p>"

				sqlStr = "insert into db_user.dbo.tbl_user_coupon " &_
						" (masteridx,userid,coupontype,couponvalue,couponname,minbuyprice,startdate,expiredate,targetitemlist,couponmeaipprice,reguserid) " &_
						" select '449','" & loginid & "','3','2000','화난 직장인을 달래주세요!(무료배송쿠폰)','20000','2013-09-02 00:00:00' ,'2013-09-10 23:59:59','',0,'system'"
