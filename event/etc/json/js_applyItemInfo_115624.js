						...
						if(isPrc){
							if(isSale){
								...
								if(this.saleper !=null && this.saleper!="") {
									...
									if(opts.saleBracket) {
										$("#"+opts.target+" li .price").eq(i).html("<s>"+this.orgprice+"</s> "+this.sellprice+"원<span "+saleCouponTag+">["+this.saleper+"]</span>");
									} else {
										$("#"+opts.target+" li .price").eq(i).html("<s>"+this.orgprice+"</s> "+this.sellprice+"원<span "+saleCouponTag+">"+this.saleper+"</span>");
									}
								} else {
...
function fnApplyItemInfoList6(opts) {
	// 필터 정의
	var isImg=false, 
		isNm=false, 
		isPrc=false, 
...
function fnApplyItemInfoList7(opts) {
	// 필터 정의
	var isImg=false, 
		isNm=false, 
		isPrc=false, 
...
function fnApplyItemInfoList8(opts) {
	// 필터 정의
	var isImg=false, 
		isNm=false, 
		isPrc=false, 
