...
function currenttime()
	...
	tmpcurrenttime = now()
	'tmpcurrenttime = #10/13/2014 11:01:00#
...
function dateopenyn(timeval)
	...
	elseif left(timeval,10)="2014-10-09" then
		if timeval >= #10/09/2014 11:00:00# then tmpopenyn="Y"
	...
	elseif left(timeval,10)="2014-10-14" then
		if timeval >= #10/14/2014 10:00:00# then tmpopenyn="Y"
	elseif left(timeval,10)="2014-10-15" then
		if timeval >= #10/15/2014 09:30:00# then tmpopenyn="Y"
	elseif left(timeval,10)="2014-10-16" then
		if timeval >= #10/16/2014 11:00:00# then tmpopenyn="Y"
	elseif left(timeval,10)="2014-10-17" then
		if timeval >= #10/17/2014 09:00:00# then tmpopenyn="Y"
	elseif left(timeval,10)="2014-10-20" then
		if timeval >= #10/20/2014 10:10:00# then tmpopenyn="Y"
	end if
