...
<!-- Brand Components -->
<script src="/vue/components/brand/brd_list.js?v=1.1"></script>
<script src="/vue/components/brand/brd_img.js?v=1.0"></script>
<script src="/vue/components/brand/brd_info.js?v=1.0"></script>
<!-- //Brand Components -->

<!-- Core -->
<script src="/vue/search/Result/brand_store.js?v=1.1"></script>
<script src="/vue/search/Result/brand_result.js?v=1.01"></script>
<!-- //Core -->