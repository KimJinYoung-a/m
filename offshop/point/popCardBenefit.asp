		...
		<div id="content" class="content mileage-guide">
			...
			<div class="guide guide1">
				...
				<p class="ftLt">
					...
					<a href="/my10x10/userinfo/grade_guide.asp"></a>
					<!--<a href="" onclick="fnAPPpopupBrowserURL('등급별 혜택','/apps/appCom/wish/web2014/my10x10/userinfo/grade_guide.asp');return false;"></a>-->
				</p>
				<p class="ftRt">
