...
.mEvt111585 .topic .sub-txt {position:absolute; left:50%; top:26rem; width:43.37vw; transform: translate(-50%,0); opacity:0; transition:all 1s .5s;}
.mEvt111585 .topic .sub-txt.on {opacity:1; top:28rem;}
.mEvt111585 .topic .icon-app {position:absolute; right:7%; top:68%; width:15.9vw; animation:updown 1s ease-in-out alternate infinite;}
...
.mEvt111585 .section-01 .bg-prd-item01 {display:none; position:absolute; left:16%; top:14%; width:35.47vw; height:16vw; background:transparent;}
...
.mEvt111585 .section-01 .bg-prd-item03 {display:none; position:absolute; left:8%; top:28%; width:35.47vw; height:16vw; background:transparent;}
.mEvt111585 .section-01 .bg-prd-item04 {display:none; position:absolute; right:12%; top:29%; width:35.47vw; height:16vw; background:transparent;}
.mEvt111585 .section-01 .bg-prd-item05 {display:none; position:absolute; left:8%; bottom:40%; width:35.47vw; height:16vw; background:transparent;}
.mEvt111585 .section-01 .bg-prd-item06 {display:none; position:absolute; right:31%; bottom:43%; width:35.47vw; height:16vw; background:transparent;}
.mEvt111585 .section-01 .bg-prd-item07 {display:none; position:absolute; right:37%; bottom:9%; width:35.47vw; height:16vw; background:transparent;}
        ...
        buttons: [
			...
			<div class="mEvt111585">
                ...
                <div class="topic">
                    ...
                    <div class="sub-txt"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/tit_sub02.png" alt="지금 텐바이텐 APP에서 바로 응모하세요!"></div>
                    <div class="icon-app"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/icon_app.png" alt="app 전용"></div>
                ...
                <div class="section-01">
                    ...
                    <button type="button" class="btn-item item01">
                        <a href="" class="prd-info disabled"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/img_item01.png" alt="활용도 200% 꼭 필요한 폴딩박스"></a>
                        <span><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/icon_cros.png" alt=""></span>
                    </button>
                    <div class="bg-prd bg-prd-item01"></div>
                    ...
                    <button type="button" class="btn-item item03">
                        <a href="" class="prd-info disabled"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/img_item03.png" alt="편리한 캠핑을 위한 첨스 폴딩 웨건"></a>
                        <span><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/icon_cros.png" alt=""></span>
                    </button>
                    <div class="bg-prd bg-prd-item03"></div>
                    <button type="button" class="btn-item item04">
                        <a href="" class="prd-info disabled"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/img_item04.png" alt="어두운 밤 더 분위기있게 스누피 무드등"></a>
                        <span><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/icon_cros.png" alt=""></span>
                    </button>
                    <div class="bg-prd bg-prd-item04"></div>
                    <button type="button" class="btn-item item05">
                        <a href="" class="prd-info disabled"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/img_item05.png" alt="귀엽고 고급스럽다 스누피 코펠세트"></a>
                        <span><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/icon_cros.png" alt=""></span>
                    </button>
                    <div class="bg-prd bg-prd-item05"></div>
                    <button type="button" class="btn-item item06">
                        <a href="" class="prd-info disabled"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/img_item06.png" alt="캠핑의 기본 감성적인 데코뷰 의자"></a>
                        <span><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/icon_cros.png" alt=""></span>
                    </button>
                    <div class="bg-prd bg-prd-item06"></div>
                    <button type="button" class="btn-item item07">
                        <p class="prd-info disabled"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/img_item07.png" alt="컵홀더까지 있고 완벽해 폴딩 테이블"></p>
                        <span><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/icon_cros.png" alt=""></span>
                    </button>
                    <div class="bg-prd bg-prd-item07"></div>
                </div>
                <!-- 응모하기 버튼 -->
                <a href="https://tenten.app.link/q58XD5Fwlgb?%24deeplink_no_attribution=true" class="btn-apply"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/btn_apply02.jpg" alt="APP에서 응모하기"></a>
                ...
                <a href="/event/eventmain.asp?eventid=111230"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/img_link01.jpg" alt="캠핑 갈 때 꼭 준비해야 할 6가지"></a>
                <a href="/event/eventmain.asp?eventid=111188"><img src="//webimage.10x10.co.kr/fixevent/event/2021/111585/m/img_link02.jpg" alt="캐핑은 장비빨!"></a>
                <!-- 카카오 공유하기 링크 -->
